...
func TestToBytes(t *testing.T) {
	tests := []struct {
		...
		{a: 255, b: []byte{255, 0}},
		{a: 256, b: []byte{0, 1}},
		{a: 65534, b: []byte{254, 255}},
		{a: 65535, b: []byte{255, 255}},
		{a: 0, b: []byte{0, 0, 0}},
		{a: 255, b: []byte{255, 0, 0}},
		{a: 256, b: []byte{0, 1, 0}},
		{a: 65535, b: []byte{255, 255, 0}},
		{a: 65536, b: []byte{0, 0, 1}},
		{a: 16777215, b: []byte{255, 255, 255}},
		{a: 0, b: []byte{0, 0, 0, 0}},
		{a: 256, b: []byte{0, 1, 0, 0}},
		{a: 65536, b: []byte{0, 0, 1, 0}},
		{a: 16777216, b: []byte{0, 0, 0, 1}},
		{a: 16777217, b: []byte{1, 0, 0, 1}},
		{a: 4294967295, b: []byte{255, 255, 255, 255}},
		{a: 0, b: []byte{0, 0, 0, 0, 0, 0, 0, 0}},
		{a: 16777216, b: []byte{0, 0, 0, 1, 0, 0, 0, 0}},
		{a: 4294967296, b: []byte{0, 0, 0, 0, 1, 0, 0, 0}},
		{a: 4294967297, b: []byte{1, 0, 0, 0, 1, 0, 0, 0}},
		{a: 9223372036854775806, b: []byte{254, 255, 255, 255, 255, 255, 255, 127}},
		{a: 9223372036854775807, b: []byte{255, 255, 255, 255, 255, 255, 255, 127}},
	}
...
func TestSetBit(t *testing.T) {
	tests := []struct {
		...
		{a: []byte{0b00000000}, b: 1, c: []byte{0b00000010}},
		{a: []byte{0b00000010}, b: 7, c: []byte{0b10000010}},
		{a: []byte{0b10000010}, b: 9, c: []byte{0b10000010, 0b00000010}},
		{a: []byte{0b10000010}, b: 27, c: []byte{0b10000010, 0b00000000, 0b00000000, 0b00001000}},
		{a: []byte{0b10000010, 0b00000000}, b: 8, c: []byte{0b10000010, 0b00000001}},
		{a: []byte{0b10000010, 0b00000000}, b: 31, c: []byte{0b10000010, 0b00000000, 0b00000000, 0b10000000}},
	}
	for _, tt := range tests {
...
func TestClearBit(t *testing.T) {
	tests := []struct {
		...
		{a: []byte{0b00000000}, b: 1, c: []byte{0b00000000}},
		{a: []byte{0b00000010}, b: 1, c: []byte{0b00000000}},
		{a: []byte{0b10000010}, b: 1, c: []byte{0b10000000}},
		{a: []byte{0b10000010}, b: 8, c: []byte{0b10000010}},
		{a: []byte{0b10000010, 0b00001111}, b: 7, c: []byte{0b00000010, 0b00001111}},
		{a: []byte{0b10000010, 0b00001111}, b: 10, c: []byte{0b10000010, 0b00001011}},
	}
	for _, tt := range tests {
