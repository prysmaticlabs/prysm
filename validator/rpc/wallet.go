...
func (s *Server) WalletConfig(ctx context.Context, _ *emptypb.Empty) (*pb.WalletResponse, error) {
...
func (s *Server) GenerateMnemonic(_ context.Context, _ *emptypb.Empty) (*pb.GenerateMnemonicResponse, error) {
