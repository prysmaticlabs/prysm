...
func (m *MockBeaconServiceClient) GenesisStartTime(arg0 context.Context, arg1 *empty.Empty, arg2 ...grpc.CallOption) (*v10.GenesisTime, error) {
	varargs := []interface{}{arg0, arg1}
	for _, a := range arg2 {
		varargs = append(varargs, a)
	}
	ret := m.ctrl.Call(m, "GenesisStartTime", varargs...)
...
func (mr *MockBeaconServiceClientMockRecorder) GenesisStartTime(arg0, arg1 interface{}, arg2 ...interface{}) *gomock.Call {
	varargs := append([]interface{}{arg0, arg1}, arg2...)
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GenesisStartTime", reflect.TypeOf((*MockBeaconServiceClient)(nil).GenesisStartTime), varargs...)
}
