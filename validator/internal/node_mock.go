...
func (m *MockNodeClient) GetNodeInfo(ctx context.Context, in *types.Empty, opts ...grpc.CallOption) (*v1alpha1.NodeInfo, error) {
	m.ctrl.T.Helper()
...
func (mr *MockNodeClientMockRecorder) GetNodeInfo(ctx, in interface{}, opts ...interface{}) *gomock.Call {
...
// GetNodeInfo mocks base method
func (m *MockNodeServer) GetNodeInfo(arg0 context.Context, arg1 *types.Empty) (*v1alpha1.NodeInfo, error) {
	m.ctrl.T.Helper()
...
// GetNodeInfo indicates an expected call of GetNodeInfo
func (mr *MockNodeServerMockRecorder) GetNodeInfo(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetNodeInfo", reflect.TypeOf((*MockNodeServer)(nil).GetNodeInfo), arg0, arg1)
}
