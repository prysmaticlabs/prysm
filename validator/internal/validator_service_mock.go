...
func (m *MockValidatorServiceClient) WaitTillSync(arg0 context.Context, arg1 *types.Empty, arg2 ...grpc.CallOption) (*types.Empty, error) {
	m.ctrl.T.Helper()
	varargs := []interface{}{arg0, arg1}
	for _, a := range arg2 {
		varargs = append(varargs, a)
...
func (mr *MockValidatorServiceClientMockRecorder) WaitTillSync(arg0, arg1 interface{}, arg2 ...interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]interface{}{arg0, arg1}, arg2...)
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "WaitTillSync", reflect.TypeOf((*MockValidatorServiceClient)(nil).WaitTillSync), varargs...)
}
