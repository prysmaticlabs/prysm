...
func (v *validator) SubmitAggregateAndProof(ctx context.Context, slot params.SlotNumber, pubKey params.KeyBytes) {
...
func (v *validator) signSlot(ctx context.Context, pubKey params.KeyBytes, slot params.SlotNumber) ([]byte, error) {
...
func (v *validator) waitToSlotTwoThirds(ctx context.Context, slot params.SlotNumber) {
