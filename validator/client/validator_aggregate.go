...
func (v *validator) SubmitAggregateAndProof(ctx context.Context, slot uint64, pubKey [params.KEY_BYTES_LENGTH]byte) {
...
func (v *validator) signSlot(ctx context.Context, pubKey [params.KEY_BYTES_LENGTH]byte, slot uint64) ([]byte, error) {
