...
func (v *validator) SubmitAggregateAndProof(ctx context.Context, slot uint64, pubKey params.KeyBytes) {
...
func (v *validator) signSlot(ctx context.Context, pubKey params.KeyBytes, slot uint64) ([]byte, error) {
