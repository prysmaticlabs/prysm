...
func (c *beaconApiValidatorClient) submitValidatorRegistrations(registrations []*ethpb.SignedValidatorRegistrationV1) error {
	...
	if _, err := c.jsonRestHandler.PostRestJson(endpoint, nil, bytes.NewBuffer(marshalledJsonRegistration), nil); err != nil {
