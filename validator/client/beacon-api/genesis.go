...
type genesisProvider interface {
	GetGenesis(ctx context.Context) (*shared.GenesisResponse, *apimiddleware.DefaultErrorJson, error)
}
...
func (c beaconApiGenesisProvider) GetGenesis(ctx context.Context) (*shared.GenesisResponse, *apimiddleware.DefaultErrorJson, error) {
	genesisJson := &struct {
