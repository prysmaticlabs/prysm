...
func (c beaconApiValidatorClient) submitSignedContributionAndProof(in *ethpb.SignedContributionAndProof) error {
	if in == nil {
	...
	if _, err := c.jsonRestHandler.PostRestJson("/eth/v1/validator/contribution_and_proofs", nil, bytes.NewBuffer(jsonContributionAndProofsBytes), nil); err != nil {
