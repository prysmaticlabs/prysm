...
func TestProposeBeaconBlock_BlindedCapella(t *testing.T) {
		...
		Message: &apimiddleware.BlindedBeaconBlockCapellaJson{
			...
			Body: &apimiddleware.BlindedBeaconBlockBodyCapellaJson{
				...
				ExecutionPayloadHeader: &apimiddleware.ExecutionPayloadHeaderCapellaJson{
					BaseFeePerGas:    littleEndianBytesToString(blindedCapellaBlock.BlindedCapella.Block.Body.ExecutionPayloadHeader.BaseFeePerGas),
	...
	assert.DeepEqual(t, blindedCapellaBlock.BlindedCapella.Block.Body.Attestations[0].Data.BeaconBlockRoot, proposeResponse.BlockRoot)
}
			...
			Block: &ethpb.BlindedBeaconBlockCapella{
				...
				Body: &ethpb.BlindedBeaconBlockBodyCapella{
					...
					ExecutionPayloadHeader: &enginev1.ExecutionPayloadHeaderCapella{
						...
						WithdrawalsRoot:  []byte{126},
					},
					BlsToExecutionChanges: []*ethpb.SignedBLSToExecutionChange{
						{
							Message: &ethpb.BLSToExecutionChange{
								ValidatorIndex:     127,
								FromBlsPubkey:      []byte{128},
								ToExecutionAddress: []byte{129},
							},
							Signature: []byte{130},
						},
						{
							Message: &ethpb.BLSToExecutionChange{
								ValidatorIndex:     131,
								FromBlsPubkey:      []byte{132},
								ToExecutionAddress: []byte{133},
							},
							Signature: []byte{134},
						},
					},
