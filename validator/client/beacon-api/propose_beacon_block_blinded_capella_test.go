					...
					BlsToExecutionChanges: []*ethpb.SignedBLSToExecutionChange{
						{
							Message: &ethpb.BLSToExecutionChange{
								ValidatorIndex:     127,
								FromBlsPubkey:      fillByteSlice(48, 128),
								ToExecutionAddress: fillByteSlice(20, 129),
							},
						...
						},
						{
							Message: &ethpb.BLSToExecutionChange{
								ValidatorIndex:     131,
								FromBlsPubkey:      fillByteSlice(48, 132),
								ToExecutionAddress: fillByteSlice(20, 133),
							},
							Signature: fillByteSlice(96, 134),
						},
					},
				},
			},
			Signature: fillByteSlice(96, 135),
		},
	}
}
