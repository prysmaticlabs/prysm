...
func (c *beaconApiValidatorClient) submitSignedAggregateSelectionProof(in *ethpb.SignedAggregateSubmitRequest) (*ethpb.SignedAggregateSubmitResponse, error) {
	...
	if _, err := c.jsonRestHandler.PostRestJson("/eth/v1/validator/aggregate_and_proofs", nil, bytes.NewBuffer(body), nil); err != nil {
