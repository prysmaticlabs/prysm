...
func TestUpdateLogAggregateStats(t *testing.T) {
	...
	pubKeyBytes := [][48]byte{
		butil.ToBytes48([]byte("000000000000000000000000000000000000000012345678")),
		butil.ToBytes48([]byte("000000000000000000000000000000000000000099999999")),
		butil.ToBytes48([]byte("000000000000000000000000000000000000000055555555")),
	}
	...
	responses := []*ethpb.ValidatorPerformanceResponse{
		{
			PublicKeys: [][]byte{
				butil.FromBytes48(pubKeyBytes[0]),
				butil.FromBytes48(pubKeyBytes[1]),
				butil.FromBytes48(pubKeyBytes[2]),
			},
