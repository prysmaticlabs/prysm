...
type mocks struct {
	coordinator *validatormock.MockCoordinator
...
func setupWithKey(t *testing.T, validatorKey bls.SecretKey) (*validator, *mocks, bls.SecretKey, func()) {
	...
	m := &mocks{
		coordinator: validatormock.NewMockCoordinator(ctrl),
...
func TestProposeBlock_RequestBlockFailed(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			m.coordinator.EXPECT().GetBeaconBlock(
				gomock.Any(), // ctx
...
func TestProposeBlock_ProposeBlockFailed(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			m.coordinator.EXPECT().ProposeBeaconBlock(
				gomock.Any(), // ctx
...
func TestProposeExit_ValidatorIndexFailed(t *testing.T) {
	...
	m.coordinator.EXPECT().ValidatorIndex(
		gomock.Any(),
		gomock.Any(),
