...
type ValidatorClient interface {
	...
	ProposeAttestation(ctx context.Context, atts []*ethpb.Attestation) (*ethpb.AttestResponse, error)
	ProposeAttestationElectra(ctx context.Context, atts []*ethpb.SingleAttestation) (*ethpb.AttestResponse, error)
