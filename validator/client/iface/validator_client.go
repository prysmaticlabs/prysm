...
type ValidatorClient interface {
	...
	SubscribeCommitteeSubnets(ctx context.Context, in *ethpb.CommitteeSubnetsSubscribeRequest, validatorIndices []types.ValidatorIndex, currentSlot types.Epoch) (*empty.Empty, error)
