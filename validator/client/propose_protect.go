...
func (v *validator) preBlockSignValidations(
	ctx context.Context, pubKey [48]byte, block block2.BeaconBlock, signingRoot [32]byte,
) error {
...
func blockLogFields(pubKey [48]byte, blk block2.BeaconBlock, sig []byte) logrus.Fields {
