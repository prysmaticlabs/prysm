...
func (v *validator) preBlockSignValidations(
	ctx context.Context, pubKey [48]byte, block prysm.BeaconBlock, signingRoot [32]byte,
) error {
...
func blockLogFields(pubKey [48]byte, blk prysm.BeaconBlock, sig []byte) logrus.Fields {
