...
bazel build //proto/beacon/p2p/v1:v1_go_proto
bazel build //proto/beacon/rpc/v1:v1_go_proto
bazel build //proto/sharding/p2p/v1:v1_go_proto
bazel build //proto/common:common_go_proto
...
done < <(find -L bazel-bin/proto -type f -name "*pb.go" -print0)
