...
func ConfigToYaml(cfg *BeaconChainConfig) []byte {
	...
	lines = append(lines, fmt.Sprintf("SHARDING_FORK_EPOCH: %d", cfg.ShardingForkEpoch))
	lines = append(lines, fmt.Sprintf("SHARDING_FORK_VERSION: %#x", cfg.ShardingForkVersion))
