...
type BeaconChainConfig struct {
	...
	MaxRequestDataColumnSidecars          uint64           `yaml:"MAX_REQUEST_DATA_COLUMN_SIDECARS"`             // MaxRequestDataColumnSidecars is the maximum number of data columns to request in a single request.
