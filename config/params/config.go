...
type BeaconChainConfig struct {
	...
	GetHeaderCutoff                  time.Duration   // GetHeaderCutoff defines the cutoff time for getHeader request for seconds into the slot before falling back to local execution engine for block construction.
