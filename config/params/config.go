...
type BeaconChainConfig struct {
	...
	MaxWithdrawalsPerEpoch         uint64 `yaml:"MAX_WITHDRAWALS_PER_EPOCH" spec:"true"`          // MaxWithdrawalsPerEpoch is the maximum number of withdrawals that will be processed in an epoch.
