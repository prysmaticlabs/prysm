...
func InitializeFromProtoPhase0(st *ethpb.BeaconState) (types.BeaconState, error) {
...
func InitializeFromProtoAltair(st *ethpb.BeaconStateAltair) (types.BeaconState, error) {
...
func InitializeFromProtoBellatrix(st *ethpb.BeaconStateBellatrix) (types.BeaconState, error) {
...
func InitializeFromProtoCapella(st *ethpb.BeaconStateCapella) (types.BeaconState, error) {
...
func InitializeFromProtoUnsafePhase0(st *ethpb.BeaconState) (types.BeaconState, error) {
	if st == nil {
...
// and sets them as fields of the BeaconState type.
func InitializeFromProtoUnsafeAltair(st *ethpb.BeaconStateAltair) (types.BeaconState, error) {
	if st == nil {
		return nil, errors.New("received nil state")
	}
...
// and sets them as fields of the BeaconState type.
func InitializeFromProtoUnsafeBellatrix(st *ethpb.BeaconStateBellatrix) (types.BeaconState, error) {
	if st == nil {
		return nil, errors.New("received nil state")
	}
...
// and sets them as fields of the BeaconState type.
func InitializeFromProtoUnsafeCapella(st *ethpb.BeaconStateCapella) (types.BeaconState, error) {
	if st == nil {
		return nil, errors.New("received nil state")
	}
...
func (b *State) Copy() types.BeaconState {
	b.lock.RLock()
