...
var _ = types.ReadOnlyValidator(readOnlyValidator{})

// NewValidator initializes the read only wrapper for validator.
func NewValidator(v *ethpb.Validator) (types.ReadOnlyValidator, error) {
...
// checked.
func (v readOnlyValidator) IsFullyWithdrawable(epoch primitives.Epoch) bool {
