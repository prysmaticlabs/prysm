...
type Config struct {
	...
	MinValidatorSetChangeInterval          uint64    // MinValidatorSetChangeInterval is the slots needed before beacon node validator set changes.
	ShardPersistentCommitteeChangeInterval uint64    // ShardPersistentCommitteeChangeInterval is the slots needed before shard validator set changes.
...
var defaultConfig = &Config{
	...
	ShardPersistentCommitteeChangeInterval: uint64(65536),
