...
import (
	...
	"github.com/prysmaticlabs/prysm/v4/beacon-chain/api/eth/blob"
	rpcBuilder "github.com/prysmaticlabs/prysm/v4/beacon-chain/api/eth/builder"
	...
	lightclient "github.com/prysmaticlabs/prysm/v4/beacon-chain/api/eth/light-client"
	...
	nodeprysm "github.com/prysmaticlabs/prysm/v4/beacon-chain/api/prysm/node"
	beaconv1alpha1 "github.com/prysmaticlabs/prysm/v4/beacon-chain/api/prysm/v1alpha1/beacon"
	debugv1alpha1 "github.com/prysmaticlabs/prysm/v4/beacon-chain/api/prysm/v1alpha1/debug"
	nodev1alpha1 "github.com/prysmaticlabs/prysm/v4/beacon-chain/api/prysm/v1alpha1/node"
	validatorv1alpha1 "github.com/prysmaticlabs/prysm/v4/beacon-chain/api/prysm/v1alpha1/validator"
	httpserver "github.com/prysmaticlabs/prysm/v4/beacon-chain/api/prysm/validator"
...
func (s *Service) Start() {
	...
	s.cfg.Router.HandleFunc("/eth/v1/beacon/pool/attester_slashings", beaconChainServerV1.GetAttesterSlashings).Methods(http.MethodGet)
	s.cfg.Router.HandleFunc("/eth/v1/beacon/pool/attester_slashings", beaconChainServerV1.SubmitAttesterSlashing).Methods(http.MethodPost)
	s.cfg.Router.HandleFunc("/eth/v1/beacon/pool/proposer_slashings", beaconChainServerV1.GetProposerSlashings).Methods(http.MethodGet)
	s.cfg.Router.HandleFunc("/eth/v1/beacon/pool/proposer_slashings", beaconChainServerV1.SubmitProposerSlashing).Methods(http.MethodPost)
