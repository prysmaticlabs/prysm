...
// GenesisStartTime mocks base method
func (m *MockBeaconServiceServer) GenesisStartTime(arg0 context.Context, arg1 *empty.Empty) (*v10.GenesisTime, error) {
	ret := m.ctrl.Call(m, "GenesisStartTime", arg0, arg1)
	ret0, _ := ret[0].(*v10.GenesisTime)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GenesisStartTime indicates an expected call of GenesisStartTime
func (mr *MockBeaconServiceServerMockRecorder) GenesisStartTime(arg0, arg1 interface{}) *gomock.Call {
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GenesisStartTime", reflect.TypeOf((*MockBeaconServiceServer)(nil).GenesisStartTime), arg0, arg1)
}
