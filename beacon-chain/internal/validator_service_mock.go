...
func (mr *MockValidatorServiceServerMockRecorder) WaitTillSync(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "WaitTillSync", reflect.TypeOf((*MockValidatorServiceServer)(nil).WaitTillSync), arg0, arg1)
}
