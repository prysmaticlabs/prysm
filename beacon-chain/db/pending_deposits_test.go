...
func TestInsertPendingDeposit_OK(t *testing.T) {
	db := BeaconDB{}
	db.InsertPendingDeposit(context.Background(), &pb.Deposit{}, big.NewInt(111), 100)
...
func TestInsertPendingDeposit_ignoresNilDeposit(t *testing.T) {
	db := BeaconDB{}
	db.InsertPendingDeposit(context.Background(), nil /*deposit*/, nil /*blockNum*/, 0)
...
func TestPendingDeposit_RoundTrip(t *testing.T) {
	...
	db.InsertPendingDeposit(context.Background(), dep, big.NewInt(111), 100)
