...
func (e Exporter) publish(ctx context.Context, topic string, msg block2.SignedBeaconBlock) error {
...
func (e Exporter) SaveBlock(ctx context.Context, block block2.SignedBeaconBlock) error {
	go func() {
...
func (e Exporter) SaveBlocks(ctx context.Context, blocks []block2.SignedBeaconBlock) error {
	go func() {
