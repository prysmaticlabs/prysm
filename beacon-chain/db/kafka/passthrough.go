...
// Block -- passthrough.
func (e Exporter) Block(ctx context.Context, blockRoot [32]byte) (blockInterface.SignedBeaconBlock, error) {
	return e.db.Block(ctx, blockRoot)
}

// HeadBlock -- passthrough.
func (e Exporter) HeadBlock(ctx context.Context) (blockInterface.SignedBeaconBlock, error) {
	return e.db.HeadBlock(ctx)
}

// Blocks -- passthrough.
func (e Exporter) Blocks(ctx context.Context, f *filters.QueryFilter) ([]blockInterface.SignedBeaconBlock, [][32]byte, error) {
...
func (e Exporter) BlocksBySlot(ctx context.Context, slot types.Slot) (bool, []blockInterface.SignedBeaconBlock, error) {
...
func (e Exporter) GenesisBlock(ctx context.Context) (blockInterface.SignedBeaconBlock, error) {
...
func (e Exporter) FinalizedChildBlock(ctx context.Context, blockRoot [32]byte) (blockInterface.SignedBeaconBlock, error) {
...
func (e Exporter) HighestSlotBlocksBelow(ctx context.Context, slot types.Slot) ([]blockInterface.SignedBeaconBlock, error) {
