...
func TestStore_SaveAltairBlock_NoDuplicates(t *testing.T) {
	...
	prevBlock := customtesting.NewBeaconBlockAltair()
	...
	block := customtesting.NewBeaconBlockAltair()
...
func TestStore_AltairBlocksBatchDelete(t *testing.T) {
	...
	for i := 0; i < len(totalBlocks); i++ {
		b := customtesting.NewBeaconBlockAltair()
...
func TestStore_AltairBlocks_VerifyBlockRoots(t *testing.T) {
	ctx := context.Background()
	db := setupDB(t)
	b1 := customtesting.NewBeaconBlockAltair()
	b1.Block.Slot = 1
	r1, err := b1.Block.HashTreeRoot()
	require.NoError(t, err)
	b2 := customtesting.NewBeaconBlockAltair()
	b2.Block.Slot = 2
...
func TestStore_SaveAltairBlock_CanGetHighestAt(t *testing.T) {
	...
	block1 := customtesting.NewBeaconBlockAltair()
	block1.Block.Slot = 1
	block2 := customtesting.NewBeaconBlockAltair()
	block2.Block.Slot = 10
	block3 := customtesting.NewBeaconBlockAltair()
...
func TestStore_SaveAltairBlocks_HasCachedBlocks(t *testing.T) {
	...
	for i := 0; i < 500; i++ {
		blk := customtesting.NewBeaconBlockAltair()
...
func TestStore_AltairBlocksBySlot_BlockRootsBySlot(t *testing.T) {
	...
	b3 := customtesting.NewBeaconBlockAltair()
	b3.Block.Slot = 100
