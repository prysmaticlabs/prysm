...
func TestStore_SaveAltairBlock_NoDuplicates(t *testing.T) {
	...
	prevBlock := testing2.NewBeaconBlockAltair()
	...
	block := testing2.NewBeaconBlockAltair()
...
func TestStore_AltairBlocks_VerifyBlockRoots(t *testing.T) {
	ctx := context.Background()
	db := setupDB(t)
	b1 := testing2.NewBeaconBlockAltair()
	b1.Block.Slot = 1
	r1, err := b1.Block.HashTreeRoot()
	require.NoError(t, err)
	b2 := testing2.NewBeaconBlockAltair()
	b2.Block.Slot = 2
...
func TestStore_SaveAltairBlock_CanGetHighestAt(t *testing.T) {
	...
	block1 := testing2.NewBeaconBlockAltair()
	block1.Block.Slot = 1
	block2 := testing2.NewBeaconBlockAltair()
	block2.Block.Slot = 10
	block3 := testing2.NewBeaconBlockAltair()
...
func TestStore_SaveAltairBlocks_HasCachedBlocks(t *testing.T) {
	...
	for i := 0; i < 500; i++ {
		blk := testing2.NewBeaconBlockAltair()
...
func TestStore_AltairBlocksBySlot_BlockRootsBySlot(t *testing.T) {
	...
	b3 := testing2.NewBeaconBlockAltair()
	b3.Block.Slot = 100
