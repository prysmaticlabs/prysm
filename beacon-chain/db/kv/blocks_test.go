...
func TestStore_SaveBlock_NoDuplicates(t *testing.T) {
	...
	require.NoError(t, db.SaveBlock(ctx, blockInterface.WrappedPhase0SignedBeaconBlock(prevBlock)))
	...
	for i := 0; i < 100; i++ {
		require.NoError(t, db.SaveBlock(ctx, blockInterface.WrappedPhase0SignedBeaconBlock(block)))
	}
...
func TestStore_BlocksBatchDelete(t *testing.T) {
	...
	ctx := context.Background()
	numBlocks := 10
	totalBlocks := make([]blockInterface.SignedBeaconBlock, numBlocks)
	blockRoots := make([][32]byte, 0)
	oddBlocks := make([]blockInterface.SignedBeaconBlock, 0)
	for i := 0; i < len(totalBlocks); i++ {
		b := testutil.NewBeaconBlock()
		b.Block.Slot = types.Slot(i)
		b.Block.ParentRoot = bytesutil.PadTo([]byte("parent"), 32)
		totalBlocks[i] = blockInterface.WrappedPhase0SignedBeaconBlock(b)
		if i%2 == 0 {
...
func TestStore_GenesisBlock(t *testing.T) {
	...
	require.NoError(t, db.SaveBlock(ctx, blockInterface.WrappedPhase0SignedBeaconBlock(genesisBlock)))
...
func TestStore_Blocks_FiltersCorrectly(t *testing.T) {
	...
	blocks := []blockInterface.SignedBeaconBlock{
		blockInterface.WrappedPhase0SignedBeaconBlock(b4),
		blockInterface.WrappedPhase0SignedBeaconBlock(b5),
		blockInterface.WrappedPhase0SignedBeaconBlock(b6),
		blockInterface.WrappedPhase0SignedBeaconBlock(b7),
		blockInterface.WrappedPhase0SignedBeaconBlock(b8),
	}
	ctx := context.Background()
...
func TestStore_Blocks_VerifyBlockRoots(t *testing.T) {
	...
	require.NoError(t, db.SaveBlock(ctx, blockInterface.WrappedPhase0SignedBeaconBlock(b1)))
	require.NoError(t, db.SaveBlock(ctx, blockInterface.WrappedPhase0SignedBeaconBlock(b2)))
...
func TestStore_Blocks_Retrieve_SlotRange(t *testing.T) {
	db := setupDB(t)
	totalBlocks := make([]blockInterface.SignedBeaconBlock, 500)
	for i := 0; i < 500; i++ {
		b := testutil.NewBeaconBlock()
		b.Block.Slot = types.Slot(i)
		b.Block.ParentRoot = bytesutil.PadTo([]byte("parent"), 32)
...
func TestStore_Blocks_Retrieve_Epoch(t *testing.T) {
	...
	totalBlocks := make([]blockInterface.SignedBeaconBlock, slots)
...
func TestStore_SaveBlock_CanGetHighestAt(t *testing.T) {
	...
	block1.Block.Slot = 1
	require.NoError(t, db.SaveBlock(ctx, blockInterface.WrappedPhase0SignedBeaconBlock(block1)))
	block2 := testutil.NewBeaconBlock()
	block2.Block.Slot = 10
	require.NoError(t, db.SaveBlock(ctx, blockInterface.WrappedPhase0SignedBeaconBlock(block2)))
	block3 := testutil.NewBeaconBlock()
	block3.Block.Slot = 100
	require.NoError(t, db.SaveBlock(ctx, blockInterface.WrappedPhase0SignedBeaconBlock(block3)))
...
func TestStore_SaveBlocks_HasCachedBlocks(t *testing.T) {
	...
	b := make([]blockInterface.SignedBeaconBlock, 500)
	for i := 0; i < 500; i++ {
		blk := testutil.NewBeaconBlock()
		blk.Block.ParentRoot = bytesutil.PadTo([]byte("parent"), 32)
		blk.Block.Slot = types.Slot(i)
		b[i] = blockInterface.WrappedPhase0SignedBeaconBlock(blk)
	}
...
func TestStore_BlocksBySlot_BlockRootsBySlot(t *testing.T) {
	...
	require.NoError(t, db.SaveBlock(ctx, blockInterface.WrappedPhase0SignedBeaconBlock(b3)))
