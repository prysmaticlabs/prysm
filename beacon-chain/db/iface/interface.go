...
type ReadOnlyDatabase interface {
	...
	Block(ctx context.Context, blockRoot [32]byte) (blockInterface.SignedBeaconBlock, error)
	Blocks(ctx context.Context, f *filters.QueryFilter) ([]blockInterface.SignedBeaconBlock, [][32]byte, error)
	BlockRoots(ctx context.Context, f *filters.QueryFilter) ([][32]byte, error)
	BlocksBySlot(ctx context.Context, slot types.Slot) (bool, []blockInterface.SignedBeaconBlock, error)
	BlockRootsBySlot(ctx context.Context, slot types.Slot) (bool, [][32]byte, error)
	HasBlock(ctx context.Context, blockRoot [32]byte) bool
	GenesisBlock(ctx context.Context) (blockInterface.SignedBeaconBlock, error)
	IsFinalizedBlock(ctx context.Context, blockRoot [32]byte) bool
	FinalizedChildBlock(ctx context.Context, blockRoot [32]byte) (blockInterface.SignedBeaconBlock, error)
	HighestSlotBlocksBelow(ctx context.Context, slot types.Slot) ([]blockInterface.SignedBeaconBlock, error)
...
type NoHeadAccessDatabase interface {
	...
	// Block related methods.
	SaveBlock(ctx context.Context, block blockInterface.SignedBeaconBlock) error
	SaveBlocks(ctx context.Context, blocks []blockInterface.SignedBeaconBlock) error
...
type HeadAccessDatabase interface {
	...
	// Block related methods.
	HeadBlock(ctx context.Context) (blockInterface.SignedBeaconBlock, error)
