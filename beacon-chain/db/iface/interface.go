...
type ReadOnlyDatabase interface {
	...
	State(ctx context.Context, blockRoot [32]byte) (interfaces.BeaconState, error)
	GenesisState(ctx context.Context) (interfaces.BeaconState, error)
	...
	HighestSlotStatesBelow(ctx context.Context, slot types.Slot) ([]interfaces.ReadOnlyBeaconState, error)
	// Slashing operations.
...
type NoHeadAccessDatabase interface {
	...
	// State related methods.
	SaveState(ctx context.Context, state interfaces.ReadOnlyBeaconState, blockRoot [32]byte) error
	SaveStates(ctx context.Context, states []interfaces.ReadOnlyBeaconState, blockRoots [][32]byte) error
...
type HeadAccessDatabase interface {
	...
	SaveGenesisData(ctx context.Context, state interfaces.BeaconState) error
