...
type ReadOnlyDatabase interface {
	...
	Block(ctx context.Context, blockRoot [32]byte) (prysm.SignedBeaconBlock, error)
	Blocks(ctx context.Context, f *filters.QueryFilter) ([]prysm.SignedBeaconBlock, [][32]byte, error)
	BlockRoots(ctx context.Context, f *filters.QueryFilter) ([][32]byte, error)
	BlocksBySlot(ctx context.Context, slot types.Slot) (bool, []prysm.SignedBeaconBlock, error)
	BlockRootsBySlot(ctx context.Context, slot types.Slot) (bool, [][32]byte, error)
	HasBlock(ctx context.Context, blockRoot [32]byte) bool
	GenesisBlock(ctx context.Context) (prysm.SignedBeaconBlock, error)
	IsFinalizedBlock(ctx context.Context, blockRoot [32]byte) bool
	FinalizedChildBlock(ctx context.Context, blockRoot [32]byte) (prysm.SignedBeaconBlock, error)
	HighestSlotBlocksBelow(ctx context.Context, slot types.Slot) ([]prysm.SignedBeaconBlock, error)
...
type NoHeadAccessDatabase interface {
	...
	// Block related methods.
	SaveBlock(ctx context.Context, block prysm.SignedBeaconBlock) error
	SaveBlocks(ctx context.Context, blocks []prysm.SignedBeaconBlock) error
...
type HeadAccessDatabase interface {
	...
	// Block related methods.
	HeadBlock(ctx context.Context) (prysm.SignedBeaconBlock, error)
