...
type ReadOnlyDatabase interface {
	...
	Block(ctx context.Context, blockRoot [32]byte) (block2.SignedBeaconBlock, error)
	Blocks(ctx context.Context, f *filters.QueryFilter) ([]block2.SignedBeaconBlock, [][32]byte, error)
	BlockRoots(ctx context.Context, f *filters.QueryFilter) ([][32]byte, error)
	BlocksBySlot(ctx context.Context, slot types.Slot) (bool, []block2.SignedBeaconBlock, error)
	BlockRootsBySlot(ctx context.Context, slot types.Slot) (bool, [][32]byte, error)
	HasBlock(ctx context.Context, blockRoot [32]byte) bool
	GenesisBlock(ctx context.Context) (block2.SignedBeaconBlock, error)
	IsFinalizedBlock(ctx context.Context, blockRoot [32]byte) bool
	FinalizedChildBlock(ctx context.Context, blockRoot [32]byte) (block2.SignedBeaconBlock, error)
	HighestSlotBlocksBelow(ctx context.Context, slot types.Slot) ([]block2.SignedBeaconBlock, error)
...
type NoHeadAccessDatabase interface {
	...
	// Block related methods.
	SaveBlock(ctx context.Context, block block2.SignedBeaconBlock) error
	SaveBlocks(ctx context.Context, blocks []block2.SignedBeaconBlock) error
