...
import (
	...
	"github.com/prysmaticlabs/prysm/tools/bootnode-query/main"
...
func (s *InitialSync) exitInitialSync(ctx context.Context, block *pb.BeaconBlock) error {
	...
	if err := host.Network().ClosePeer(s.bestPeer); err != nil {
		return fmt.Errorf("could not drop a best peer: %v", err)
	}
