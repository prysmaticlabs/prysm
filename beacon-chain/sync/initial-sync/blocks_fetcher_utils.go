...
func (f *blocksFetcher) findAncestor(ctx context.Context, pid peer.ID, block blockInterface.SignedBeaconBlock) (*forkData, error) {
	outBlocks := []blockInterface.SignedBeaconBlock{block}
