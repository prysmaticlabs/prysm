...
func (s *Service) writeBlockRangeToStream(ctx context.Context, startSlot, endSlot types.Slot, step uint64,
	...
	if startSlot == 0 {
		...
		blks = append([]blockInterface.SignedBeaconBlock{genBlock}, blks...)
...
func (s *Service) filterBlocks(ctx context.Context, blks []blockInterface.SignedBeaconBlock, roots [][32]byte, prevRoot *[32]byte,
	step uint64, startSlot types.Slot) ([]blockInterface.SignedBeaconBlock, error) {
...
func (s *Service) retrieveGenesisBlock(ctx context.Context) (blockInterface.SignedBeaconBlock, [32]byte, error) {
