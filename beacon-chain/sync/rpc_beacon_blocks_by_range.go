...
func (s *Service) writeBlockRangeToStream(ctx context.Context, startSlot, endSlot types.Slot, step uint64,
	...
	if startSlot == 0 {
		...
		blks = append([]block2.SignedBeaconBlock{genBlock}, blks...)
...
func (s *Service) filterBlocks(ctx context.Context, blks []block2.SignedBeaconBlock, roots [][32]byte, prevRoot *[32]byte,
	step uint64, startSlot types.Slot) ([]block2.SignedBeaconBlock, error) {
...
func (s *Service) retrieveGenesisBlock(ctx context.Context) (block2.SignedBeaconBlock, [32]byte, error) {
