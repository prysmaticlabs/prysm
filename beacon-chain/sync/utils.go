...
func (s *Service) dedupBlocksAndRoots(blks []block2.SignedBeaconBlock, roots [][32]byte) ([]block2.SignedBeaconBlock, [][32]byte, error) {
...
func (s *Service) sortBlocksAndRoots(blks []block2.SignedBeaconBlock, roots [][32]byte) ([]block2.SignedBeaconBlock, [][32]byte) {
	obj := sortedObj{
		blks:  blks,
		roots: roots,
	}
