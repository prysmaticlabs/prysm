...
type sortedObj struct {
	blks  []blockInterface.SignedBeaconBlock
	roots [][32]byte
}
...
func (s *Service) dedupBlocksAndRoots(blks []blockInterface.SignedBeaconBlock, roots [][32]byte) ([]blockInterface.SignedBeaconBlock, [][32]byte, error) {
...
func (s *Service) sortBlocksAndRoots(blks []blockInterface.SignedBeaconBlock, roots [][32]byte) ([]blockInterface.SignedBeaconBlock, [][32]byte) {
	obj := sortedObj{
		blks:  blks,
		roots: roots,
	}
