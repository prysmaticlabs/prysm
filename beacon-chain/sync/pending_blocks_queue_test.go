...
func TestRegularSyncBeaconBlockSubscriber_ProcessPendingBlocks1(t *testing.T) {
	...
	require.NoError(t, err)
	b2 := customtesting.NewBeaconBlock()
	b2.Block.Slot = 2
	...
	require.NoError(t, r.insertBlockToPendingQueue(b1.Block.Slot, wrapper.WrappedPhase0SignedBeaconBlock(customtesting.NewBeaconBlock()), [32]byte{}))
...
func TestService_sortedPendingSlots(t *testing.T) {
	...
	require.NoError(t, r.insertBlockToPendingQueue(lastSlot, wrapper.WrappedPhase0SignedBeaconBlock(customtesting.HydrateSignedBeaconBlock(&ethpb.SignedBeaconBlock{Block: &ethpb.BeaconBlock{Slot: lastSlot}})), [32]byte{1}))
	require.NoError(t, r.insertBlockToPendingQueue(lastSlot-3, wrapper.WrappedPhase0SignedBeaconBlock(customtesting.HydrateSignedBeaconBlock(&ethpb.SignedBeaconBlock{Block: &ethpb.BeaconBlock{Slot: lastSlot - 3}})), [32]byte{2}))
	require.NoError(t, r.insertBlockToPendingQueue(lastSlot-5, wrapper.WrappedPhase0SignedBeaconBlock(customtesting.HydrateSignedBeaconBlock(&ethpb.SignedBeaconBlock{Block: &ethpb.BeaconBlock{Slot: lastSlot - 5}})), [32]byte{3}))
	require.NoError(t, r.insertBlockToPendingQueue(lastSlot-2, wrapper.WrappedPhase0SignedBeaconBlock(customtesting.HydrateSignedBeaconBlock(&ethpb.SignedBeaconBlock{Block: &ethpb.BeaconBlock{Slot: lastSlot - 2}})), [32]byte{4}))
...
func TestService_ProcessPendingBlockOnCorrectSlot(t *testing.T) {
	...
	parentBlock := customtesting.NewBeaconBlock()
...
func TestService_ProcessBadPendingBlocks(t *testing.T) {
	...
	bB := wrapper.WrappedPhase0SignedBeaconBlock(customtesting.NewBeaconBlock())
	assert.NoError(t, err)
