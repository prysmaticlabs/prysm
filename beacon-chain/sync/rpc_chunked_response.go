...
func ReadChunkedBlock(stream libp2pcore.Stream, chain blockchain.ChainInfoFetcher, p2p p2p.P2P, isFirstChunk bool) (prysm.SignedBeaconBlock, error) {
...
// it.
func readFirstChunkedBlock(stream libp2pcore.Stream, chain blockchain.ChainInfoFetcher, p2p p2p.P2P) (prysm.SignedBeaconBlock, error) {
	blk := &eth.SignedBeaconBlock{}
