...
func (s *Service) validateUnaggregatedAttTopic(ctx context.Context, a *eth.Attestation, bs interfaces.ReadOnlyBeaconState, t string) pubsub.ValidationResult {
...
func (s *Service) validateUnaggregatedAttWithState(ctx context.Context, a *eth.Attestation, bs interfaces.ReadOnlyBeaconState) pubsub.ValidationResult {
