...
func validateIndexInCommittee(ctx context.Context, bs interfaces.ReadOnlyBeaconState, a *ethpb.Attestation, validatorIndex types.ValidatorIndex) error {
...
func validateSelectionIndex(
	ctx context.Context,
	bs interfaces.ReadOnlyBeaconState,
...
func aggSigSet(s interfaces.ReadOnlyBeaconState, a *ethpb.SignedAggregateAttestationAndProof) (*bls.SignatureSet, error) {
