...
type BeaconBlockProcessor func(block block2.SignedBeaconBlock) error
...
func SendBeaconBlocksByRangeRequest(
	...
	blocks := make([]block2.SignedBeaconBlock, 0, req.Count)
	process := func(blk block2.SignedBeaconBlock) error {
...
func SendBeaconBlocksByRootRequest(
	...
	// Augment block processing function, if non-nil block processor is provided.
	blocks := make([]block2.SignedBeaconBlock, 0, len(*req))
	process := func(block block2.SignedBeaconBlock) error {
