...
type RegularSync struct {
	...
	announceBlockBuf             chan deprecated_p2p.Message
	blockBuf                     chan deprecated_p2p.Message
	blockRequestByHash           chan deprecated_p2p.Message
	batchedRequestBuf            chan deprecated_p2p.Message
	stateRequestBuf              chan deprecated_p2p.Message
	chainHeadReqBuf              chan deprecated_p2p.Message
	attestationBuf               chan deprecated_p2p.Message
	exitBuf                      chan deprecated_p2p.Message
	canonicalBuf                 chan *pb.BeaconBlockAnnounce
	highestObservedSlot          uint64
	blocksAwaitingProcessing     map[[32]byte]deprecated_p2p.Message
...
func NewRegularSyncService(ctx context.Context, cfg *RegularSyncConfig) *RegularSync {
	...
	return &RegularSync{
		...
		announceBlockBuf:         make(chan deprecated_p2p.Message, cfg.BlockAnnounceBufferSize),
		blockBuf:                 make(chan deprecated_p2p.Message, cfg.BlockBufferSize),
		blockRequestByHash:       make(chan deprecated_p2p.Message, cfg.BlockReqHashBufferSize),
		batchedRequestBuf:        make(chan deprecated_p2p.Message, cfg.BatchedBufferSize),
		stateRequestBuf:          make(chan deprecated_p2p.Message, cfg.StateReqBufferSize),
		attestationBuf:           make(chan deprecated_p2p.Message, cfg.AttestationBufferSize),
		exitBuf:                  make(chan deprecated_p2p.Message, cfg.ExitBufferSize),
		chainHeadReqBuf:          make(chan deprecated_p2p.Message, cfg.ChainHeadReqBufferSize),
		canonicalBuf:             make(chan *pb.BeaconBlockAnnounce, cfg.CanonicalBufferSize),
		blocksAwaitingProcessing: make(map[[32]byte]deprecated_p2p.Message),
...
func (rs *RegularSync) handleStateRequest(msg deprecated_p2p.Message) error {
...
func (rs *RegularSync) handleChainHeadRequest(msg deprecated_p2p.Message) error {
...
// pool if we have not.
func (rs *RegularSync) receiveAttestation(msg deprecated_p2p.Message) error {
	...
	rs.p2p.Reputation(msg.Peer, deprecated_p2p.RepRewardValidAttestation)
	sentAttestation.Inc()
...
func (rs *RegularSync) receiveExitRequest(msg deprecated_p2p.Message) error {
...
func (rs *RegularSync) handleBlockRequestByHash(msg deprecated_p2p.Message) error {
...
func (rs *RegularSync) handleBatchedBlockRequest(msg deprecated_p2p.Message) error {
