...
<<<<<<< HEAD
The beacon chain idea emerged from the research around attestation of shard information by a committee of attesters, similar to a committee of validators in Casper. The key difference in sharding, however, is the pseudorandomness generation required for fast reshuffling of actors across shards within the system.
=======
