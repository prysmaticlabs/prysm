...
type EngineCaller interface {
	NewPayload(ctx context.Context, payload interfaces.ExecutionData, versionedHashes []common.Hash) ([]byte, error)
	ForkchoiceUpdated(
...
func (s *Service) NewPayload(ctx context.Context, payload interfaces.ExecutionData, versionedHashes []common.Hash) ([]byte, error) {
...
func (s *Service) ReconstructFullBlock(
	...
	payload, err := fullPayloadFromExecutionBlock(blindedBlock.Version(), header, executionBlock)
	if err != nil {
		return nil, err
	}
