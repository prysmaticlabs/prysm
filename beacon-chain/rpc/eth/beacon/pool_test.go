...
func TestListPoolAttestations(t *testing.T) {
	...
	att1 := &ethpb_v1alpha1.Attestation{
		...
		Data: &ethpb_v1alpha1.AttestationData{
			Slot:            1,
			CommitteeIndex:  1,
			BeaconBlockRoot: bytes.PadTo([]byte("blockroot1"), 32),
			Source: &ethpb_v1alpha1.Checkpoint{
				Epoch: 1,
				Root:  bytes.PadTo([]byte("sourceroot1"), 32),
			},
			Target: &ethpb_v1alpha1.Checkpoint{
				Epoch: 10,
				Root:  bytes.PadTo([]byte("targetroot1"), 32),
			},
		},
		Signature: bytes.PadTo([]byte("signature1"), 96),
	}
	att2 := &ethpb_v1alpha1.Attestation{
		...
		Data: &ethpb_v1alpha1.AttestationData{
			Slot:            4,
			CommitteeIndex:  4,
			BeaconBlockRoot: bytes.PadTo([]byte("blockroot4"), 32),
			Source: &ethpb_v1alpha1.Checkpoint{
				Epoch: 4,
				Root:  bytes.PadTo([]byte("sourceroot4"), 32),
			},
			Target: &ethpb_v1alpha1.Checkpoint{
				Epoch: 40,
				Root:  bytes.PadTo([]byte("targetroot4"), 32),
			},
		},
		Signature: bytes.PadTo([]byte("signature4"), 96),
	}
	att3 := &ethpb_v1alpha1.Attestation{
		...
		Data: &ethpb_v1alpha1.AttestationData{
			Slot:            2,
			CommitteeIndex:  2,
			BeaconBlockRoot: bytes.PadTo([]byte("blockroot2"), 32),
			Source: &ethpb_v1alpha1.Checkpoint{
				Epoch: 2,
				Root:  bytes.PadTo([]byte("sourceroot2"), 32),
			},
			Target: &ethpb_v1alpha1.Checkpoint{
				Epoch: 20,
				Root:  bytes.PadTo([]byte("targetroot2"), 32),
			},
		},
		Signature: bytes.PadTo([]byte("signature2"), 96),
	}
	...
	slashing2 := &ethpb_v1alpha1.AttesterSlashing{
		Attestation_1: &ethpb_v1alpha1.IndexedAttestation{
			...
			Data: &ethpb_v1alpha1.AttestationData{
				Slot:            3,
				CommitteeIndex:  3,
				BeaconBlockRoot: bytes.PadTo([]byte("blockroot3"), 32),
				Source: &ethpb_v1alpha1.Checkpoint{
					Epoch: 3,
					Root:  bytes.PadTo([]byte("sourceroot3"), 32),
				},
				Target: &ethpb_v1alpha1.Checkpoint{
					Epoch: 30,
					Root:  bytes.PadTo([]byte("targetroot3"), 32),
				},
			},
			Signature: bytes.PadTo([]byte("signature3"), 96),
		},
		Attestation_2: &ethpb_v1alpha1.IndexedAttestation{
	...
	slashing1 := &ethpb_v1alpha1.ProposerSlashing{
		Header_1: &ethpb_v1alpha1.SignedBeaconBlockHeader{
			Header: &ethpb_v1alpha1.BeaconBlockHeader{
				Slot:          1,
				ProposerIndex: 1,
				ParentRoot:    bytes.PadTo([]byte("parentroot1"), 32),
				StateRoot:     bytes.PadTo([]byte("stateroot1"), 32),
				BodyRoot:      bytes.PadTo([]byte("bodyroot1"), 32),
			},
			Signature: bytes.PadTo([]byte("signature1"), 96),
		},
		Header_2: &ethpb_v1alpha1.SignedBeaconBlockHeader{
			Header: &ethpb_v1alpha1.BeaconBlockHeader{
				Slot:          2,
				ProposerIndex: 2,
				ParentRoot:    bytes.PadTo([]byte("parentroot2"), 32),
				StateRoot:     bytes.PadTo([]byte("stateroot2"), 32),
				BodyRoot:      bytes.PadTo([]byte("bodyroot2"), 32),
			},
			Signature: bytes.PadTo([]byte("signature2"), 96),
		},
	}
	slashing2 := &ethpb_v1alpha1.ProposerSlashing{
		Header_1: &ethpb_v1alpha1.SignedBeaconBlockHeader{
			Header: &ethpb_v1alpha1.BeaconBlockHeader{
				Slot:          3,
				ProposerIndex: 3,
				ParentRoot:    bytes.PadTo([]byte("parentroot3"), 32),
				StateRoot:     bytes.PadTo([]byte("stateroot3"), 32),
				BodyRoot:      bytes.PadTo([]byte("bodyroot3"), 32),
			},
			Signature: bytes.PadTo([]byte("signature3"), 96),
		},
		Header_2: &ethpb_v1alpha1.SignedBeaconBlockHeader{
			Header: &ethpb_v1alpha1.BeaconBlockHeader{
				Slot:          4,
				ProposerIndex: 4,
				ParentRoot:    bytes.PadTo([]byte("parentroot4"), 32),
				StateRoot:     bytes.PadTo([]byte("stateroot4"), 32),
				BodyRoot:      bytes.PadTo([]byte("bodyroot4"), 32),
			},
			Signature: bytes.PadTo([]byte("signature4"), 96),
		},
	}
...
func TestServer_SubmitAttestations_Ok(t *testing.T) {
	...
	att1 := &ethpb.Attestation{
		...
		Data: &ethpb.AttestationData{
			Slot:            0,
			Index:           0,
			BeaconBlockRoot: bytes.PadTo([]byte("beaconblockroot1"), 32),
	...
	att2 := &ethpb.Attestation{
		...
		Data: &ethpb.AttestationData{
			Slot:            0,
			Index:           0,
			BeaconBlockRoot: bytes.PadTo([]byte("beaconblockroot2"), 32),
			Source:          sourceCheckpoint,
			Target: &ethpb.Checkpoint{
				Epoch: 0,
				Root:  bytes.PadTo([]byte("targetroot2"), 32),
