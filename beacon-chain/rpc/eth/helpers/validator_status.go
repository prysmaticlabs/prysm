...
func ValidatorStatus(val validator.ReadOnlyValidator, epoch primitives.Epoch) (validator.Status, error) {
...
func ValidatorSubStatus(val validator.ReadOnlyValidator, epoch primitives.Epoch) (validator.Status, error) {
