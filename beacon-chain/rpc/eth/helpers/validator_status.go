...
func ValidatorStatus(validator types.ReadOnlyValidator, epoch primitives.Epoch) (ethpb.ValidatorStatus, error) {
...
func ValidatorSubStatus(validator types.ReadOnlyValidator, epoch primitives.Epoch) (ethpb.ValidatorStatus, error) {
