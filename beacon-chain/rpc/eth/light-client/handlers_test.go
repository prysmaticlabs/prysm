...
func TestLightClientHandler_GetLightClientBootstrap_Altair(t *testing.T) {
	...
	require.Equal(t, hexutil.Encode(header.Header.BodyRoot), resp.Data.Header.(*structs.LightClientHeader).Beacon.BodyRoot)
...
func TestLightClientHandler_GetLightClientBootstrap_Capella(t *testing.T) {
	...
	require.Equal(t, hexutil.Encode(header.Header.BodyRoot), resp.Data.Header.(*structs.LightClientHeaderCapella).Beacon.BodyRoot)
	require.NotNil(t, resp.Data)
}
...
func TestLightClientHandler_GetLightClientBootstrap_Deneb(t *testing.T) {
	...
	require.Equal(t, hexutil.Encode(header.Header.BodyRoot), resp.Data.Header.(*structs.LightClientHeaderDeneb).Beacon.BodyRoot)
	require.NotNil(t, resp.Data)
}
...
func TestLightClientHandler_GetLightClientUpdatesByRangeCapella(t *testing.T) {
	...
	require.Equal(t, hexutil.Encode(attestedHeader.BodyRoot), resp.Updates[0].Data.AttestedHeader.(*structs.LightClientHeaderCapella).Beacon.BodyRoot)
...
func TestLightClientHandler_GetLightClientUpdatesByRangeAltair(t *testing.T) {
	...
	require.Equal(t, hexutil.Encode(attestedHeader.BodyRoot), resp.Updates[0].Data.AttestedHeader.(*structs.LightClientHeader).Beacon.BodyRoot)
	require.NotNil(t, resp)
}
...
func TestLightClientHandler_GetLightClientUpdatesByRangeDeneb(t *testing.T) {
	...
	require.Equal(t, hexutil.Encode(attestedHeader.BodyRoot), resp.Updates[0].Data.AttestedHeader.(*structs.LightClientHeaderDeneb).Beacon.BodyRoot)
	require.NotNil(t, resp)
}
...
func TestLightClientHandler_GetLightClientFinalityUpdateCapella(t *testing.T) {
	...
	require.NoError(t, err)
	require.Equal(t, "capella", resp.Version)
	require.Equal(t, hexutil.Encode(attestedHeader.BodyRoot), resp.Data.AttestedHeader.(*structs.LightClientHeaderCapella).Beacon.BodyRoot)
	require.NotNil(t, resp.Data)
}
...
func TestLightClientHandler_GetLightClientFinalityUpdateAltair(t *testing.T) {
	...
	require.NoError(t, err)
	require.Equal(t, "altair", resp.Version)
	require.Equal(t, hexutil.Encode(attestedHeader.BodyRoot), resp.Data.AttestedHeader.(*structs.LightClientHeader).Beacon.BodyRoot)
	require.NotNil(t, resp.Data)
}
...
func TestLightClientHandler_GetLightClientFinalityUpdateDeneb(t *testing.T) {
	...
	require.NoError(t, err)
	require.Equal(t, "deneb", resp.Version)
	require.Equal(t, hexutil.Encode(attestedHeader.BodyRoot), resp.Data.AttestedHeader.(*structs.LightClientHeaderDeneb).Beacon.BodyRoot)
	require.NotNil(t, resp.Data)
}
