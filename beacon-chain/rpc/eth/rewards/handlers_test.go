...
func TestBlockRewards(t *testing.T) {
	...
	t.Run("ok", func(t *testing.T) {
		...
		assert.Equal(t, primitives.ValidatorIndex(12), resp.Data.ProposerIndex)
		assert.Equal(t, uint64(125089490), resp.Data.Total)
		assert.Equal(t, uint64(89442), resp.Data.Attestations)
		assert.Equal(t, uint64(48), resp.Data.SyncAggregate)
		assert.Equal(t, uint64(62500000), resp.Data.AttesterSlashings)
		assert.Equal(t, uint64(62500000), resp.Data.ProposerSlashings)
