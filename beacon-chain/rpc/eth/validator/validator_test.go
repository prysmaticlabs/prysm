...
func TestGetAggregateAttestation(t *testing.T) {
	ctx := context.Background()
	root1 := butil.PadTo([]byte("root1"), 32)
	sig1 := butil.PadTo([]byte("sig1"), 96)
	...
	root2_1 := butil.PadTo([]byte("root2_1"), 32)
	sig2_1 := butil.PadTo([]byte("sig2_1"), 96)
	...
	root2_2 := butil.PadTo([]byte("root2_2"), 32)
	sig2_2 := butil.PadTo([]byte("sig2_2"), 96)
	...
	t.Run("No matching attestation", func(t *testing.T) {
		req := &ethpbv1.AggregateAttestationRequest{
			AttestationDataRoot: butil.PadTo([]byte("foo"), 32),
			Slot:                2,
		}
...
func TestGetAggregateAttestation_SameSlotAndRoot_ReturnMostAggregationBits(t *testing.T) {
	ctx := context.Background()
	root := butil.PadTo([]byte("root"), 32)
	sig := butil.PadTo([]byte("sig"), 96)
...
func TestSubmitAggregateAndProofs(t *testing.T) {
	...
	root := butil.PadTo([]byte("root"), 32)
	sig := butil.PadTo([]byte("sig"), 96)
	proof := butil.PadTo([]byte("proof"), 96)
