...
func (bs *Server) GetValidator(
	ctx context.Context,
	req *ethpb.StateValidatorRequest,
) (*ethpb.StateValidatorResponse, error) {
...
func (bs *Server) ListValidators(
	ctx context.Context,
	req *ethpb.StateValidatorsRequest,
) (*ethpb.StateValidatorsResponse, error) {
	return nil, errors.New("unimplemented")
}
...
) (*ethpb.ValidatorBalancesResponse, error) {
	return nil, errors.New("unimplemented")
}

// ListCommittees retrieves the committees for the given state at the given epoch.
func (bs *Server) ListCommittees(
	ctx context.Context,
	req *ethpb.StateCommitteesRequest,
) (*ethpb.StateCommitteesResponse, error) {
	return nil, errors.New("unimplemented")
}
