...
func TestGetStateRoot(t *testing.T) {
	...
	t.Run("Head", func(t *testing.T) {
		...
		require.NoError(t, err)
		assert.DeepEqual(t, resp.Data.StateRoot, resp.Data.StateRoot)
	})
	...
	t.Run("Finalized", func(t *testing.T) {
		...
		require.NoError(t, err)
		assert.DeepEqual(t, resp.Data.StateRoot, bytesutil.PadTo([]byte("finalized"), 32))
	})
	...
	t.Run("Justified", func(t *testing.T) {
		...
		require.NoError(t, err)
		assert.DeepEqual(t, resp.Data.StateRoot, bytesutil.PadTo([]byte("justified"), 32))
	})
