...
type Fetcher interface {
	State(ctx context.Context, stateId []byte) (interfaces.BeaconState, error)
...
func (p *StateProvider) State(ctx context.Context, stateId []byte) (interfaces.BeaconState, error) {
	var (
...
func (p *StateProvider) stateByHex(ctx context.Context, stateId []byte) (interfaces.BeaconState, error) {
...
func (p *StateProvider) stateBySlot(ctx context.Context, slot types.Slot) (interfaces.BeaconState, error) {
