...
func TestServer_SubmitProposerSlashing(t *testing.T) {
	...
	st, privs := testing2.DeterministicGenesisState(t, 64)
	...
	slashing, err := testing2.GenerateProposerSlashingForValidator(st, privs[2], types.ValidatorIndex(2))
	require.NoError(t, err)
...
func TestServer_SubmitAttesterSlashing(t *testing.T) {
	...
	slashing, err := testing2.GenerateAttesterSlashingForValidator(st, privs[2], types.ValidatorIndex(2))
	require.NoError(t, err)
...
func TestServer_SubmitProposerSlashing_DontBroadcast(t *testing.T) {
	...
	slashing, err = testing2.GenerateProposerSlashingForValidator(st, privs[5], types.ValidatorIndex(5))
	require.NoError(t, err)
...
func TestServer_SubmitAttesterSlashing_DontBroadcast(t *testing.T) {
	...
	slashing, err = testing2.GenerateAttesterSlashingForValidator(st, privs[5], types.ValidatorIndex(5))
	require.NoError(t, err)
