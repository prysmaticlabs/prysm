...
func TestServer_SubmitProposerSlashing(t *testing.T) {
	...
	st, privs := customtesting.DeterministicGenesisState(t, 64)
	...
	slashing, err := customtesting.GenerateProposerSlashingForValidator(st, privs[2], types.ValidatorIndex(2))
	require.NoError(t, err)
...
func TestServer_SubmitAttesterSlashing(t *testing.T) {
	...
	slashing, err := customtesting.GenerateAttesterSlashingForValidator(st, privs[2], types.ValidatorIndex(2))
	require.NoError(t, err)
...
func TestServer_SubmitProposerSlashing_DontBroadcast(t *testing.T) {
	...
	slashing, err = customtesting.GenerateProposerSlashingForValidator(st, privs[5], types.ValidatorIndex(5))
	require.NoError(t, err)
...
func TestServer_SubmitAttesterSlashing_DontBroadcast(t *testing.T) {
	...
	slashing, err = customtesting.GenerateAttesterSlashingForValidator(st, privs[5], types.ValidatorIndex(5))
	require.NoError(t, err)
