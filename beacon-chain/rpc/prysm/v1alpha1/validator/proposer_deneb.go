...
func buildBlobSidecars(blk interfaces.SignedBeaconBlock, metadata *sidecarMetaData) ([]*ethpb.BlobSidecar, error) {
	...
	if clen != len(metadata.Blobs) || clen != len(metadata.KzgProofs) {
