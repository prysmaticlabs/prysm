...
func (vs *Server) constructGenericBeaconBlock(sBlk interfaces.SignedBeaconBlock) (*ethpb.GenericBeaconBlock, error) {
	...
	switch sBlk.Version() {
	case version.Deneb:
		return vs.constructDenebBlock(blockProto, isBlinded, payloadValue), nil
...
func (vs *Server) constructDenebBlock(pb proto.Message, isBlinded bool, payloadValue uint64) *ethpb.GenericBeaconBlock {
	if isBlinded {
		return &ethpb.GenericBeaconBlock{Block: &ethpb.GenericBeaconBlock_BlindedDeneb{BlindedDeneb: pb.(*ethpb.BlindedBeaconBlockDeneb)}, IsBlinded: true, PayloadValue: payloadValue}
	}
	return &ethpb.GenericBeaconBlock{Block: &ethpb.GenericBeaconBlock_Deneb{Deneb: pb.(*ethpb.BeaconBlockDeneb)}, IsBlinded: false, PayloadValue: payloadValue}
}
