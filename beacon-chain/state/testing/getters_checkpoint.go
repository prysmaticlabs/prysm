...
type getStateWithJustificationBits = func(bitfield.Bitvector4) (types.BeaconState, error)
...
type getStateWithCheckpoint = func(checkpoint *ethpb.Checkpoint) (types.BeaconState, error)
