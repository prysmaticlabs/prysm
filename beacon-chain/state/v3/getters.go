...
func CopyExecutionPayloadHeader(payload *ethpb.ExecutionPayloadHeader) *ethpb.ExecutionPayloadHeader {
	if payload == nil {
		return nil
	}
...
func executionPayloadRoot(payload *ethpb.ExecutionPayloadHeader) ([32]byte, error) {
