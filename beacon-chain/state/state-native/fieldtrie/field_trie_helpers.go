...
func ProofFromMerkleLayers(layers [][][]byte, startingLeafIndex v0types.FieldIndex) [][]byte {
...
func validateElements(field v0types.FieldIndex, dataType types.DataType, elements interface{}, length uint64) error {
...
func fieldConverters(field v0types.FieldIndex, indices []uint64, elements interface{}, convertAll bool) ([][32]byte, error) {
	switch field {
