...
type StateManager interface {
	...
	ReplayBlocks(ctx context.Context, state iface.BeaconState, signed []blockInterface.SignedBeaconBlock, targetSlot types.Slot) (iface.BeaconState, error)
	LoadBlocks(ctx context.Context, startSlot, endSlot types.Slot, endBlockRoot [32]byte) ([]blockInterface.SignedBeaconBlock, error)
