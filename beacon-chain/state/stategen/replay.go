...
func processSlotsStateGen(ctx context.Context, state interfaces.BeaconState, slot types.Slot) (interfaces.BeaconState, error) {
...
// This is used by both hot and cold state management.
func (s *State) lastSavedState(ctx context.Context, slot types.Slot) (interfaces.ReadOnlyBeaconState, error) {
