...
func (s *State) SaveState(ctx context.Context, blockRoot [32]byte, st types.BeaconState) error {
...
func (s *State) saveStateByRoot(ctx context.Context, blockRoot [32]byte, st types.BeaconState) error {
