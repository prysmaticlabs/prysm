...
func (s *State) SaveState(ctx context.Context, root [32]byte, st interfaces.BeaconState) error {
...
func (s *State) saveStateByRoot(ctx context.Context, blockRoot [32]byte, st interfaces.BeaconState) error {
