...
func (s *State) StateByRootInitialSync(ctx context.Context, blockRoot [32]byte) (state.BeaconState, error) {
	...
	blks, err := s.LoadBlocks(ctx, startState.Slot()+1, summary.Slot, bytes.ToBytes32(summary.Root))
	if err != nil {
...
func (s *State) loadStateByRoot(ctx context.Context, blockRoot [32]byte) (state.BeaconState, error) {
	...
	blks, err := s.LoadBlocks(ctx, startState.Slot()+1, targetSlot, bytes.ToBytes32(summary.Root))
	if err != nil {
