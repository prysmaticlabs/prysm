...
func (s *State) StateByRoot(ctx context.Context, blockRoot [32]byte) (interfaces.BeaconState, error) {
...
func (s *State) StateByRootInitialSync(ctx context.Context, blockRoot [32]byte) (interfaces.BeaconState, error) {
...
func (s *State) StateBySlot(ctx context.Context, slot types.Slot) (interfaces.BeaconState, error) {
...
func (s *State) loadStateByRoot(ctx context.Context, blockRoot [32]byte) (interfaces.BeaconState, error) {
...
func (s *State) loadStateBySlot(ctx context.Context, slot types.Slot) (interfaces.BeaconState, error) {
...
func (s *State) lastAncestorState(ctx context.Context, root [32]byte) (interfaces.BeaconState, error) {
