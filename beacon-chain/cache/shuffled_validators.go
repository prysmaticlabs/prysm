...
var (
	...
	// maxShuffledListSize can handle max 4 shuffled validator lists in cache.
...
// ShuffledValidatorsInEpoch defines the shuffled validator indices per randao seed.
