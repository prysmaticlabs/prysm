...
func (t *LLRB) ReplaceOrInsertBulk(items ...Item) (error) {
	for _, i := range items {
		if _,err := t.ReplaceOrInsert(i); err != nil {
			return err
		}
	}
	return nil
...
func (t *LLRB) ReplaceOrInsert(item Item) (Item, error) {
	if item == nil {
		return nil, errors.New("inserting nil item in ReplaceOrInsert")
	}
	var replaced Item
...
func (t *LLRB) InsertNoReplace(item Item) (error) {
	if item == nil {
		return errors.New("inserting nil item in InsertNoReplace")
	}
