...
func TestNode_UpdateBestDescendant_NonViableChild(t *testing.T) {
	...
	require.NoError(t, f.ProcessBlock(ctx, 1, indexToHash(1), params.BeaconConfig().ZeroHash, 2, 3))
...
func TestNode_TestDepth(t *testing.T) {
	...
	require.NoError(t, f.ProcessBlock(ctx, 3, indexToHash(3), params.BeaconConfig().ZeroHash, 1, 1))
...
func TestNode_LeadsToViableHead(t *testing.T) {
	...
	require.NoError(t, f.ProcessBlock(ctx, 5, indexToHash(5), indexToHash(3), 4, 3))
...
func TestNode_SetFullyValidated(t *testing.T) {
	...
	require.NoError(t, f.ProcessBlock(ctx, 3, indexToHash(3), indexToHash(2), 1, 1))
	require.NoError(t, f.ProcessBlock(ctx, 4, indexToHash(4), indexToHash(3), 1, 1))
	require.NoError(t, f.ProcessBlock(ctx, 5, indexToHash(5), indexToHash(1), 1, 1))
