...
func (s *ChainService) HeadState(context.Context) (types.BeaconState, error) {
	return s.State, nil
}
...
func (s *ChainService) AttestationTargetState(_ context.Context, _ *ethpb.Checkpoint) (types.BeaconState, error) {
	return s.State, nil
}
