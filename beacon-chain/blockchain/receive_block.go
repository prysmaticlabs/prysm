...
type BlockReceiver interface {
	ReceiveBlock(ctx context.Context, block blockInterface.SignedBeaconBlock, blockRoot [32]byte) error
	ReceiveBlockBatch(ctx context.Context, blocks []blockInterface.SignedBeaconBlock, blkRoots [][32]byte) error
...
func (s *Service) ReceiveBlock(ctx context.Context, block blockInterface.SignedBeaconBlock, blockRoot [32]byte) error {
...
func (s *Service) ReceiveBlockBatch(ctx context.Context, blocks []blockInterface.SignedBeaconBlock, blkRoots [][32]byte) error {
...
func (s *Service) handlePostBlockOperations(b blockInterface.BeaconBlock) error {
