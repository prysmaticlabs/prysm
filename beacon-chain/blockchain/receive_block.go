...
// blocks that is received from rpc. The operations consists of:
...
// that are preformed on blocks that is received from p2p. The operations consists of:
...
// that are preformed blocks that is received from initial sync. The operations consists of:
//   1. Validate block, apply state transition and update check points
