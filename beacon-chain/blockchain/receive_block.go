...
type BlockReceiver interface {
	ReceiveBlock(ctx context.Context, block block2.SignedBeaconBlock, blockRoot [32]byte) error
	ReceiveBlockBatch(ctx context.Context, blocks []block2.SignedBeaconBlock, blkRoots [][32]byte) error
...
func (s *Service) ReceiveBlock(ctx context.Context, block block2.SignedBeaconBlock, blockRoot [32]byte) error {
...
func (s *Service) ReceiveBlockBatch(ctx context.Context, blocks []block2.SignedBeaconBlock, blkRoots [][32]byte) error {
...
func (s *Service) handlePostBlockOperations(b block2.BeaconBlock) error {
