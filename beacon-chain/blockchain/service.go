...
func (s *Service) initializeBeaconChain(
	...
	eth1data *ethpb.Eth1Data) (interfaces.BeaconState, error) {
...
func (s *Service) saveGenesisData(ctx context.Context, genesisState interfaces.BeaconState) error {
...
func (s *Service) initializeChainInfo(ctx context.Context) error {
	...
	var finalizedState interfaces.BeaconState
