...
var (
	...
	ErrInvalidPayload = invalidBlock{errors.New("received an INVALID payload from execution engine")}
	// ErrInvalidBlockHashPayloadStatus is returned when the payload has invalid block hash.
	ErrInvalidBlockHashPayloadStatus = invalidBlock{errors.New("received an INVALID_BLOCK_HASH payload from execution engine")}
