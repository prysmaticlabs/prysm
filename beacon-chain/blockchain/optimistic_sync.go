...
// isOptimisticCandidateBlock returns true if this block can be optimistically
// synced. The spec definition is
...
//
func (s *Service) isOptimisticCandidateBlock(ctx context.Context, blk block.BeaconBlock) (bool, error) {
	...
	return blocks.IsExecutionBlock(jBlock.Block())
}
