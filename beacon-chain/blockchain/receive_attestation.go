...
type AttestationReceiver interface {
	...
	AttestationPreState(ctx context.Context, att *ethpb.Attestation) (interfaces.BeaconState, error)
...
func (s *Service) AttestationPreState(ctx context.Context, att *ethpb.Attestation) (interfaces.BeaconState, error) {
