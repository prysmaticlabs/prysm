...
func (e *batchParentEngine) NewPayload(ctx context.Context, payload interfaces.ExecutionData, hashes []common.Hash, parent *common.Hash, requests enginev1.ExecutionRequester) ([]byte, error) {
	e.calls++
