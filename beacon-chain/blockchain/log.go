...
func logStateTransitionData(b block2.BeaconBlock) {
...
func logBlockSyncStatus(block block2.BeaconBlock, blockRoot [32]byte, finalized *ethpb.Checkpoint, receivedTime time.Time, genesisTime uint64) error {
