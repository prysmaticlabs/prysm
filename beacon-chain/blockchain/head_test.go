...
func TestSaveHead_Different(t *testing.T) {
	...
	newHeadSignedBlock := customtesting.NewBeaconBlock()
	...
	require.NoError(t, err)
	headState, err := customtesting.NewBeaconState()
	require.NoError(t, err)
...
func TestCacheJustifiedStateBalances_CanCache(t *testing.T) {
	...
	state, _ := customtesting.DeterministicGenesisState(t, 100)
	r := [32]byte{'a'}
...
func Test_notifyNewHeadEvent(t *testing.T) {
	t.Run("genesis_state_root", func(t *testing.T) {
		bState, _ := customtesting.DeterministicGenesisState(t, 10)
