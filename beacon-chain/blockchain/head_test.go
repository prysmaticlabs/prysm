...
func TestUpdateHead_MissingJustifiedRoot(t *testing.T) {
	...
	service.store.SetJustifiedCheckptAndPayloadHash(&ethpb.Checkpoint{Root: r[:]}, [32]byte{})
	service.store.SetFinalizedCheckptAndPayloadHash(&ethpb.Checkpoint{}, [32]byte{})
...
func TestUpdateHead_noSavedChanges(t *testing.T) {
	...
	service.store.SetFinalizedCheckptAndPayloadHash(fcp, [32]byte{})
	service.store.SetJustifiedCheckptAndPayloadHash(fcp, [32]byte{})
