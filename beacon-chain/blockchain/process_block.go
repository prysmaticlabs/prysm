...
//                store.justified_checkpoint = state.current_justified_checkpoint
func (s *Service) onBlock(ctx context.Context, signed prysm.SignedBeaconBlock, blockRoot [32]byte) error {
...
func (s *Service) onBlockBatch(ctx context.Context, blks []prysm.SignedBeaconBlock,
...
func (s *Service) handleBlockAfterBatchVerify(ctx context.Context, signed prysm.SignedBeaconBlock,
...
func (s *Service) insertBlockAndAttestationsToForkChoiceStore(ctx context.Context, blk prysm.BeaconBlock, root [32]byte,
...
func (s *Service) insertBlockToForkChoiceStore(ctx context.Context, blk prysm.BeaconBlock,
...
func (s *Service) savePostStateInfo(ctx context.Context, r [32]byte, b prysm.SignedBeaconBlock, st state.BeaconState, initSync bool) error {
