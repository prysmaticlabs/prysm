...
//                store.justified_checkpoint = state.current_justified_checkpoint
func (s *Service) onBlock(ctx context.Context, signed blockInterface.SignedBeaconBlock, blockRoot [32]byte) error {
...
func (s *Service) onBlockBatch(ctx context.Context, blks []blockInterface.SignedBeaconBlock,
...
func (s *Service) handleBlockAfterBatchVerify(ctx context.Context, signed blockInterface.SignedBeaconBlock,
...
func (s *Service) insertBlockAndAttestationsToForkChoiceStore(ctx context.Context, blk blockInterface.BeaconBlock, root [32]byte,
...
func (s *Service) insertBlockToForkChoiceStore(ctx context.Context, blk blockInterface.BeaconBlock,
...
func (s *Service) savePostStateInfo(ctx context.Context, r [32]byte, b blockInterface.SignedBeaconBlock, st iface.BeaconState, initSync bool) error {
