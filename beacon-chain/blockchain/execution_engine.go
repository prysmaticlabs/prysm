...
func (s *Service) getPayloadAttribute(ctx context.Context, st types.BeaconState, slot primitives.Slot) (bool, payloadattribute.Attributer, primitives.ValidatorIndex) {
