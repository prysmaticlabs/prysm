...
func (s *Service) getBlockPreState(ctx context.Context, b blockInterface.BeaconBlock) (iface.BeaconState, error) {
...
func (s *Service) verifyBlkPreState(ctx context.Context, b blockInterface.BeaconBlock) error {
...
func (s *Service) verifyBlkFinalizedSlot(b blockInterface.BeaconBlock) error {
...
func (s *Service) shouldUpdateCurrentJustified(ctx context.Context, newJustifiedCheckpt *ethpb.Checkpoint) (bool, error) {
	...
	var newJustifiedBlockSigned blockInterface.SignedBeaconBlock
	...
	var justifiedBlockSigned blockInterface.SignedBeaconBlock
...
func (s *Service) fillInForkChoiceMissingBlocks(ctx context.Context, blk blockInterface.BeaconBlock,
	fCheckpoint, jCheckpoint *ethpb.Checkpoint) error {
	pendingNodes := make([]blockInterface.BeaconBlock, 0)
