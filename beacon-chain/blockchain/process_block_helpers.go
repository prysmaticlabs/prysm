...
func (s *Service) getBlockPreState(ctx context.Context, b interfaces.BeaconBlock) (interfaces.BeaconState, error) {
...
func (s *Service) updateJustified(ctx context.Context, state interfaces.ReadOnlyBeaconState) error {
...
//                store.justified_checkpoint = state.current_justified_checkpoint
func (s *Service) finalizedImpliesNewJustified(ctx context.Context, state interfaces.BeaconState) error {
