...
func (s *Service) getBlockPreState(ctx context.Context, b block2.BeaconBlock) (state.BeaconState, error) {
...
func (s *Service) verifyBlkPreState(ctx context.Context, b block2.BeaconBlock) error {
...
func (s *Service) verifyBlkFinalizedSlot(b block2.BeaconBlock) error {
...
func (s *Service) shouldUpdateCurrentJustified(ctx context.Context, newJustifiedCheckpt *ethpb.Checkpoint) (bool, error) {
	...
	var newJustifiedBlockSigned block2.SignedBeaconBlock
	...
	var justifiedBlockSigned block2.SignedBeaconBlock
...
func (s *Service) fillInForkChoiceMissingBlocks(ctx context.Context, blk block2.BeaconBlock,
	fCheckpoint, jCheckpoint *ethpb.Checkpoint) error {
	pendingNodes := make([]block2.BeaconBlock, 0)
