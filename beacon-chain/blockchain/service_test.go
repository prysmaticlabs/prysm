...
func TestChainStartStop_Initialized(t *testing.T) {
	...
	require.NoError(t, err)
	require.NoError(t, beaconDB.SaveBlock(ctx, blockInterface.WrappedPhase0SignedBeaconBlock(genesisBlk)))
...
func TestChainService_InitializeChainInfo(t *testing.T) {
	...
	require.NoError(t, beaconDB.SaveBlock(ctx, blockInterface.WrappedPhase0SignedBeaconBlock(headBlock)))
...
func TestChainService_InitializeChainInfo_HeadSync(t *testing.T) {
	...
	require.NoError(t, err)
	require.NoError(t, beaconDB.SaveGenesisBlockRoot(ctx, genesisRoot))
	require.NoError(t, beaconDB.SaveBlock(ctx, blockInterface.WrappedPhase0SignedBeaconBlock(genesisBlock)))
	...
	require.NoError(t, err)
	require.NoError(t, beaconDB.SaveBlock(ctx, blockInterface.WrappedPhase0SignedBeaconBlock(finalizedBlock)))
...
func TestChainService_SaveHeadNoDB(t *testing.T) {
	...
	require.NoError(t, s.saveHeadNoDB(ctx, blockInterface.WrappedPhase0SignedBeaconBlock(blk), r, newState))
...
func TestHasBlock_ForkChoiceAndDB(t *testing.T) {
	...
	require.NoError(t, err)
	require.NoError(t, s.insertBlockAndAttestationsToForkChoiceStore(ctx, blockInterface.WrappedPhase0SignedBeaconBlock(block).Block(), r, beaconState))
...
func TestServiceStop_SaveCachedBlocks(t *testing.T) {
	...
	r, err := block.Block.HashTreeRoot()
	require.NoError(t, err)
	s.saveInitSyncBlock(r, blockInterface.WrappedPhase0SignedBeaconBlock(block))
...
func BenchmarkHasBlockDB(b *testing.B) {
	...
	block := testutil.NewBeaconBlock()
	require.NoError(b, s.cfg.BeaconDB.SaveBlock(ctx, blockInterface.WrappedPhase0SignedBeaconBlock(block)))
	r, err := block.Block.HashTreeRoot()
...
func BenchmarkHasBlockForkChoiceStore(b *testing.B) {
	...
	require.NoError(b, err)
	require.NoError(b, s.insertBlockAndAttestationsToForkChoiceStore(ctx, blockInterface.WrappedPhase0SignedBeaconBlock(block).Block(), r, beaconState))
