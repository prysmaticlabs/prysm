...
func ProcessJustificationAndFinalizationPreCompute(state interfaces.BeaconState, pBal *Balance) (interfaces.BeaconState, error) {
...
//        state.finalized_checkpoint = old_current_justified_checkpoint
func weighJustificationAndFinalization(state interfaces.BeaconState,
	totalActiveBalance, prevEpochTargetBalance, currEpochTargetBalance uint64) (interfaces.BeaconState, error) {
