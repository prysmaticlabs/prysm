...
func UnrealizedCheckpoints(st types.BeaconState) (uint64, *ethpb.Checkpoint, *ethpb.Checkpoint, error) {
	if st == nil || st.IsNil() {
...
func ProcessJustificationAndFinalizationPreCompute(state types.BeaconState, pBal *Balance) (types.BeaconState, error) {
...
func processJustificationBits(state types.BeaconState, totalActiveBalance, prevEpochTargetBalance, currEpochTargetBalance uint64) bitfield.Bitvector4 {
...
// epoch processing. This is where a beacon node can justify and finalize a new epoch.
func weighJustificationAndFinalization(state types.BeaconState, newBits bitfield.Bitvector4) (types.BeaconState, error) {
...
//	    state.finalized_checkpoint = old_current_justified_checkpoint
func computeCheckpoints(state types.BeaconState, newBits bitfield.Bitvector4) (*ethpb.Checkpoint, *ethpb.Checkpoint, error) {
