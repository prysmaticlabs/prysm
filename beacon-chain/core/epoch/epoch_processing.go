...
func AttestingBalance(state interfaces.ReadOnlyBeaconState, atts []*pb.PendingAttestation) (uint64, error) {
...
func ProcessRegistryUpdates(state interfaces.BeaconState) (interfaces.BeaconState, error) {
...
func ProcessSlashings(state interfaces.BeaconState) (interfaces.BeaconState, error) {
	currentEpoch := helpers.CurrentEpoch(state)
...
func ProcessEth1DataReset(state interfaces.BeaconState) (interfaces.BeaconState, error) {
	currentEpoch := helpers.CurrentEpoch(state)
...
func ProcessEffectiveBalanceUpdates(state interfaces.BeaconState) (interfaces.BeaconState, error) {
...
func ProcessSlashingsReset(state interfaces.BeaconState) (interfaces.BeaconState, error) {
	currentEpoch := helpers.CurrentEpoch(state)
	nextEpoch := currentEpoch + 1
...
func ProcessRandaoMixesReset(state interfaces.BeaconState) (interfaces.BeaconState, error) {
	currentEpoch := helpers.CurrentEpoch(state)
	nextEpoch := currentEpoch + 1
...
func ProcessHistoricalRootsUpdate(state interfaces.BeaconState) (interfaces.BeaconState, error) {
	currentEpoch := helpers.CurrentEpoch(state)
	nextEpoch := currentEpoch + 1
...
func ProcessParticipationRecordUpdates(state interfaces.BeaconState) (interfaces.BeaconState, error) {
...
func ProcessFinalUpdates(state interfaces.BeaconState) (interfaces.BeaconState, error) {
	var err error
...
func UnslashedAttestingIndices(state interfaces.ReadOnlyBeaconState, atts []*pb.PendingAttestation) ([]types.ValidatorIndex, error) {
...
func BaseReward(state interfaces.ReadOnlyBeaconState, index types.ValidatorIndex) (uint64, error) {
	totalBalance, err := helpers.TotalActiveBalance(state)
	if err != nil {
