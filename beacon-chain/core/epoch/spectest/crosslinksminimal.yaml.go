	...
	TestCases     []struct {
		...
		Pre         struct {
			...
			PreviousEpochAttestations []struct {
				AggregationBitfield []byte `yaml:"aggregation_bitfield"`
				Data                struct {
					BeaconBlockRoot []byte `yaml:"beacon_block_root",ssz:"size=32"`
					SourceEpoch     uint64 `yaml:"source_epoch"`
					SourceRoot      []byte `yaml:"source_root",ssz:"size=32"`
					TargetEpoch     uint64 `yaml:"target_epoch"`
					TargetRoot      []byte `yaml:"target_root",ssz:"size=32"`
					Crosslink       struct {
			...
			} `yaml:"previous_epoch_attestations"`
