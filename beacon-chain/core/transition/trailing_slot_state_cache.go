...
// one advancement.
func NextSlotState(_ context.Context, root []byte) (types.BeaconState, error) {
	nsc.RLock()
	defer nsc.RUnlock()
...
func UpdateNextSlotCache(ctx context.Context, root []byte, state types.BeaconState) error {
