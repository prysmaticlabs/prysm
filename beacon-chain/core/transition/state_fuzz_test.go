...
func TestGenesisBeaconState_1000(t *testing.T) {
	...
	for i := 0; i < 1000; i++ {
		...
		gs, err := GenesisBeaconState(context.Background(), deposits, genesisTime, eth1Data, false)
		if err != nil {
			if gs != nil {
...
func TestOptimizedGenesisBeaconState_1000(t *testing.T) {
	...
	for i := 0; i < 1000; i++ {
		...
		gs, err := OptimizedGenesisBeaconState(genesisTime, preState, eth1Data, false)
		if err != nil {
			if gs != nil {
