...
func TestFuzzExecuteStateTransition_1000(t *testing.T) {
	...
	for i := 0; i < 1000; i++ {
		fuzzer.Fuzz(state)
		fuzzer.Fuzz(sb)
		s, err := ExecuteStateTransition(ctx, state, blockInterface.WrappedPhase0SignedBeaconBlock(sb))
		if err != nil && s != nil {
...
func TestFuzzCalculateStateRoot_1000(t *testing.T) {
	...
	for i := 0; i < 1000; i++ {
		fuzzer.Fuzz(state)
		fuzzer.Fuzz(sb)
		stateRoot, err := CalculateStateRoot(ctx, state, blockInterface.WrappedPhase0SignedBeaconBlock(sb))
...
func TestFuzzProcessBlock_1000(t *testing.T) {
	...
	for i := 0; i < 1000; i++ {
		fuzzer.Fuzz(state)
		fuzzer.Fuzz(sb)
		s, err := ProcessBlock(ctx, state, blockInterface.WrappedPhase0SignedBeaconBlock(sb))
		if err != nil && s != nil {
...
func TestFuzzProcessOperations_1000(t *testing.T) {
	...
	for i := 0; i < 1000; i++ {
		fuzzer.Fuzz(state)
		fuzzer.Fuzz(bb)
		s, err := ProcessBlock(ctx, state, blockInterface.WrappedPhase0SignedBeaconBlock(bb))
		if err != nil && s != nil {
...
func TestFuzzprocessOperationsNoVerify_1000(t *testing.T) {
	...
	for i := 0; i < 1000; i++ {
		fuzzer.Fuzz(state)
		fuzzer.Fuzz(bb)
		s, err := ProcessOperationsNoVerifyAttsSigs(ctx, state, blockInterface.WrappedPhase0SignedBeaconBlock(bb))
		if err != nil && s != nil {
			t.Fatalf("state should be nil on err. found: %v on error: %v for block body: %v", s, err, bb)
		}
	}
...
func TestFuzzverifyOperationLengths_10000(t *testing.T) {
	...
	for i := 0; i < 10000; i++ {
		fuzzer.Fuzz(state)
		fuzzer.Fuzz(bb)
		_, err := VerifyOperationLengths(context.Background(), state, blockInterface.WrappedPhase0SignedBeaconBlock(bb))
		_ = err
	}
}
...
func TestFuzzProcessBlockForStateRoot_1000(t *testing.T) {
	...
	for i := 0; i < 1000; i++ {
		fuzzer.Fuzz(state)
		fuzzer.Fuzz(sb)
		s, err := ProcessBlockForStateRoot(ctx, state, blockInterface.WrappedPhase0SignedBeaconBlock(sb))
		if err != nil && s != nil {
			t.Fatalf("state should be nil on err. found: %v on error: %v for signed block: %v", s, err, sb)
		}
	}
