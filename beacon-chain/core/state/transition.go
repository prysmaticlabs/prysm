...
type processFunc func(context.Context, interfaces.BeaconState, interfaces.SignedBeaconBlock) (interfaces.BeaconState, error)

var processDepositsFunc = func(ctx context.Context, s interfaces.BeaconState, blk interfaces.SignedBeaconBlock) (interfaces.BeaconState, error) {
	return b.ProcessDeposits(ctx, s, blk.Block().Body().Deposits())
}
var processProposerSlashingFunc = func(ctx context.Context, s interfaces.BeaconState, blk interfaces.SignedBeaconBlock) (interfaces.BeaconState, error) {
	return b.ProcessProposerSlashings(ctx, s, blk.Block().Body().ProposerSlashings(), v.SlashValidator)
}

var processAttesterSlashingFunc = func(ctx context.Context, s interfaces.BeaconState, blk interfaces.SignedBeaconBlock) (interfaces.BeaconState, error) {
	return b.ProcessAttesterSlashings(ctx, s, blk.Block().Body().AttesterSlashings(), v.SlashValidator)
}

var processEth1DataFunc = func(ctx context.Context, s interfaces.BeaconState, blk interfaces.SignedBeaconBlock) (interfaces.BeaconState, error) {
	return b.ProcessEth1DataInBlock(ctx, s, blk.Block().Body().Eth1Data())
}

var processExitFunc = func(ctx context.Context, s interfaces.BeaconState, blk interfaces.SignedBeaconBlock) (interfaces.BeaconState, error) {
...
func ProcessSlot(ctx context.Context, state interfaces.BeaconState) (interfaces.BeaconState, error) {
...
func ProcessSlotsUsingNextSlotCache(
	ctx context.Context,
	parentState interfaces.BeaconState,
	parentRoot []byte,
	slot types.Slot) (interfaces.BeaconState, error) {
...
func ProcessSlots(ctx context.Context, state interfaces.BeaconState, slot types.Slot) (interfaces.BeaconState, error) {
...
func VerifyOperationLengths(_ context.Context, state interfaces.BeaconState, b interfaces.SignedBeaconBlock) (interfaces.BeaconState, error) {
...
// Spec pseudocode definition:
//    If (state.slot + 1) % SLOTS_PER_EPOCH == 0:
func CanProcessEpoch(state interfaces.ReadOnlyBeaconState) bool {
...
func ProcessEpochPrecompute(ctx context.Context, state interfaces.BeaconState) (interfaces.BeaconState, error) {
