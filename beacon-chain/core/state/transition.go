...
type processFunc func(context.Context, iface.BeaconState, blockInterface.SignedBeaconBlock) (iface.BeaconState, error)

var processDepositsFunc = func(ctx context.Context, s iface.BeaconState, blk blockInterface.SignedBeaconBlock) (iface.BeaconState, error) {
	return b.ProcessDeposits(ctx, s, blk.Block().Body().Deposits())
}
var processProposerSlashingFunc = func(ctx context.Context, s iface.BeaconState, blk blockInterface.SignedBeaconBlock) (iface.BeaconState, error) {
	return b.ProcessProposerSlashings(ctx, s, blk.Block().Body().ProposerSlashings(), v.SlashValidator)
}

var processAttesterSlashingFunc = func(ctx context.Context, s iface.BeaconState, blk blockInterface.SignedBeaconBlock) (iface.BeaconState, error) {
	return b.ProcessAttesterSlashings(ctx, s, blk.Block().Body().AttesterSlashings(), v.SlashValidator)
}

var processEth1DataFunc = func(ctx context.Context, s iface.BeaconState, blk blockInterface.SignedBeaconBlock) (iface.BeaconState, error) {
	return b.ProcessEth1DataInBlock(ctx, s, blk.Block().Body().Eth1Data())
}

var processExitFunc = func(ctx context.Context, s iface.BeaconState, blk blockInterface.SignedBeaconBlock) (iface.BeaconState, error) {
...
func VerifyOperationLengths(_ context.Context, state iface.BeaconState, b blockInterface.SignedBeaconBlock) (iface.BeaconState, error) {
