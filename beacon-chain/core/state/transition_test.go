...
func TestProcessBlock_IncorrectProposerSlashing(t *testing.T) {
	...
	_, err = state.ProcessBlock(context.Background(), beaconState, blockInterface.WrappedPhase0SignedBeaconBlock(block))
	assert.ErrorContains(t, want, err)
}
...
func TestProcessBlock_IncorrectProcessExits(t *testing.T) {
	...
	_, err = state.VerifyOperationLengths(context.Background(), beaconState, blockInterface.WrappedPhase0SignedBeaconBlock(block))
...
func TestProcessBlock_PassesProcessingConditions(t *testing.T) {
	...
	beaconState, err := state.ProcessBlock(context.Background(), beaconState, blockInterface.WrappedPhase0SignedBeaconBlock(block))
...
func BenchmarkProcessBlk_65536Validators_FullBlock(b *testing.B) {
	...
	b.ResetTimer()
	for n := 0; n < b.N; n++ {
		_, err := state.ProcessBlock(context.Background(), s, blockInterface.WrappedPhase0SignedBeaconBlock(blk))
		require.NoError(b, err)
...
func TestProcessBlock_OverMaxProposerSlashings(t *testing.T) {
	...
	_, err := state.VerifyOperationLengths(context.Background(), &v1.BeaconState{}, blockInterface.WrappedPhase0SignedBeaconBlock(b))
	assert.ErrorContains(t, want, err)
}
...
func TestProcessBlock_IncorrectDeposits(t *testing.T) {
	...
	_, err = state.VerifyOperationLengths(context.Background(), s, blockInterface.WrappedPhase0SignedBeaconBlock(b))
	assert.ErrorContains(t, want, err)
}
