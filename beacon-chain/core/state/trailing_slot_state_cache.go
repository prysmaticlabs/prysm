...
// one advancement.
func NextSlotState(ctx context.Context, root []byte) (interfaces.BeaconState, error) {
	nsc.RLock()
	defer nsc.RUnlock()
...
func UpdateNextSlotCache(ctx context.Context, root []byte, state interfaces.BeaconState) error {
