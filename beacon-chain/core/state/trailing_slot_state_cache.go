...
// one advancement.
func NextSlotState(ctx context.Context, root []byte) (state2.BeaconState, error) {
	nsc.RLock()
	defer nsc.RUnlock()
...
func UpdateNextSlotCache(ctx context.Context, root []byte, state state2.BeaconState) error {
