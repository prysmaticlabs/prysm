...
func NextSyncCommittee(ctx context.Context, s types.BeaconState) (*ethpb.SyncCommittee, error) {
...
func NextSyncCommitteeIndices(ctx context.Context, s types.BeaconState) ([]primitives.ValidatorIndex, error) {
