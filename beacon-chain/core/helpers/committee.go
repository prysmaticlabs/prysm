...
//    )
func BeaconCommitteeFromState(state interfaces.ReadOnlyBeaconState, slot types.Slot, committeeIndex types.CommitteeIndex) ([]types.ValidatorIndex, error) {
...
func VerifyAttestationBitfieldLengths(state interfaces.ReadOnlyBeaconState, att *ethpb.Attestation) error {
...
func ShuffledIndices(state interfaces.ReadOnlyBeaconState, epoch types.Epoch) ([]types.ValidatorIndex, error) {
	seed, err := Seed(state, epoch, params.BeaconConfig().DomainBeaconAttester)
	if err != nil {
...
func UpdateCommitteeCache(state interfaces.ReadOnlyBeaconState, epoch types.Epoch) error {
...
func UpdateProposerIndicesInCache(state interfaces.ReadOnlyBeaconState) error {
...
func precomputeProposerIndices(state interfaces.ReadOnlyBeaconState, activeIndices []types.ValidatorIndex) ([]types.ValidatorIndex, error) {
