...
func Seed(state interfaces.ReadOnlyBeaconState, epoch types.Epoch, domain [bls.DomainByteLength]byte) ([32]byte, error) {
...
func RandaoMix(state interfaces.ReadOnlyBeaconState, epoch types.Epoch) ([]byte, error) {
