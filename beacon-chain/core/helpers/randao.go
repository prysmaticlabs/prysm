...
func Seed(state types.ReadOnlyBeaconState, epoch primitives.Epoch, domain [bls.DomainByteLength]byte) ([32]byte, error) {
...
func RandaoMix(state types.ReadOnlyBeaconState, epoch primitives.Epoch) ([]byte, error) {
