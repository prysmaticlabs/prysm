...
//
//	return ws_period
func ComputeWeakSubjectivityPeriod(ctx context.Context, st types.ReadOnlyBeaconState, cfg *params.BeaconChainConfig) (primitives.Epoch, error) {
...
func IsWithinWeakSubjectivityPeriod(
	ctx context.Context, currentEpoch primitives.Epoch, wsState types.ReadOnlyBeaconState, wsStateRoot [fieldparams.RootLength]byte, wsEpoch primitives.Epoch, cfg *params.BeaconChainConfig) (bool, error) {
...
func LatestWeakSubjectivityEpoch(ctx context.Context, st types.ReadOnlyBeaconState, cfg *params.BeaconChainConfig) (primitives.Epoch, error) {
