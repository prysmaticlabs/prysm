...
//
//    return ws_period
func ComputeWeakSubjectivityPeriod(st interfaces.ReadOnlyBeaconState) (types.Epoch, error) {
...
func IsWithinWeakSubjectivityPeriod(
	currentEpoch types.Epoch, wsState interfaces.ReadOnlyBeaconState, wsCheckpoint *eth.WeakSubjectivityCheckpoint) (bool, error) {
...
func LatestWeakSubjectivityEpoch(st interfaces.ReadOnlyBeaconState) (types.Epoch, error) {
