...
func TestProcessAttesterSlashings_RegressionSlashableIndices(t *testing.T) {
	...
	beaconState, privKeys := customtesting.DeterministicGenesisState(t, 5500)
	...
	att1 := &ethpb.IndexedAttestation{
		Data:             customtesting.HydrateAttestationData(&ethpb.AttestationData{Target: &ethpb.Checkpoint{Epoch: 0, Root: root1[:]}}),
