...
func TestProcessRandao_IncorrectProposerFailsVerification(t *testing.T) {
	...
	_, err = blocks.ProcessRandao(context.Background(), beaconState, blockInterface.WrappedPhase0SignedBeaconBlock(b))
...
func TestProcessRandao_SignatureVerifiesAndUpdatesLatestStateMixes(t *testing.T) {
	...
	newState, err := blocks.ProcessRandao(
		context.Background(),
		beaconState,
		blockInterface.WrappedPhase0SignedBeaconBlock(b),
	)
