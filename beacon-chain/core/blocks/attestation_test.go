...
func TestProcessAttestations_InclusionDelayFailure(t *testing.T) {
	...
	_, err := blocks.ProcessAttestations(context.Background(), beaconState, blockInterface.WrappedPhase0SignedBeaconBlock(b))
...
func TestProcessAttestations_OK(t *testing.T) {
	...
	err = beaconState.SetSlot(beaconState.Slot() + params.BeaconConfig().MinAttestationInclusionDelay)
	require.NoError(t, err)
	_, err = blocks.ProcessAttestations(context.Background(), beaconState, blockInterface.WrappedPhase0SignedBeaconBlock(block))
