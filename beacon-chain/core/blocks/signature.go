...
func VerifyBlockSignature(beaconState interfaces.ReadOnlyBeaconState,
...
func BlockSignatureSet(beaconState interfaces.ReadOnlyBeaconState,
	proposerIndex types.ValidatorIndex,
	sig []byte,
...
func RandaoSignatureSet(beaconState interfaces.ReadOnlyBeaconState,
	reveal []byte,
...
func randaoSigningData(beaconState interfaces.ReadOnlyBeaconState) ([]byte, []byte, []byte, error) {
...
func createAttestationSignatureSet(
	ctx context.Context,
	beaconState interfaces.ReadOnlyBeaconState,
...
func AttestationSignatureSet(ctx context.Context, beaconState interfaces.ReadOnlyBeaconState, atts []*ethpb.Attestation) (*bls.SignatureSet, error) {
	if len(atts) == 0 {
