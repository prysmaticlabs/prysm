...
func TestProcessBlockHeader_ImproperBlockSlot(t *testing.T) {
	...
	_, err = blocks.ProcessBlockHeader(context.Background(), state, blockInterface.WrappedPhase0SignedBeaconBlock(block))
...
func TestProcessBlockHeader_WrongProposerSig(t *testing.T) {
	...
	_, err = blocks.ProcessBlockHeader(context.Background(), beaconState, blockInterface.WrappedPhase0SignedBeaconBlock(block))
...
func TestProcessBlockHeader_OK(t *testing.T) {
	...
	newState, err := blocks.ProcessBlockHeader(context.Background(), state, blockInterface.WrappedPhase0SignedBeaconBlock(block))
