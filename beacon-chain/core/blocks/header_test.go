...
func TestProcessBlockHeader_ImproperBlockSlot(t *testing.T) {
	...
	require.NoError(t, state.SetLatestBlockHeader(customtesting.HydrateBeaconHeader(&ethpb.BeaconBlockHeader{
...
func TestProcessBlockHeader_WrongProposerSig(t *testing.T) {
	...
	require.NoError(t, beaconState.SetLatestBlockHeader(customtesting.HydrateBeaconHeader(&ethpb.BeaconBlockHeader{
		Slot: 9,
	})))
