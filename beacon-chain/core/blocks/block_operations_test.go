...
func TestConvertToIndexed_OK(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			wantedCustodyBit0Indices: []uint64{61},
			wantedCustodyBit1Indices: []uint64{115},
		},
		{
			aggregationBitfield:      bitfield.Bitlist{0x07},
			custodyBitfield:          bitfield.Bitlist{0x06},
			wantedCustodyBit0Indices: []uint64{115},
			wantedCustodyBit1Indices: []uint64{61},
		},
		{
			aggregationBitfield:      bitfield.Bitlist{0x07},
			custodyBitfield:          bitfield.Bitlist{0x07},
			wantedCustodyBit0Indices: []uint64{},
			wantedCustodyBit1Indices: []uint64{61, 115},
		},
	}
