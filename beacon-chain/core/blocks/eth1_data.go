...
func ProcessEth1DataInBlock(_ context.Context, beaconState interfaces.BeaconState, eth1Data *ethpb.Eth1Data) (interfaces.BeaconState, error) {
...
func Eth1DataHasEnoughSupport(beaconState interfaces.ReadOnlyBeaconState, data *ethpb.Eth1Data) (bool, error) {
	voteCount := uint64(0)
