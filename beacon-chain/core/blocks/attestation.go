...
func VerifyAttestationSignature(ctx context.Context, beaconState interfaces.ReadOnlyBeaconState, att *ethpb.Attestation) error {
	if err := helpers.ValidateNilAttestation(att); err != nil {
		return err
	}
	committee, err := helpers.BeaconCommitteeFromState(beaconState, att.Data.Slot, att.Data.CommitteeIndex)
...
func VerifyIndexedAttestation(ctx context.Context, beaconState interfaces.ReadOnlyBeaconState, indexedAtt *ethpb.IndexedAttestation) error {
