...
func (p *Pool) PendingAttesterSlashings(ctx context.Context, state interfaces.ReadOnlyBeaconState, noLimit bool) []*ethpb.AttesterSlashing {
	p.lock.Lock()
	defer p.lock.Unlock()
...
func (p *Pool) PendingProposerSlashings(ctx context.Context, state interfaces.ReadOnlyBeaconState, noLimit bool) []*ethpb.ProposerSlashing {
	p.lock.Lock()
	defer p.lock.Unlock()
