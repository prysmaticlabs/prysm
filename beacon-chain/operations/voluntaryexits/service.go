...
type PoolManager interface {
	PendingExits(state interfaces.ReadOnlyBeaconState, slot types.Slot, noLimit bool) []*ethpb.SignedVoluntaryExit
	InsertVoluntaryExit(ctx context.Context, state interfaces.ReadOnlyBeaconState, exit *ethpb.SignedVoluntaryExit)
...
func (p *Pool) PendingExits(state interfaces.ReadOnlyBeaconState, slot types.Slot, noLimit bool) []*ethpb.SignedVoluntaryExit {
	p.lock.RLock()
...
func (p *Pool) InsertVoluntaryExit(ctx context.Context, state interfaces.ReadOnlyBeaconState, exit *ethpb.SignedVoluntaryExit) {
