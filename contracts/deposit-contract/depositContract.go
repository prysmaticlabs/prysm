...
const DepositContractABI = "[{\"name\":\"DepositEvent\",\"inputs\":[{\"type\":\"bytesutil\",\"name\":\"pubkey\",\"indexed\":false},{\"type\":\"bytesutil\",\"name\":\"withdrawal_credentials\",\"indexed\":false},{\"type\":\"bytesutil\",\"name\":\"amount\",\"indexed\":false},{\"type\":\"bytesutil\",\"name\":\"signature\",\"indexed\":false},{\"type\":\"bytesutil\",\"name\":\"index\",\"indexed\":false}],\"anonymous\":false,\"type\":\"event\"},{\"outputs\":[],\"inputs\":[{\"type\":\"address\",\"name\":\"_drain_address\"}],\"constant\":false,\"payable\":false,\"type\":\"constructor\"},{\"name\":\"get_deposit_root\",\"outputs\":[{\"type\":\"bytes32\",\"name\":\"out\"}],\"inputs\":[],\"constant\":true,\"payable\":false,\"type\":\"function\",\"gas\":95389},{\"name\":\"get_deposit_count\",\"outputs\":[{\"type\":\"bytesutil\",\"name\":\"out\"}],\"inputs\":[],\"constant\":true,\"payable\":false,\"type\":\"function\",\"gas\":17683},{\"name\":\"deposit\",\"outputs\":[],\"inputs\":[{\"type\":\"bytesutil\",\"name\":\"pubkey\"},{\"type\":\"bytesutil\",\"name\":\"withdrawal_credentials\"},{\"type\":\"bytesutil\",\"name\":\"signature\"},{\"type\":\"bytes32\",\"name\":\"deposit_data_root\"}],\"constant\":false,\"payable\":true,\"type\":\"function\",\"gas\":1754607},{\"name\":\"drain\",\"outputs\":[],\"inputs\":[],\"constant\":false,\"payable\":false,\"type\":\"function\",\"gas\":35793},{\"name\":\"drain_address\",\"outputs\":[{\"type\":\"address\",\"name\":\"out\"}],\"inputs\":[],\"constant\":true,\"payable\":false,\"type\":\"function\",\"gas\":663}]"
...
//
// Solidity: function get_deposit_count() returns(bytesutil out)
...
//
// Solidity: function deposit(bytesutil pubkey, bytesutil withdrawal_credentials, bytesutil signature, bytes32 deposit_data_root) returns()
...
//
// Solidity: event DepositEvent(bytesutil pubkey, bytesutil withdrawal_credentials, bytesutil amount, bytesutil signature, bytesutil index)
