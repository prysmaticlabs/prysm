...
//   - Send a transaction on the Ethereum 1.0 chain to DEPOSIT_CONTRACT_ADDRESS executing `deposit(pubkey: bytesutil[48], withdrawal_credentials: bytesutil[32], signature: bytesutil[96])` along with a deposit of amount Gwei.
//
