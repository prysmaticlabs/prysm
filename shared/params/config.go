...
type BeaconChainConfig struct {
	...
	// Light client values.
	EpochsPerSyncCommitteePeriod types.Epoch `yaml:"EPOCHS_PER_SYNC_COMMITTEE_PERIOD"`      // EpochsPerSyncCommitteePeriod defines the epochs per sync committee period.
