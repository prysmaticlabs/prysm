...
type BeaconChainConfig struct {
	...
	DuplicateValidatorEpochCheck	 uint8		 `yaml:"NUMBER_OF_EPOCHS_TO_CHECK_FOR_DOPPLEGANGER_VALIDATOR" spec:"false"` //N=2 number of epochs to check for duplicate validator before starting
