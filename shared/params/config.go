...
func DemoBeaconConfig() *BeaconChainConfig {
	...
	demoConfig.LatestRandaoMixesLength = 40
	demoConfig.LatestActiveIndexRootsLength = 40
	demoConfig.LatestSlashedExitLength = 40
	demoConfig.LatestBlockRootsLength = 40
