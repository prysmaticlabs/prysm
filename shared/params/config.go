...
type BeaconChainConfig struct {
	...
	ValidatorRagistryLimit    uint64 `yaml:"VALIDATOR_REGISTRY_LIMIT"`     // ValidatorRagistryLimit defines the upper bound of validators can participate in eth2.
...
var defaultBeaconConfig = &BeaconChainConfig{
	...
	ValidatorRagistryLimit:    1099511627776,
...
func MinimalSpecConfig() *BeaconChainConfig {
	...
	minimalConfig.ValidatorRagistryLimit = 1099511627776
