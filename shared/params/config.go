...
type BeaconChainConfig struct {
	...
	PropotionalSlashingMultiplier uint64 `yaml:"PROPORTIONAL_SLASHING_MULTIPLIER"` // PropotionalSlashingMultiplier is used to as a multiplier on slashed penalties.
