...
func (m *MockBeaconNodeValidator_StreamDutiesClient) Send(arg0 *eth.DutiesRequest) error {
	m.ctrl.T.Helper()
...
func (mr *MockBeaconNodeValidator_StreamDutiesClientMockRecorder) Send(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Send", reflect.TypeOf((*MockBeaconNodeValidator_StreamDutiesClient)(nil).Send), arg0)
}
