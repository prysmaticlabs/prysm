...
// Source: github.com/prysmaticlabs/prysm/proto/eth/v1alpha1 (interfaces: BeaconNodeValidatorClient,BeaconNodeValidator_WaitForChainStartClient,BeaconNodeValidator_WaitForActivationClient,BeaconNodeValidator_StreamDutiesClient)
...
func (m *MockBeaconNodeValidatorClient) GetBlockV2(arg0 context.Context, arg1 *v1alpha1.BlockRequest, arg2 ...grpc.CallOption) (*v1alpha1.BeaconBlockAltair, error) {
	m.ctrl.T.Helper()
	varargs := []interface{}{arg0, arg1}
	for _, a := range arg2 {
		varargs = append(varargs, a)
...
func (m *MockBeaconNodeValidatorClient) GetSyncMessageBlockRoot(arg0 context.Context, arg1 *v1alpha1.SyncMessageBlockRootRequest, arg2 ...grpc.CallOption) (*v1alpha1.SyncMessageBlockRootResponse, error) {
	m.ctrl.T.Helper()
	varargs := []interface{}{arg0, arg1}
	for _, a := range arg2 {
		varargs = append(varargs, a)
...
func (m *MockBeaconNodeValidatorClient) ProposeBlockV2(arg0 context.Context, arg1 *v1alpha1.SignedBeaconBlockAltair, arg2 ...grpc.CallOption) (*v1alpha1.ProposeResponse, error) {
	m.ctrl.T.Helper()
	varargs := []interface{}{arg0, arg1}
	for _, a := range arg2 {
		varargs = append(varargs, a)
