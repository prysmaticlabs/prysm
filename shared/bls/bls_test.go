...
func TestComputeDomain_OK(t *testing.T) {
	...
	for _, tt := range tests {
		if !bytes.Equal(bls.ComputeDomain(tt.domainType, nil, nil), tt.domain) {
			t.Errorf("wanted domain version: %d, got: %d", tt.domain, bls.ComputeDomain(tt.domainType, nil, nil))
		}
	}
}
