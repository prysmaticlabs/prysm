...
// BLSDomain returns the bls domain given by the domain type and the operation 4 byte fork version.
//
...
func BLSDomain(domainType uint64, forkVersion []byte) uint64 {
	b := []byte{}
