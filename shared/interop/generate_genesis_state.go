...
func GenerateGenesisState(ctx context.Context, genesisTime, numValidators uint64) (*statepb.BeaconState, []*ethpb.Deposit, error) {
...
) (*statepb.BeaconState, []*ethpb.Deposit, error) {
