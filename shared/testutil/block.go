...
func HydrateBeaconBlockBody(b *ethpb.BeaconBlockBody) *ethpb.BeaconBlockBody {
	...
	if b.SyncCommitteeSignature == nil {
		b.SyncCommitteeSignature = make([]byte, params.BeaconConfig().BLSSignatureLength)
	}
	if b.SyncCommitteeBits == nil {
		b.SyncCommitteeBits = bitfield.NewBitvector1024()
	}
	return b
}
