...
// 	protoc        v3.15.8
// source: proto/prysm/v2/attestation.proto
...
func (x *Attestation) Reset() {
	*x = Attestation{}
	if protoimpl.UnsafeEnabled {
		mi := &file_proto_prysm_v2_attestation_proto_msgTypes[0]
...
func (*Attestation) Descriptor() ([]byte, []int) {
	return file_proto_prysm_v2_attestation_proto_rawDescGZIP(), []int{0}
}
...
func (x *AggregateAttestationAndProof) Reset() {
	*x = AggregateAttestationAndProof{}
	if protoimpl.UnsafeEnabled {
		mi := &file_proto_prysm_v2_attestation_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*AggregateAttestationAndProof) Descriptor() ([]byte, []int) {
	return file_proto_prysm_v2_attestation_proto_rawDescGZIP(), []int{1}
}
...
func (x *SignedAggregateAttestationAndProof) Reset() {
	*x = SignedAggregateAttestationAndProof{}
	if protoimpl.UnsafeEnabled {
		mi := &file_proto_prysm_v2_attestation_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*SignedAggregateAttestationAndProof) Descriptor() ([]byte, []int) {
	return file_proto_prysm_v2_attestation_proto_rawDescGZIP(), []int{2}
}
...
func (x *AttestationData) Reset() {
	*x = AttestationData{}
	if protoimpl.UnsafeEnabled {
		mi := &file_proto_prysm_v2_attestation_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*AttestationData) Descriptor() ([]byte, []int) {
	return file_proto_prysm_v2_attestation_proto_rawDescGZIP(), []int{3}
}
...
func (x *Checkpoint) Reset() {
	*x = Checkpoint{}
	if protoimpl.UnsafeEnabled {
		mi := &file_proto_prysm_v2_attestation_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*Checkpoint) Descriptor() ([]byte, []int) {
	return file_proto_prysm_v2_attestation_proto_rawDescGZIP(), []int{4}
}
...
var File_proto_prysm_v2_attestation_proto protoreflect.FileDescriptor

var file_proto_prysm_v2_attestation_proto_rawDesc = []byte{
	0x0a, 0x20, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2f, 0x70, 0x72, 0x79, 0x73, 0x6d, 0x2f, 0x76, 0x32,
	0x2f, 0x61, 0x74, 0x74, 0x65, 0x73, 0x74, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x2e, 0x70, 0x72, 0x6f,
	0x74, 0x6f, 0x12, 0x11, 0x65, 0x74, 0x68, 0x65, 0x72, 0x65, 0x75, 0x6d, 0x2e, 0x70, 0x72, 0x79,
	0x73, 0x6d, 0x2e, 0x76, 0x32, 0x1a, 0x1b, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2f, 0x65, 0x74, 0x68,
	0x2f, 0x65, 0x78, 0x74, 0x2f, 0x6f, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x2e, 0x70, 0x72, 0x6f,
	0x74, 0x6f, 0x22, 0xd0, 0x01, 0x0a, 0x0b, 0x41, 0x74, 0x74, 0x65, 0x73, 0x74, 0x61, 0x74, 0x69,
	...
	0x69, 0x6f, 0x6e, 0x42, 0x69, 0x74, 0x73, 0x12, 0x36, 0x0a, 0x04, 0x64, 0x61, 0x74, 0x61, 0x18,
	...
	0x61, 0x74, 0x75, 0x72, 0x65, 0x22, 0xf0, 0x01, 0x0a, 0x1c, 0x41, 0x67, 0x67, 0x72, 0x65, 0x67,
	...
	0x61, 0x74, 0x6f, 0x72, 0x49, 0x6e, 0x64, 0x65, 0x78, 0x12, 0x3c, 0x0a, 0x09, 0x61, 0x67, 0x67,
	0x72, 0x65, 0x67, 0x61, 0x74, 0x65, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1e, 0x2e, 0x65,
	...
	0x69, 0x6f, 0x6e, 0x50, 0x72, 0x6f, 0x6f, 0x66, 0x22, 0x95, 0x01, 0x0a, 0x22, 0x53, 0x69, 0x67,
	...
	0x49, 0x0a, 0x07, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b,
	0x32, 0x2f, 0x2e, 0x65, 0x74, 0x68, 0x65, 0x72, 0x65, 0x75, 0x6d, 0x2e, 0x70, 0x72, 0x79, 0x73,
	0x6d, 0x2e, 0x76, 0x32, 0x2e, 0x41, 0x67, 0x67, 0x72, 0x65, 0x67, 0x61, 0x74, 0x65, 0x41, 0x74,
	...
	0x22, 0xd6, 0x02, 0x0a, 0x0f, 0x41, 0x74, 0x74, 0x65, 0x73, 0x74, 0x61, 0x74, 0x69, 0x6f, 0x6e,
	...
	0x6f, 0x75, 0x72, 0x63, 0x65, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1d, 0x2e, 0x65, 0x74,
	...
	0x79, 0x73, 0x6d, 0x2e, 0x76, 0x32, 0x2e, 0x43, 0x68, 0x65, 0x63, 0x6b, 0x70, 0x6f, 0x69, 0x6e,
	...
	0x33, 0x32, 0x52, 0x04, 0x72, 0x6f, 0x6f, 0x74, 0x42, 0x83, 0x01, 0x0a, 0x15, 0x6f, 0x72, 0x67,
	0x2e, 0x65, 0x74, 0x68, 0x65, 0x72, 0x65, 0x75, 0x6d, 0x2e, 0x70, 0x72, 0x79, 0x73, 0x6d, 0x2e,
	0x76, 0x32, 0x42, 0x10, 0x41, 0x74, 0x74, 0x65, 0x73, 0x74, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x50,
	...
	0x73, 0x6d, 0x2f, 0x76, 0x32, 0x3b, 0x76, 0x32, 0xaa, 0x02, 0x0f, 0x45, 0x74, 0x68, 0x65, 0x72,
	0x65, 0x75, 0x6d, 0x2e, 0x45, 0x74, 0x68, 0x2e, 0x76, 0x32, 0xca, 0x02, 0x11, 0x45, 0x74, 0x68,
	0x65, 0x72, 0x65, 0x75, 0x6d, 0x5c, 0x50, 0x72, 0x79, 0x73, 0x6d, 0x5c, 0x76, 0x32, 0x62, 0x06,
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}

var (
	file_proto_prysm_v2_attestation_proto_rawDescOnce sync.Once
	file_proto_prysm_v2_attestation_proto_rawDescData = file_proto_prysm_v2_attestation_proto_rawDesc
)

func file_proto_prysm_v2_attestation_proto_rawDescGZIP() []byte {
	file_proto_prysm_v2_attestation_proto_rawDescOnce.Do(func() {
		file_proto_prysm_v2_attestation_proto_rawDescData = protoimpl.X.CompressGZIP(file_proto_prysm_v2_attestation_proto_rawDescData)
	})
	return file_proto_prysm_v2_attestation_proto_rawDescData
}

var file_proto_prysm_v2_attestation_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_proto_prysm_v2_attestation_proto_goTypes = []interface{}{
	(*Attestation)(nil),                        // 0: ethereum.prysm.v2.Attestation
	(*AggregateAttestationAndProof)(nil),       // 1: ethereum.prysm.v2.AggregateAttestationAndProof
	(*SignedAggregateAttestationAndProof)(nil), // 2: ethereum.prysm.v2.SignedAggregateAttestationAndProof
	(*AttestationData)(nil),                    // 3: ethereum.prysm.v2.AttestationData
	(*Checkpoint)(nil),                         // 4: ethereum.prysm.v2.Checkpoint
}
var file_proto_prysm_v2_attestation_proto_depIdxs = []int32{
	3, // 0: ethereum.prysm.v2.Attestation.data:type_name -> ethereum.prysm.v2.AttestationData
	0, // 1: ethereum.prysm.v2.AggregateAttestationAndProof.aggregate:type_name -> ethereum.prysm.v2.Attestation
	1, // 2: ethereum.prysm.v2.SignedAggregateAttestationAndProof.message:type_name -> ethereum.prysm.v2.AggregateAttestationAndProof
	4, // 3: ethereum.prysm.v2.AttestationData.source:type_name -> ethereum.prysm.v2.Checkpoint
	4, // 4: ethereum.prysm.v2.AttestationData.target:type_name -> ethereum.prysm.v2.Checkpoint
...
func init() { file_proto_prysm_v2_attestation_proto_init() }
func file_proto_prysm_v2_attestation_proto_init() {
	if File_proto_prysm_v2_attestation_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_proto_prysm_v2_attestation_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_proto_prysm_v2_attestation_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_proto_prysm_v2_attestation_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_proto_prysm_v2_attestation_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_proto_prysm_v2_attestation_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_proto_prysm_v2_attestation_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_proto_prysm_v2_attestation_proto_goTypes,
		DependencyIndexes: file_proto_prysm_v2_attestation_proto_depIdxs,
		MessageInfos:      file_proto_prysm_v2_attestation_proto_msgTypes,
	}.Build()
	File_proto_prysm_v2_attestation_proto = out.File
	file_proto_prysm_v2_attestation_proto_rawDesc = nil
	file_proto_prysm_v2_attestation_proto_goTypes = nil
	file_proto_prysm_v2_attestation_proto_depIdxs = nil
}
