...
// Hash: 517a01f6866cd3345d8100321f98daef834987355e350686ee12d3c4dc5bd993
package eth
...
func (b *BeaconBlockBodyElectra) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	// Offset (12) 'InclusionList'
	dst = ssz.WriteOffset(dst, offset)
	if b.InclusionList == nil {
		b.InclusionList = new(v1.InclusionList)
	}
	offset += b.InclusionList.SizeSSZ()
	...
	// Field (12) 'InclusionList'
	if dst, err = b.InclusionList.MarshalSSZTo(dst); err != nil {
		return
	}
...
func (b *BeaconBlockBodyElectra) UnmarshalSSZ(buf []byte) error {
	...
	// Field (12) 'InclusionList'
	{
		...
		if err = b.InclusionList.UnmarshalSSZ(buf); err != nil {
			return err
		}
	}
	return err
...
func (b *BeaconBlockBodyElectra) HashTreeRootWith(hh *ssz.Hasher) (err error) {
	...
	// Field (12) 'InclusionList'
	if err = b.InclusionList.HashTreeRootWith(hh); err != nil {
		return
	}
