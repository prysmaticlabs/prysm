...
func (c *ExecutionProof) SizeSSZ() int {
	size := 37
	size += len(c.ProofData)
	return size
}

func (c *ExecutionProof) MarshalSSZ() ([]byte, error) {
	buf := make([]byte, c.SizeSSZ())
	return c.MarshalSSZTo(buf[:0])
}

func (c *ExecutionProof) MarshalSSZTo(dst []byte) ([]byte, error) {
	var err error
	offset := 37
	...
	// Field 2: PublicInput
	if c.PublicInput == nil {
		c.PublicInput = new(PublicInput)
	}
	if dst, err = c.PublicInput.MarshalSSZTo(dst); err != nil {
		return nil, fmt.Errorf("PublicInput: %w", err)
	}

	// Field 0: ProofData
	if len(c.ProofData) > 409600 {
		return nil, ssz.ErrListTooBig
	}
...
func (c *ExecutionProof) UnmarshalSSZ(buf []byte) error {
	var err error
	size := uint64(len(buf))
	if size < 37 {
		return ssz.ErrSize
	...
	sszSlice2 := buf[5:37] // c.PublicInput
	...
	// Field 2: PublicInput
	c.PublicInput = new(PublicInput)
	if err = c.PublicInput.UnmarshalSSZ(sszSlice2); err != nil {
		return fmt.Errorf("PublicInput: %w", err)
	}
	return err
}

func (c *ExecutionProof) HashTreeRoot() ([32]byte, error) {
	hh := ssz.DefaultHasherPool.Get()
	if err := c.HashTreeRootWith(hh); err != nil {
		ssz.DefaultHasherPool.Put(hh)
		return [32]byte{}, err
...
func (c *ExecutionProof) HashTreeRootWith(hh *ssz.Hasher) (err error) {
	indx := hh.Index()
	// Field 0: ProofData

	{
		...
		numItems := uint64(len(c.ProofData))
		hh.MerkleizeWithMixin(subIndx, numItems, (409600*1+31)/32)
	}
	...
	// Field 2: PublicInput
	if err := c.PublicInput.HashTreeRootWith(hh); err != nil {
		return fmt.Errorf("PublicInput: %w", err)
	}
	hh.Merkleize(indx)
	return nil
...
func (c *ProofByRootIdentifier) SizeSSZ() int {
	size := 36
	size += len(c.ProofTypes)
	return size
}

func (c *ProofByRootIdentifier) MarshalSSZ() ([]byte, error) {
	buf := make([]byte, c.SizeSSZ())
	return c.MarshalSSZTo(buf[:0])
}

func (c *ProofByRootIdentifier) MarshalSSZTo(dst []byte) ([]byte, error) {
	var err error
	offset := 36
	...
	// Field 1: ProofTypes
	dst = ssz.WriteOffset(dst, offset)
	offset += len(c.ProofTypes)

	// Field 1: ProofTypes
	if len(c.ProofTypes) > 4 {
		return nil, ssz.ErrListTooBig
	}
	dst = append(dst, c.ProofTypes...)
	return dst, err
}

func (c *ProofByRootIdentifier) UnmarshalSSZ(buf []byte) error {
	var err error
	size := uint64(len(buf))
	if size < 36 {
		return ssz.ErrSize
	...
	sszVarOffset1 := ssz.ReadOffset(buf[32:36]) // c.ProofTypes
	if sszVarOffset1 != 36 {
		return ssz.ErrInvalidVariableOffset
	}
	...
	sszSlice1 := buf[sszVarOffset1:] // c.ProofTypes
	...
	// Field 1: ProofTypes
	c.ProofTypes = append([]byte{}, sszSlice1...)
	return err
}

func (c *ProofByRootIdentifier) HashTreeRoot() ([32]byte, error) {
	hh := ssz.DefaultHasherPool.Get()
	if err := c.HashTreeRootWith(hh); err != nil {
		ssz.DefaultHasherPool.Put(hh)
		return [32]byte{}, err
...
func (c *ProofByRootIdentifier) HashTreeRootWith(hh *ssz.Hasher) (err error) {
	indx := hh.Index()
	// Field 0: BlockRoot
	if len(c.BlockRoot) != 32 {
		return ssz.ErrBytesLength
...

	{
		...
		subIndx := hh.Index()
		hh.AppendBytes32(c.ProofTypes)
		numItems := uint64(len(c.ProofTypes))
		hh.MerkleizeWithMixin(subIndx, numItems, (4*1+31)/32)
	}
...
func (c *PublicInput) SizeSSZ() int {
	size := 32

	return size
}

func (c *PublicInput) MarshalSSZ() ([]byte, error) {
	buf := make([]byte, c.SizeSSZ())
	return c.MarshalSSZTo(buf[:0])
}

func (c *PublicInput) MarshalSSZTo(dst []byte) ([]byte, error) {
	var err error

	// Field 0: NewPayloadRequestRoot
	if len(c.NewPayloadRequestRoot) != 32 {
		return nil, ssz.ErrBytesLength
	}
	dst = append(dst, c.NewPayloadRequestRoot...)

	return dst, err
}

func (c *PublicInput) UnmarshalSSZ(buf []byte) error {
	var err error
	size := uint64(len(buf))
	if size != 32 {
		return ssz.ErrSize
	...
	sszSlice0 := buf[0:32] // c.NewPayloadRequestRoot

	// Field 0: NewPayloadRequestRoot
	c.NewPayloadRequestRoot = make([]byte, 0, 32)
	c.NewPayloadRequestRoot = append(c.NewPayloadRequestRoot, sszSlice0...)
	return err
}

func (c *PublicInput) HashTreeRoot() ([32]byte, error) {
	hh := ssz.DefaultHasherPool.Get()
	if err := c.HashTreeRootWith(hh); err != nil {
		ssz.DefaultHasherPool.Put(hh)
		return [32]byte{}, err
...
func (c *PublicInput) HashTreeRootWith(hh *ssz.Hasher) (err error) {
	indx := hh.Index()
	// Field 0: NewPayloadRequestRoot
	if len(c.NewPayloadRequestRoot) != 32 {
		return ssz.ErrBytesLength
	}
	hh.PutBytes(c.NewPayloadRequestRoot)
	hh.Merkleize(indx)
	return nil
}
...
func (c *SignedExecutionProof) SizeSSZ() int {
	size := 108
	if c.Message == nil {
		c.Message = new(ExecutionProof)
	}
	size += c.Message.SizeSSZ()
	return size
}

func (c *SignedExecutionProof) MarshalSSZ() ([]byte, error) {
	buf := make([]byte, c.SizeSSZ())
	return c.MarshalSSZTo(buf[:0])
}

func (c *SignedExecutionProof) MarshalSSZTo(dst []byte) ([]byte, error) {
	var err error
	offset := 108
...
func (c *SignedExecutionProof) UnmarshalSSZ(buf []byte) error {
	var err error
	size := uint64(len(buf))
	if size < 108 {
		return ssz.ErrSize
...
func (c *SignedExecutionProof) HashTreeRoot() ([32]byte, error) {
	hh := ssz.DefaultHasherPool.Get()
	if err := c.HashTreeRootWith(hh); err != nil {
		ssz.DefaultHasherPool.Put(hh)
		return [32]byte{}, err
...
func (c *SignedExecutionProof) HashTreeRootWith(hh *ssz.Hasher) (err error) {
	indx := hh.Index()
	// Field 0: Message
	if err := c.Message.HashTreeRootWith(hh); err != nil {
		return fmt.Errorf("Message: %w", err)
