...
func (c *BeaconState) UnmarshalSSZ(buf []byte) error {
	...
	sszVarOffset15 := ssz.ReadOffset(buf[6928:6932]) // c.PreviousEpochAttestations
	if sszVarOffset15 > size || sszVarOffset15 < sszVarOffset12 {
		return ssz.ErrOffset
	}
	sszVarOffset16 := ssz.ReadOffset(buf[6932:6936]) // c.CurrentEpochAttestations
...
func (c *HistoricalBatch) UnmarshalSSZ(buf []byte) error {
	...
	sszSlice0 := buf[0:2048]    // c.BlockRoots
	sszSlice1 := buf[2048:4096] // c.StateRoots
