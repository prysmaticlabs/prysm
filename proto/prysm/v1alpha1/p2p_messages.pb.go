...
func (x *BlobsSidecarsByRangeRequest) Reset() {
	*x = BlobsSidecarsByRangeRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *BlobsSidecarsByRangeRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*BlobsSidecarsByRangeRequest) ProtoMessage() {}

func (x *BlobsSidecarsByRangeRequest) ProtoReflect() protoreflect.Message {
	mi := &file_proto_prysm_v1alpha1_p2p_messages_proto_msgTypes[5]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use BlobsSidecarsByRangeRequest.ProtoReflect.Descriptor instead.
func (*BlobsSidecarsByRangeRequest) Descriptor() ([]byte, []int) {
	return file_proto_prysm_v1alpha1_p2p_messages_proto_rawDescGZIP(), []int{5}
}

func (x *BlobsSidecarsByRangeRequest) GetStartSlot() github_com_prysmaticlabs_prysm_v3_consensus_types_primitives.Slot {
	if x != nil {
		return x.StartSlot
	}
	return github_com_prysmaticlabs_prysm_v3_consensus_types_primitives.Slot(0)
...
func (x *BlobsSidecarsByRangeRequest) GetCount() uint64 {
	if x != nil {
		return x.Count
	}
	return 0
...
var file_proto_prysm_v1alpha1_p2p_messages_proto_rawDesc = []byte{
	...
	0x74, 0x6f, 0x72, 0x34, 0x52, 0x08, 0x73, 0x79, 0x6e, 0x63, 0x6e, 0x65, 0x74, 0x73, 0x22, 0x99,
	0x01, 0x0a, 0x1b, 0x42, 0x6c, 0x6f, 0x62, 0x73, 0x53, 0x69, 0x64, 0x65, 0x63, 0x61, 0x72, 0x73,
	0x42, 0x79, 0x52, 0x61, 0x6e, 0x67, 0x65, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x64,
	...
	0x01, 0x28, 0x04, 0x52, 0x05, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x42, 0x9b, 0x01, 0x0a, 0x19, 0x6f,
	0x72, 0x67, 0x2e, 0x65, 0x74, 0x68, 0x65, 0x72, 0x65, 0x75, 0x6d, 0x2e, 0x65, 0x74, 0x68, 0x2e,
	0x76, 0x31, 0x61, 0x6c, 0x70, 0x68, 0x61, 0x31, 0x42, 0x10, 0x50, 0x32, 0x50, 0x4d, 0x65, 0x73,
	0x73, 0x61, 0x67, 0x65, 0x73, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50, 0x01, 0x5a, 0x3a, 0x67, 0x69,
	...
	0x65, 0x75, 0x6d, 0x2e, 0x45, 0x74, 0x68, 0x2e, 0x56, 0x31, 0x61, 0x6c, 0x70, 0x68, 0x61, 0x31,
...
var file_proto_prysm_v1alpha1_p2p_messages_proto_goTypes = []interface{}{
	...
	(*BlobsSidecarsByRangeRequest)(nil), // 5: ethereum.eth.v1alpha1.BlobsSidecarsByRangeRequest
}
...
func file_proto_prysm_v1alpha1_p2p_messages_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_proto_prysm_v1alpha1_p2p_messages_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*BlobsSidecarsByRangeRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
