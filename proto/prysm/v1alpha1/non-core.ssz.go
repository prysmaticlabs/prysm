...
// Hash: 61016ffa736065f82cfed43813dfb5f1b43b775b91b71470c66da266ac9fd837
package eth
...
// MarshalSSZ ssz marshals the LightClientUpdatesByRangeReq object
func (l *LightClientUpdatesByRangeReq) MarshalSSZ() ([]byte, error) {
	return ssz.MarshalSSZ(l)
}

// MarshalSSZTo ssz marshals the LightClientUpdatesByRangeReq object to a target array
func (l *LightClientUpdatesByRangeReq) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	dst = buf
...
// UnmarshalSSZ ssz unmarshals the LightClientUpdatesByRangeReq object
func (l *LightClientUpdatesByRangeReq) UnmarshalSSZ(buf []byte) error {
	var err error
	size := uint64(len(buf))
	if size != 16 {
		return ssz.ErrSize
...
// SizeSSZ returns the ssz encoded size in bytes for the LightClientUpdatesByRangeReq object
func (l *LightClientUpdatesByRangeReq) SizeSSZ() (size int) {
	size = 16
	return
}

// HashTreeRoot ssz hashes the LightClientUpdatesByRangeReq object
func (l *LightClientUpdatesByRangeReq) HashTreeRoot() ([32]byte, error) {
	return ssz.HashWithDefaultHasher(l)
}

// HashTreeRootWith ssz hashes the LightClientUpdatesByRangeReq object with a hasher
func (l *LightClientUpdatesByRangeReq) HashTreeRootWith(hh *ssz.Hasher) (err error) {
	indx := hh.Index()
