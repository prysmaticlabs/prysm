...
func TestMaxCover_MaxCoverCandidates_filter(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			name: "all processed",
			cl: MaxCoverCandidates{
				{key: 0, bits: &bitfield.Bitlist{0b00001010, 0b1}, score: 2, processed: true},
				{key: 2, bits: &bitfield.Bitlist{0b01000010, 0b1}, score: 2, processed: true},
				{key: 3, bits: &bitfield.Bitlist{0b00001010, 0b1}, score: 2, processed: true},
				{key: 4, bits: &bitfield.Bitlist{0b01000010, 0b1}, score: 2, processed: true},
				{key: 4, bits: &bitfield.Bitlist{0b00001010, 0b1}, score: 2, processed: true},
			},
			args: args{},
			want: &MaxCoverCandidates{},
		},
		{
			...
			cl: MaxCoverCandidates{
				{key: 0, bits: &bitfield.Bitlist{0b00001010, 0b1}, score: 2, processed: true},
				{key: 2, bits: &bitfield.Bitlist{0b01000010, 0b1}, score: 2, processed: false},
				{key: 3, bits: &bitfield.Bitlist{0b00001010, 0b1}, score: 2, processed: true},
				{key: 4, bits: &bitfield.Bitlist{0b01000010, 0b1}, score: 2, processed: false},
				{key: 4, bits: &bitfield.Bitlist{0b00001010, 0b1}, score: 2, processed: true},
			},
			args: args{
		...
		},
		{
			...
			cl: MaxCoverCandidates{
				{key: 0, bits: &bitfield.Bitlist{0b00001010, 0b1}, score: 2, processed: false},
				{key: 2, bits: &bitfield.Bitlist{0b01000010, 0b1}, score: 2, processed: false},
				{key: 3, bits: &bitfield.Bitlist{0b00001010, 0b1}, score: 2, processed: false},
				{key: 4, bits: &bitfield.Bitlist{0b01000010, 0b1}, score: 2, processed: false},
				{key: 4, bits: &bitfield.Bitlist{0b00001010, 0b1}, score: 2, processed: false},
			},
			args: args{
		...
		},
		{
			...
			cl: MaxCoverCandidates{
				{key: 0, bits: &bitfield.Bitlist{0b00001010, 0b1}, score: 2, processed: false},
				{key: 2, bits: &bitfield.Bitlist{0b11000010, 0b1}, score: 2, processed: false},
				{key: 3, bits: &bitfield.Bitlist{0b00001010, 0b1}, score: 2, processed: false},
				{key: 4, bits: &bitfield.Bitlist{0b01000011, 0b1}, score: 2, processed: false},
				{key: 4, bits: &bitfield.Bitlist{0b10001010, 0b1}, score: 2, processed: false},
			},
			args: args{
		...
		},
		{
			...
			cl: MaxCoverCandidates{
				...
				{key: 2, bits: &bitfield.Bitlist{0b11000010, 0b1}, score: 2, processed: false},
				{key: 3, bits: &bitfield.Bitlist{0b00001010, 0b1}, score: 2, processed: true},
				{key: 4, bits: &bitfield.Bitlist{0b01000011, 0b1}, score: 0, processed: false},
				{key: 4, bits: &bitfield.Bitlist{0b10001010, 0b1}, score: 2, processed: false},
			},
			args: args{
...
func TestMaxCover_MaxCoverCandidates_sort(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			name: "single item",
			cl: MaxCoverCandidates{
				{key: 0, bits: &bitfield.Bitlist{}, score: 5, processed: false},
			},
			want: &MaxCoverCandidates{
				{key: 0, bits: &bitfield.Bitlist{}, score: 5, processed: false},
			},
		},
		{
			name: "already sorted",
			cl: MaxCoverCandidates{
				{key: 5, bits: &bitfield.Bitlist{}, score: 5, processed: false},
				{key: 3, bits: &bitfield.Bitlist{}, score: 4, processed: false},
				{key: 4, bits: &bitfield.Bitlist{}, score: 4, processed: false},
				{key: 2, bits: &bitfield.Bitlist{}, score: 2, processed: false},
				{key: 1, bits: &bitfield.Bitlist{}, score: 1, processed: false},
			},
			want: &MaxCoverCandidates{
				{key: 5, bits: &bitfield.Bitlist{}, score: 5, processed: false},
				{key: 3, bits: &bitfield.Bitlist{}, score: 4, processed: false},
...
func TestMaxCover_MaxCoverCandidates_union(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			cl: MaxCoverCandidates{
				{key: 0, bits: &bitfield.Bitlist{0b00000000, 0b1}, score: 0, processed: false},
			},
		...
		},
		{
			...
			cl: MaxCoverCandidates{
				{key: 0, bits: &bitfield.Bitlist{0b11111111, 0b1}, score: 8, processed: false},
			},
		...
		},
		{
			name: "mixed",
			cl: MaxCoverCandidates{
				{key: 1, bits: &bitfield.Bitlist{0b00000000, 0b00001110, 0b00001110, 0b1}, score: 6, processed: false},
				{key: 2, bits: &bitfield.Bitlist{0b00000000, 0b01110000, 0b01110000, 0b1}, score: 6, processed: false},
				{key: 3, bits: &bitfield.Bitlist{0b00000111, 0b10000001, 0b10000000, 0b1}, score: 6, processed: false},
				{key: 4, bits: &bitfield.Bitlist{0b00000000, 0b00000110, 0b00000110, 0b1}, score: 4, processed: false},
				{key: 5, bits: &bitfield.Bitlist{0b10000000, 0b00000001, 0b01100010, 0b1}, score: 4, processed: false},
				{key: 6, bits: &bitfield.Bitlist{0b00001000, 0b00001000, 0b10000010, 0b1}, score: 4, processed: false},
				{key: 7, bits: &bitfield.Bitlist{0b00000000, 0b00000001, 0b11111110, 0b1}, score: 8, processed: false},
			},
...
func TestMaxCover_MaxCoverCandidates_score(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			cl: MaxCoverCandidates{
				{key: 0, bits: &bitfield.Bitlist{0b00000100, 0b1}, score: 1, processed: false},
				{key: 1, bits: &bitfield.Bitlist{0b00011011, 0b1}, score: 4, processed: false},
				{key: 2, bits: &bitfield.Bitlist{0b00011011, 0b1}, score: 4, processed: false},
				{key: 3, bits: &bitfield.Bitlist{0b00000001, 0b1}, score: 1, processed: false},
				{key: 4, bits: &bitfield.Bitlist{0b00011010, 0b1}, score: 3, processed: false},
			},
			uncovered: bitfield.NewBitlist(8),
			want: &MaxCoverCandidates{
				{key: 0, bits: &bitfield.Bitlist{0b00000100, 0b1}, score: 0, processed: false},
				{key: 1, bits: &bitfield.Bitlist{0b00011011, 0b1}, score: 0, processed: false},
				{key: 2, bits: &bitfield.Bitlist{0b00011011, 0b1}, score: 0, processed: false},
				{key: 3, bits: &bitfield.Bitlist{0b00000001, 0b1}, score: 0, processed: false},
				{key: 4, bits: &bitfield.Bitlist{0b00011010, 0b1}, score: 0, processed: false},
			},
		},
		{
		...
		},
		{
			...
			cl: MaxCoverCandidates{
				{key: 0, bits: &bitfield.Bitlist{0b00000100, 0b1}, score: 0, processed: false},
				{key: 1, bits: &bitfield.Bitlist{0b00011011, 0b1}, score: 1, processed: false},
				{key: 2, bits: &bitfield.Bitlist{0b10011011, 0b1}, score: 0, processed: false},
				{key: 3, bits: &bitfield.Bitlist{0b11111111, 0b1}, score: 1, processed: false},
				{key: 4, bits: &bitfield.Bitlist{0b00011010, 0b1}, score: 0, processed: false},
			},
			uncovered: bitfield.Bitlist{0b11010010, 0b1},
			want: &MaxCoverCandidates{
				{key: 0, bits: &bitfield.Bitlist{0b00000100, 0b1}, score: 0, processed: false},
				{key: 1, bits: &bitfield.Bitlist{0b00011011, 0b1}, score: 2, processed: false},
				{key: 2, bits: &bitfield.Bitlist{0b10011011, 0b1}, score: 3, processed: false},
				{key: 3, bits: &bitfield.Bitlist{0b11111111, 0b1}, score: 4, processed: false},
				{key: 4, bits: &bitfield.Bitlist{0b00011010, 0b1}, score: 2, processed: false},
			},
		},
	}
	for _, tt := range tests {
	...
	tests := []struct {
		...
		},
		{
			...
			args: args{k: 3, candidates: MaxCoverCandidates{
				{key: 0, bits: &bitfield.Bitlist{0b00000000, 0b00011111, 0xf1}, score: 0, processed: false},
				{key: 2, bits: &bitfield.Bitlist{0b00000001, 0b11100000, 0b1}, score: 0, processed: false},
				{key: 3, bits: &bitfield.Bitlist{0b00000110, 0b00000000, 0b1}, score: 0, processed: false},
			}},
			want: &Aggregation{
		...
		},
		{
			...
			args: args{k: 3, candidates: MaxCoverCandidates{
				{key: 0, bits: &bitfield.Bitlist{0b00000000, 0b00011111, 0b1}, score: 0, processed: false},
				{key: 2, bits: &bitfield.Bitlist{0b00000001, 0b11100000, 0b1}, score: 0, processed: false},
				{key: 3, bits: &bitfield.Bitlist{0b00000110, 0b00000000, 0b1}, score: 0, processed: false},
				{key: 1, bits: &bitfield.Bitlist{0b00110000, 0b01110000, 0b1}, score: 0, processed: false},
				{key: 4, bits: &bitfield.Bitlist{0b00000110, 0b10001100, 0b1}, score: 0, processed: false},
				{key: 5, bits: &bitfield.Bitlist{0b01001001, 0b00000011, 0b1}, score: 0, processed: false},
			}},
			want: &Aggregation{
		...
		},
		{
			...
			args: args{k: 5, allowOverlaps: true, candidates: MaxCoverCandidates{
				{key: 0, bits: &bitfield.Bitlist{0b00000000, 0b00000001, 0b11111110, 0b1}, score: 0, processed: false},
				{key: 1, bits: &bitfield.Bitlist{0b00000000, 0b00001110, 0b00001110, 0b1}, score: 0, processed: false},
				{key: 2, bits: &bitfield.Bitlist{0b00000000, 0b01110000, 0b01110000, 0b1}, score: 0, processed: false},
				{key: 3, bits: &bitfield.Bitlist{0b00000111, 0b10000001, 0b10000000, 0b1}, score: 0, processed: false},
				{key: 4, bits: &bitfield.Bitlist{0b00000000, 0b00000110, 0b00000110, 0b1}, score: 0, processed: false},
				{key: 5, bits: &bitfield.Bitlist{0b00000000, 0b00000001, 0b01100010, 0b1}, score: 0, processed: false},
				{key: 6, bits: &bitfield.Bitlist{0b00001000, 0b00001000, 0b10000010, 0b1}, score: 0, processed: false},
			}},
			want: &Aggregation{
		...
		},
		{
			name: "empty bitlists",
			args: args{k: 5, allowOverlaps: true, candidates: MaxCoverCandidates{
				{key: 1, bits: &bitfield.Bitlist{0b0}, score: 0, processed: false},
				{key: 0, bits: &bitfield.Bitlist{0b00000000, 0b00000000, 0b00000000, 0b1}, score: 0, processed: false},
				{key: 2, bits: &bitfield.Bitlist{0b00000000, 0b00000000, 0b00000000, 0b1}, score: 0, processed: false},
			}},
		...
		},
		{
			...
			args: args{k: 5, allowOverlaps: false, candidates: MaxCoverCandidates{
				{key: 0, bits: &bitfield.Bitlist{0b11111111, 0b11000111, 0b11111111, 0b1}, score: 0, processed: false},
				// All remaining bitlists will overlap, so will be dropped.
				{key: 1, bits: &bitfield.Bitlist{0b11111111, 0b00001100, 0b11111111, 0b1}, score: 0, processed: false},
				{key: 2, bits: &bitfield.Bitlist{0b00000000, 0b01110000, 0b01110000, 0b1}, score: 0, processed: false},
				{key: 3, bits: &bitfield.Bitlist{0b00000111, 0b10000001, 0b10000000, 0b1}, score: 0, processed: false},
				{key: 4, bits: &bitfield.Bitlist{0b00000000, 0b00000110, 0b00000110, 0b1}, score: 0, processed: false},
				{key: 5, bits: &bitfield.Bitlist{0b00000000, 0b00000001, 0b01100010, 0b1}, score: 0, processed: false},
