...
func (x *BeaconCommitteeSelection) Reset() {
	*x = BeaconCommitteeSelection{}
	if protoimpl.UnsafeEnabled {
...
func (x *BeaconCommitteeSelection) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*BeaconCommitteeSelection) ProtoMessage() {}

func (x *BeaconCommitteeSelection) ProtoReflect() protoreflect.Message {
	mi := &file_proto_prysm_v1alpha1_attestation_proto_msgTypes[5]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use BeaconCommitteeSelection.ProtoReflect.Descriptor instead.
func (*BeaconCommitteeSelection) Descriptor() ([]byte, []int) {
	return file_proto_prysm_v1alpha1_attestation_proto_rawDescGZIP(), []int{5}
}

func (x *BeaconCommitteeSelection) GetValidatorIndex() github_com_prysmaticlabs_prysm_v4_consensus_types_primitives.ValidatorIndex {
	if x != nil {
...
func (x *BeaconCommitteeSelection) GetSlot() github_com_prysmaticlabs_prysm_v4_consensus_types_primitives.Slot {
	if x != nil {
		return x.Slot
	}
	return github_com_prysmaticlabs_prysm_v4_consensus_types_primitives.Slot(0)
...
func (x *BeaconCommitteeSelection) GetSelectionProof() []byte {
	if x != nil {
		return x.SelectionProof
	}
	return nil
...
var file_proto_prysm_v1alpha1_attestation_proto_rawDesc = []byte{
	...
	0xb5, 0x18, 0x02, 0x33, 0x32, 0x52, 0x04, 0x72, 0x6f, 0x6f, 0x74, 0x22, 0xa0, 0x02, 0x0a, 0x18,
	0x42, 0x65, 0x61, 0x63, 0x6f, 0x6e, 0x43, 0x6f, 0x6d, 0x6d, 0x69, 0x74, 0x74, 0x65, 0x65, 0x53,
	0x65, 0x6c, 0x65, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x78, 0x0a, 0x0f, 0x76, 0x61, 0x6c, 0x69,
	...
	0x65, 0x78, 0x12, 0x59, 0x0a, 0x04, 0x73, 0x6c, 0x6f, 0x74, 0x18, 0x02, 0x20, 0x01, 0x28, 0x04,
	0x42, 0x45, 0x82, 0xb5, 0x18, 0x41, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d,
	0x2f, 0x70, 0x72, 0x79, 0x73, 0x6d, 0x61, 0x74, 0x69, 0x63, 0x6c, 0x61, 0x62, 0x73, 0x2f, 0x70,
	0x72, 0x79, 0x73, 0x6d, 0x2f, 0x76, 0x34, 0x2f, 0x63, 0x6f, 0x6e, 0x73, 0x65, 0x6e, 0x73, 0x75,
	0x73, 0x2d, 0x74, 0x79, 0x70, 0x65, 0x73, 0x2f, 0x70, 0x72, 0x69, 0x6d, 0x69, 0x74, 0x69, 0x76,
	0x65, 0x73, 0x2e, 0x53, 0x6c, 0x6f, 0x74, 0x52, 0x04, 0x73, 0x6c, 0x6f, 0x74, 0x12, 0x2f, 0x0a,
	...
	0x73, 0x65, 0x6c, 0x65, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x50, 0x72, 0x6f, 0x6f, 0x66, 0x42, 0x9b,
	0x01, 0x0a, 0x19, 0x6f, 0x72, 0x67, 0x2e, 0x65, 0x74, 0x68, 0x65, 0x72, 0x65, 0x75, 0x6d, 0x2e,
	0x65, 0x74, 0x68, 0x2e, 0x76, 0x31, 0x61, 0x6c, 0x70, 0x68, 0x61, 0x31, 0x42, 0x10, 0x41, 0x74,
	0x74, 0x65, 0x73, 0x74, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50, 0x01,
...
var file_proto_prysm_v1alpha1_attestation_proto_goTypes = []interface{}{
	...
	(*BeaconCommitteeSelection)(nil),           // 5: ethereum.eth.v1alpha1.BeaconCommitteeSelection
}
...
func file_proto_prysm_v1alpha1_attestation_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_proto_prysm_v1alpha1_attestation_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*BeaconCommitteeSelection); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
