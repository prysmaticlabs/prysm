...
type AggregatorEquivocation struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	SignedAggregate_1 *SignedAggregateAttestationAndProof `protobuf:"bytes,1,opt,name=signed_aggregate_1,json=signedAggregate1,proto3" json:"signed_aggregate_1,omitempty"`
	SignedAggregate_2 *SignedAggregateAttestationAndProof `protobuf:"bytes,2,opt,name=signed_aggregate_2,json=signedAggregate2,proto3" json:"signed_aggregate_2,omitempty"`
}

func (x *AggregatorEquivocation) Reset() {
	*x = AggregatorEquivocation{}
	if protoimpl.UnsafeEnabled {
...
func (x *AggregatorEquivocation) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*AggregatorEquivocation) ProtoMessage() {}

func (x *AggregatorEquivocation) ProtoReflect() protoreflect.Message {
	mi := &file_proto_prysm_v1alpha1_attestation_proto_msgTypes[3]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use AggregatorEquivocation.ProtoReflect.Descriptor instead.
func (*AggregatorEquivocation) Descriptor() ([]byte, []int) {
	return file_proto_prysm_v1alpha1_attestation_proto_rawDescGZIP(), []int{3}
}

func (x *AggregatorEquivocation) GetSignedAggregate_1() *SignedAggregateAttestationAndProof {
	if x != nil {
		return x.SignedAggregate_1
	}
	return nil
}

func (x *AggregatorEquivocation) GetSignedAggregate_2() *SignedAggregateAttestationAndProof {
	if x != nil {
		return x.SignedAggregate_2
	}
	return nil
}
...
var file_proto_prysm_v1alpha1_attestation_proto_rawDesc = []byte{
	...
	0xea, 0x01, 0x0a, 0x16, 0x41, 0x67, 0x67, 0x72, 0x65, 0x67, 0x61, 0x74, 0x6f, 0x72, 0x45, 0x71,
	0x75, 0x69, 0x76, 0x6f, 0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x67, 0x0a, 0x12, 0x73, 0x69,
	0x67, 0x6e, 0x65, 0x64, 0x5f, 0x61, 0x67, 0x67, 0x72, 0x65, 0x67, 0x61, 0x74, 0x65, 0x5f, 0x31,
	...
	0x66, 0x52, 0x10, 0x73, 0x69, 0x67, 0x6e, 0x65, 0x64, 0x41, 0x67, 0x67, 0x72, 0x65, 0x67, 0x61,
	0x74, 0x65, 0x31, 0x12, 0x67, 0x0a, 0x12, 0x73, 0x69, 0x67, 0x6e, 0x65, 0x64, 0x5f, 0x61, 0x67,
	0x67, 0x72, 0x65, 0x67, 0x61, 0x74, 0x65, 0x5f, 0x32, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32,
	...
	0x67, 0x72, 0x65, 0x67, 0x61, 0x74, 0x65, 0x41, 0x74, 0x74, 0x65, 0x73, 0x74, 0x61, 0x74, 0x69,
	0x6f, 0x6e, 0x41, 0x6e, 0x64, 0x50, 0x72, 0x6f, 0x6f, 0x66, 0x52, 0x10, 0x73, 0x69, 0x67, 0x6e,
	0x65, 0x64, 0x41, 0x67, 0x67, 0x72, 0x65, 0x67, 0x61, 0x74, 0x65, 0x32, 0x22, 0x90, 0x03, 0x0a,
	0x0f, 0x41, 0x74, 0x74, 0x65, 0x73, 0x74, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x44, 0x61, 0x74, 0x61,
	...
	0x86, 0x01, 0x0a, 0x0a, 0x43, 0x68, 0x65, 0x63, 0x6b, 0x70, 0x6f, 0x69, 0x6e, 0x74, 0x12, 0x5c,
	...
	0x33, 0x32, 0x52, 0x04, 0x72, 0x6f, 0x6f, 0x74, 0x42, 0x9b, 0x01, 0x0a, 0x19, 0x6f, 0x72, 0x67,
	0x2e, 0x65, 0x74, 0x68, 0x65, 0x72, 0x65, 0x75, 0x6d, 0x2e, 0x65, 0x74, 0x68, 0x2e, 0x76, 0x31,
	0x61, 0x6c, 0x70, 0x68, 0x61, 0x31, 0x42, 0x10, 0x41, 0x74, 0x74, 0x65, 0x73, 0x74, 0x61, 0x74,
...
var file_proto_prysm_v1alpha1_attestation_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
var file_proto_prysm_v1alpha1_attestation_proto_goTypes = []interface{}{
	...
	(*AggregatorEquivocation)(nil),             // 3: ethereum.eth.v1alpha1.AggregatorEquivocation
	(*AttestationData)(nil),                    // 4: ethereum.eth.v1alpha1.AttestationData
	(*Checkpoint)(nil),                         // 5: ethereum.eth.v1alpha1.Checkpoint
}
var file_proto_prysm_v1alpha1_attestation_proto_depIdxs = []int32{
	4, // 0: ethereum.eth.v1alpha1.Attestation.data:type_name -> ethereum.eth.v1alpha1.AttestationData
	...
	2, // 3: ethereum.eth.v1alpha1.AggregatorEquivocation.signed_aggregate_1:type_name -> ethereum.eth.v1alpha1.SignedAggregateAttestationAndProof
	2, // 4: ethereum.eth.v1alpha1.AggregatorEquivocation.signed_aggregate_2:type_name -> ethereum.eth.v1alpha1.SignedAggregateAttestationAndProof
	5, // 5: ethereum.eth.v1alpha1.AttestationData.source:type_name -> ethereum.eth.v1alpha1.Checkpoint
	5, // 6: ethereum.eth.v1alpha1.AttestationData.target:type_name -> ethereum.eth.v1alpha1.Checkpoint
...
func file_proto_prysm_v1alpha1_attestation_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_proto_prysm_v1alpha1_attestation_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*AggregatorEquivocation); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
