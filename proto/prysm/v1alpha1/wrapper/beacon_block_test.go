...
func TestAltairSignedBeaconBlock_MarshalSSZTo(t *testing.T) {
	wsb, err := wrapper.WrappedAltairSignedBeaconBlock(customtesting.HydrateSignedBeaconBlockAltair(&ethpb.SignedBeaconBlockAltair{}))
	assert.NoError(t, err)
...
func TestAltairBeaconBlock_HashTreeRoot(t *testing.T) {
	wb, err := wrapper.WrappedAltairBeaconBlock(customtesting.HydrateBeaconBlockAltair(&ethpb.BeaconBlockAltair{}))
	require.NoError(t, err)
...
func TestAltairBeaconBlockBody_HashTreeRoot(t *testing.T) {
	wb, err := wrapper.WrappedAltairBeaconBlockBody(customtesting.HydrateBeaconBlockBodyAltair(&ethpb.BeaconBlockBodyAltair{}))
	assert.NoError(t, err)
...
func TestPhase0SignedBeaconBlock_Header(t *testing.T) {
	...
	body = customtesting.HydrateBeaconBlockBody(body)
...
func TestAltairSignedBeaconBlock_Header(t *testing.T) {
	...
	signature := bytesutil.PadTo([]byte("sig"), 96)
	body := &ethpb.BeaconBlockBodyAltair{}
	body = customtesting.HydrateBeaconBlockBodyAltair(body)
	bodyRoot, err := body.HashTreeRoot()
	require.NoError(t, err)
