...
// Hash: 66581c00519b1ee9bdaae114cdc087c475761f59aebdecf49de22e6829f5daaf
package eth
...
// MarshalSSZ ssz marshals the SignedBlindedBeaconBlockMerge object
func (s *SignedBlindedBeaconBlockMerge) MarshalSSZ() ([]byte, error) {
	return ssz.MarshalSSZ(s)
}

// MarshalSSZTo ssz marshals the SignedBlindedBeaconBlockMerge object to a target array
func (s *SignedBlindedBeaconBlockMerge) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	dst = buf
	offset := int(100)
	...
	dst = ssz.WriteOffset(dst, offset)
	if s.Block == nil {
		s.Block = new(BlindedBeaconBlockMerge)
	}
	offset += s.Block.SizeSSZ()
...
// UnmarshalSSZ ssz unmarshals the SignedBlindedBeaconBlockMerge object
func (s *SignedBlindedBeaconBlockMerge) UnmarshalSSZ(buf []byte) error {
	var err error
	size := uint64(len(buf))
	if size < 100 {
		return ssz.ErrSize
...
// SizeSSZ returns the ssz encoded size in bytes for the SignedBlindedBeaconBlockMerge object
func (s *SignedBlindedBeaconBlockMerge) SizeSSZ() (size int) {
	size = 100
...
// HashTreeRoot ssz hashes the SignedBlindedBeaconBlockMerge object
func (s *SignedBlindedBeaconBlockMerge) HashTreeRoot() ([32]byte, error) {
	return ssz.HashWithDefaultHasher(s)
}

// HashTreeRootWith ssz hashes the SignedBlindedBeaconBlockMerge object with a hasher
func (s *SignedBlindedBeaconBlockMerge) HashTreeRootWith(hh *ssz.Hasher) (err error) {
	indx := hh.Index()
...
// MarshalSSZ ssz marshals the BlindedBeaconBlockMerge object
func (b *BlindedBeaconBlockMerge) MarshalSSZ() ([]byte, error) {
	return ssz.MarshalSSZ(b)
}

// MarshalSSZTo ssz marshals the BlindedBeaconBlockMerge object to a target array
func (b *BlindedBeaconBlockMerge) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	dst = buf
	offset := int(84)
	...
	dst = ssz.WriteOffset(dst, offset)
	if b.Body == nil {
		b.Body = new(BlindedBeaconBlockBodyMerge)
	}
	offset += b.Body.SizeSSZ()
...
// UnmarshalSSZ ssz unmarshals the BlindedBeaconBlockMerge object
func (b *BlindedBeaconBlockMerge) UnmarshalSSZ(buf []byte) error {
	var err error
	size := uint64(len(buf))
	if size < 84 {
		return ssz.ErrSize
...
// SizeSSZ returns the ssz encoded size in bytes for the BlindedBeaconBlockMerge object
func (b *BlindedBeaconBlockMerge) SizeSSZ() (size int) {
	size = 84
...
// HashTreeRoot ssz hashes the BlindedBeaconBlockMerge object
func (b *BlindedBeaconBlockMerge) HashTreeRoot() ([32]byte, error) {
	return ssz.HashWithDefaultHasher(b)
}

// HashTreeRootWith ssz hashes the BlindedBeaconBlockMerge object with a hasher
func (b *BlindedBeaconBlockMerge) HashTreeRootWith(hh *ssz.Hasher) (err error) {
	indx := hh.Index()
...
// MarshalSSZ ssz marshals the BlindedBeaconBlockBodyMerge object
func (b *BlindedBeaconBlockBodyMerge) MarshalSSZ() ([]byte, error) {
	return ssz.MarshalSSZ(b)
}

// MarshalSSZTo ssz marshals the BlindedBeaconBlockBodyMerge object to a target array
func (b *BlindedBeaconBlockBodyMerge) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	dst = buf
	offset := int(384)
...
// UnmarshalSSZ ssz unmarshals the BlindedBeaconBlockBodyMerge object
func (b *BlindedBeaconBlockBodyMerge) UnmarshalSSZ(buf []byte) error {
	var err error
	size := uint64(len(buf))
	if size < 384 {
		return ssz.ErrSize
...
// SizeSSZ returns the ssz encoded size in bytes for the BlindedBeaconBlockBodyMerge object
func (b *BlindedBeaconBlockBodyMerge) SizeSSZ() (size int) {
	size = 384
...
// HashTreeRoot ssz hashes the BlindedBeaconBlockBodyMerge object
func (b *BlindedBeaconBlockBodyMerge) HashTreeRoot() ([32]byte, error) {
	return ssz.HashWithDefaultHasher(b)
}

// HashTreeRootWith ssz hashes the BlindedBeaconBlockBodyMerge object with a hasher
func (b *BlindedBeaconBlockBodyMerge) HashTreeRootWith(hh *ssz.Hasher) (err error) {
	indx := hh.Index()
