...
// Hash: 77dcd789aa2dd5f6c9dbb50ae7eae884216f199156144a8b5d15c54e57fa2618
package eth
...
// MarshalSSZ ssz marshals the BeaconCommitteeSelection object
func (b *BeaconCommitteeSelection) MarshalSSZ() ([]byte, error) {
	return ssz.MarshalSSZ(b)
}

// MarshalSSZTo ssz marshals the BeaconCommitteeSelection object to a target array
func (b *BeaconCommitteeSelection) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	dst = buf
	...
	// Field (2) 'SelectionProof'
	if size := len(b.SelectionProof); size != 96 {
		err = ssz.ErrBytesLengthFn("--.SelectionProof", size, 96)
		return
	}
	dst = append(dst, b.SelectionProof...)

	return
}

// UnmarshalSSZ ssz unmarshals the BeaconCommitteeSelection object
func (b *BeaconCommitteeSelection) UnmarshalSSZ(buf []byte) error {
	var err error
	size := uint64(len(buf))
	if size != 112 {
		return ssz.ErrSize
	...
	// Field (1) 'Slot'
	b.Slot = github_com_prysmaticlabs_prysm_v4_consensus_types_primitives.Slot(ssz.UnmarshallUint64(buf[8:16]))

	// Field (2) 'SelectionProof'
	if cap(b.SelectionProof) == 0 {
		b.SelectionProof = make([]byte, 0, len(buf[16:112]))
	}
	b.SelectionProof = append(b.SelectionProof, buf[16:112]...)

	return err
}

// SizeSSZ returns the ssz encoded size in bytes for the BeaconCommitteeSelection object
func (b *BeaconCommitteeSelection) SizeSSZ() (size int) {
	size = 112
	return
}

// HashTreeRoot ssz hashes the BeaconCommitteeSelection object
func (b *BeaconCommitteeSelection) HashTreeRoot() ([32]byte, error) {
	return ssz.HashWithDefaultHasher(b)
}

// HashTreeRootWith ssz hashes the BeaconCommitteeSelection object with a hasher
func (b *BeaconCommitteeSelection) HashTreeRootWith(hh *ssz.Hasher) (err error) {
	indx := hh.Index()
