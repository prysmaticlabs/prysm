...
// Hash: ab37dd44e8ae8825e900b963778bb4617883781cb7b5f01209550ce97c2b70dc
package eth
...
func (b *BeaconBlockBodyePBS) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	dst = ssz.WriteOffset(dst, offset)
	if b.InclusionListSummary == nil {
		b.InclusionListSummary = new(v1.SignedInclusionListSummary)
	}
	offset += b.InclusionListSummary.SizeSSZ()
	...
	if dst, err = b.InclusionListSummary.MarshalSSZTo(dst); err != nil {
		return
	}
...
func (b *BeaconBlockBodyePBS) UnmarshalSSZ(buf []byte) error {
	...
	// Field (11) 'InclusionListSummary'
	{
		...
		if err = b.InclusionListSummary.UnmarshalSSZ(buf); err != nil {
			return err
		}
	}
...
func (b *BeaconBlockBodyePBS) SizeSSZ() (size int) {
	...
	size += b.InclusionListSummary.SizeSSZ()
...
func (b *BeaconBlockBodyePBS) HashTreeRootWith(hh *ssz.Hasher) (err error) {
	...
	// Field (11) 'InclusionListSummary'
	if err = b.InclusionListSummary.HashTreeRootWith(hh); err != nil {
		return
	}
