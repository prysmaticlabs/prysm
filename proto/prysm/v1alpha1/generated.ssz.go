...
// Hash: 9e730949b2239ba697a34c8b2b9f36e96a33bee1a8bfe8b39eaf93b94e998163
package eth
...
func (e *ExecutionPayload) UnmarshalSSZ(buf []byte) error {
	...
	{
		buf = tail[o13:]
		num, err := ssz.DivideInt2(len(buf), 0, 16384)
		if err != nil {
			return err
		}
		e.Transactions = make([]*Transaction, num)
		for ii := 0; ii < num; ii++ {
			if e.Transactions[ii] == nil {
				e.Transactions[ii] = new(Transaction)
			}
			if err = e.Transactions[ii].UnmarshalSSZ(buf[ii*0 : (ii+1)*0]); err != nil {
				return err
			}
		}
	}
