...
// Hash: d035377d2aafc37cbb39a3dfeaf475c1d3e6ba67b5b31513a56692220dceecc0
package eth
...
func (d *DepositSnapshot) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	// Field (0) 'Finalized'
	if size := len(d.Finalized); size > 1048576 {
		err = ssz.ErrListTooBigFn("--.Finalized", size, 1048576)
		return
	}
...
func (d *DepositSnapshot) UnmarshalSSZ(buf []byte) error {
	...
	{
		buf = tail[o0:]
		num, err := ssz.DivideInt2(len(buf), 32, 1048576)
		if err != nil {
			return err
		}
...
func (d *DepositSnapshot) HashTreeRootWith(hh *ssz.Hasher) (err error) {
	...
	// Field (0) 'Finalized'
	{
		...
		if ssz.EnableVectorizedHTR {
			hh.MerkleizeWithMixinVectorizedHTR(subIndx, numItems, 1048576)
		} else {
			hh.MerkleizeWithMixin(subIndx, numItems, 1048576)
		}
	}
