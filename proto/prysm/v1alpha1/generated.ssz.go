...
// Hash: 050e86cc92690603d4c328eea81f5ca09012184e81dc5545c24c244096415333
package eth
...
func (b *BeaconStateEPBS) UnmarshalSSZ(buf []byte) error {
	...
	// Field (28) 'DepositBalanceToConsume'
	b.DepositBalanceToConsume = github_com_prysmaticlabs_prysm_v5_math.Gwei(ssz.UnmarshallUint64(buf[2736657:2736665]))

	// Field (29) 'ExitBalanceToConsume'
	b.ExitBalanceToConsume = github_com_prysmaticlabs_prysm_v5_math.Gwei(ssz.UnmarshallUint64(buf[2736665:2736673]))
	...
	// Field (31) 'ConsolidationBalanceToConsume'
	b.ConsolidationBalanceToConsume = github_com_prysmaticlabs_prysm_v5_math.Gwei(ssz.UnmarshallUint64(buf[2736681:2736689]))
...
func (e *BlindPayloadEnvelope) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	// Field (0) 'PayloadRoot'
	if size := len(e.PayloadRoot); size != 32 {
		err = ssz.ErrBytesLengthFn("--.PayloadRoot", size, 32)
		return
	}
	dst = append(dst, e.PayloadRoot...)
...
func (e *BlindPayloadEnvelope) UnmarshalSSZ(buf []byte) error {
	...
	// Field (0) 'PayloadRoot'
	if cap(e.PayloadRoot) == 0 {
		e.PayloadRoot = make([]byte, 0, len(buf[0:32]))
	}
	e.PayloadRoot = append(e.PayloadRoot, buf[0:32]...)

	// Field (1) 'BuilderIndex'
	e.BuilderIndex = github_com_prysmaticlabs_prysm_v5_consensus_types_primitives.ValidatorIndex(ssz.UnmarshallUint64(buf[32:40]))

	// Field (2) 'BeaconBlockRoot'
	if cap(e.BeaconBlockRoot) == 0 {
		e.BeaconBlockRoot = make([]byte, 0, len(buf[40:72]))
	}
	e.BeaconBlockRoot = append(e.BeaconBlockRoot, buf[40:72]...)
	...
	// Field (4) 'InclusionListProposerIndex'
	e.InclusionListProposerIndex = github_com_prysmaticlabs_prysm_v5_consensus_types_primitives.ValidatorIndex(ssz.UnmarshallUint64(buf[76:84]))

	// Field (5) 'InclusionListSlot'
	e.InclusionListSlot = github_com_prysmaticlabs_prysm_v5_consensus_types_primitives.Slot(ssz.UnmarshallUint64(buf[84:92]))

	// Field (6) 'InclusionListSignature'
	if cap(e.InclusionListSignature) == 0 {
		e.InclusionListSignature = make([]byte, 0, len(buf[92:188]))
	}
	e.InclusionListSignature = append(e.InclusionListSignature, buf[92:188]...)

	// Field (7) 'PayloadWithheld'
	e.PayloadWithheld = ssz.UnmarshalBool(buf[188:189])

	// Field (8) 'StateRoot'
	if cap(e.StateRoot) == 0 {
		e.StateRoot = make([]byte, 0, len(buf[189:221]))
	}
