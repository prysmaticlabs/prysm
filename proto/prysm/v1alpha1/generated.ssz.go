...
// Hash: 8d90749cfa9f68fa6a218c5ee353f7121632433520273dec08b3d62dbb6e64ca
package eth
...
func (b *BlobSidecar) UnmarshalSSZ(buf []byte) error {
	...
	// Field (4) 'ProposerIndex'
	b.ProposerIndex = github_com_prysmaticlabs_prysm_v3_consensus_types_primitives.ValidatorIndex(ssz.UnmarshallUint64(buf[80:88]))

	// Field (5) 'Blob'
	if b.Blob == nil {
		b.Blob = new(v1.Blob)
	}
	if err = b.Blob.UnmarshalSSZ(buf[88:131160]); err != nil {
		return err
	}
