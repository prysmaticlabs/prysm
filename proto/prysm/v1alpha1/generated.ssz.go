...
// Hash: efc017b2d00a644d7b8ff8ded4cf0366dd521702d65fc02f01d0cc272ef1a25f
package eth
...
// MarshalSSZ ssz marshals the SignedBeaconBlockWithBlobKZGsCompat object
func (s *SignedBeaconBlockWithBlobKZGsCompat) MarshalSSZ() ([]byte, error) {
	return ssz.MarshalSSZ(s)
}

// MarshalSSZTo ssz marshals the SignedBeaconBlockWithBlobKZGsCompat object to a target array
func (s *SignedBeaconBlockWithBlobKZGsCompat) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	dst = buf
	offset := int(100)
	...
	dst = ssz.WriteOffset(dst, offset)
	if s.Block == nil {
		s.Block = new(BeaconBlockWithBlobKZGsCompat)
	}
	offset += s.Block.SizeSSZ()
...
// UnmarshalSSZ ssz unmarshals the SignedBeaconBlockWithBlobKZGsCompat object
func (s *SignedBeaconBlockWithBlobKZGsCompat) UnmarshalSSZ(buf []byte) error {
	var err error
	size := uint64(len(buf))
	if size < 100 {
		return ssz.ErrSize
...
// SizeSSZ returns the ssz encoded size in bytes for the SignedBeaconBlockWithBlobKZGsCompat object
func (s *SignedBeaconBlockWithBlobKZGsCompat) SizeSSZ() (size int) {
	size = 100
...
// HashTreeRoot ssz hashes the SignedBeaconBlockWithBlobKZGsCompat object
func (s *SignedBeaconBlockWithBlobKZGsCompat) HashTreeRoot() ([32]byte, error) {
	return ssz.HashWithDefaultHasher(s)
}

// HashTreeRootWith ssz hashes the SignedBeaconBlockWithBlobKZGsCompat object with a hasher
func (s *SignedBeaconBlockWithBlobKZGsCompat) HashTreeRootWith(hh *ssz.Hasher) (err error) {
	indx := hh.Index()
...
// MarshalSSZ ssz marshals the BeaconBlockWithBlobKZGsCompat object
func (b *BeaconBlockWithBlobKZGsCompat) MarshalSSZ() ([]byte, error) {
	return ssz.MarshalSSZ(b)
}

// MarshalSSZTo ssz marshals the BeaconBlockWithBlobKZGsCompat object to a target array
func (b *BeaconBlockWithBlobKZGsCompat) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	dst = buf
	offset := int(84)
	...
	dst = ssz.WriteOffset(dst, offset)
	if b.Body == nil {
		b.Body = new(BeaconBlockBodyWithBlobKZGsCompat)
	}
	offset += b.Body.SizeSSZ()
...
// UnmarshalSSZ ssz unmarshals the BeaconBlockWithBlobKZGsCompat object
func (b *BeaconBlockWithBlobKZGsCompat) UnmarshalSSZ(buf []byte) error {
	var err error
	size := uint64(len(buf))
	if size < 84 {
		return ssz.ErrSize
...
// SizeSSZ returns the ssz encoded size in bytes for the BeaconBlockWithBlobKZGsCompat object
func (b *BeaconBlockWithBlobKZGsCompat) SizeSSZ() (size int) {
	size = 84
...
// HashTreeRoot ssz hashes the BeaconBlockWithBlobKZGsCompat object
func (b *BeaconBlockWithBlobKZGsCompat) HashTreeRoot() ([32]byte, error) {
	return ssz.HashWithDefaultHasher(b)
}

// HashTreeRootWith ssz hashes the BeaconBlockWithBlobKZGsCompat object with a hasher
func (b *BeaconBlockWithBlobKZGsCompat) HashTreeRootWith(hh *ssz.Hasher) (err error) {
	indx := hh.Index()
...
// MarshalSSZ ssz marshals the BeaconBlockBodyWithBlobKZGsCompat object
func (b *BeaconBlockBodyWithBlobKZGsCompat) MarshalSSZ() ([]byte, error) {
	return ssz.MarshalSSZ(b)
}

// MarshalSSZTo ssz marshals the BeaconBlockBodyWithBlobKZGsCompat object to a target array
func (b *BeaconBlockBodyWithBlobKZGsCompat) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	dst = buf
	offset := int(388)
...
// UnmarshalSSZ ssz unmarshals the BeaconBlockBodyWithBlobKZGsCompat object
func (b *BeaconBlockBodyWithBlobKZGsCompat) UnmarshalSSZ(buf []byte) error {
	var err error
	size := uint64(len(buf))
	if size < 388 {
		return ssz.ErrSize
...
// SizeSSZ returns the ssz encoded size in bytes for the BeaconBlockBodyWithBlobKZGsCompat object
func (b *BeaconBlockBodyWithBlobKZGsCompat) SizeSSZ() (size int) {
	size = 388
...
// HashTreeRoot ssz hashes the BeaconBlockBodyWithBlobKZGsCompat object
func (b *BeaconBlockBodyWithBlobKZGsCompat) HashTreeRoot() ([32]byte, error) {
	return ssz.HashWithDefaultHasher(b)
}

// HashTreeRootWith ssz hashes the BeaconBlockBodyWithBlobKZGsCompat object with a hasher
func (b *BeaconBlockBodyWithBlobKZGsCompat) HashTreeRootWith(hh *ssz.Hasher) (err error) {
	indx := hh.Index()
