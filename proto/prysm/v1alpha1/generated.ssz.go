...
// Hash: af4a4e027bbec9c239aa36cd4ded7ce20889cfb5948941503460f8893d067a90
package eth
...
func (b *BlobSidecar) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	if dst, err = b.Blob.MarshalSSZTo(dst); err != nil {
		return
	}

	// Field (5) 'BlobIndex'
	dst = ssz.MarshalUint64(dst, b.BlobIndex)
...
func (b *BlobSidecar) UnmarshalSSZ(buf []byte) error {
	...
	// Field (2) 'ValidatorIndex'
	b.ValidatorIndex = github_com_prysmaticlabs_prysm_v3_consensus_types_primitives.ValidatorIndex(ssz.UnmarshallUint64(buf[40:48]))
	...
	if err = b.Blob.UnmarshalSSZ(buf[80:131152]); err != nil {
		return err
	}

	// Field (5) 'BlobIndex'
	b.BlobIndex = ssz.UnmarshallUint64(buf[131152:131160])
...
func (b *BlobSidecar) HashTreeRootWith(hh *ssz.Hasher) (err error) {
	...
	// Field (4) 'Blob'
	if err = b.Blob.HashTreeRootWith(hh); err != nil {
		return
	}

	// Field (5) 'BlobIndex'
	hh.PutUint64(b.BlobIndex)
