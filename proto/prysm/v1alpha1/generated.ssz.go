...
// Hash: 22229822fa48a7cc1d55221d7b6be6401ecb440c31c895cc67c1a2d0ba403c1e
package eth
...
func (a *AttestationElectra) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	// Offset (2) 'CommitteeBits'
	dst = ssz.WriteOffset(dst, offset)
	offset += len(a.CommitteeBits)
	...
	if size := len(a.CommitteeBits); size > 64 {
		err = ssz.ErrBytesLengthFn("--.CommitteeBits", size, 64)
		return
	}
...
func (a *AttestationElectra) UnmarshalSSZ(buf []byte) error {
	...
	// Field (3) 'Signature'
	if cap(a.Signature) == 0 {
		a.Signature = make([]byte, 0, len(buf[136:232]))
	}
	...
	// Field (2) 'CommitteeBits'
	{
		...
		if cap(a.CommitteeBits) == 0 {
			a.CommitteeBits = make([]byte, 0, len(buf))
		}
		a.CommitteeBits = append(a.CommitteeBits, buf...)
	}
	return err
}
...
func (a *AttestationElectra) HashTreeRootWith(hh *ssz.Hasher) (err error) {
	...
	hh.PutBitlist(a.CommitteeBits, 64)
