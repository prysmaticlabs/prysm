...
func (x *BeaconBlockMerge) GetBody() *BeaconBlockBodyBellatrix {
	if x != nil {
		return x.Body
	}
	return nil
...
func (x *BeaconBlockBodyBellatrix) GetExecutionPayload() *ExecutionPayload {
	if x != nil {
...
var file_proto_prysm_v1alpha1_beacon_block_proto_rawDesc = []byte{
	...
	0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0c, 0x42, 0x06, 0x8a, 0xb5, 0x18, 0x02, 0x39, 0x36, 0x52,
	0x09, 0x73, 0x69, 0x67, 0x6e, 0x61, 0x74, 0x75, 0x72, 0x65, 0x22, 0xc8, 0x02, 0x0a, 0x10, 0x42,
	...
	0x04, 0x62, 0x6f, 0x64, 0x79, 0x22, 0xfd, 0x05, 0x0a, 0x18, 0x42, 0x65, 0x61, 0x63, 0x6f, 0x6e,
	...
	0x74, 0x69, 0x6f, 0x6e, 0x73, 0x42, 0x98, 0x01, 0x0a, 0x19, 0x6f, 0x72, 0x67, 0x2e, 0x65, 0x74,
...
var file_proto_prysm_v1alpha1_beacon_block_proto_depIdxs = []int32{
	...
	20, // 32: ethereum.eth.v1alpha1.BeaconBlockMerge.body:type_name -> ethereum.eth.v1alpha1.BeaconBlockBodyBellatrix
	...
	23, // 36: ethereum.eth.v1alpha1.BeaconBlockBodyBellatrix.attestations:type_name -> ethereum.eth.v1alpha1.Attestation
	...
	21, // 40: ethereum.eth.v1alpha1.BeaconBlockBodyBellatrix.execution_payload:type_name -> ethereum.eth.v1alpha1.ExecutionPayload
