...
type BeaconBlockBodyePBS struct {
	...
	PayloadAttestations                  []*v1.PayloadAttestation                 `protobuf:"bytes,12,rep,name=payload_attestations,json=payloadAttestations,proto3" json:"payload_attestations,omitempty" ssz-max:"2"`
}
...
var file_proto_prysm_v1alpha1_beacon_block_proto_rawDesc = []byte{
	...
	0x79, 0x22, 0x8b, 0x08, 0x0a, 0x13, 0x42, 0x65, 0x61, 0x63, 0x6f, 0x6e, 0x42, 0x6c, 0x6f, 0x63,
	...
	0x65, 0x61, 0x64, 0x65, 0x72, 0x45, 0x6e, 0x76, 0x65, 0x6c, 0x6f, 0x70, 0x65, 0x12, 0x60, 0x0a,
	...
	0x69, 0x6f, 0x6e, 0x42, 0x05, 0x92, 0xb5, 0x18, 0x01, 0x32, 0x52, 0x13, 0x70, 0x61, 0x79, 0x6c,
...
var file_proto_prysm_v1alpha1_beacon_block_proto_goTypes = []interface{}{
	...
	(*v1.PayloadAttestation)(nil),                   // 63: ethereum.engine.v1.PayloadAttestation
}
var file_proto_prysm_v1alpha1_beacon_block_proto_depIdxs = []int32{
	...
	63,  // 129: ethereum.eth.v1alpha1.BeaconBlockBodyePBS.payload_attestations:type_name -> ethereum.engine.v1.PayloadAttestation
	49,  // 130: ethereum.eth.v1alpha1.SignedBeaconBlockePBS.block:type_name -> ethereum.eth.v1alpha1.BeaconBlockePBS
