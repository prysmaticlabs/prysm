...
type GenericSignedBeaconBlock struct {
	...
	//	*GenericSignedBeaconBlock_Phase0Block
	//	*GenericSignedBeaconBlock_AltairBlock
...
func (x *GenericSignedBeaconBlock) GetPhase0Block() *SignedBeaconBlock {
	if x, ok := x.GetBlock().(*GenericSignedBeaconBlock_Phase0Block); ok {
		return x.Phase0Block
	}
	return nil
}

func (x *GenericSignedBeaconBlock) GetAltairBlock() *SignedBeaconBlockAltair {
	if x, ok := x.GetBlock().(*GenericSignedBeaconBlock_AltairBlock); ok {
...
type GenericSignedBeaconBlock_Phase0Block struct {
	Phase0Block *SignedBeaconBlock `protobuf:"bytes,1,opt,name=phase0_block,json=phase0Block,proto3,oneof"`
}

type GenericSignedBeaconBlock_AltairBlock struct {
	AltairBlock *SignedBeaconBlockAltair `protobuf:"bytes,2,opt,name=altair_block,json=altairBlock,proto3,oneof"`
}

func (*GenericSignedBeaconBlock_Phase0Block) isGenericSignedBeaconBlock_Block() {}

func (*GenericSignedBeaconBlock_AltairBlock) isGenericSignedBeaconBlock_Block() {}
...
type GenericBeaconBlock struct {
	...
	// Types that are assignable to Block:
	//	*GenericBeaconBlock_Phase0Block
	//	*GenericBeaconBlock_AltairBlock
...
func (x *GenericBeaconBlock) GetPhase0Block() *BeaconBlock {
	if x, ok := x.GetBlock().(*GenericBeaconBlock_Phase0Block); ok {
		return x.Phase0Block
	}
	return nil
}

func (x *GenericBeaconBlock) GetAltairBlock() *BeaconBlockAltair {
	if x, ok := x.GetBlock().(*GenericBeaconBlock_AltairBlock); ok {
		return x.AltairBlock
	}
	return nil
}
...
type GenericBeaconBlock_Phase0Block struct {
	Phase0Block *BeaconBlock `protobuf:"bytes,1,opt,name=phase0_block,json=phase0Block,proto3,oneof"`
}

type GenericBeaconBlock_AltairBlock struct {
	AltairBlock *BeaconBlockAltair `protobuf:"bytes,2,opt,name=altair_block,json=altairBlock,proto3,oneof"`
}

func (*GenericBeaconBlock_Phase0Block) isGenericBeaconBlock_Block() {}

func (*GenericBeaconBlock_AltairBlock) isGenericBeaconBlock_Block() {}
...
var file_proto_prysm_v1alpha1_beacon_block_proto_rawDesc = []byte{
	...
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xc7, 0x01, 0x0a, 0x18, 0x47, 0x65, 0x6e, 0x65, 0x72, 0x69,
	0x63, 0x53, 0x69, 0x67, 0x6e, 0x65, 0x64, 0x42, 0x65, 0x61, 0x63, 0x6f, 0x6e, 0x42, 0x6c, 0x6f,
	0x63, 0x6b, 0x12, 0x4d, 0x0a, 0x0c, 0x70, 0x68, 0x61, 0x73, 0x65, 0x30, 0x5f, 0x62, 0x6c, 0x6f,
	...
	0x6b, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x2e, 0x2e, 0x65, 0x74, 0x68, 0x65, 0x72, 0x65,
	...
	0xb5, 0x01, 0x0a, 0x12, 0x47, 0x65, 0x6e, 0x65, 0x72, 0x69, 0x63, 0x42, 0x65, 0x61, 0x63, 0x6f,
	0x6e, 0x42, 0x6c, 0x6f, 0x63, 0x6b, 0x12, 0x47, 0x0a, 0x0c, 0x70, 0x68, 0x61, 0x73, 0x65, 0x30,
	0x5f, 0x62, 0x6c, 0x6f, 0x63, 0x6b, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x22, 0x2e, 0x65,
	...
	0x4d, 0x0a, 0x0c, 0x61, 0x6c, 0x74, 0x61, 0x69, 0x72, 0x5f, 0x62, 0x6c, 0x6f, 0x63, 0x6b, 0x18,
	...
	0x6d, 0x69, 0x74, 0x74, 0x65, 0x65, 0x53, 0x69, 0x67, 0x6e, 0x61, 0x74, 0x75, 0x72, 0x65, 0x42,
...
var file_proto_prysm_v1alpha1_beacon_block_proto_msgTypes = make([]protoimpl.MessageInfo, 19)
var file_proto_prysm_v1alpha1_beacon_block_proto_goTypes = []interface{}{
	...
	(*Deposit_Data)(nil),             // 18: ethereum.eth.v1alpha1.Deposit.Data
	(*Attestation)(nil),              // 19: ethereum.eth.v1alpha1.Attestation
...
var file_proto_prysm_v1alpha1_beacon_block_proto_depIdxs = []int32{
	3,  // 0: ethereum.eth.v1alpha1.GenericSignedBeaconBlock.phase0_block:type_name -> ethereum.eth.v1alpha1.SignedBeaconBlock
	5,  // 1: ethereum.eth.v1alpha1.GenericSignedBeaconBlock.altair_block:type_name -> ethereum.eth.v1alpha1.SignedBeaconBlockAltair
	2,  // 2: ethereum.eth.v1alpha1.GenericBeaconBlock.phase0_block:type_name -> ethereum.eth.v1alpha1.BeaconBlock
	4,  // 3: ethereum.eth.v1alpha1.GenericBeaconBlock.altair_block:type_name -> ethereum.eth.v1alpha1.BeaconBlockAltair
	...
	19, // 11: ethereum.eth.v1alpha1.BeaconBlockBody.attestations:type_name -> ethereum.eth.v1alpha1.Attestation
	...
	19, // 17: ethereum.eth.v1alpha1.BeaconBlockBodyAltair.attestations:type_name -> ethereum.eth.v1alpha1.Attestation
	...
	18, // 25: ethereum.eth.v1alpha1.Deposit.data:type_name -> ethereum.eth.v1alpha1.Deposit.Data
	...
	20, // 28: ethereum.eth.v1alpha1.IndexedAttestation.data:type_name -> ethereum.eth.v1alpha1.AttestationData
...
func file_proto_prysm_v1alpha1_beacon_block_proto_init() {
	...
	file_proto_prysm_v1alpha1_beacon_block_proto_msgTypes[0].OneofWrappers = []interface{}{
		(*GenericSignedBeaconBlock_Phase0Block)(nil),
		(*GenericSignedBeaconBlock_AltairBlock)(nil),
	}
	file_proto_prysm_v1alpha1_beacon_block_proto_msgTypes[1].OneofWrappers = []interface{}{
		(*GenericBeaconBlock_Phase0Block)(nil),
		(*GenericBeaconBlock_AltairBlock)(nil),
	}
	type x struct{}
