...
func (*Deposit_Data) Descriptor() ([]byte, []int) {
	return file_proto_prysm_v1alpha1_beacon_block_proto_rawDescGZIP(), []int{8, 0}
}
...
var file_proto_prysm_v1alpha1_beacon_block_proto_rawDesc = []byte{
	...
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xba, 0x02, 0x0a, 0x0b, 0x42, 0x65, 0x61, 0x63, 0x6f, 0x6e,
	0x42, 0x6c, 0x6f, 0x63, 0x6b, 0x12, 0x40, 0x0a, 0x04, 0x73, 0x6c, 0x6f, 0x74, 0x18, 0x01, 0x20,
	...
	0x67, 0x6e, 0x61, 0x74, 0x75, 0x72, 0x65, 0x22, 0xc6, 0x02, 0x0a, 0x11, 0x42, 0x65, 0x61, 0x63,
	0x6f, 0x6e, 0x42, 0x6c, 0x6f, 0x63, 0x6b, 0x41, 0x6c, 0x74, 0x61, 0x69, 0x72, 0x12, 0x40, 0x0a,
	...
	0x73, 0x69, 0x67, 0x6e, 0x61, 0x74, 0x75, 0x72, 0x65, 0x22, 0xb5, 0x01, 0x0a, 0x0d, 0x56, 0x6f,
	0x6c, 0x75, 0x6e, 0x74, 0x61, 0x72, 0x79, 0x45, 0x78, 0x69, 0x74, 0x12, 0x43, 0x0a, 0x05, 0x65,
	...
	0x32, 0x52, 0x09, 0x62, 0x6c, 0x6f, 0x63, 0x6b, 0x48, 0x61, 0x73, 0x68, 0x22, 0xa9, 0x02, 0x0a,
	0x11, 0x42, 0x65, 0x61, 0x63, 0x6f, 0x6e, 0x42, 0x6c, 0x6f, 0x63, 0x6b, 0x48, 0x65, 0x61, 0x64,
	0x65, 0x72, 0x12, 0x40, 0x0a, 0x04, 0x73, 0x6c, 0x6f, 0x74, 0x18, 0x01, 0x20, 0x01, 0x28, 0x04,
	...
	0x73, 0x6c, 0x6f, 0x74, 0x12, 0x5d, 0x0a, 0x0e, 0x70, 0x72, 0x6f, 0x70, 0x6f, 0x73, 0x65, 0x72,
	...
	0x74, 0x74, 0x65, 0x65, 0x53, 0x69, 0x67, 0x6e, 0x61, 0x74, 0x75, 0x72, 0x65, 0x42, 0x98, 0x01,
...
var file_proto_prysm_v1alpha1_beacon_block_proto_msgTypes = make([]protoimpl.MessageInfo, 17)
var file_proto_prysm_v1alpha1_beacon_block_proto_goTypes = []interface{}{
	...
	(*BeaconBlockAltair)(nil),       // 2: ethereum.eth.v1alpha1.BeaconBlockAltair
	(*SignedBeaconBlockAltair)(nil), // 3: ethereum.eth.v1alpha1.SignedBeaconBlockAltair
	(*BeaconBlockBody)(nil),         // 4: ethereum.eth.v1alpha1.BeaconBlockBody
	(*BeaconBlockBodyAltair)(nil),   // 5: ethereum.eth.v1alpha1.BeaconBlockBodyAltair
	(*ProposerSlashing)(nil),        // 6: ethereum.eth.v1alpha1.ProposerSlashing
	(*AttesterSlashing)(nil),        // 7: ethereum.eth.v1alpha1.AttesterSlashing
	(*Deposit)(nil),                 // 8: ethereum.eth.v1alpha1.Deposit
	(*VoluntaryExit)(nil),           // 9: ethereum.eth.v1alpha1.VoluntaryExit
	(*SignedVoluntaryExit)(nil),     // 10: ethereum.eth.v1alpha1.SignedVoluntaryExit
	(*Eth1Data)(nil),                // 11: ethereum.eth.v1alpha1.Eth1Data
	(*BeaconBlockHeader)(nil),       // 12: ethereum.eth.v1alpha1.BeaconBlockHeader
	(*SignedBeaconBlockHeader)(nil), // 13: ethereum.eth.v1alpha1.SignedBeaconBlockHeader
	(*IndexedAttestation)(nil),      // 14: ethereum.eth.v1alpha1.IndexedAttestation
	(*SyncAggregate)(nil),           // 15: ethereum.eth.v1alpha1.SyncAggregate
	(*Deposit_Data)(nil),            // 16: ethereum.eth.v1alpha1.Deposit.Data
	(*Attestation)(nil),             // 17: ethereum.eth.v1alpha1.Attestation
...
var file_proto_prysm_v1alpha1_beacon_block_proto_depIdxs = []int32{
	4,  // 0: ethereum.eth.v1alpha1.BeaconBlock.body:type_name -> ethereum.eth.v1alpha1.BeaconBlockBody
	0,  // 1: ethereum.eth.v1alpha1.SignedBeaconBlock.block:type_name -> ethereum.eth.v1alpha1.BeaconBlock
	5,  // 2: ethereum.eth.v1alpha1.BeaconBlockAltair.body:type_name -> ethereum.eth.v1alpha1.BeaconBlockBodyAltair
	2,  // 3: ethereum.eth.v1alpha1.SignedBeaconBlockAltair.block:type_name -> ethereum.eth.v1alpha1.BeaconBlockAltair
	11, // 4: ethereum.eth.v1alpha1.BeaconBlockBody.eth1_data:type_name -> ethereum.eth.v1alpha1.Eth1Data
	6,  // 5: ethereum.eth.v1alpha1.BeaconBlockBody.proposer_slashings:type_name -> ethereum.eth.v1alpha1.ProposerSlashing
	7,  // 6: ethereum.eth.v1alpha1.BeaconBlockBody.attester_slashings:type_name -> ethereum.eth.v1alpha1.AttesterSlashing
	17, // 7: ethereum.eth.v1alpha1.BeaconBlockBody.attestations:type_name -> ethereum.eth.v1alpha1.Attestation
	8,  // 8: ethereum.eth.v1alpha1.BeaconBlockBody.deposits:type_name -> ethereum.eth.v1alpha1.Deposit
	10, // 9: ethereum.eth.v1alpha1.BeaconBlockBody.voluntary_exits:type_name -> ethereum.eth.v1alpha1.SignedVoluntaryExit
	11, // 10: ethereum.eth.v1alpha1.BeaconBlockBodyAltair.eth1_data:type_name -> ethereum.eth.v1alpha1.Eth1Data
	6,  // 11: ethereum.eth.v1alpha1.BeaconBlockBodyAltair.proposer_slashings:type_name -> ethereum.eth.v1alpha1.ProposerSlashing
	7,  // 12: ethereum.eth.v1alpha1.BeaconBlockBodyAltair.attester_slashings:type_name -> ethereum.eth.v1alpha1.AttesterSlashing
	17, // 13: ethereum.eth.v1alpha1.BeaconBlockBodyAltair.attestations:type_name -> ethereum.eth.v1alpha1.Attestation
	8,  // 14: ethereum.eth.v1alpha1.BeaconBlockBodyAltair.deposits:type_name -> ethereum.eth.v1alpha1.Deposit
	10, // 15: ethereum.eth.v1alpha1.BeaconBlockBodyAltair.voluntary_exits:type_name -> ethereum.eth.v1alpha1.SignedVoluntaryExit
	15, // 16: ethereum.eth.v1alpha1.BeaconBlockBodyAltair.sync_aggregate:type_name -> ethereum.eth.v1alpha1.SyncAggregate
	13, // 17: ethereum.eth.v1alpha1.ProposerSlashing.header_1:type_name -> ethereum.eth.v1alpha1.SignedBeaconBlockHeader
	13, // 18: ethereum.eth.v1alpha1.ProposerSlashing.header_2:type_name -> ethereum.eth.v1alpha1.SignedBeaconBlockHeader
	14, // 19: ethereum.eth.v1alpha1.AttesterSlashing.attestation_1:type_name -> ethereum.eth.v1alpha1.IndexedAttestation
	14, // 20: ethereum.eth.v1alpha1.AttesterSlashing.attestation_2:type_name -> ethereum.eth.v1alpha1.IndexedAttestation
	16, // 21: ethereum.eth.v1alpha1.Deposit.data:type_name -> ethereum.eth.v1alpha1.Deposit.Data
	9,  // 22: ethereum.eth.v1alpha1.SignedVoluntaryExit.exit:type_name -> ethereum.eth.v1alpha1.VoluntaryExit
	12, // 23: ethereum.eth.v1alpha1.SignedBeaconBlockHeader.header:type_name -> ethereum.eth.v1alpha1.BeaconBlockHeader
	18, // 24: ethereum.eth.v1alpha1.IndexedAttestation.data:type_name -> ethereum.eth.v1alpha1.AttestationData
