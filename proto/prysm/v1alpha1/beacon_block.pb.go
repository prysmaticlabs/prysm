...
type ExecutionPayload struct {
	...
	Transactions  []*Transaction `protobuf:"bytes,14,rep,name=transactions,proto3" json:"transactions,omitempty" ssz-max:"16384"`
}
...
func (x *Transaction) GetOpaqueTransaction() []byte {
	if x, ok := x.GetTransactionOneof().(*Transaction_OpaqueTransaction); ok {
		return x.OpaqueTransaction
	}
	return nil
}
...
type Transaction_OpaqueTransaction struct {
	OpaqueTransaction []byte `protobuf:"bytes,1,opt,name=opaque_transaction,json=opaqueTransaction,proto3,oneof" ssz-max:"1048576"`
}

func (*Transaction_OpaqueTransaction) isTransaction_TransactionOneof() {}
...
var file_proto_prysm_v1alpha1_beacon_block_proto_rawDesc = []byte{
	...
	0x63, 0x75, 0x74, 0x69, 0x6f, 0x6e, 0x50, 0x61, 0x79, 0x6c, 0x6f, 0x61, 0x64, 0x22, 0xc4, 0x04,
	...
	0x0a, 0x70, 0x61, 0x72, 0x65, 0x6e, 0x74, 0x48, 0x61, 0x73, 0x68, 0x12, 0x22, 0x0a, 0x08, 0x63,
	0x6f, 0x69, 0x6e, 0x62, 0x61, 0x73, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0c, 0x42, 0x06, 0x8a,
	0xb5, 0x18, 0x02, 0x32, 0x30, 0x52, 0x08, 0x63, 0x6f, 0x69, 0x6e, 0x62, 0x61, 0x73, 0x65, 0x12,
	...
	,
...
var file_proto_prysm_v1alpha1_beacon_block_proto_msgTypes = make([]protoimpl.MessageInfo, 24)
var file_proto_prysm_v1alpha1_beacon_block_proto_goTypes = []interface{}{
	...
	(*Transaction)(nil),              // 22: ethereum.eth.v1alpha1.Transaction
	(*Deposit_Data)(nil),             // 23: ethereum.eth.v1alpha1.Deposit.Data
	(*Attestation)(nil),              // 24: ethereum.eth.v1alpha1.Attestation
	(*AttestationData)(nil),          // 25: ethereum.eth.v1alpha1.AttestationData
}
var file_proto_prysm_v1alpha1_beacon_block_proto_depIdxs = []int32{
	...
	24, // 13: ethereum.eth.v1alpha1.BeaconBlockBody.attestations:type_name -> ethereum.eth.v1alpha1.Attestation
	...
	24, // 19: ethereum.eth.v1alpha1.BeaconBlockBodyAltair.attestations:type_name -> ethereum.eth.v1alpha1.Attestation
	...
	23, // 27: ethereum.eth.v1alpha1.Deposit.data:type_name -> ethereum.eth.v1alpha1.Deposit.Data
	...
	25, // 30: ethereum.eth.v1alpha1.IndexedAttestation.data:type_name -> ethereum.eth.v1alpha1.AttestationData
	...
	24, // 36: ethereum.eth.v1alpha1.BeaconBlockBodyMerge.attestations:type_name -> ethereum.eth.v1alpha1.Attestation
	...
	22, // 41: ethereum.eth.v1alpha1.ExecutionPayload.transactions:type_name -> ethereum.eth.v1alpha1.Transaction
...
func file_proto_prysm_v1alpha1_beacon_block_proto_init() {
	...
	file_proto_prysm_v1alpha1_beacon_block_proto_msgTypes[22].OneofWrappers = []interface{}{
		(*Transaction_OpaqueTransaction)(nil),
	}
	type x struct{}
