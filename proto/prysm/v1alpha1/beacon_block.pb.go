...
type GenericSignedBeaconBlock struct {
	...
	//	*GenericSignedBeaconBlock_Shanghai
...
func (x *GenericSignedBeaconBlock) GetShanghai() *SignedBeaconBlockAndBlobs {
	if x, ok := x.GetBlock().(*GenericSignedBeaconBlock_Shanghai); ok {
		return x.Shanghai
	}
	return nil
}
...
type GenericSignedBeaconBlock_Shanghai struct {
	Shanghai *SignedBeaconBlockAndBlobs `protobuf:"bytes,4,opt,name=shanghai,proto3,oneof"`
}
...
func (*GenericSignedBeaconBlock_Shanghai) isGenericSignedBeaconBlock_Block() {}
...
func (x *GenericBeaconBlock) GetShanghai() *BeaconBlockAndBlobs {
	if x, ok := x.GetBlock().(*GenericBeaconBlock_Shanghai); ok {
		return x.Shanghai
	}
	return nil
}
...
type GenericBeaconBlock_Shanghai struct {
	Shanghai *BeaconBlockAndBlobs `protobuf:"bytes,4,opt,name=shanghai,proto3,oneof"`
}
...
func (*GenericBeaconBlock_Shanghai) isGenericBeaconBlock_Block() {}
...
type BeaconBlockBodyWithBlobKZGs struct {
	...
	VoluntaryExits    []*SignedVoluntaryExit          `protobuf:"bytes,8,rep,name=voluntary_exits,json=voluntaryExits,proto3" json:"voluntary_exits,omitempty" ssz-max:"16"`
	SyncAggregate     *SyncAggregate                  `protobuf:"bytes,9,opt,name=sync_aggregate,json=syncAggregate,proto3" json:"sync_aggregate,omitempty"`
	ExecutionPayload  *v1.ExecutionPayloadWithBlobTxs `protobuf:"bytes,10,opt,name=execution_payload,json=executionPayload,proto3" json:"execution_payload,omitempty"`
...
func (x *BeaconBlockBodyWithBlobKZGs) GetExecutionPayload() *v1.ExecutionPayloadWithBlobTxs {
	if x != nil {
		return x.ExecutionPayload
	}
	return nil
...
type BeaconBlockAndBlobs struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Block *BeaconBlockWithBlobKZGs `protobuf:"bytes,1,opt,name=block,proto3" json:"block,omitempty"`
	Blobs []*Blob                  `protobuf:"bytes,2,rep,name=blobs,proto3" json:"blobs,omitempty" ssz-max:"16777216"`
}

func (x *BeaconBlockAndBlobs) Reset() {
	*x = BeaconBlockAndBlobs{}
	if protoimpl.UnsafeEnabled {
...
func (x *BeaconBlockAndBlobs) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*BeaconBlockAndBlobs) ProtoMessage() {}

func (x *BeaconBlockAndBlobs) ProtoReflect() protoreflect.Message {
	mi := &file_proto_prysm_v1alpha1_beacon_block_proto_msgTypes[24]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use BeaconBlockAndBlobs.ProtoReflect.Descriptor instead.
func (*BeaconBlockAndBlobs) Descriptor() ([]byte, []int) {
	return file_proto_prysm_v1alpha1_beacon_block_proto_rawDescGZIP(), []int{24}
}

func (x *BeaconBlockAndBlobs) GetBlock() *BeaconBlockWithBlobKZGs {
	if x != nil {
		return x.Block
	}
	return nil
...
func (x *BeaconBlockAndBlobs) GetBlobs() []*Blob {
	if x != nil {
		return x.Blobs
	}
	return nil
...
type SignedBeaconBlockAndBlobs struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *SignedBeaconBlockAndBlobs) Reset() {
	*x = SignedBeaconBlockAndBlobs{}
	if protoimpl.UnsafeEnabled {
...
func (x *SignedBeaconBlockAndBlobs) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SignedBeaconBlockAndBlobs) ProtoMessage() {}

func (x *SignedBeaconBlockAndBlobs) ProtoReflect() protoreflect.Message {
	mi := &file_proto_prysm_v1alpha1_beacon_block_proto_msgTypes[25]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SignedBeaconBlockAndBlobs.ProtoReflect.Descriptor instead.
func (*SignedBeaconBlockAndBlobs) Descriptor() ([]byte, []int) {
	return file_proto_prysm_v1alpha1_beacon_block_proto_rawDescGZIP(), []int{25}
}

func (x *SignedBeaconBlockAndBlobs) GetBlock() *SignedBeaconBlockWithBlobKZGs {
	if x != nil {
		return x.Block
	}
	return nil
...
func (x *SignedBeaconBlockAndBlobs) GetBlobs() []*Blob {
	if x != nil {
		return x.Blobs
	}
	return nil
...
type Blob struct {
	...
	Blob [][]byte `protobuf:"bytes,1,rep,name=blob,proto3" json:"blob,omitempty" ssz-size:"4096,48"`
}
...
var file_proto_prysm_v1alpha1_beacon_block_proto_rawDesc = []byte{
	...
	0x5f, 0x65, 0x6e, 0x67, 0x69, 0x6e, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xd4, 0x02,
	...
	0x52, 0x09, 0x62, 0x65, 0x6c, 0x6c, 0x61, 0x74, 0x72, 0x69, 0x78, 0x12, 0x4e, 0x0a, 0x08, 0x73,
	0x68, 0x61, 0x6e, 0x67, 0x68, 0x61, 0x69, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x30, 0x2e,
	...
	0x6f, 0x6e, 0x42, 0x6c, 0x6f, 0x63, 0x6b, 0x41, 0x6e, 0x64, 0x42, 0x6c, 0x6f, 0x62, 0x73, 0x48,
	0x00, 0x52, 0x08, 0x73, 0x68, 0x61, 0x6e, 0x67, 0x68, 0x61, 0x69, 0x42, 0x07, 0x0a, 0x05, 0x62,
	0x6c, 0x6f, 0x63, 0x6b, 0x22, 0xb6, 0x02, 0x0a, 0x12, 0x47, 0x65, 0x6e, 0x65, 0x72, 0x69, 0x63,
	...
	0x09, 0x62, 0x65, 0x6c, 0x6c, 0x61, 0x74, 0x72, 0x69, 0x78, 0x12, 0x48, 0x0a, 0x08, 0x73, 0x68,
	0x61, 0x6e, 0x67, 0x68, 0x61, 0x69, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x2a, 0x2e, 0x65,
	0x74, 0x68, 0x65, 0x72, 0x65, 0x75, 0x6d, 0x2e, 0x65, 0x74, 0x68, 0x2e, 0x76, 0x31, 0x61, 0x6c,
	0x70, 0x68, 0x61, 0x31, 0x2e, 0x42, 0x65, 0x61, 0x63, 0x6f, 0x6e, 0x42, 0x6c, 0x6f, 0x63, 0x6b,
	0x41, 0x6e, 0x64, 0x42, 0x6c, 0x6f, 0x62, 0x73, 0x48, 0x00, 0x52, 0x08, 0x73, 0x68, 0x61, 0x6e,
	0x67, 0x68, 0x61, 0x69, 0x42, 0x07, 0x0a, 0x05, 0x62, 0x6c, 0x6f, 0x63, 0x6b, 0x22, 0xba, 0x02,
	0x0a, 0x0b, 0x42, 0x65, 0x61, 0x63, 0x6f, 0x6e, 0x42, 0x6c, 0x6f, 0x63, 0x6b, 0x12, 0x40, 0x0a,
	...
	0xc6, 0x02, 0x0a, 0x11, 0x42, 0x65, 0x61, 0x63, 0x6f, 0x6e, 0x42, 0x6c, 0x6f, 0x63, 0x6b, 0x41,
	...
	0x65, 0x22, 0xb5, 0x01, 0x0a, 0x0d, 0x56, 0x6f, 0x6c, 0x75, 0x6e, 0x74, 0x61, 0x72, 0x79, 0x45,
	0x78, 0x69, 0x74, 0x12, 0x43, 0x0a, 0x05, 0x65, 0x70, 0x6f, 0x63, 0x68, 0x18, 0x01, 0x20, 0x01,
	...
	0x68, 0x52, 0x05, 0x65, 0x70, 0x6f, 0x63, 0x68, 0x12, 0x5f, 0x0a, 0x0f, 0x76, 0x61, 0x6c, 0x69,
	...
	0x48, 0x61, 0x73, 0x68, 0x22, 0xa9, 0x02, 0x0a, 0x11, 0x42, 0x65, 0x61, 0x63, 0x6f, 0x6e, 0x42,
	0x6c, 0x6f, 0x63, 0x6b, 0x48, 0x65, 0x61, 0x64, 0x65, 0x72, 0x12, 0x40, 0x0a, 0x04, 0x73, 0x6c,
	...
	0x39, 0x36, 0x52, 0x09, 0x73, 0x69, 0x67, 0x6e, 0x61, 0x74, 0x75, 0x72, 0x65, 0x22, 0xcc, 0x02,
	0x0a, 0x14, 0x42, 0x65, 0x61, 0x63, 0x6f, 0x6e, 0x42, 0x6c, 0x6f, 0x63, 0x6b, 0x42, 0x65, 0x6c,
	0x6c, 0x61, 0x74, 0x72, 0x69, 0x78, 0x12, 0x40, 0x0a, 0x04, 0x73, 0x6c, 0x6f, 0x74, 0x18, 0x01,
	...
	0x6f, 0x6e, 0x50, 0x61, 0x79, 0x6c, 0x6f, 0x61, 0x64, 0x22, 0x8b, 0x01, 0x0a, 0x1d, 0x53, 0x69,
	0x67, 0x6e, 0x65, 0x64, 0x42, 0x65, 0x61, 0x63, 0x6f, 0x6e, 0x42, 0x6c, 0x6f, 0x63, 0x6b, 0x57,
	0x69, 0x74, 0x68, 0x42, 0x6c, 0x6f, 0x62, 0x4b, 0x5a, 0x47, 0x73, 0x12, 0x44, 0x0a, 0x05, 0x62,
	...
	0x67, 0x6e, 0x61, 0x74, 0x75, 0x72, 0x65, 0x22, 0xd2, 0x02, 0x0a, 0x17, 0x42, 0x65, 0x61, 0x63,
	0x6f, 0x6e, 0x42, 0x6c, 0x6f, 0x63, 0x6b, 0x57, 0x69, 0x74, 0x68, 0x42, 0x6c, 0x6f, 0x62, 0x4b,
	0x5a, 0x47, 0x73, 0x12, 0x40, 0x0a, 0x04, 0x73, 0x6c, 0x6f, 0x74, 0x18, 0x01, 0x20, 0x01, 0x28,
	...
	0x6f, 0x62, 0x4b, 0x5a, 0x47, 0x73, 0x52, 0x04, 0x62, 0x6f, 0x64, 0x79, 0x22, 0xbb, 0x06, 0x0a,
	...
	0x41, 0x67, 0x67, 0x72, 0x65, 0x67, 0x61, 0x74, 0x65, 0x12, 0x5c, 0x0a, 0x11, 0x65, 0x78, 0x65,
	...
	,
	...
	,
	...
	0x0c, 0x92, 0xb5, 0x18, 0x08, 0x31, 0x36, 0x37, 0x37, 0x37, 0x32, 0x31, 0x36, 0x52, 0x05, 0x62,
	0x6c, 0x6f, 0x62, 0x73, 0x22, 0x27, 0x0a, 0x04, 0x42, 0x6c, 0x6f, 0x62, 0x12, 0x1f, 0x0a, 0x04,
	0x62, 0x6c, 0x6f, 0x62, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0c, 0x42, 0x0b, 0x8a, 0xb5, 0x18, 0x07,
	0x34, 0x30, 0x39, 0x36, 0x2c, 0x34, 0x38, 0x52, 0x04, 0x62, 0x6c, 0x6f, 0x62, 0x42, 0x98, 0x01,
...
var file_proto_prysm_v1alpha1_beacon_block_proto_goTypes = []interface{}{
	...
	(*BeaconBlockAndBlobs)(nil),            // 24: ethereum.eth.v1alpha1.BeaconBlockAndBlobs
	(*SignedBeaconBlockAndBlobs)(nil),      // 25: ethereum.eth.v1alpha1.SignedBeaconBlockAndBlobs
	(*Blob)(nil),                           // 26: ethereum.eth.v1alpha1.Blob
	...
	(*v1.ExecutionPayload)(nil),            // 30: ethereum.engine.v1.ExecutionPayload
	(*v1.ExecutionPayloadWithBlobTxs)(nil), // 31: ethereum.engine.v1.ExecutionPayloadWithBlobTxs
}
var file_proto_prysm_v1alpha1_beacon_block_proto_depIdxs = []int32{
	...
	25, // 3: ethereum.eth.v1alpha1.GenericSignedBeaconBlock.shanghai:type_name -> ethereum.eth.v1alpha1.SignedBeaconBlockAndBlobs
	...
	24, // 7: ethereum.eth.v1alpha1.GenericBeaconBlock.shanghai:type_name -> ethereum.eth.v1alpha1.BeaconBlockAndBlobs
	...
	28, // 15: ethereum.eth.v1alpha1.BeaconBlockBody.attestations:type_name -> ethereum.eth.v1alpha1.Attestation
	...
	28, // 21: ethereum.eth.v1alpha1.BeaconBlockBodyAltair.attestations:type_name -> ethereum.eth.v1alpha1.Attestation
	...
	27, // 29: ethereum.eth.v1alpha1.Deposit.data:type_name -> ethereum.eth.v1alpha1.Deposit.Data
	...
	29, // 32: ethereum.eth.v1alpha1.IndexedAttestation.data:type_name -> ethereum.eth.v1alpha1.AttestationData
	...
	28, // 38: ethereum.eth.v1alpha1.BeaconBlockBodyBellatrix.attestations:type_name -> ethereum.eth.v1alpha1.Attestation
	...
	30, // 42: ethereum.eth.v1alpha1.BeaconBlockBodyBellatrix.execution_payload:type_name -> ethereum.engine.v1.ExecutionPayload
	...
	28, // 48: ethereum.eth.v1alpha1.BeaconBlockBodyWithBlobKZGs.attestations:type_name -> ethereum.eth.v1alpha1.Attestation
	...
	31, // 52: ethereum.eth.v1alpha1.BeaconBlockBodyWithBlobKZGs.execution_payload:type_name -> ethereum.engine.v1.ExecutionPayloadWithBlobTxs
	22, // 53: ethereum.eth.v1alpha1.BeaconBlockAndBlobs.block:type_name -> ethereum.eth.v1alpha1.BeaconBlockWithBlobKZGs
	26, // 54: ethereum.eth.v1alpha1.BeaconBlockAndBlobs.blobs:type_name -> ethereum.eth.v1alpha1.Blob
	21, // 55: ethereum.eth.v1alpha1.SignedBeaconBlockAndBlobs.block:type_name -> ethereum.eth.v1alpha1.SignedBeaconBlockWithBlobKZGs
	26, // 56: ethereum.eth.v1alpha1.SignedBeaconBlockAndBlobs.blobs:type_name -> ethereum.eth.v1alpha1.Blob
...
func file_proto_prysm_v1alpha1_beacon_block_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_proto_prysm_v1alpha1_beacon_block_proto_msgTypes[24].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*BeaconBlockAndBlobs); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_proto_prysm_v1alpha1_beacon_block_proto_msgTypes[25].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*SignedBeaconBlockAndBlobs); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_proto_prysm_v1alpha1_beacon_block_proto_msgTypes[0].OneofWrappers = []interface{}{
		...
		(*GenericSignedBeaconBlock_Shanghai)(nil),
	}
	file_proto_prysm_v1alpha1_beacon_block_proto_msgTypes[1].OneofWrappers = []interface{}{
		...
		(*GenericBeaconBlock_Shanghai)(nil),
	}
	type x struct{}
