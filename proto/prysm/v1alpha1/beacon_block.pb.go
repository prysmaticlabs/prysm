...
func (x *BlobSidecarNew) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*BlobSidecarNew) ProtoMessage() {}

func (x *BlobSidecarNew) ProtoReflect() protoreflect.Message {
	mi := &file_proto_prysm_v1alpha1_beacon_block_proto_msgTypes[49]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use BlobSidecarNew.ProtoReflect.Descriptor instead.
func (*BlobSidecarNew) Descriptor() ([]byte, []int) {
	return file_proto_prysm_v1alpha1_beacon_block_proto_rawDescGZIP(), []int{49}
}

func (x *BlobSidecarNew) GetIndex() uint64 {
	if x != nil {
		return x.Index
	}
	return 0
...
func (x *BlobSidecarNew) GetBlob() []byte {
	if x != nil {
		return x.Blob
	}
	return nil
...
func (x *BlobSidecarNew) GetKzgCommitment() []byte {
	if x != nil {
...
func (x *BlobSidecarNew) GetKzgProof() []byte {
	if x != nil {
		return x.KzgProof
	}
	return nil
...
func (x *BlobSidecarNew) GetSignedBlockHeader() *SignedBeaconBlockHeader {
	if x != nil {
...
func (x *BlobSidecarNew) GetCommitmentInclusionProof() [][]byte {
	if x != nil {
...
var file_proto_prysm_v1alpha1_beacon_block_proto_rawDesc = []byte{
	...
	0x74, 0x75, 0x72, 0x65, 0x22, 0xc8, 0x02, 0x0a, 0x0e, 0x42, 0x6c, 0x6f, 0x62, 0x53, 0x69, 0x64,
	0x65, 0x63, 0x61, 0x72, 0x4e, 0x65, 0x77, 0x12, 0x14, 0x0a, 0x05, 0x69, 0x6e, 0x64, 0x65, 0x78,
	...
	0x72, 0x12, 0x4c, 0x0a, 0x1a, 0x63, 0x6f, 0x6d, 0x6d, 0x69, 0x74, 0x6d, 0x65, 0x6e, 0x74, 0x5f,
	0x69, 0x6e, 0x63, 0x6c, 0x75, 0x73, 0x69, 0x6f, 0x6e, 0x5f, 0x70, 0x72, 0x6f, 0x6f, 0x66, 0x18,
	0x06, 0x20, 0x03, 0x28, 0x0c, 0x42, 0x0e, 0x8a, 0xb5, 0x18, 0x04, 0x3f, 0x2c, 0x33, 0x32, 0x92,
	0xb5, 0x18, 0x02, 0x31, 0x37, 0x52, 0x18, 0x63, 0x6f, 0x6d, 0x6d, 0x69, 0x74, 0x6d, 0x65, 0x6e,
	0x74, 0x49, 0x6e, 0x63, 0x6c, 0x75, 0x73, 0x69, 0x6f, 0x6e, 0x50, 0x72, 0x6f, 0x6f, 0x66, 0x42,
...
var file_proto_prysm_v1alpha1_beacon_block_proto_goTypes = []interface{}{
	...
	(*BlobSidecarNew)(nil),                        // 49: ethereum.eth.v1alpha1.BlobSidecarNew
	...
	(*BlobSidecar)(nil),                           // 56: ethereum.eth.v1alpha1.BlobSidecar
...
var file_proto_prysm_v1alpha1_beacon_block_proto_depIdxs = []int32{
	...
	56,  // 65: ethereum.eth.v1alpha1.BeaconBlockAndBlobsDeneb.blobs:type_name -> ethereum.eth.v1alpha1.BlobSidecar
	...
	15,  // 122: ethereum.eth.v1alpha1.BlobSidecarNew.signed_block_header:type_name -> ethereum.eth.v1alpha1.SignedBeaconBlockHeader
