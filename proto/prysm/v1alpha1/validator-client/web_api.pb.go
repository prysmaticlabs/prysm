...
var file_proto_prysm_v1alpha1_validator_client_web_api_proto_rawDesc = []byte{
	...
	0x70, 0x6f, 0x72, 0x74, 0x3a, 0x01, 0x2a, 0x32, 0xc8, 0x05, 0x0a, 0x0f, 0x56, 0x61, 0x6c, 0x69,
	0x64, 0x61, 0x74, 0x6f, 0x72, 0x48, 0x65, 0x61, 0x6c, 0x74, 0x68, 0x12, 0x97, 0x01, 0x0a, 0x17,
	...
	0x6f, 0x6e, 0x12, 0x82, 0x01, 0x0a, 0x10, 0x53, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x42, 0x65, 0x61,
	...
	0x74, 0x72, 0x65, 0x61, 0x6d, 0x30, 0x01, 0x12, 0x88, 0x01, 0x0a, 0x13, 0x53, 0x74, 0x72, 0x65,
	...
	0x64, 0x61, 0x74, 0x6f, 0x72, 0x2f, 0x6c, 0x6f, 0x67, 0x6f, 0x75, 0x74, 0x3a, 0x01, 0x2a, 0x42,
	0xc4, 0x01, 0x0a, 0x22, 0x6f, 0x72, 0x67, 0x2e, 0x65, 0x74, 0x68, 0x65, 0x72, 0x65, 0x75, 0x6d,
	0x2e, 0x76, 0x61, 0x6c, 0x69, 0x64, 0x61, 0x74, 0x6f, 0x72, 0x2e, 0x61, 0x63, 0x63, 0x6f, 0x75,
	0x6e, 0x74, 0x73, 0x2e, 0x76, 0x32, 0x42, 0x08, 0x57, 0x65, 0x62, 0x50, 0x72, 0x6f, 0x74, 0x6f,
...
var file_proto_prysm_v1alpha1_validator_client_web_api_proto_depIdxs = []int32{
	...
	31, // 24: ethereum.validator.accounts.v2.ValidatorHealth.GetBeaconNodeConnection:input_type -> google.protobuf.Empty
	31, // 25: ethereum.validator.accounts.v2.ValidatorHealth.GetLogsEndpoints:input_type -> google.protobuf.Empty
	31, // 26: ethereum.validator.accounts.v2.ValidatorHealth.GetVersion:input_type -> google.protobuf.Empty
	31, // 27: ethereum.validator.accounts.v2.ValidatorHealth.StreamBeaconLogs:input_type -> google.protobuf.Empty
	31, // 28: ethereum.validator.accounts.v2.ValidatorHealth.StreamValidatorLogs:input_type -> google.protobuf.Empty
	...
	13, // 52: ethereum.validator.accounts.v2.ValidatorHealth.GetBeaconNodeConnection:output_type -> ethereum.validator.accounts.v2.NodeConnectionResponse
	14, // 53: ethereum.validator.accounts.v2.ValidatorHealth.GetLogsEndpoints:output_type -> ethereum.validator.accounts.v2.LogsEndpointResponse
	15, // 54: ethereum.validator.accounts.v2.ValidatorHealth.GetVersion:output_type -> ethereum.validator.accounts.v2.VersionResponse
	42, // 55: ethereum.validator.accounts.v2.ValidatorHealth.StreamBeaconLogs:output_type -> ethereum.eth.v1alpha1.LogsResponse
	42, // 56: ethereum.validator.accounts.v2.ValidatorHealth.StreamValidatorLogs:output_type -> ethereum.eth.v1alpha1.LogsResponse
...
func (c *validatorHealthClient) GetBeaconNodeConnection(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*NodeConnectionResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/ethereum.validator.accounts.v2.ValidatorHealth/GetBeaconNodeConnection", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *validatorHealthClient) GetLogsEndpoints(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*LogsEndpointResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/ethereum.validator.accounts.v2.ValidatorHealth/GetLogsEndpoints", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *validatorHealthClient) GetVersion(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*VersionResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/ethereum.validator.accounts.v2.ValidatorHealth/GetVersion", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *validatorHealthClient) StreamBeaconLogs(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (ValidatorHealth_StreamBeaconLogsClient, error) {
	stream, err := c.cc.NewStream(ctx, &_ValidatorHealth_serviceDesc.Streams[0], "/ethereum.validator.accounts.v2.ValidatorHealth/StreamBeaconLogs", opts...)
	if err != nil {
		return nil, err
	}
...
func (x *validatorHealthStreamBeaconLogsClient) Recv() (*v1alpha1.LogsResponse, error) {
...
func (c *validatorHealthClient) StreamValidatorLogs(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (ValidatorHealth_StreamValidatorLogsClient, error) {
	stream, err := c.cc.NewStream(ctx, &_ValidatorHealth_serviceDesc.Streams[1], "/ethereum.validator.accounts.v2.ValidatorHealth/StreamValidatorLogs", opts...)
	if err != nil {
		return nil, err
	}
...
func (x *validatorHealthStreamValidatorLogsClient) Recv() (*v1alpha1.LogsResponse, error) {
	m := new(v1alpha1.LogsResponse)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
func _ValidatorHealth_GetBeaconNodeConnection_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ethereum.validator.accounts.v2.ValidatorHealth/GetBeaconNodeConnection",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _ValidatorHealth_GetLogsEndpoints_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ethereum.validator.accounts.v2.ValidatorHealth/GetLogsEndpoints",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _ValidatorHealth_GetVersion_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ethereum.validator.accounts.v2.ValidatorHealth/GetVersion",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func (x *validatorHealthStreamBeaconLogsServer) Send(m *v1alpha1.LogsResponse) error {
...
func (x *validatorHealthStreamValidatorLogsServer) Send(m *v1alpha1.LogsResponse) error {
	return x.ServerStream.SendMsg(m)
}

var _ValidatorHealth_serviceDesc = grpc.ServiceDesc{
	ServiceName: "ethereum.validator.accounts.v2.ValidatorHealth",
