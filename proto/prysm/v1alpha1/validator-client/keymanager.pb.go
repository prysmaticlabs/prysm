...
type SignRequest struct {
	...
	//	*SignRequest_BlockEip4844
	//	*SignRequest_BlockEip4844Compat
	//	*SignRequest_Sidecar
...
func (x *SignRequest) GetBlockEip4844() *v1alpha1.BeaconBlockWithBlobKZGs {
	if x, ok := x.GetObject().(*SignRequest_BlockEip4844); ok {
		return x.BlockEip4844
	}
	return nil
}

func (x *SignRequest) GetBlockEip4844Compat() *v1alpha1.BeaconBlockWithBlobKZGsCompat {
	if x, ok := x.GetObject().(*SignRequest_BlockEip4844Compat); ok {
		return x.BlockEip4844Compat
	}
	return nil
}
...
type SignRequest_BlockEip4844 struct {
	BlockEip4844 *v1alpha1.BeaconBlockWithBlobKZGs `protobuf:"bytes,114,opt,name=block_eip4844,json=blockEip4844,proto3,oneof"`
}

type SignRequest_BlockEip4844Compat struct {
	BlockEip4844Compat *v1alpha1.BeaconBlockWithBlobKZGsCompat `protobuf:"bytes,115,opt,name=block_eip4844_compat,json=blockEip4844Compat,proto3,oneof"`
}

type SignRequest_Sidecar struct {
	Sidecar *v1alpha1.BlobsSidecar `protobuf:"bytes,116,opt,name=sidecar,proto3,oneof"`
}
...
func (*SignRequest_BlockEip4844) isSignRequest_Object() {}

func (*SignRequest_BlockEip4844Compat) isSignRequest_Object() {}
...
var file_proto_prysm_v1alpha1_validator_client_keymanager_proto_rawDesc = []byte{
	...
	0x63, 0x4b, 0x65, 0x79, 0x73, 0x22, 0x88, 0x0d, 0x0a, 0x0b, 0x53, 0x69, 0x67, 0x6e, 0x52, 0x65,
	...
	0x52, 0x0c, 0x72, 0x65, 0x67, 0x69, 0x73, 0x74, 0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x55,
	0x0a, 0x0d, 0x62, 0x6c, 0x6f, 0x63, 0x6b, 0x5f, 0x65, 0x69, 0x70, 0x34, 0x38, 0x34, 0x34, 0x18,
	0x72, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x2e, 0x2e, 0x65, 0x74, 0x68, 0x65, 0x72, 0x65, 0x75, 0x6d,
	...
	0x62, 0x4b, 0x5a, 0x47, 0x73, 0x48, 0x00, 0x52, 0x0c, 0x62, 0x6c, 0x6f, 0x63, 0x6b, 0x45, 0x69,
	0x70, 0x34, 0x38, 0x34, 0x34, 0x12, 0x68, 0x0a, 0x14, 0x62, 0x6c, 0x6f, 0x63, 0x6b, 0x5f, 0x65,
	0x69, 0x70, 0x34, 0x38, 0x34, 0x34, 0x5f, 0x63, 0x6f, 0x6d, 0x70, 0x61, 0x74, 0x18, 0x73, 0x20,
	...
	0x5a, 0x47, 0x73, 0x43, 0x6f, 0x6d, 0x70, 0x61, 0x74, 0x48, 0x00, 0x52, 0x12, 0x62, 0x6c, 0x6f,
	0x63, 0x6b, 0x45, 0x69, 0x70, 0x34, 0x38, 0x34, 0x34, 0x43, 0x6f, 0x6d, 0x70, 0x61, 0x74, 0x12,
	0x3f, 0x0a, 0x07, 0x73, 0x69, 0x64, 0x65, 0x63, 0x61, 0x72, 0x18, 0x74, 0x20, 0x01, 0x28, 0x0b,
	...
	0x64, 0x65, 0x63, 0x61, 0x72, 0x48, 0x00, 0x52, 0x07, 0x73, 0x69, 0x64, 0x65, 0x63, 0x61, 0x72,
	...
	0x73, 0x69, 0x67, 0x6e, 0x42, 0xce, 0x01, 0x0a, 0x22, 0x6f, 0x72, 0x67, 0x2e, 0x65, 0x74, 0x68,
	...
	0x6d, 0x61, 0x6e, 0x61, 0x67, 0x65, 0x72, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50, 0x01, 0x5a, 0x53,
...
var file_proto_prysm_v1alpha1_validator_client_keymanager_proto_goTypes = []interface{}{
	...
	(*v1alpha1.BeaconBlockWithBlobKZGsCompat)(nil), // 15: ethereum.eth.v1alpha1.BeaconBlockWithBlobKZGsCompat
	(*v1alpha1.BlobsSidecar)(nil),                  // 16: ethereum.eth.v1alpha1.BlobsSidecar
...
var file_proto_prysm_v1alpha1_validator_client_keymanager_proto_depIdxs = []int32{
	...
	14, // 10: ethereum.validator.accounts.v2.SignRequest.block_eip4844:type_name -> ethereum.eth.v1alpha1.BeaconBlockWithBlobKZGs
	15, // 11: ethereum.validator.accounts.v2.SignRequest.block_eip4844_compat:type_name -> ethereum.eth.v1alpha1.BeaconBlockWithBlobKZGsCompat
	16, // 12: ethereum.validator.accounts.v2.SignRequest.sidecar:type_name -> ethereum.eth.v1alpha1.BlobsSidecar
	0,  // 13: ethereum.validator.accounts.v2.SignResponse.status:type_name -> ethereum.validator.accounts.v2.SignResponse.Status
	17, // 14: ethereum.validator.accounts.v2.RemoteSigner.ListValidatingPublicKeys:input_type -> google.protobuf.Empty
	2,  // 15: ethereum.validator.accounts.v2.RemoteSigner.Sign:input_type -> ethereum.validator.accounts.v2.SignRequest
	1,  // 16: ethereum.validator.accounts.v2.RemoteSigner.ListValidatingPublicKeys:output_type -> ethereum.validator.accounts.v2.ListPublicKeysResponse
	3,  // 17: ethereum.validator.accounts.v2.RemoteSigner.Sign:output_type -> ethereum.validator.accounts.v2.SignResponse
...
func file_proto_prysm_v1alpha1_validator_client_keymanager_proto_init() {
	...
	file_proto_prysm_v1alpha1_validator_client_keymanager_proto_msgTypes[1].OneofWrappers = []interface{}{
		...
		(*SignRequest_BlockEip4844)(nil),
		(*SignRequest_BlockEip4844Compat)(nil),
