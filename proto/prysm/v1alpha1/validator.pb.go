...
type GenericValidator struct {
	...
	Block isGenericValidator_Block `protobuf_oneof:"block"`
}
...
func (m *GenericValidator) GetBlock() isGenericValidator_Block {
	if m != nil {
		return m.Block
	}
	return nil
...
func (x *GenericValidator) GetPhase0() *Validator {
	if x, ok := x.GetBlock().(*GenericValidator_Phase0); ok {
		return x.Phase0
	}
	return nil
}
...
func (x *GenericValidator) GetEpbs() *ValidatorEpbs {
	if x, ok := x.GetBlock().(*GenericValidator_Epbs); ok {
		return x.Epbs
	}
	return nil
}

type isGenericValidator_Block interface {
	isGenericValidator_Block()
}

type GenericValidator_Phase0 struct {
	// Representing a phase 0 validator.
	Phase0 *Validator `protobuf:"bytes,1,opt,name=phase0,proto3,oneof"`
}

type GenericValidator_Epbs struct {
	// Representing a post-epbs fork validator.
	Epbs *ValidatorEpbs `protobuf:"bytes,2,opt,name=epbs,proto3,oneof"`
}

func (*GenericValidator_Phase0) isGenericValidator_Block() {}

func (*GenericValidator_Epbs) isGenericValidator_Block() {}
...
// The Validator post Epbs, changes slashed to keep track of categories
...
func (x *ValidatorEpbs) GetActivationEligibilityEpoch() uint64 {
	if x != nil {
		return x.ActivationEligibilityEpoch
	}
	return 0
...
func (x *ValidatorEpbs) GetActivationEpoch() uint64 {
	if x != nil {
		return x.ActivationEpoch
	}
	return 0
...
func (x *ValidatorEpbs) GetExitEpoch() uint64 {
	if x != nil {
		return x.ExitEpoch
	}
	return 0
...
func (x *ValidatorEpbs) GetWithdrawableEpoch() uint64 {
	if x != nil {
		return x.WithdrawableEpoch
	}
	return 0
...
var file_proto_prysm_v1alpha1_validator_proto_rawDesc = []byte{
	...
	0x67, 0x67, 0x72, 0x65, 0x67, 0x61, 0x74, 0x6f, 0x72, 0x22, 0x93, 0x01, 0x0a, 0x10, 0x47, 0x65,
	...
	0x52, 0x04, 0x65, 0x70, 0x62, 0x73, 0x42, 0x07, 0x0a, 0x05, 0x62, 0x6c, 0x6f, 0x63, 0x6b, 0x22,
	...
	0x22, 0xa2, 0x05, 0x0a, 0x0d, 0x56, 0x61, 0x6c, 0x69, 0x64, 0x61, 0x74, 0x6f, 0x72, 0x45, 0x70,
	0x62, 0x73, 0x12, 0x2f, 0x0a, 0x0a, 0x70, 0x75, 0x62, 0x6c, 0x69, 0x63, 0x5f, 0x6b, 0x65, 0x79,
	...
	0x18, 0x0a, 0x07, 0x73, 0x6c, 0x61, 0x73, 0x68, 0x65, 0x64, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0d,
	...
	0x75, 0x70, 0x6c, 0x69, 0x63, 0x61, 0x74, 0x65, 0x45, 0x78, 0x69, 0x73, 0x74, 0x73, 0x22, 0x3e,
	...
	0x45, 0x50, 0x4f, 0x53, 0x49, 0x54, 0x45, 0x44, 0x10, 0x08, 0x32, 0x99, 0x24, 0x0a, 0x13, 0x42,
	...
	0x75, 0x74, 0x69, 0x65, 0x73, 0x12, 0x8f, 0x01, 0x0a, 0x0c, 0x53, 0x74, 0x72, 0x65, 0x61, 0x6d,
	...
	0x61, 0x6d, 0x88, 0x02, 0x01, 0x30, 0x01, 0x12, 0x81, 0x01, 0x0a, 0x0a, 0x44, 0x6f, 0x6d, 0x61,
	...
	0x66, 0x12, 0xa1, 0x01, 0x0a, 0x12, 0x53, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x42, 0x6c, 0x6f, 0x63,
