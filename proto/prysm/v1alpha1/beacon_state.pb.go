...
type BeaconStateCapella struct {
	...
	NextSyncCommittee                   *SyncCommittee                                                           `protobuf:"bytes,9003,opt,name=next_sync_committee,json=nextSyncCommittee,proto3" json:"next_sync_committee,omitempty"`
	LatestExecutionPayloadHeader        *v1.ExecutionPayloadHeader                                               `protobuf:"bytes,10001,opt,name=latest_execution_payload_header,json=latestExecutionPayloadHeader,proto3" json:"latest_execution_payload_header,omitempty"`
	WithdrawalQueue                     []*Withdrawal                                                            `protobuf:"bytes,11001,rep,name=withdrawal_queue,json=withdrawalQueue,proto3" json:"withdrawal_queue,omitempty" ssz-max:"1099511627776"`
...
func (x *BeaconStateCapella) GetWithdrawalQueue() []*Withdrawal {
	if x != nil {
...
var file_proto_prysm_v1alpha1_beacon_state_proto_rawDesc = []byte{
	...
	0x79, 0x6c, 0x6f, 0x61, 0x64, 0x48, 0x65, 0x61, 0x64, 0x65, 0x72, 0x22, 0x81, 0x11, 0x0a, 0x12,
	...
	0x65, 0x72, 0x12, 0x60, 0x0a, 0x10, 0x77, 0x69, 0x74, 0x68, 0x64, 0x72, 0x61, 0x77, 0x61, 0x6c,
	0x5f, 0x71, 0x75, 0x65, 0x75, 0x65, 0x18, 0xf9, 0x55, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x21, 0x2e,
	0x65, 0x74, 0x68, 0x65, 0x72, 0x65, 0x75, 0x6d, 0x2e, 0x65, 0x74, 0x68, 0x2e, 0x76, 0x31, 0x61,
	0x6c, 0x70, 0x68, 0x61, 0x31, 0x2e, 0x57, 0x69, 0x74, 0x68, 0x64, 0x72, 0x61, 0x77, 0x61, 0x6c,
	0x42, 0x11, 0x92, 0xb5, 0x18, 0x0d, 0x31, 0x30, 0x39, 0x39, 0x35, 0x31, 0x31, 0x36, 0x32, 0x37,
	...
	0x61, 0x77, 0x61, 0x6c, 0x49, 0x6e, 0x64, 0x65, 0x78, 0x12, 0xa3, 0x01, 0x0a, 0x27, 0x6e, 0x65,
	...
	0x69, 0x6e, 0x64, 0x65, 0x78, 0x18, 0xfb, 0x55, 0x20, 0x01, 0x28, 0x04, 0x42, 0x4c, 0x82, 0xb5,
	...
	0x64, 0x61, 0x74, 0x6f, 0x72, 0x49, 0x6e, 0x64, 0x65, 0x78, 0x52, 0x23, 0x6e, 0x65, 0x78, 0x74,
...
var file_proto_prysm_v1alpha1_beacon_state_proto_goTypes = []interface{}{
	...
	(*Withdrawal)(nil),                  // 21: ethereum.eth.v1alpha1.Withdrawal
}
var file_proto_prysm_v1alpha1_beacon_state_proto_depIdxs = []int32{
	...
	21, // 44: ethereum.eth.v1alpha1.BeaconStateCapella.withdrawal_queue:type_name -> ethereum.eth.v1alpha1.Withdrawal
