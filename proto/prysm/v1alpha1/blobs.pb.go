...
func (x *DeprecatedBlobSidecar) GetSlot() github_com_prysmaticlabs_prysm_v4_consensus_types_primitives.Slot {
	if x != nil {
		return x.Slot
	}
...
func (x *DeprecatedBlobSidecar) GetProposerIndex() github_com_prysmaticlabs_prysm_v4_consensus_types_primitives.ValidatorIndex {
	if x != nil {
...
func file_proto_prysm_v1alpha1_blobs_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_proto_prysm_v1alpha1_blobs_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*DeprecatedBlobSidecar); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
