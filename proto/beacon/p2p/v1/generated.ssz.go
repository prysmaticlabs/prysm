...
func (b *BeaconState) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	// Field (21) 'ShardGasPrice'
	dst = ssz.MarshalUint64(dst, b.ShardGasPrice)

	// Field (22) 'CurrentEpochStartShard'
...
func (b *BeaconState) UnmarshalSSZ(buf []byte) error {
	...
	// Field (21) 'ShardGasPrice'
	b.ShardGasPrice = ssz.UnmarshallUint64(buf[2687377:2687385])

	// Field (22) 'CurrentEpochStartShard'
	b.CurrentEpochStartShard = ssz.UnmarshallUint64(buf[2687385:2687393])
