...
type BeaconStateResponse struct {
	...
	FinalizedBlock       *BeaconBlock `protobuf:"bytes,2,opt,name=finalized_block,json=finalizedBlock,proto3" json:"finalized_block,omitempty"`
	XXX_NoUnkeyedLiteral struct{}     `json:"-"`
	XXX_unrecognized     []byte       `json:"-"`
	XXX_sizecache        int32        `json:"-"`
}
...
func (m *BeaconStateResponse) GetFinalizedBlock() *BeaconBlock {
	if m != nil {
