...
type ChainHeadResponse struct {
	HighestSlot               uint64   `protobuf:"varint,1,opt,name=highest_slot,json=highestSlot,proto3" json:"highest_slot,omitempty"`
	HighestStateRootHash32    []byte   `protobuf:"bytes,2,opt,name=highest_state_root_hash32,json=highestStateRootHash32,proto3" json:"highest_state_root_hash32,omitempty"`
...
func (m *ChainHeadResponse) GetHighestSlot() uint64 {
	if m != nil {
...
func (m *ChainHeadResponse) GetHighestStateRootHash32() []byte {
	if m != nil {
		return m.HighestStateRootHash32
	}
	return nil
}
...
var fileDescriptor_a1d590cda035b632 = []byte{
	...
	,
}
...
func (m *ChainHeadResponse) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.HighestSlot != 0 {
		dAtA[i] = 0x8
		i++
		i = encodeVarintMessages(dAtA, i, uint64(m.HighestSlot))
	}
	if len(m.HighestStateRootHash32) > 0 {
		dAtA[i] = 0x12
		i++
		i = encodeVarintMessages(dAtA, i, uint64(len(m.HighestStateRootHash32)))
		i += copy(dAtA[i:], m.HighestStateRootHash32)
	}
...
func (m *ChainHeadResponse) Size() (n int) {
	...
	_ = l
	if m.HighestSlot != 0 {
		n += 1 + sovMessages(uint64(m.HighestSlot))
	}
	l = len(m.HighestStateRootHash32)
	if l > 0 {
		n += 1 + l + sovMessages(uint64(l))
	}
...
func (m *ChainHeadResponse) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field HighestSlot", wireType)
			}
			m.HighestSlot = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.HighestSlot |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field HighestStateRootHash32", wireType)
			}
			var byteLen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.HighestStateRootHash32 = append(m.HighestStateRootHash32[:0], dAtA[iNdEx:postIndex]...)
			if m.HighestStateRootHash32 == nil {
				m.HighestStateRootHash32 = []byte{}
			}
			iNdEx = postIndex
		case 3:
			if wireType != 2 {
