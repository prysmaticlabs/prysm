...
type BatchedBeaconBlockRequest struct {
	FinalizedRoot        []byte   `protobuf:"bytes,1,opt,name=finalized_root,json=finalizedRoot,proto3" json:"finalized_root,omitempty"`
	HeadRoot             []byte   `protobuf:"bytes,2,opt,name=head_root,json=headRoot,proto3" json:"head_root,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *BatchedBeaconBlockRequest) GetHeadRoot() []byte {
	if m != nil {
		return m.HeadRoot
	}
	return nil
...
var fileDescriptor_a1d590cda035b632 = []byte{
	...
	,
}
