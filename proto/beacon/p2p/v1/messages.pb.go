...
type ChainHeadResponse struct {
	...
	FinalizedStateRoot   []byte   `protobuf:"bytes,3,opt,name=finalized_state_root,json=finalizedStateRoot,proto3" json:"finalized_state_root,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *ChainHeadResponse) GetFinalizedStateRoot() []byte {
	if m != nil {
...
type BeaconStateRequest struct {
	FinalizedStateRoot   []byte   `protobuf:"bytes,1,opt,name=finalized_state_root,json=finalizedStateRoot,proto3" json:"finalized_state_root,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *BeaconStateRequest) GetFinalizedStateRoot() []byte {
	if m != nil {
		return m.FinalizedStateRoot
	}
	return nil
...
func (m *UnseenAttestationsRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_UnseenAttestationsRequest.Merge(m, src)
}
...
func (m *UnseenAttestationResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_UnseenAttestationResponse.Merge(m, src)
}
...
var fileDescriptor_a1d590cda035b632 = []byte{
	...
	,
}
...
func (m *ChainHeadResponse) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.FinalizedStateRoot) > 0 {
		dAtA[i] = 0x1a
		i++
		i = encodeVarintMessages(dAtA, i, uint64(len(m.FinalizedStateRoot)))
		i += copy(dAtA[i:], m.FinalizedStateRoot)
	}
	if m.XXX_unrecognized != nil {
		i += copy(dAtA[i:], m.XXX_unrecognized)
	}
