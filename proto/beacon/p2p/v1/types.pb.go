...
func (*BeaconState) Descriptor() ([]byte, []int) {
	...
	return fileDescriptor_types_46fec8bcfe502972, []int{0}
...
type POWDepositState struct {
	...
	DepositTrie          []byte   `protobuf:"bytes,3,opt,name=deposit_trie,json=depositTrie,proto3" json:"deposit_trie,omitempty"`
	DepositCount         uint64   `protobuf:"varint,4,opt,name=deposit_count,json=depositCount,proto3" json:"deposit_count,omitempty"`
	PendingDepositsCount uint64   `protobuf:"varint,5,opt,name=pending_deposits_count,json=pendingDepositsCount,proto3" json:"pending_deposits_count,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (*POWDepositState) Descriptor() ([]byte, []int) {
	return fileDescriptor_types_46fec8bcfe502972, []int{1}
}
...
func (dst *POWDepositState) XXX_Merge(src proto.Message) {
	xxx_messageInfo_POWDepositState.Merge(dst, src)
}
...
func (m *POWDepositState) GetDepositTrie() []byte {
	if m != nil {
...
func (m *POWDepositState) GetPendingDepositsCount() uint64 {
	if m != nil {
		return m.PendingDepositsCount
	}
	return 0
}
...
func (*Fork) Descriptor() ([]byte, []int) {
	...
	return fileDescriptor_types_46fec8bcfe502972, []int{2}
...
func (*PendingAttestation) Descriptor() ([]byte, []int) {
	...
	return fileDescriptor_types_46fec8bcfe502972, []int{3}
...
func (*Attestation) Descriptor() ([]byte, []int) {
	...
	return fileDescriptor_types_46fec8bcfe502972, []int{4}
...
func (*AttestationData) Descriptor() ([]byte, []int) {
	...
	return fileDescriptor_types_46fec8bcfe502972, []int{5}
...
func (*AttestationDataAndCustodyBit) Descriptor() ([]byte, []int) {
	...
	return fileDescriptor_types_46fec8bcfe502972, []int{6}
...
func (*Validator) Descriptor() ([]byte, []int) {
	...
	return fileDescriptor_types_46fec8bcfe502972, []int{7}
...
func (*ShardReassignmentRecord) Descriptor() ([]byte, []int) {
	...
	return fileDescriptor_types_46fec8bcfe502972, []int{8}
...
func (*Crosslink) Descriptor() ([]byte, []int) {
	...
	return fileDescriptor_types_46fec8bcfe502972, []int{9}
...
func (*BeaconBlock) Descriptor() ([]byte, []int) {
	...
	return fileDescriptor_types_46fec8bcfe502972, []int{10}
...
func (*BeaconBlockBody) Descriptor() ([]byte, []int) {
	...
	return fileDescriptor_types_46fec8bcfe502972, []int{11}
...
func (*DepositInput) Descriptor() ([]byte, []int) {
	...
	return fileDescriptor_types_46fec8bcfe502972, []int{12}
...
func (*ProposalSignedData) Descriptor() ([]byte, []int) {
	...
	return fileDescriptor_types_46fec8bcfe502972, []int{13}
...
func (*SlashableAttestation) Descriptor() ([]byte, []int) {
	...
	return fileDescriptor_types_46fec8bcfe502972, []int{14}
...
func (*DepositData) Descriptor() ([]byte, []int) {
	...
	return fileDescriptor_types_46fec8bcfe502972, []int{15}
...
func (*ProposerSlashing) Descriptor() ([]byte, []int) {
	...
	return fileDescriptor_types_46fec8bcfe502972, []int{16}
...
func (*AttesterSlashing) Descriptor() ([]byte, []int) {
	...
	return fileDescriptor_types_46fec8bcfe502972, []int{17}
...
func (*Deposit) Descriptor() ([]byte, []int) {
	...
	return fileDescriptor_types_46fec8bcfe502972, []int{18}
...
func (*VoluntaryExit) Descriptor() ([]byte, []int) {
	...
	return fileDescriptor_types_46fec8bcfe502972, []int{19}
...
func (*Eth1Data) Descriptor() ([]byte, []int) {
	...
	return fileDescriptor_types_46fec8bcfe502972, []int{20}
...
func (*Eth1DataVote) Descriptor() ([]byte, []int) {
	...
	return fileDescriptor_types_46fec8bcfe502972, []int{21}
...
func (m *POWDepositState) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.DepositTrie) > 0 {
		dAtA[i] = 0x1a
		i++
		i = encodeVarintTypes(dAtA, i, uint64(len(m.DepositTrie)))
		i += copy(dAtA[i:], m.DepositTrie)
	}
	if m.DepositCount != 0 {
		dAtA[i] = 0x20
		i++
	...
	if m.PendingDepositsCount != 0 {
		dAtA[i] = 0x28
		i++
		i = encodeVarintTypes(dAtA, i, uint64(m.PendingDepositsCount))
	}
	if m.XXX_unrecognized != nil {
		i += copy(dAtA[i:], m.XXX_unrecognized)
	}
...
func (m *POWDepositState) Size() (n int) {
	...
	if m.PendingDepositsCount != 0 {
		n += 1 + sovTypes(uint64(m.PendingDepositsCount))
	}
	if m.XXX_unrecognized != nil {
		n += len(m.XXX_unrecognized)
	}
...
func (m *POWDepositState) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			...
			m.DepositTrie = append(m.DepositTrie[:0], dAtA[iNdEx:postIndex]...)
		...
		case 5:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field PendingDepositsCount", wireType)
			}
			m.PendingDepositsCount = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowTypes
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.PendingDepositsCount |= (uint64(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func init() {
	proto.RegisterFile("proto/beacon/p2p/v1/types.proto", fileDescriptor_types_a13fc60d9be92e55)
}

var fileDescriptor_types_a13fc60d9be92e55 = []byte{
	// 1939 bytes of a gzipped FileDescriptorProto
	0x1f, 0x8b, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0xff, 0xd4, 0x58, 0xcb, 0x6f, 0x23, 0x49,
	0x19, 0xa7, 0xed, 0x3c, 0x3f, 0x3b, 0xb1, 0x53, 0x99, 0xc4, 0xcd, 0xbc, 0x92, 0xe9, 0xd9, 0xd5,
	0x64, 0x86, 0x5d, 0x07, 0x7b, 0x25, 0x46, 0x30, 0xac, 0x44, 0x3c, 0xc9, 0xb2, 0x81, 0xd9, 0xdd,
