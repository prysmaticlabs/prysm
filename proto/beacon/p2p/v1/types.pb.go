...
type BeaconState struct {
	...
	Validators                  []*Validator          `protobuf:"bytes,2001,rep,name=validators,proto3" json:"validators,omitempty" ssz:"size=1099511627776"`
	Balances                    []uint64              `protobuf:"varint,2002,rep,packed,name=balances,proto3" json:"balances,omitempty" ssz:"size=1099511627776"`
	...
	CompactCommitteesRoots      [][]byte              `protobuf:"bytes,3003,rep,name=compact_committees_roots,json=compactCommitteesRoots,proto3" json:"compact_committees_roots,omitempty" ssz:"size=8192,32"`
	PreviousEpochAttestations   []*PendingAttestation `protobuf:"bytes,4001,rep,name=previous_epoch_attestations,json=previousEpochAttestations,proto3" json:"previous_epoch_attestations,omitempty" ssz:"size=8192"`
	CurrentEpochAttestations    []*PendingAttestation `protobuf:"bytes,4002,rep,name=current_epoch_attestations,json=currentEpochAttestations,proto3" json:"current_epoch_attestations,omitempty" ssz:"size=8192"`
	JustificationBits           uint64                `protobuf:"varint,4003,opt,name=justification_bits,json=justificationBits,proto3" json:"justification_bits,omitempty"`
	PreviousJustifiedCheckpoint *Checkpoint           `protobuf:"bytes,4004,opt,name=previous_justified_checkpoint,json=previousJustifiedCheckpoint,proto3" json:"previous_justified_checkpoint,omitempty"`
	CurrentJustifiedCheckpoint  *Checkpoint           `protobuf:"bytes,4005,opt,name=current_justified_checkpoint,json=currentJustifiedCheckpoint,proto3" json:"current_justified_checkpoint,omitempty"`
	FinalizedCheckpoint         *Checkpoint           `protobuf:"bytes,4006,opt,name=finalized_checkpoint,json=finalizedCheckpoint,proto3" json:"finalized_checkpoint,omitempty"`
	...
	Slashings                   []uint64              `protobuf:"varint,5006,rep,packed,name=slashings,proto3" json:"slashings,omitempty" ssz:"size=8192"`
	...
	HistoricalRoots             [][]byte              `protobuf:"bytes,5008,rep,name=historical_roots,json=historicalRoots,proto3" json:"historical_roots,omitempty" ssz:"size=16777216,32"`
	Eth1Data                    *Eth1Data             `protobuf:"bytes,6001,opt,name=eth1_data,json=eth1Data,proto3" json:"eth1_data,omitempty"`
	Eth1DataVotes               []*Eth1Data           `protobuf:"bytes,6002,rep,name=eth1_data_votes,json=eth1DataVotes,proto3" json:"eth1_data_votes,omitempty" ssz:"size=1024"`
...
func (m *BeaconState) GetJustificationBits() uint64 {
	if m != nil {
...
type PendingAttestation struct {
	AggregationBits      []byte           `protobuf:"bytes,1,opt,name=aggregation_bits,json=aggregationBits,proto3" json:"aggregation_bits,omitempty" ssz:"size=4096"`
...
type Attestation struct {
	...
	AggregationBits      []byte           `protobuf:"bytes,2,opt,name=aggregation_bits,json=aggregationBits,proto3" json:"aggregation_bits,omitempty" ssz:"size=4096"`
	CustodyBits          []byte           `protobuf:"bytes,3,opt,name=custody_bits,json=custodyBits,proto3" json:"custody_bits,omitempty" ssz:"size=4096"`
...
type AttestationData struct {
	...
	SourceEpoch          uint64      `protobuf:"varint,1001,opt,name=source_epoch,json=sourceEpoch,proto3" json:"source_epoch,omitempty"`
	SourceRoot           []byte      `protobuf:"bytes,1002,opt,name=source_root,json=sourceRoot,proto3" json:"source_root,omitempty"`
	TargetEpoch          uint64      `protobuf:"varint,1003,opt,name=target_epoch,json=targetEpoch,proto3" json:"target_epoch,omitempty"`
	TargetRoot           []byte      `protobuf:"bytes,1004,opt,name=target_root,json=targetRoot,proto3" json:"target_root,omitempty"`
	XXX_NoUnkeyedLiteral struct{}    `json:"-"`
	XXX_unrecognized     []byte      `json:"-"`
	XXX_sizecache        int32       `json:"-"`
}
...
type IndexedAttestation struct {
	CustodyBit_0Indices  []uint64         `protobuf:"varint,1,rep,packed,name=custody_bit_0_indices,json=custodyBit0Indices,proto3" json:"custody_bit_0_indices,omitempty" ssz:"size=4096"`
	CustodyBit_1Indices  []uint64         `protobuf:"varint,2,rep,packed,name=custody_bit_1_indices,json=custodyBit1Indices,proto3" json:"custody_bit_1_indices,omitempty" ssz:"size=4096"`
...
type BeaconBlockBody struct {
	...
	ProposerSlashings    []*ProposerSlashing `protobuf:"bytes,4,rep,name=proposer_slashings,json=proposerSlashings,proto3" json:"proposer_slashings,omitempty" ssz:"size=16"`
	AttesterSlashings    []*AttesterSlashing `protobuf:"bytes,5,rep,name=attester_slashings,json=attesterSlashings,proto3" json:"attester_slashings,omitempty" ssz:"size=1"`
	Attestations         []*Attestation      `protobuf:"bytes,6,rep,name=attestations,proto3" json:"attestations,omitempty" ssz:"size=128"`
	Deposits             []*Deposit          `protobuf:"bytes,7,rep,name=deposits,proto3" json:"deposits,omitempty" ssz:"size=16"`
	VoluntaryExits       []*VoluntaryExit    `protobuf:"bytes,8,rep,name=voluntary_exits,json=voluntaryExits,proto3" json:"voluntary_exits,omitempty" ssz:"size=16"`
	Transfers            []*Transfer         `protobuf:"bytes,9,rep,name=transfers,proto3" json:"transfers,omitempty" ssz:"size=0"`
	XXX_NoUnkeyedLiteral struct{}            `json:"-"`
	XXX_unrecognized     []byte              `json:"-"`
	XXX_sizecache        int32               `json:"-"`
}
...
type SlashableAttestation struct {
	...
	CustodyBits          []byte           `protobuf:"bytes,2,opt,name=custody_bits,json=custodyBits,proto3" json:"custody_bits,omitempty"`
	Data                 *AttestationData `protobuf:"bytes,3,opt,name=data,proto3" json:"data,omitempty"`
	Signature            []byte           `protobuf:"bytes,4,opt,name=signature,proto3" json:"signature,omitempty" ssz:"size=96"`
	XXX_NoUnkeyedLiteral struct{}         `json:"-"`
	XXX_unrecognized     []byte           `json:"-"`
...
type CompactCommittee struct {
	Pubkeys              [][]byte `protobuf:"bytes,1,rep,name=pubkeys,proto3" json:"pubkeys,omitempty" ssz:"size=4096,48"`
...
var fileDescriptor_e719e7d82cfa7b0d = []byte{
	...
	,
}
...
func (m *BeaconState) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.JustificationBits != 0 {
		...
		dAtA[i] = 0x1
		i++
		i = encodeVarintTypes(dAtA, i, uint64(m.JustificationBits))
	}
	if m.PreviousJustifiedCheckpoint != nil {
		...
		n4, err := m.PreviousJustifiedCheckpoint.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n4
	...
	if m.CurrentJustifiedCheckpoint != nil {
		...
		n5, err := m.CurrentJustifiedCheckpoint.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n5
	...
	if m.FinalizedCheckpoint != nil {
		...
		n6, err := m.FinalizedCheckpoint.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n6
	...
	if len(m.Slashings) > 0 {
		dAtA8 := make([]byte, len(m.Slashings)*10)
		var j7 int
	...
	if m.LatestBlockHeader != nil {
		...
		n9, err := m.LatestBlockHeader.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n9
...
func (m *SlashableAttestation) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.ValidatorIndices) > 0 {
		dAtA25 := make([]byte, len(m.ValidatorIndices)*10)
		var j24 int
...
func (m *ProposerSlashing) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Header_1 != nil {
		...
		n27, err := m.Header_1.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n27
	...
	if m.Header_2 != nil {
		...
		n28, err := m.Header_2.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n28
...
func (m *CompactCommittee) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.CompactValidators) > 0 {
		dAtA34 := make([]byte, len(m.CompactValidators)*10)
		var j33 int
...
func (m *BeaconState) Size() (n int) {
	...
	if m.JustificationBits != 0 {
		n += 3 + sovTypes(uint64(m.JustificationBits))
	}
	if m.PreviousJustifiedCheckpoint != nil {
	...
	for iNdEx < l {
		...
		case 4003:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.JustificationBits |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
