...
func (ValidatorRole) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_services_0504b7df1bce5bb6, []int{0}
}
...
func (*ProposeResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_services_0504b7df1bce5bb6, []int{1}
}
...
func (*POWChainResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_services_0504b7df1bce5bb6, []int{2}
}
...
func (*ProposerIndexRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_services_0504b7df1bce5bb6, []int{3}
}
...
func (*StateRootResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_services_0504b7df1bce5bb6, []int{4}
}
...
func (*AttestRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_services_0504b7df1bce5bb6, []int{5}
}
...
func (*AttestResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_services_0504b7df1bce5bb6, []int{6}
}
...
func (*ValidatorAssignmentRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_services_0504b7df1bce5bb6, []int{7}
}
...
func (*ValidatorAssignmentResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_services_0504b7df1bce5bb6, []int{8}
}
...
func (*Assignment) Descriptor() ([]byte, []int) {
	return fileDescriptor_services_0504b7df1bce5bb6, []int{9}
}
...
func (*PublicKey) Descriptor() ([]byte, []int) {
	return fileDescriptor_services_0504b7df1bce5bb6, []int{10}
}
...
func (*SlotResponsibilityResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_services_0504b7df1bce5bb6, []int{11}
}
...
func (*IndexResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_services_0504b7df1bce5bb6, []int{12}
}
...
func (*ShardIDResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_services_0504b7df1bce5bb6, []int{13}
}
...
func (*CurrentAssignmentsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_services_0504b7df1bce5bb6, []int{14}
}
...
type ValidatorEpochAssignmentRequest struct {
	EpochStart           uint64     `protobuf:"varint,1,opt,name=epoch_start,json=epochStart,proto3" json:"epoch_start,omitempty"`
	PubKey               *PublicKey `protobuf:"bytes,2,opt,name=pub_key,json=pubKey" json:"pub_key,omitempty"`
	XXX_NoUnkeyedLiteral struct{}   `json:"-"`
	XXX_unrecognized     []byte     `json:"-"`
	XXX_sizecache        int32      `json:"-"`
}

func (m *ValidatorEpochAssignmentRequest) Reset()         { *m = ValidatorEpochAssignmentRequest{} }
func (m *ValidatorEpochAssignmentRequest) String() string { return proto.CompactTextString(m) }
func (*ValidatorEpochAssignmentRequest) ProtoMessage()    {}
func (*ValidatorEpochAssignmentRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_services_0504b7df1bce5bb6, []int{15}
}
func (m *ValidatorEpochAssignmentRequest) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *ValidatorEpochAssignmentRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_ValidatorEpochAssignmentRequest.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalTo(b)
		if err != nil {
...
func (dst *ValidatorEpochAssignmentRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ValidatorEpochAssignmentRequest.Merge(dst, src)
}
func (m *ValidatorEpochAssignmentRequest) XXX_Size() int {
	return m.Size()
}
func (m *ValidatorEpochAssignmentRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_ValidatorEpochAssignmentRequest.DiscardUnknown(m)
}

var xxx_messageInfo_ValidatorEpochAssignmentRequest proto.InternalMessageInfo

func (m *ValidatorEpochAssignmentRequest) GetEpochStart() uint64 {
	if m != nil {
		return m.EpochStart
	}
	return 0
...
func (m *ValidatorEpochAssignmentRequest) GetPubKey() *PublicKey {
	if m != nil {
		return m.PubKey
	}
	return nil
...
func (*ValidatorEpochAssignmentsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_services_0504b7df1bce5bb6, []int{16}
}
...
func init() {
	...
	proto.RegisterType((*ValidatorEpochAssignmentRequest)(nil), "ethereum.beacon.rpc.v1.ValidatorEpochAssignmentRequest")
...
type ValidatorServiceClient interface {
	...
	ValidatorEpochAssignments(ctx context.Context, in *ValidatorEpochAssignmentRequest, opts ...grpc.CallOption) (*ValidatorEpochAssignmentsResponse, error)
}
...
func (c *validatorServiceClient) ValidatorEpochAssignments(ctx context.Context, in *ValidatorEpochAssignmentRequest, opts ...grpc.CallOption) (*ValidatorEpochAssignmentsResponse, error) {
...
type ValidatorServiceServer interface {
	...
	ValidatorEpochAssignments(context.Context, *ValidatorEpochAssignmentRequest) (*ValidatorEpochAssignmentsResponse, error)
}
...
func _ValidatorService_ValidatorEpochAssignments_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ValidatorEpochAssignmentRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ValidatorServiceServer).ValidatorEpochAssignments(ctx, req.(*ValidatorEpochAssignmentRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func (m *ValidatorEpochAssignmentRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *ValidatorEpochAssignmentRequest) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	...
	if m.PubKey != nil {
		dAtA[i] = 0x12
		i++
		i = encodeVarintServices(dAtA, i, uint64(m.PubKey.Size()))
		n7, err := m.PubKey.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n7
...
func (m *ValidatorEpochAssignmentRequest) Size() (n int) {
	var l int
	_ = l
	if m.EpochStart != 0 {
...
func (m *ValidatorEpochAssignmentRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ValidatorEpochAssignmentRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ValidatorEpochAssignmentRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
...
func init() {
	proto.RegisterFile("proto/beacon/rpc/v1/services.proto", fileDescriptor_services_0504b7df1bce5bb6)
}

var fileDescriptor_services_0504b7df1bce5bb6 = []byte{
	...
	,
}
