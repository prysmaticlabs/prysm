...
func (ValidatorRole) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_services_fe9c9e65cdee4f41, []int{0}
}
...
func (*ProposeResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_services_fe9c9e65cdee4f41, []int{1}
}
...
func (*POWChainResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_services_fe9c9e65cdee4f41, []int{2}
}
...
func (*ProposerIndexRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_services_fe9c9e65cdee4f41, []int{3}
}
...
func (*StateRootResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_services_fe9c9e65cdee4f41, []int{4}
}
...
func (*AttestRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_services_fe9c9e65cdee4f41, []int{5}
}
...
func (*AttestResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_services_fe9c9e65cdee4f41, []int{6}
}
...
func (*ValidatorAssignmentRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_services_fe9c9e65cdee4f41, []int{7}
}
...
func (*ValidatorAssignmentResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_services_fe9c9e65cdee4f41, []int{8}
}
...
func (*Assignment) Descriptor() ([]byte, []int) {
	return fileDescriptor_services_fe9c9e65cdee4f41, []int{9}
}
...
func (*PublicKey) Descriptor() ([]byte, []int) {
	return fileDescriptor_services_fe9c9e65cdee4f41, []int{10}
}
...
func (*SlotResponsibilityResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_services_fe9c9e65cdee4f41, []int{11}
}
...
func (*IndexResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_services_fe9c9e65cdee4f41, []int{12}
}
...
func (*ShardIDResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_services_fe9c9e65cdee4f41, []int{13}
}
...
func (*CurrentAssignmentsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_services_fe9c9e65cdee4f41, []int{14}
}
...
type ProposerServiceClient interface {
	...
	CurrentPOWChainBlockHash(ctx context.Context, in *types.Empty, opts ...grpc.CallOption) (*POWChainResponse, error)
	ComputeStateRootForBlock(ctx context.Context, in *v1.BeaconBlock, opts ...grpc.CallOption) (*StateRootResponse, error)
...
func (c *proposerServiceClient) CurrentPOWChainBlockHash(ctx context.Context, in *types.Empty, opts ...grpc.CallOption) (*POWChainResponse, error) {
	out := new(POWChainResponse)
	err := c.cc.Invoke(ctx, "/ethereum.beacon.rpc.v1.ProposerService/CurrentPOWChainBlockHash", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *proposerServiceClient) ComputeStateRootForBlock(ctx context.Context, in *v1.BeaconBlock, opts ...grpc.CallOption) (*StateRootResponse, error) {
	out := new(StateRootResponse)
	err := c.cc.Invoke(ctx, "/ethereum.beacon.rpc.v1.ProposerService/ComputeStateRootForBlock", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ProposerServiceServer interface {
	...
	CurrentPOWChainBlockHash(context.Context, *types.Empty) (*POWChainResponse, error)
	ComputeStateRootForBlock(context.Context, *v1.BeaconBlock) (*StateRootResponse, error)
...
func _ProposerService_CurrentPOWChainBlockHash_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(types.Empty)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ProposerServiceServer).CurrentPOWChainBlockHash(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ethereum.beacon.rpc.v1.ProposerService/CurrentPOWChainBlockHash",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ProposerServiceServer).CurrentPOWChainBlockHash(ctx, req.(*types.Empty))
	}
	return interceptor(ctx, in, info, handler)
}

func _ProposerService_ComputeStateRootForBlock_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(v1.BeaconBlock)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ProposerServiceServer).ComputeStateRootForBlock(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ethereum.beacon.rpc.v1.ProposerService/ComputeStateRootForBlock",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ProposerServiceServer).ComputeStateRootForBlock(ctx, req.(*v1.BeaconBlock))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _ProposerService_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "CurrentPOWChainBlockHash",
			Handler:    _ProposerService_CurrentPOWChainBlockHash_Handler,
		},
		{
			MethodName: "ComputeStateRootForBlock",
			Handler:    _ProposerService_ComputeStateRootForBlock_Handler,
		},
		{
...
func init() {
	proto.RegisterFile("proto/beacon/rpc/v1/services.proto", fileDescriptor_services_fe9c9e65cdee4f41)
}

var fileDescriptor_services_fe9c9e65cdee4f41 = []byte{
	...
	,
}
