...
import (
	...
	eth "github.com/prysmaticlabs/prysm/bazel-bin/external/com_github_prysmaticlabs_ethereumapis/eth/v1alpha1/go_proto_/github.com/prysmaticlabs/ethereumapis/eth/v1alpha1"
...
var (
	...
	pattern_Debug_GetInclusionSlot_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"eth", "v1alpha1", "debug", "inclusion"}, "", runtime.AssumeColonVerbOpt(true)))
)
