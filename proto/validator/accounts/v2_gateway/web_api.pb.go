...
type RecoverWalletRequest struct {
	...
	SkipMnemonic25ThWord bool   `protobuf:"varint,6,opt,name=skip_mnemonic25th_word,json=skipMnemonic25thWord,proto3" json:"skip_mnemonic25th_word,omitempty"`
}
...
func (x *RecoverWalletRequest) GetSkipMnemonic25ThWord() bool {
	if x != nil {
		return x.SkipMnemonic25ThWord
	}
	return false
}
...
var file_proto_validator_accounts_v2_web_api_proto_rawDesc = []byte{
	...
	0x63, 0x32, 0x35, 0x74, 0x68, 0x57, 0x6f, 0x72, 0x64, 0x12, 0x34, 0x0a, 0x16, 0x73, 0x6b, 0x69,
	0x70, 0x5f, 0x6d, 0x6e, 0x65, 0x6d, 0x6f, 0x6e, 0x69, 0x63, 0x32, 0x35, 0x74, 0x68, 0x5f, 0x77,
