...
type CreateWalletRequest struct {
	...
	KeystoresImported    [][]byte                           `protobuf:"bytes,6,rep,name=keystores_imported,json=keystoresImported,proto3" json:"keystores_imported,omitempty"`
	KeystoresPassword    [][]byte                           `protobuf:"bytes,7,rep,name=keystores_password,json=keystoresPassword,proto3" json:"keystores_password,omitempty"`
...
func (m *CreateWalletRequest) GetKeystoresImported() [][]byte {
	if m != nil {
...
func (m *CreateWalletRequest) GetKeystoresPassword() [][]byte {
	if m != nil {
...
var fileDescriptor_8a5153635bfe042e = []byte{
	...
	,
}
