...
var file_proto_validator_accounts_v2_web_api_proto_rawDesc = []byte{
	...
	0x64, 0x2f, 0x65, 0x64, 0x69, 0x74, 0x3a, 0x01, 0x2a, 0x32, 0xb4, 0x09, 0x0a, 0x06, 0x42, 0x65,
	...
	0x61, 0x63, 0x6f, 0x6e, 0x2f, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x12, 0xb0, 0x01, 0x0a, 0x0e,
	...
	0x75, 0x6e, 0x74, 0x73, 0x2f, 0x62, 0x61, 0x63, 0x6b, 0x75, 0x70, 0x3a, 0x01, 0x2a, 0x12, 0xb7,
...
var file_proto_validator_accounts_v2_web_api_proto_depIdxs = []int32{
	...
	25, // 11: ethereum.validator.accounts.v2.Beacon.GetBeaconStatus:input_type -> google.protobuf.Empty
	22, // 12: ethereum.validator.accounts.v2.Beacon.BackupAccounts:input_type -> ethereum.validator.accounts.v2.BackupAccountsRequest
	...
	23, // 35: ethereum.validator.accounts.v2.Beacon.BackupAccounts:output_type -> ethereum.validator.accounts.v2.BackupAccountsResponse
...
func (c *beaconClient) BackupAccounts(ctx context.Context, in *BackupAccountsRequest, opts ...grpc.CallOption) (*BackupAccountsResponse, error) {
	out := new(BackupAccountsResponse)
	err := c.cc.Invoke(ctx, "/ethereum.validator.accounts.v2.Beacon/BackupAccounts", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedBeaconServer) BackupAccounts(context.Context, *BackupAccountsRequest) (*BackupAccountsResponse, error) {
...
func _Beacon_BackupAccounts_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(BackupAccountsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(BeaconServer).BackupAccounts(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ethereum.validator.accounts.v2.Beacon/BackupAccounts",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BeaconServer).BackupAccounts(ctx, req.(*BackupAccountsRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _Beacon_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _Beacon_BackupAccounts_Handler,
		},
		{
