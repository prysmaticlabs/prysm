...
type SignRequest_BlockV2 struct {
	BlockV2 *v1alpha1.BeaconBlockAltair `protobuf:"bytes,102,opt,name=blockV2,proto3,oneof"`
}

type SignRequest_AttestationData struct {
	AttestationData *v1alpha1.AttestationData `protobuf:"bytes,103,opt,name=attestation_data,json=attestationData,proto3,oneof"`
}

type SignRequest_AggregateAttestationAndProof struct {
	AggregateAttestationAndProof *v1alpha1.AggregateAttestationAndProof `protobuf:"bytes,104,opt,name=aggregate_attestation_and_proof,json=aggregateAttestationAndProof,proto3,oneof"`
}

type SignRequest_Exit struct {
	Exit *v1alpha1.VoluntaryExit `protobuf:"bytes,105,opt,name=exit,proto3,oneof"`
}

type SignRequest_Slot struct {
	Slot github_com_prysmaticlabs_eth2_types.Slot `protobuf:"varint,106,opt,name=slot,proto3,oneof" cast-type:"github.com/prysmaticlabs/eth2-types.Slot"`
}

type SignRequest_Epoch struct {
	Epoch github_com_prysmaticlabs_eth2_types.Epoch `protobuf:"varint,107,opt,name=epoch,proto3,oneof" cast-type:"github.com/prysmaticlabs/eth2-types.Epoch"`
}
...
var file_proto_validator_accounts_v2_keymanager_proto_rawDesc = []byte{
	...
	0x6b, 0x48, 0x00, 0x52, 0x05, 0x62, 0x6c, 0x6f, 0x63, 0x6b, 0x12, 0x44, 0x0a, 0x07, 0x62, 0x6c,
	0x6f, 0x63, 0x6b, 0x56, 0x32, 0x18, 0x66, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x28, 0x2e, 0x65, 0x74,
	...
	0x64, 0x61, 0x74, 0x61, 0x18, 0x67, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x26, 0x2e, 0x65, 0x74, 0x68,
	...
	0x6e, 0x64, 0x5f, 0x70, 0x72, 0x6f, 0x6f, 0x66, 0x18, 0x68, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x33,
	...
	0x41, 0x74, 0x74, 0x65, 0x73, 0x74, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x41, 0x6e, 0x64, 0x50, 0x72,
	0x6f, 0x6f, 0x66, 0x12, 0x3a, 0x0a, 0x04, 0x65, 0x78, 0x69, 0x74, 0x18, 0x69, 0x20, 0x01, 0x28,
	...
	0x42, 0x0a, 0x04, 0x73, 0x6c, 0x6f, 0x74, 0x18, 0x6a, 0x20, 0x01, 0x28, 0x04, 0x42, 0x2c, 0x82,
	...
	0x6c, 0x6f, 0x74, 0x12, 0x45, 0x0a, 0x05, 0x65, 0x70, 0x6f, 0x63, 0x68, 0x18, 0x6b, 0x20, 0x01,
	...
	0x68, 0x48, 0x00, 0x52, 0x05, 0x65, 0x70, 0x6f, 0x63, 0x68, 0x42, 0x08, 0x0a, 0x06, 0x6f, 0x62,
...
var file_proto_validator_accounts_v2_keymanager_proto_goTypes = []interface{}{
	...
	(*v1alpha1.BeaconBlockAltair)(nil),            // 5: ethereum.eth.v1alpha1.BeaconBlockAltair
	(*v1alpha1.AttestationData)(nil),              // 6: ethereum.eth.v1alpha1.AttestationData
	(*v1alpha1.AggregateAttestationAndProof)(nil), // 7: ethereum.eth.v1alpha1.AggregateAttestationAndProof
	(*v1alpha1.VoluntaryExit)(nil),                // 8: ethereum.eth.v1alpha1.VoluntaryExit
...
var file_proto_validator_accounts_v2_keymanager_proto_depIdxs = []int32{
	...
	5, // 1: ethereum.validator.accounts.v2.SignRequest.blockV2:type_name -> ethereum.eth.v1alpha1.BeaconBlockAltair
	6, // 2: ethereum.validator.accounts.v2.SignRequest.attestation_data:type_name -> ethereum.eth.v1alpha1.AttestationData
	7, // 3: ethereum.validator.accounts.v2.SignRequest.aggregate_attestation_and_proof:type_name -> ethereum.eth.v1alpha1.AggregateAttestationAndProof
	8, // 4: ethereum.validator.accounts.v2.SignRequest.exit:type_name -> ethereum.eth.v1alpha1.VoluntaryExit
