...
type BeaconStateContainer_Eip4844State struct {
	Eip4844State *BeaconState4844 `protobuf:"bytes,4,opt,name=eip4844_state,json=eip4844State,proto3,oneof"`
}
...
var file_proto_eth_v2_beacon_state_proto_rawDesc = []byte{
	...
	0x6f, 0x61, 0x64, 0x48, 0x65, 0x61, 0x64, 0x65, 0x72, 0x22, 0x8c, 0x0e, 0x0a, 0x0f, 0x42, 0x65,
	0x61, 0x63, 0x6f, 0x6e, 0x53, 0x74, 0x61, 0x74, 0x65, 0x34, 0x38, 0x34, 0x34, 0x12, 0x22, 0x0a,
	...
	0x48, 0x65, 0x61, 0x64, 0x65, 0x72, 0x34, 0x38, 0x34, 0x34, 0x52, 0x1c, 0x6c, 0x61, 0x74, 0x65,
	0x73, 0x74, 0x45, 0x78, 0x65, 0x63, 0x75, 0x74, 0x69, 0x6f, 0x6e, 0x50, 0x61, 0x79, 0x6c, 0x6f,
	0x61, 0x64, 0x48, 0x65, 0x61, 0x64, 0x65, 0x72, 0x22, 0x31, 0x0a, 0x14, 0x42, 0x65, 0x61, 0x63,
	...
	0x28, 0x0c, 0x52, 0x07, 0x73, 0x74, 0x61, 0x74, 0x65, 0x49, 0x64, 0x22, 0xb9, 0x01, 0x0a, 0x15,
	...
	0x69, 0x6d, 0x69, 0x73, 0x74, 0x69, 0x63, 0x22, 0x62, 0x0a, 0x18, 0x42, 0x65, 0x61, 0x63, 0x6f,
	...
	0x02, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x04, 0x64, 0x61, 0x74, 0x61, 0x22, 0xc0, 0x02, 0x0a, 0x14,
	...
	0x6c, 0x6c, 0x61, 0x74, 0x72, 0x69, 0x78, 0x53, 0x74, 0x61, 0x74, 0x65, 0x12, 0x47, 0x0a, 0x0d,
	0x65, 0x69, 0x70, 0x34, 0x38, 0x34, 0x34, 0x5f, 0x73, 0x74, 0x61, 0x74, 0x65, 0x18, 0x04, 0x20,
	0x01, 0x28, 0x0b, 0x32, 0x20, 0x2e, 0x65, 0x74, 0x68, 0x65, 0x72, 0x65, 0x75, 0x6d, 0x2e, 0x65,
	0x74, 0x68, 0x2e, 0x76, 0x32, 0x2e, 0x42, 0x65, 0x61, 0x63, 0x6f, 0x6e, 0x53, 0x74, 0x61, 0x74,
	0x65, 0x34, 0x38, 0x34, 0x34, 0x48, 0x00, 0x52, 0x0c, 0x65, 0x69, 0x70, 0x34, 0x38, 0x34, 0x34,
...
var file_proto_eth_v2_beacon_state_proto_goTypes = []interface{}{
	...
	(*BeaconState4844)(nil),                // 2: ethereum.eth.v2.BeaconState4844
	...
	(*v11.ExecutionPayloadHeader4844)(nil), // 16: ethereum.engine.v1.ExecutionPayloadHeader4844
	(Version)(0),                           // 17: ethereum.eth.v2.Version
	(*v1.BeaconState)(nil),                 // 18: ethereum.eth.v1.BeaconState
}
var file_proto_eth_v2_beacon_state_proto_depIdxs = []int32{
	9,  // 0: ethereum.eth.v2.BeaconState.fork:type_name -> ethereum.eth.v1.Fork
	10, // 1: ethereum.eth.v2.BeaconState.latest_block_header:type_name -> ethereum.eth.v1.BeaconBlockHeader
	11, // 2: ethereum.eth.v2.BeaconState.eth1_data:type_name -> ethereum.eth.v1.Eth1Data
	11, // 3: ethereum.eth.v2.BeaconState.eth1_data_votes:type_name -> ethereum.eth.v1.Eth1Data
	12, // 4: ethereum.eth.v2.BeaconState.validators:type_name -> ethereum.eth.v1.Validator
	13, // 5: ethereum.eth.v2.BeaconState.previous_justified_checkpoint:type_name -> ethereum.eth.v1.Checkpoint
	13, // 6: ethereum.eth.v2.BeaconState.current_justified_checkpoint:type_name -> ethereum.eth.v1.Checkpoint
	13, // 7: ethereum.eth.v2.BeaconState.finalized_checkpoint:type_name -> ethereum.eth.v1.Checkpoint
	14, // 8: ethereum.eth.v2.BeaconState.current_sync_committee:type_name -> ethereum.eth.v2.SyncCommittee
	14, // 9: ethereum.eth.v2.BeaconState.next_sync_committee:type_name -> ethereum.eth.v2.SyncCommittee
	...
	9,  // 21: ethereum.eth.v2.BeaconState4844.fork:type_name -> ethereum.eth.v1.Fork
	10, // 22: ethereum.eth.v2.BeaconState4844.latest_block_header:type_name -> ethereum.eth.v1.BeaconBlockHeader
	11, // 23: ethereum.eth.v2.BeaconState4844.eth1_data:type_name -> ethereum.eth.v1.Eth1Data
	11, // 24: ethereum.eth.v2.BeaconState4844.eth1_data_votes:type_name -> ethereum.eth.v1.Eth1Data
	12, // 25: ethereum.eth.v2.BeaconState4844.validators:type_name -> ethereum.eth.v1.Validator
	13, // 26: ethereum.eth.v2.BeaconState4844.previous_justified_checkpoint:type_name -> ethereum.eth.v1.Checkpoint
	13, // 27: ethereum.eth.v2.BeaconState4844.current_justified_checkpoint:type_name -> ethereum.eth.v1.Checkpoint
	13, // 28: ethereum.eth.v2.BeaconState4844.finalized_checkpoint:type_name -> ethereum.eth.v1.Checkpoint
	14, // 29: ethereum.eth.v2.BeaconState4844.current_sync_committee:type_name -> ethereum.eth.v2.SyncCommittee
	14, // 30: ethereum.eth.v2.BeaconState4844.next_sync_committee:type_name -> ethereum.eth.v2.SyncCommittee
	16, // 31: ethereum.eth.v2.BeaconState4844.latest_execution_payload_header:type_name -> ethereum.engine.v1.ExecutionPayloadHeader4844
	17, // 32: ethereum.eth.v2.BeaconStateResponseV2.version:type_name -> ethereum.eth.v2.Version
	6,  // 33: ethereum.eth.v2.BeaconStateResponseV2.data:type_name -> ethereum.eth.v2.BeaconStateContainer
	17, // 34: ethereum.eth.v2.BeaconStateSSZResponseV2.version:type_name -> ethereum.eth.v2.Version
	18, // 35: ethereum.eth.v2.BeaconStateContainer.phase0_state:type_name -> ethereum.eth.v1.BeaconState
	...
	2,  // 38: ethereum.eth.v2.BeaconStateContainer.eip4844_state:type_name -> ethereum.eth.v2.BeaconState4844
