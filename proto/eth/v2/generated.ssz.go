...
// Hash: 602dafcc2607391373ebcaee3a5c7d2a06df4a42d595cfbf529961b1797ec9c9
package eth
...
// MarshalSSZ ssz marshals the SignedBlindedBeaconBlockEip4844 object
func (s *SignedBlindedBeaconBlockEip4844) MarshalSSZ() ([]byte, error) {
	return ssz.MarshalSSZ(s)
}

// MarshalSSZTo ssz marshals the SignedBlindedBeaconBlockEip4844 object to a target array
func (s *SignedBlindedBeaconBlockEip4844) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	dst = buf
	offset := int(100)
	...
	dst = ssz.WriteOffset(dst, offset)
	if s.Message == nil {
		s.Message = new(BlindedBeaconBlockEip4844)
	}
	offset += s.Message.SizeSSZ()
...
// UnmarshalSSZ ssz unmarshals the SignedBlindedBeaconBlockEip4844 object
func (s *SignedBlindedBeaconBlockEip4844) UnmarshalSSZ(buf []byte) error {
	var err error
	size := uint64(len(buf))
	if size < 100 {
		return ssz.ErrSize
...
// SizeSSZ returns the ssz encoded size in bytes for the SignedBlindedBeaconBlockEip4844 object
func (s *SignedBlindedBeaconBlockEip4844) SizeSSZ() (size int) {
	size = 100
...
// HashTreeRoot ssz hashes the SignedBlindedBeaconBlockEip4844 object
func (s *SignedBlindedBeaconBlockEip4844) HashTreeRoot() ([32]byte, error) {
	return ssz.HashWithDefaultHasher(s)
}

// HashTreeRootWith ssz hashes the SignedBlindedBeaconBlockEip4844 object with a hasher
func (s *SignedBlindedBeaconBlockEip4844) HashTreeRootWith(hh *ssz.Hasher) (err error) {
	indx := hh.Index()
...
// MarshalSSZ ssz marshals the BlindedBeaconBlockEip4844 object
func (b *BlindedBeaconBlockEip4844) MarshalSSZ() ([]byte, error) {
	return ssz.MarshalSSZ(b)
}

// MarshalSSZTo ssz marshals the BlindedBeaconBlockEip4844 object to a target array
func (b *BlindedBeaconBlockEip4844) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	dst = buf
	offset := int(84)
	...
	dst = ssz.WriteOffset(dst, offset)
	if b.Body == nil {
		b.Body = new(BlindedBeaconBlockBodyEip4844)
	}
	offset += b.Body.SizeSSZ()
...
// UnmarshalSSZ ssz unmarshals the BlindedBeaconBlockEip4844 object
func (b *BlindedBeaconBlockEip4844) UnmarshalSSZ(buf []byte) error {
	var err error
	size := uint64(len(buf))
	if size < 84 {
		return ssz.ErrSize
...
// SizeSSZ returns the ssz encoded size in bytes for the BlindedBeaconBlockEip4844 object
func (b *BlindedBeaconBlockEip4844) SizeSSZ() (size int) {
	size = 84
...
// HashTreeRoot ssz hashes the BlindedBeaconBlockEip4844 object
func (b *BlindedBeaconBlockEip4844) HashTreeRoot() ([32]byte, error) {
	return ssz.HashWithDefaultHasher(b)
}

// HashTreeRootWith ssz hashes the BlindedBeaconBlockEip4844 object with a hasher
func (b *BlindedBeaconBlockEip4844) HashTreeRootWith(hh *ssz.Hasher) (err error) {
	indx := hh.Index()
...
func (b *BeaconBlockBodyEip4844) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	dst = ssz.WriteOffset(dst, offset)
	if b.ExecutionPayload == nil {
		b.ExecutionPayload = new(v11.ExecutionPayload4844)
	}
	offset += b.ExecutionPayload.SizeSSZ()
	...
	// Field (10) 'BlobKzgs'
	if size := len(b.BlobKzgs); size > 16777216 {
		err = ssz.ErrListTooBigFn("--.BlobKzgs", size, 16777216)
		return
	}
	for ii := 0; ii < len(b.BlobKzgs); ii++ {
		if size := len(b.BlobKzgs[ii]); size != 48 {
			err = ssz.ErrBytesLengthFn("--.BlobKzgs[ii]", size, 48)
			return
		}
...
func (b *BeaconBlockBodyEip4844) HashTreeRootWith(hh *ssz.Hasher) (err error) {
	...
	// Field (10) 'BlobKzgs'
	{
		...
		if ssz.EnableVectorizedHTR {
			hh.MerkleizeWithMixinVectorizedHTR(subIndx, numItems, ssz.CalculateLimit(16777216, numItems, 0))
		} else {
...
// MarshalSSZ ssz marshals the BlindedBeaconBlockBodyEip4844 object
func (b *BlindedBeaconBlockBodyEip4844) MarshalSSZ() ([]byte, error) {
	return ssz.MarshalSSZ(b)
}

// MarshalSSZTo ssz marshals the BlindedBeaconBlockBodyEip4844 object to a target array
func (b *BlindedBeaconBlockBodyEip4844) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	dst = buf
	offset := int(388)
	...
	dst = ssz.WriteOffset(dst, offset)
	if b.ExecutionPayloadHeader == nil {
		b.ExecutionPayloadHeader = new(v11.ExecutionPayloadHeader4844)
	}
	offset += b.ExecutionPayloadHeader.SizeSSZ()
...
// UnmarshalSSZ ssz unmarshals the BlindedBeaconBlockBodyEip4844 object
func (b *BlindedBeaconBlockBodyEip4844) UnmarshalSSZ(buf []byte) error {
	var err error
	size := uint64(len(buf))
	if size < 388 {
		return ssz.ErrSize
...
// SizeSSZ returns the ssz encoded size in bytes for the BlindedBeaconBlockBodyEip4844 object
func (b *BlindedBeaconBlockBodyEip4844) SizeSSZ() (size int) {
	size = 388
...
// HashTreeRoot ssz hashes the BlindedBeaconBlockBodyEip4844 object
func (b *BlindedBeaconBlockBodyEip4844) HashTreeRoot() ([32]byte, error) {
	return ssz.HashWithDefaultHasher(b)
}

// HashTreeRootWith ssz hashes the BlindedBeaconBlockBodyEip4844 object with a hasher
func (b *BlindedBeaconBlockBodyEip4844) HashTreeRootWith(hh *ssz.Hasher) (err error) {
	indx := hh.Index()
