...
// Hash: b0b9fcf52e566c80455b8c5fc94a1f0923cbbfbf7bd53fd5345a5a9f5ab9fed2
package eth
...
// MarshalSSZ ssz marshals the BeaconBlockContainerAltair object
func (b *BeaconBlockContainerAltair) MarshalSSZ() ([]byte, error) {
	return ssz.MarshalSSZ(b)
}

// MarshalSSZTo ssz marshals the BeaconBlockContainerAltair object to a target array
func (b *BeaconBlockContainerAltair) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	dst = buf
	offset := int(100)
	...
	if b.Message == nil {
		b.Message = new(BeaconBlockAltair)
	}
...
// UnmarshalSSZ ssz unmarshals the BeaconBlockContainerAltair object
func (b *BeaconBlockContainerAltair) UnmarshalSSZ(buf []byte) error {
	var err error
	size := uint64(len(buf))
	if size < 100 {
		return ssz.ErrSize
...
// SizeSSZ returns the ssz encoded size in bytes for the BeaconBlockContainerAltair object
func (b *BeaconBlockContainerAltair) SizeSSZ() (size int) {
	size = 100
...
// HashTreeRoot ssz hashes the BeaconBlockContainerAltair object
func (b *BeaconBlockContainerAltair) HashTreeRoot() ([32]byte, error) {
	return ssz.HashWithDefaultHasher(b)
}

// HashTreeRootWith ssz hashes the BeaconBlockContainerAltair object with a hasher
func (b *BeaconBlockContainerAltair) HashTreeRootWith(hh *ssz.Hasher) (err error) {
	indx := hh.Index()
