...
// Hash: 6e6590f09193260cf3ad0f5720cf0ee562388c1060a79c009de16aaf32033433
package eth
...
func (b *BeaconBlockBodyEip4844) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	if size := len(b.BlobKzgCommitments); size > 16777216 {
		err = ssz.ErrListTooBigFn("--.BlobKzgCommitments", size, 16777216)
		return
	}
