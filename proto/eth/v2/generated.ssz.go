...
// Hash: 40bd031b3a61639f93db78bffb2a5edbb222eec690e84b82fbc2f19fd363c0da
package eth
...
func (s *SignedBlindedBeaconBlock4844) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	dst = ssz.WriteOffset(dst, offset)
	if s.Message == nil {
		s.Message = new(BlindedBeaconBlock4844)
	}
	offset += s.Message.SizeSSZ()
...
func (b *BeaconBlockBodyCapella) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	if size := len(b.BlobKzgCommitments); size > 4 {
		err = ssz.ErrListTooBigFn("--.BlobKzgCommitments", size, 4)
		return
	}
