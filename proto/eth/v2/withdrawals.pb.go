...
type SubmitBLSToExecutionChangesRequest struct {
	...
	List []*SignedBLSToExecutionChange `protobuf:"bytes,1,rep,name=list,proto3" json:"list,omitempty"`
}
...
func (x *SubmitBLSToExecutionChangesRequest) GetList() []*SignedBLSToExecutionChange {
	if x != nil {
		return x.List
	}
	return nil
...
var file_proto_eth_v2_withdrawals_proto_rawDesc = []byte{
	...
	0x65, 0x22, 0x65, 0x0a, 0x22, 0x53, 0x75, 0x62, 0x6d, 0x69, 0x74, 0x42, 0x4c, 0x53, 0x54, 0x6f,
	0x45, 0x78, 0x65, 0x63, 0x75, 0x74, 0x69, 0x6f, 0x6e, 0x43, 0x68, 0x61, 0x6e, 0x67, 0x65, 0x73,
	0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x3f, 0x0a, 0x04, 0x6c, 0x69, 0x73, 0x74, 0x18,
	...
	0x53, 0x54, 0x6f, 0x45, 0x78, 0x65, 0x63, 0x75, 0x74, 0x69, 0x6f, 0x6e, 0x43, 0x68, 0x61, 0x6e,
	0x67, 0x65, 0x52, 0x04, 0x6c, 0x69, 0x73, 0x74, 0x42, 0x81, 0x01, 0x0a, 0x13, 0x6f, 0x72, 0x67,
...
var file_proto_eth_v2_withdrawals_proto_depIdxs = []int32{
	...
	1, // 1: ethereum.eth.v2.SubmitBLSToExecutionChangesRequest.list:type_name -> ethereum.eth.v2.SignedBLSToExecutionChange
