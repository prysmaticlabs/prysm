...
// Hash: e63bf40e03aa0ec99fa6803520498b667c53ce2c04069aadfeac355c30bc8e5a
package eth
...
func (l *LightClientHeader) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	// Field (0) 'Beacon'
	if l.Beacon == nil {
		l.Beacon = new(v1.BeaconBlockHeader)
	}
...
func (l *LightClientHeader) HashTreeRootWith(hh *ssz.Hasher) (err error) {
	indx := hh.Index()
...
func (l *LightClientHeaderCapella) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	dst = ssz.WriteOffset(dst, offset)
	if l.Execution == nil {
		l.Execution = new(v11.ExecutionPayloadHeaderCapella)
	}
...
func (l *LightClientHeaderDeneb) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	dst = ssz.WriteOffset(dst, offset)
	if l.Execution == nil {
		l.Execution = new(v11.ExecutionPayloadHeaderDeneb)
	}
	offset += l.Execution.SizeSSZ()
...
// MarshalSSZ ssz marshals the LightClientUpdateInternal object
func (l *LightClientUpdateInternal) MarshalSSZ() ([]byte, error) {
	return ssz.MarshalSSZ(l)
}

// MarshalSSZTo ssz marshals the LightClientUpdateInternal object to a target array
func (l *LightClientUpdateInternal) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	dst = buf
	offset := int(25152)

	// Offset (0) 'AttestedHeader'
	dst = ssz.WriteOffset(dst, offset)
	offset += len(l.AttestedHeader)
	...
	if l.SyncAggregate == nil {
		l.SyncAggregate = new(v1.SyncAggregate)
	}
	...
	if size := len(l.AttestedHeader); size > 2147483647 {
		err = ssz.ErrBytesLengthFn("--.AttestedHeader", size, 2147483647)
		return
	}
	dst = append(dst, l.AttestedHeader...)

	// Field (3) 'FinalizedHeader'
	if size := len(l.FinalizedHeader); size > 2147483647 {
		err = ssz.ErrBytesLengthFn("--.FinalizedHeader", size, 2147483647)
		return
	}
	dst = append(dst, l.FinalizedHeader...)

	return
}

// UnmarshalSSZ ssz unmarshals the LightClientUpdateInternal object
func (l *LightClientUpdateInternal) UnmarshalSSZ(buf []byte) error {
	var err error
	size := uint64(len(buf))
	if size < 25152 {
		return ssz.ErrSize
	...
	// Field (0) 'AttestedHeader'
	{
		...
		if cap(l.AttestedHeader) == 0 {
			l.AttestedHeader = make([]byte, 0, len(buf))
		}
		l.AttestedHeader = append(l.AttestedHeader, buf...)
	}
	...
	// Field (3) 'FinalizedHeader'
	{
		...
		if cap(l.FinalizedHeader) == 0 {
			l.FinalizedHeader = make([]byte, 0, len(buf))
		}
		l.FinalizedHeader = append(l.FinalizedHeader, buf...)
	}
	return err
}

// SizeSSZ returns the ssz encoded size in bytes for the LightClientUpdateInternal object
func (l *LightClientUpdateInternal) SizeSSZ() (size int) {
	size = 25152

	// Field (0) 'AttestedHeader'
	size += len(l.AttestedHeader)

	// Field (3) 'FinalizedHeader'
	size += len(l.FinalizedHeader)

	return
}

// HashTreeRoot ssz hashes the LightClientUpdateInternal object
func (l *LightClientUpdateInternal) HashTreeRoot() ([32]byte, error) {
	return ssz.HashWithDefaultHasher(l)
}

// HashTreeRootWith ssz hashes the LightClientUpdateInternal object with a hasher
func (l *LightClientUpdateInternal) HashTreeRootWith(hh *ssz.Hasher) (err error) {
	indx := hh.Index()

	// Field (0) 'AttestedHeader'
	{
		elemIndx := hh.Index()
		byteLen := uint64(len(l.AttestedHeader))
		if byteLen > 2147483647 {
			err = ssz.ErrIncorrectListSize
			return
		}
		hh.PutBytes(l.AttestedHeader)
		hh.MerkleizeWithMixin(elemIndx, byteLen, (2147483647+31)/32)
	}
	...
	{
		elemIndx := hh.Index()
		byteLen := uint64(len(l.FinalizedHeader))
		if byteLen > 2147483647 {
			err = ssz.ErrIncorrectListSize
			return
		}
		hh.PutBytes(l.FinalizedHeader)
		hh.MerkleizeWithMixin(elemIndx, byteLen, (2147483647+31)/32)
	}
...
// MarshalSSZ ssz marshals the LightClientFinalityUpdateInternal object
func (l *LightClientFinalityUpdateInternal) MarshalSSZ() ([]byte, error) {
	return ssz.MarshalSSZ(l)
}

// MarshalSSZTo ssz marshals the LightClientFinalityUpdateInternal object to a target array
func (l *LightClientFinalityUpdateInternal) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	dst = buf
	offset := int(368)
...
// UnmarshalSSZ ssz unmarshals the LightClientFinalityUpdateInternal object
func (l *LightClientFinalityUpdateInternal) UnmarshalSSZ(buf []byte) error {
	var err error
	size := uint64(len(buf))
	if size < 368 {
		return ssz.ErrSize
...
// SizeSSZ returns the ssz encoded size in bytes for the LightClientFinalityUpdateInternal object
func (l *LightClientFinalityUpdateInternal) SizeSSZ() (size int) {
	size = 368
...
// HashTreeRoot ssz hashes the LightClientFinalityUpdateInternal object
func (l *LightClientFinalityUpdateInternal) HashTreeRoot() ([32]byte, error) {
	return ssz.HashWithDefaultHasher(l)
}

// HashTreeRootWith ssz hashes the LightClientFinalityUpdateInternal object with a hasher
func (l *LightClientFinalityUpdateInternal) HashTreeRootWith(hh *ssz.Hasher) (err error) {
	indx := hh.Index()
...
// MarshalSSZ ssz marshals the LightClientOptimisticUpdateInternal object
func (l *LightClientOptimisticUpdateInternal) MarshalSSZ() ([]byte, error) {
	return ssz.MarshalSSZ(l)
}

// MarshalSSZTo ssz marshals the LightClientOptimisticUpdateInternal object to a target array
func (l *LightClientOptimisticUpdateInternal) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	dst = buf
	offset := int(172)
...
// UnmarshalSSZ ssz unmarshals the LightClientOptimisticUpdateInternal object
func (l *LightClientOptimisticUpdateInternal) UnmarshalSSZ(buf []byte) error {
	var err error
	size := uint64(len(buf))
	if size < 172 {
		return ssz.ErrSize
...
// SizeSSZ returns the ssz encoded size in bytes for the LightClientOptimisticUpdateInternal object
func (l *LightClientOptimisticUpdateInternal) SizeSSZ() (size int) {
	size = 172
...
// HashTreeRoot ssz hashes the LightClientOptimisticUpdateInternal object
func (l *LightClientOptimisticUpdateInternal) HashTreeRoot() ([32]byte, error) {
	return ssz.HashWithDefaultHasher(l)
}

// HashTreeRootWith ssz hashes the LightClientOptimisticUpdateInternal object with a hasher
func (l *LightClientOptimisticUpdateInternal) HashTreeRootWith(hh *ssz.Hasher) (err error) {
	indx := hh.Index()
