...
type BeaconBlockContainerV2 struct {
	...
	//	*BeaconBlockContainerV2_DenebBlock
...
func (x *BeaconBlockContainerV2) GetDenebBlock() *BeaconBlockDeneb {
	if x, ok := x.GetBlock().(*BeaconBlockContainerV2_DenebBlock); ok {
		return x.DenebBlock
	}
	return nil
}
...
type BeaconBlockContainerV2_DenebBlock struct {
...
func (*BeaconBlockContainerV2_DenebBlock) isBeaconBlockContainerV2_Block() {}
...
type BlindedBeaconBlockContentsContainer struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
	...
	// Types that are assignable to Block:
	//
	//	*BlindedBeaconBlockContentsContainer_Phase0Block
	//	*BlindedBeaconBlockContentsContainer_AltairBlock
	//	*BlindedBeaconBlockContentsContainer_BellatrixBlock
	//	*BlindedBeaconBlockContentsContainer_CapellaBlock
	//	*BlindedBeaconBlockContentsContainer_DenebContents
	Block isBlindedBeaconBlockContentsContainer_Block `protobuf_oneof:"block"`
}

func (x *BlindedBeaconBlockContentsContainer) Reset() {
	*x = BlindedBeaconBlockContentsContainer{}
	if protoimpl.UnsafeEnabled {
...
func (x *BlindedBeaconBlockContentsContainer) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*BlindedBeaconBlockContentsContainer) ProtoMessage() {}

func (x *BlindedBeaconBlockContentsContainer) ProtoReflect() protoreflect.Message {
	mi := &file_proto_eth_v2_beacon_block_proto_msgTypes[7]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use BlindedBeaconBlockContentsContainer.ProtoReflect.Descriptor instead.
func (*BlindedBeaconBlockContentsContainer) Descriptor() ([]byte, []int) {
	return file_proto_eth_v2_beacon_block_proto_rawDescGZIP(), []int{7}
}

func (m *BlindedBeaconBlockContentsContainer) GetBlock() isBlindedBeaconBlockContentsContainer_Block {
	if m != nil {
		return m.Block
	}
	return nil
...
func (x *BlindedBeaconBlockContentsContainer) GetPhase0Block() *v1.BeaconBlock {
	if x, ok := x.GetBlock().(*BlindedBeaconBlockContentsContainer_Phase0Block); ok {
		return x.Phase0Block
	}
	return nil
}

func (x *BlindedBeaconBlockContentsContainer) GetAltairBlock() *BeaconBlockAltair {
	if x, ok := x.GetBlock().(*BlindedBeaconBlockContentsContainer_AltairBlock); ok {
		return x.AltairBlock
	}
	return nil
}

func (x *BlindedBeaconBlockContentsContainer) GetBellatrixBlock() *BlindedBeaconBlockBellatrix {
	if x, ok := x.GetBlock().(*BlindedBeaconBlockContentsContainer_BellatrixBlock); ok {
		return x.BellatrixBlock
	}
	return nil
}

func (x *BlindedBeaconBlockContentsContainer) GetCapellaBlock() *BlindedBeaconBlockCapella {
	if x, ok := x.GetBlock().(*BlindedBeaconBlockContentsContainer_CapellaBlock); ok {
		return x.CapellaBlock
	}
	return nil
}

func (x *BlindedBeaconBlockContentsContainer) GetDenebContents() *BlindedBeaconBlockContentsDeneb {
	if x, ok := x.GetBlock().(*BlindedBeaconBlockContentsContainer_DenebContents); ok {
		return x.DenebContents
	}
	return nil
}

type isBlindedBeaconBlockContentsContainer_Block interface {
	isBlindedBeaconBlockContentsContainer_Block()
}

type BlindedBeaconBlockContentsContainer_Phase0Block struct {
	Phase0Block *v1.BeaconBlock `protobuf:"bytes,1,opt,name=phase0_block,json=phase0Block,proto3,oneof"`
}

type BlindedBeaconBlockContentsContainer_AltairBlock struct {
	AltairBlock *BeaconBlockAltair `protobuf:"bytes,2,opt,name=altair_block,json=altairBlock,proto3,oneof"`
}

type BlindedBeaconBlockContentsContainer_BellatrixBlock struct {
	BellatrixBlock *BlindedBeaconBlockBellatrix `protobuf:"bytes,3,opt,name=bellatrix_block,json=bellatrixBlock,proto3,oneof"`
}

type BlindedBeaconBlockContentsContainer_CapellaBlock struct {
	CapellaBlock *BlindedBeaconBlockCapella `protobuf:"bytes,4,opt,name=capella_block,json=capellaBlock,proto3,oneof"`
}

type BlindedBeaconBlockContentsContainer_DenebContents struct {
	DenebContents *BlindedBeaconBlockContentsDeneb `protobuf:"bytes,5,opt,name=deneb_contents,json=denebContents,proto3,oneof"`
}

func (*BlindedBeaconBlockContentsContainer_Phase0Block) isBlindedBeaconBlockContentsContainer_Block() {
}

func (*BlindedBeaconBlockContentsContainer_AltairBlock) isBlindedBeaconBlockContentsContainer_Block() {
}

func (*BlindedBeaconBlockContentsContainer_BellatrixBlock) isBlindedBeaconBlockContentsContainer_Block() {
}

func (*BlindedBeaconBlockContentsContainer_CapellaBlock) isBlindedBeaconBlockContentsContainer_Block() {
}

func (*BlindedBeaconBlockContentsContainer_DenebContents) isBlindedBeaconBlockContentsContainer_Block() {
}
...
func (x *SignedBlindedBeaconBlockContentsContainer) GetPhase0Block() *v1.BeaconBlock {
...
func (x *SignedBlindedBeaconBlockContentsContainer) GetAltairBlock() *BeaconBlockAltair {
...
func (x *SignedBlindedBeaconBlockContentsContainer) GetBellatrixBlock() *BlindedBeaconBlockBellatrix {
...
func (x *SignedBlindedBeaconBlockContentsContainer) GetCapellaBlock() *BlindedBeaconBlockCapella {
...
func (x *SignedBlindedBeaconBlockContentsContainer) GetDenebContents() *BlindedBeaconBlockContentsDeneb {
...
func (x *SignedBlindedBeaconBlockContentsContainer) GetSignature() []byte {
	if x != nil {
		return x.Signature
	}
	return nil
...
type BlindedBeaconBlockContentsDeneb struct {
	...
	BlindedBlobSidecars *BlindedBlobSidecars     `protobuf:"bytes,2,opt,name=blinded_blob_sidecars,json=blindedBlobSidecars,proto3" json:"blinded_blob_sidecars,omitempty"`
}
...
func (x *BlindedBeaconBlockContentsDeneb) GetBlindedBlobSidecars() *BlindedBlobSidecars {
	if x != nil {
...
var file_proto_eth_v2_beacon_block_proto_rawDesc = []byte{
	...
	0x52, 0x09, 0x66, 0x69, 0x6e, 0x61, 0x6c, 0x69, 0x7a, 0x65, 0x64, 0x22, 0x91, 0x03, 0x0a, 0x16,
	0x42, 0x65, 0x61, 0x63, 0x6f, 0x6e, 0x42, 0x6c, 0x6f, 0x63, 0x6b, 0x43, 0x6f, 0x6e, 0x74, 0x61,
	...
	0x12, 0x44, 0x0a, 0x0b, 0x64, 0x65, 0x6e, 0x65, 0x62, 0x5f, 0x62, 0x6c, 0x6f, 0x63, 0x6b, 0x18,
	...
	0x62, 0x42, 0x6c, 0x6f, 0x63, 0x6b, 0x42, 0x07, 0x0a, 0x05, 0x62, 0x6c, 0x6f, 0x63, 0x6b, 0x22,
	0xbd, 0x03, 0x0a, 0x1a, 0x53, 0x69, 0x67, 0x6e, 0x65, 0x64, 0x42, 0x65, 0x61, 0x63, 0x6f, 0x6e,
	...
	0x6c, 0x6c, 0x61, 0x42, 0x6c, 0x6f, 0x63, 0x6b, 0x12, 0x44, 0x0a, 0x0b, 0x64, 0x65, 0x6e, 0x65,
	0x62, 0x5f, 0x62, 0x6c, 0x6f, 0x63, 0x6b, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x21, 0x2e,
	...
	0x48, 0x00, 0x52, 0x0a, 0x64, 0x65, 0x6e, 0x65, 0x62, 0x42, 0x6c, 0x6f, 0x63, 0x6b, 0x12, 0x24,
	...
	0xab, 0x03, 0x0a, 0x1b, 0x42, 0x6c, 0x69, 0x6e, 0x64, 0x65, 0x64, 0x42, 0x65, 0x61, 0x63, 0x6f,
	...
	0x61, 0x63, 0x6f, 0x6e, 0x42, 0x6c, 0x6f, 0x63, 0x6b, 0x42, 0x65, 0x6c, 0x6c, 0x61, 0x74, 0x72,
	0x69, 0x78, 0x48, 0x00, 0x52, 0x0e, 0x62, 0x65, 0x6c, 0x6c, 0x61, 0x74, 0x72, 0x69, 0x78, 0x42,
	0x6c, 0x6f, 0x63, 0x6b, 0x12, 0x51, 0x0a, 0x0d, 0x63, 0x61, 0x70, 0x65, 0x6c, 0x6c, 0x61, 0x5f,
	...
	0x6c, 0x61, 0x42, 0x6c, 0x6f, 0x63, 0x6b, 0x12, 0x4b, 0x0a, 0x0b, 0x64, 0x65, 0x6e, 0x65, 0x62,
	0x5f, 0x62, 0x6c, 0x6f, 0x63, 0x6b, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x28, 0x2e, 0x65,
	...
	0x6c, 0x6f, 0x63, 0x6b, 0x42, 0x07, 0x0a, 0x05, 0x62, 0x6c, 0x6f, 0x63, 0x6b, 0x22, 0xd9, 0x03,
	...
	0x0a, 0x07, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x22, 0xc1, 0x03, 0x0a, 0x23, 0x42, 0x6c,
	0x69, 0x6e, 0x64, 0x65, 0x64, 0x42, 0x65, 0x61, 0x63, 0x6f, 0x6e, 0x42, 0x6c, 0x6f, 0x63, 0x6b,
	...
	0x65, 0x6e, 0x74, 0x73, 0x42, 0x07, 0x0a, 0x05, 0x62, 0x6c, 0x6f, 0x63, 0x6b, 0x22, 0xef, 0x03,
	...
	0x74, 0x73, 0x43, 0x6f, 0x6e, 0x74, 0x61, 0x69, 0x6e, 0x65, 0x72, 0x12, 0x41, 0x0a, 0x0c, 0x70,
	...
	0x0d, 0x64, 0x65, 0x6e, 0x65, 0x62, 0x43, 0x6f, 0x6e, 0x74, 0x65, 0x6e, 0x74, 0x73, 0x12, 0x24,
	0x0a, 0x09, 0x73, 0x69, 0x67, 0x6e, 0x61, 0x74, 0x75, 0x72, 0x65, 0x18, 0x06, 0x20, 0x01, 0x28,
	0x0c, 0x42, 0x06, 0x8a, 0xb5, 0x18, 0x02, 0x39, 0x36, 0x52, 0x09, 0x73, 0x69, 0x67, 0x6e, 0x61,
	0x74, 0x75, 0x72, 0x65, 0x42, 0x09, 0x0a, 0x07, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x22,
	...
	0x61, 0x74, 0x75, 0x72, 0x65, 0x22, 0x7f, 0x0a, 0x18, 0x53, 0x69, 0x67, 0x6e, 0x65, 0x64, 0x42,
	0x65, 0x61, 0x63, 0x6f, 0x6e, 0x42, 0x6c, 0x6f, 0x63, 0x6b, 0x43, 0x61, 0x70, 0x65, 0x6c, 0x6c,
	0x61, 0x12, 0x3d, 0x0a, 0x07, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x18, 0x01, 0x20, 0x01,
	...
	0x6e, 0x61, 0x74, 0x75, 0x72, 0x65, 0x22, 0x7b, 0x0a, 0x16, 0x53, 0x69, 0x67, 0x6e, 0x65, 0x64,
	0x42, 0x65, 0x61, 0x63, 0x6f, 0x6e, 0x42, 0x6c, 0x6f, 0x63, 0x6b, 0x44, 0x65, 0x6e, 0x65, 0x62,
	...
	0x6c, 0x6f, 0x63, 0x6b, 0x43, 0x61, 0x70, 0x65, 0x6c, 0x6c, 0x61, 0x12, 0x44, 0x0a, 0x07, 0x6d,
	...
	0x65, 0x12, 0x24, 0x0a, 0x09, 0x73, 0x69, 0x67, 0x6e, 0x61, 0x74, 0x75, 0x72, 0x65, 0x18, 0x02,
	0x20, 0x01, 0x28, 0x0c, 0x42, 0x06, 0x8a, 0xb5, 0x18, 0x02, 0x39, 0x36, 0x52, 0x09, 0x73, 0x69,
	0x67, 0x6e, 0x61, 0x74, 0x75, 0x72, 0x65, 0x22, 0x89, 0x01, 0x0a, 0x1d, 0x53, 0x69, 0x67, 0x6e,
	0x65, 0x64, 0x42, 0x6c, 0x69, 0x6e, 0x64, 0x65, 0x64, 0x42, 0x65, 0x61, 0x63, 0x6f, 0x6e, 0x42,
	0x6c, 0x6f, 0x63, 0x6b, 0x44, 0x65, 0x6e, 0x65, 0x62, 0x12, 0x42, 0x0a, 0x07, 0x6d, 0x65, 0x73,
	...
	0x72, 0x65, 0x22, 0xf8, 0x02, 0x0a, 0x14, 0x42, 0x65, 0x61, 0x63, 0x6f, 0x6e, 0x42, 0x6c, 0x6f,
	...
	0x6c, 0x6c, 0x61, 0x74, 0x72, 0x69, 0x78, 0x52, 0x04, 0x62, 0x6f, 0x64, 0x79, 0x22, 0x86, 0x03,
	...
	0x12, 0x44, 0x0a, 0x04, 0x62, 0x6f, 0x64, 0x79, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x30,
	...
	0x70, 0x65, 0x6c, 0x6c, 0x61, 0x52, 0x04, 0x62, 0x6f, 0x64, 0x79, 0x22, 0xfe, 0x02, 0x0a, 0x17,
	0x42, 0x6c, 0x69, 0x6e, 0x64, 0x65, 0x64, 0x42, 0x65, 0x61, 0x63, 0x6f, 0x6e, 0x42, 0x6c, 0x6f,
	...
	0x79, 0x44, 0x65, 0x6e, 0x65, 0x62, 0x52, 0x04, 0x62, 0x6f, 0x64, 0x79, 0x22, 0xf2, 0x02, 0x0a,
	...
	0x72, 0x22, 0xdd, 0x06, 0x0a, 0x1d, 0x42, 0x6c, 0x69, 0x6e, 0x64, 0x65, 0x64, 0x42, 0x65, 0x61,
	...
	0x73, 0x22, 0x9a, 0x07, 0x0a, 0x1b, 0x42, 0x6c, 0x69, 0x6e, 0x64, 0x65, 0x64, 0x42, 0x65, 0x61,
	...
	0x4b, 0x7a, 0x67, 0x43, 0x6f, 0x6d, 0x6d, 0x69, 0x74, 0x6d, 0x65, 0x6e, 0x74, 0x73, 0x22, 0xfa,
	...
	0x74, 0x68, 0x65, 0x72, 0x65, 0x75, 0x6d, 0x2e, 0x65, 0x74, 0x68, 0x2e, 0x76, 0x31, 0x2e, 0x53,
	0x79, 0x6e, 0x63, 0x41, 0x67, 0x67, 0x72, 0x65, 0x67, 0x61, 0x74, 0x65, 0x52, 0x0d, 0x73, 0x79,
	0x6e, 0x63, 0x41, 0x67, 0x67, 0x72, 0x65, 0x67, 0x61, 0x74, 0x65, 0x22, 0xf4, 0x02, 0x0a, 0x12,
	...
	0x64, 0x79, 0x22, 0xc3, 0x06, 0x0a, 0x16, 0x42, 0x65, 0x61, 0x63, 0x6f, 0x6e, 0x42, 0x6c, 0x6f,
	...
	0x6e, 0x43, 0x68, 0x61, 0x6e, 0x67, 0x65, 0x73, 0x22, 0xf0, 0x02, 0x0a, 0x10, 0x42, 0x65, 0x61,
	...
	0x44, 0x65, 0x6e, 0x65, 0x62, 0x52, 0x04, 0x62, 0x6f, 0x64, 0x79, 0x22, 0x80, 0x07, 0x0a, 0x14,
	...
	0x6d, 0x65, 0x6e, 0x74, 0x73, 0x18, 0x0c, 0x20, 0x03, 0x28, 0x0c, 0x42, 0x0d, 0x8a, 0xb5, 0x18,
	0x04, 0x3f, 0x2c, 0x34, 0x38, 0x92, 0xb5, 0x18, 0x01, 0x34, 0x52, 0x12, 0x62, 0x6c, 0x6f, 0x62,
	0x4b, 0x7a, 0x67, 0x43, 0x6f, 0x6d, 0x6d, 0x69, 0x74, 0x6d, 0x65, 0x6e, 0x74, 0x73, 0x22, 0xca,
	0x01, 0x0a, 0x1f, 0x42, 0x6c, 0x69, 0x6e, 0x64, 0x65, 0x64, 0x42, 0x65, 0x61, 0x63, 0x6f, 0x6e,
	0x42, 0x6c, 0x6f, 0x63, 0x6b, 0x43, 0x6f, 0x6e, 0x74, 0x65, 0x6e, 0x74, 0x73, 0x44, 0x65, 0x6e,
	0x65, 0x62, 0x12, 0x4d, 0x0a, 0x0d, 0x62, 0x6c, 0x69, 0x6e, 0x64, 0x65, 0x64, 0x5f, 0x62, 0x6c,
	...
	0x6b, 0x12, 0x58, 0x0a, 0x15, 0x62, 0x6c, 0x69, 0x6e, 0x64, 0x65, 0x64, 0x5f, 0x62, 0x6c, 0x6f,
	0x62, 0x5f, 0x73, 0x69, 0x64, 0x65, 0x63, 0x61, 0x72, 0x73, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b,
	...
	0x64, 0x65, 0x63, 0x61, 0x72, 0x73, 0x52, 0x13, 0x62, 0x6c, 0x69, 0x6e, 0x64, 0x65, 0x64, 0x42,
...
var file_proto_eth_v2_beacon_block_proto_msgTypes = make([]protoimpl.MessageInfo, 31)
var file_proto_eth_v2_beacon_block_proto_goTypes = []interface{}{
	...
	(*BlindedBeaconBlockContentsContainer)(nil),       // 7: ethereum.eth.v2.BlindedBeaconBlockContentsContainer
	(*SignedBlindedBeaconBlockContentsContainer)(nil), // 8: ethereum.eth.v2.SignedBlindedBeaconBlockContentsContainer
	(*SignedBeaconBlockBellatrix)(nil),                // 9: ethereum.eth.v2.SignedBeaconBlockBellatrix
	(*SignedBeaconBlockCapella)(nil),                  // 10: ethereum.eth.v2.SignedBeaconBlockCapella
	(*SignedBeaconBlockDeneb)(nil),                    // 11: ethereum.eth.v2.SignedBeaconBlockDeneb
	(*SignedBlindedBeaconBlockBellatrix)(nil),         // 12: ethereum.eth.v2.SignedBlindedBeaconBlockBellatrix
	(*SignedBlindedBeaconBlockCapella)(nil),           // 13: ethereum.eth.v2.SignedBlindedBeaconBlockCapella
	(*SignedBlindedBeaconBlockDeneb)(nil),             // 14: ethereum.eth.v2.SignedBlindedBeaconBlockDeneb
	(*SignedBeaconBlockAltair)(nil),                   // 15: ethereum.eth.v2.SignedBeaconBlockAltair
	(*BeaconBlockBellatrix)(nil),                      // 16: ethereum.eth.v2.BeaconBlockBellatrix
	(*BlindedBeaconBlockBellatrix)(nil),               // 17: ethereum.eth.v2.BlindedBeaconBlockBellatrix
	(*BlindedBeaconBlockCapella)(nil),                 // 18: ethereum.eth.v2.BlindedBeaconBlockCapella
	...
	(*BlindedBeaconBlockBodyCapella)(nil),             // 23: ethereum.eth.v2.BlindedBeaconBlockBodyCapella
	(*BlindedBeaconBlockBodyDeneb)(nil),               // 24: ethereum.eth.v2.BlindedBeaconBlockBodyDeneb
	(*BeaconBlockBodyAltair)(nil),                     // 25: ethereum.eth.v2.BeaconBlockBodyAltair
	(*BeaconBlockCapella)(nil),                        // 26: ethereum.eth.v2.BeaconBlockCapella
	(*BeaconBlockBodyCapella)(nil),                    // 27: ethereum.eth.v2.BeaconBlockBodyCapella
	(*BeaconBlockDeneb)(nil),                          // 28: ethereum.eth.v2.BeaconBlockDeneb
	...
	(Version)(0),                                      // 31: ethereum.eth.v2.Version
	(*v1.BeaconBlock)(nil),                            // 32: ethereum.eth.v1.BeaconBlock
	...
	(*v11.ExecutionPayloadCapella)(nil),               // 45: ethereum.engine.v1.ExecutionPayloadCapella
	(*v11.ExecutionPayloadDeneb)(nil),                 // 46: ethereum.engine.v1.ExecutionPayloadDeneb
	(*BlindedBlobSidecars)(nil),                       // 47: ethereum.eth.v2.BlindedBlobSidecars
}
var file_proto_eth_v2_beacon_block_proto_depIdxs = []int32{
	31,  // 0: ethereum.eth.v2.BlockResponseV2.version:type_name -> ethereum.eth.v2.Version
	4,   // 1: ethereum.eth.v2.BlockResponseV2.data:type_name -> ethereum.eth.v2.SignedBeaconBlockContainer
	31,  // 2: ethereum.eth.v2.BlindedBlockResponse.version:type_name -> ethereum.eth.v2.Version
	6,   // 3: ethereum.eth.v2.BlindedBlockResponse.data:type_name -> ethereum.eth.v2.SignedBlindedBeaconBlockContainer
	32,  // 4: ethereum.eth.v2.BeaconBlockContainerV2.phase0_block:type_name -> ethereum.eth.v1.BeaconBlock
	20,  // 5: ethereum.eth.v2.BeaconBlockContainerV2.altair_block:type_name -> ethereum.eth.v2.BeaconBlockAltair
	16,  // 6: ethereum.eth.v2.BeaconBlockContainerV2.bellatrix_block:type_name -> ethereum.eth.v2.BeaconBlockBellatrix
	26,  // 7: ethereum.eth.v2.BeaconBlockContainerV2.capella_block:type_name -> ethereum.eth.v2.BeaconBlockCapella
	28,  // 8: ethereum.eth.v2.BeaconBlockContainerV2.deneb_block:type_name -> ethereum.eth.v2.BeaconBlockDeneb
	32,  // 9: ethereum.eth.v2.SignedBeaconBlockContainer.phase0_block:type_name -> ethereum.eth.v1.BeaconBlock
	20,  // 10: ethereum.eth.v2.SignedBeaconBlockContainer.altair_block:type_name -> ethereum.eth.v2.BeaconBlockAltair
	16,  // 11: ethereum.eth.v2.SignedBeaconBlockContainer.bellatrix_block:type_name -> ethereum.eth.v2.BeaconBlockBellatrix
	26,  // 12: ethereum.eth.v2.SignedBeaconBlockContainer.capella_block:type_name -> ethereum.eth.v2.BeaconBlockCapella
	28,  // 13: ethereum.eth.v2.SignedBeaconBlockContainer.deneb_block:type_name -> ethereum.eth.v2.BeaconBlockDeneb
	32,  // 14: ethereum.eth.v2.BlindedBeaconBlockContainer.phase0_block:type_name -> ethereum.eth.v1.BeaconBlock
	20,  // 15: ethereum.eth.v2.BlindedBeaconBlockContainer.altair_block:type_name -> ethereum.eth.v2.BeaconBlockAltair
	17,  // 16: ethereum.eth.v2.BlindedBeaconBlockContainer.bellatrix_block:type_name -> ethereum.eth.v2.BlindedBeaconBlockBellatrix
	18,  // 17: ethereum.eth.v2.BlindedBeaconBlockContainer.capella_block:type_name -> ethereum.eth.v2.BlindedBeaconBlockCapella
	19,  // 18: ethereum.eth.v2.BlindedBeaconBlockContainer.deneb_block:type_name -> ethereum.eth.v2.BlindedBeaconBlockDeneb
	32,  // 19: ethereum.eth.v2.SignedBlindedBeaconBlockContainer.phase0_block:type_name -> ethereum.eth.v1.BeaconBlock
	20,  // 20: ethereum.eth.v2.SignedBlindedBeaconBlockContainer.altair_block:type_name -> ethereum.eth.v2.BeaconBlockAltair
	17,  // 21: ethereum.eth.v2.SignedBlindedBeaconBlockContainer.bellatrix_block:type_name -> ethereum.eth.v2.BlindedBeaconBlockBellatrix
	18,  // 22: ethereum.eth.v2.SignedBlindedBeaconBlockContainer.capella_block:type_name -> ethereum.eth.v2.BlindedBeaconBlockCapella
	19,  // 23: ethereum.eth.v2.SignedBlindedBeaconBlockContainer.deneb_block:type_name -> ethereum.eth.v2.BlindedBeaconBlockDeneb
	32,  // 24: ethereum.eth.v2.BlindedBeaconBlockContentsContainer.phase0_block:type_name -> ethereum.eth.v1.BeaconBlock
	20,  // 25: ethereum.eth.v2.BlindedBeaconBlockContentsContainer.altair_block:type_name -> ethereum.eth.v2.BeaconBlockAltair
	17,  // 26: ethereum.eth.v2.BlindedBeaconBlockContentsContainer.bellatrix_block:type_name -> ethereum.eth.v2.BlindedBeaconBlockBellatrix
	18,  // 27: ethereum.eth.v2.BlindedBeaconBlockContentsContainer.capella_block:type_name -> ethereum.eth.v2.BlindedBeaconBlockCapella
	30,  // 28: ethereum.eth.v2.BlindedBeaconBlockContentsContainer.deneb_contents:type_name -> ethereum.eth.v2.BlindedBeaconBlockContentsDeneb
	32,  // 29: ethereum.eth.v2.SignedBlindedBeaconBlockContentsContainer.phase0_block:type_name -> ethereum.eth.v1.BeaconBlock
	20,  // 30: ethereum.eth.v2.SignedBlindedBeaconBlockContentsContainer.altair_block:type_name -> ethereum.eth.v2.BeaconBlockAltair
	17,  // 31: ethereum.eth.v2.SignedBlindedBeaconBlockContentsContainer.bellatrix_block:type_name -> ethereum.eth.v2.BlindedBeaconBlockBellatrix
	18,  // 32: ethereum.eth.v2.SignedBlindedBeaconBlockContentsContainer.capella_block:type_name -> ethereum.eth.v2.BlindedBeaconBlockCapella
	30,  // 33: ethereum.eth.v2.SignedBlindedBeaconBlockContentsContainer.deneb_contents:type_name -> ethereum.eth.v2.BlindedBeaconBlockContentsDeneb
	16,  // 34: ethereum.eth.v2.SignedBeaconBlockBellatrix.message:type_name -> ethereum.eth.v2.BeaconBlockBellatrix
	26,  // 35: ethereum.eth.v2.SignedBeaconBlockCapella.message:type_name -> ethereum.eth.v2.BeaconBlockCapella
	28,  // 36: ethereum.eth.v2.SignedBeaconBlockDeneb.message:type_name -> ethereum.eth.v2.BeaconBlockDeneb
	17,  // 37: ethereum.eth.v2.SignedBlindedBeaconBlockBellatrix.message:type_name -> ethereum.eth.v2.BlindedBeaconBlockBellatrix
	18,  // 38: ethereum.eth.v2.SignedBlindedBeaconBlockCapella.message:type_name -> ethereum.eth.v2.BlindedBeaconBlockCapella
	19,  // 39: ethereum.eth.v2.SignedBlindedBeaconBlockDeneb.message:type_name -> ethereum.eth.v2.BlindedBeaconBlockDeneb
	20,  // 40: ethereum.eth.v2.SignedBeaconBlockAltair.message:type_name -> ethereum.eth.v2.BeaconBlockAltair
	21,  // 41: ethereum.eth.v2.BeaconBlockBellatrix.body:type_name -> ethereum.eth.v2.BeaconBlockBodyBellatrix
	22,  // 42: ethereum.eth.v2.BlindedBeaconBlockBellatrix.body:type_name -> ethereum.eth.v2.BlindedBeaconBlockBodyBellatrix
	23,  // 43: ethereum.eth.v2.BlindedBeaconBlockCapella.body:type_name -> ethereum.eth.v2.BlindedBeaconBlockBodyCapella
	24,  // 44: ethereum.eth.v2.BlindedBeaconBlockDeneb.body:type_name -> ethereum.eth.v2.BlindedBeaconBlockBodyDeneb
	25,  // 45: ethereum.eth.v2.BeaconBlockAltair.body:type_name -> ethereum.eth.v2.BeaconBlockBodyAltair
	33,  // 46: ethereum.eth.v2.BeaconBlockBodyBellatrix.eth1_data:type_name -> ethereum.eth.v1.Eth1Data
	34,  // 47: ethereum.eth.v2.BeaconBlockBodyBellatrix.proposer_slashings:type_name -> ethereum.eth.v1.ProposerSlashing
	35,  // 48: ethereum.eth.v2.BeaconBlockBodyBellatrix.attester_slashings:type_name -> ethereum.eth.v1.AttesterSlashing
	36,  // 49: ethereum.eth.v2.BeaconBlockBodyBellatrix.attestations:type_name -> ethereum.eth.v1.Attestation
	37,  // 50: ethereum.eth.v2.BeaconBlockBodyBellatrix.deposits:type_name -> ethereum.eth.v1.Deposit
	38,  // 51: ethereum.eth.v2.BeaconBlockBodyBellatrix.voluntary_exits:type_name -> ethereum.eth.v1.SignedVoluntaryExit
	39,  // 52: ethereum.eth.v2.BeaconBlockBodyBellatrix.sync_aggregate:type_name -> ethereum.eth.v1.SyncAggregate
	40,  // 53: ethereum.eth.v2.BeaconBlockBodyBellatrix.execution_payload:type_name -> ethereum.engine.v1.ExecutionPayload
	33,  // 54: ethereum.eth.v2.BlindedBeaconBlockBodyBellatrix.eth1_data:type_name -> ethereum.eth.v1.Eth1Data
	34,  // 55: ethereum.eth.v2.BlindedBeaconBlockBodyBellatrix.proposer_slashings:type_name -> ethereum.eth.v1.ProposerSlashing
	35,  // 56: ethereum.eth.v2.BlindedBeaconBlockBodyBellatrix.attester_slashings:type_name -> ethereum.eth.v1.AttesterSlashing
	36,  // 57: ethereum.eth.v2.BlindedBeaconBlockBodyBellatrix.attestations:type_name -> ethereum.eth.v1.Attestation
	37,  // 58: ethereum.eth.v2.BlindedBeaconBlockBodyBellatrix.deposits:type_name -> ethereum.eth.v1.Deposit
	38,  // 59: ethereum.eth.v2.BlindedBeaconBlockBodyBellatrix.voluntary_exits:type_name -> ethereum.eth.v1.SignedVoluntaryExit
	39,  // 60: ethereum.eth.v2.BlindedBeaconBlockBodyBellatrix.sync_aggregate:type_name -> ethereum.eth.v1.SyncAggregate
	41,  // 61: ethereum.eth.v2.BlindedBeaconBlockBodyBellatrix.execution_payload_header:type_name -> ethereum.engine.v1.ExecutionPayloadHeader
	33,  // 62: ethereum.eth.v2.BlindedBeaconBlockBodyCapella.eth1_data:type_name -> ethereum.eth.v1.Eth1Data
	34,  // 63: ethereum.eth.v2.BlindedBeaconBlockBodyCapella.proposer_slashings:type_name -> ethereum.eth.v1.ProposerSlashing
	35,  // 64: ethereum.eth.v2.BlindedBeaconBlockBodyCapella.attester_slashings:type_name -> ethereum.eth.v1.AttesterSlashing
	36,  // 65: ethereum.eth.v2.BlindedBeaconBlockBodyCapella.attestations:type_name -> ethereum.eth.v1.Attestation
	37,  // 66: ethereum.eth.v2.BlindedBeaconBlockBodyCapella.deposits:type_name -> ethereum.eth.v1.Deposit
	38,  // 67: ethereum.eth.v2.BlindedBeaconBlockBodyCapella.voluntary_exits:type_name -> ethereum.eth.v1.SignedVoluntaryExit
	39,  // 68: ethereum.eth.v2.BlindedBeaconBlockBodyCapella.sync_aggregate:type_name -> ethereum.eth.v1.SyncAggregate
	42,  // 69: ethereum.eth.v2.BlindedBeaconBlockBodyCapella.execution_payload_header:type_name -> ethereum.engine.v1.ExecutionPayloadHeaderCapella
	43,  // 70: ethereum.eth.v2.BlindedBeaconBlockBodyCapella.bls_to_execution_changes:type_name -> ethereum.eth.v2.SignedBLSToExecutionChange
	33,  // 71: ethereum.eth.v2.BlindedBeaconBlockBodyDeneb.eth1_data:type_name -> ethereum.eth.v1.Eth1Data
	34,  // 72: ethereum.eth.v2.BlindedBeaconBlockBodyDeneb.proposer_slashings:type_name -> ethereum.eth.v1.ProposerSlashing
	35,  // 73: ethereum.eth.v2.BlindedBeaconBlockBodyDeneb.attester_slashings:type_name -> ethereum.eth.v1.AttesterSlashing
	36,  // 74: ethereum.eth.v2.BlindedBeaconBlockBodyDeneb.attestations:type_name -> ethereum.eth.v1.Attestation
	37,  // 75: ethereum.eth.v2.BlindedBeaconBlockBodyDeneb.deposits:type_name -> ethereum.eth.v1.Deposit
	38,  // 76: ethereum.eth.v2.BlindedBeaconBlockBodyDeneb.voluntary_exits:type_name -> ethereum.eth.v1.SignedVoluntaryExit
	39,  // 77: ethereum.eth.v2.BlindedBeaconBlockBodyDeneb.sync_aggregate:type_name -> ethereum.eth.v1.SyncAggregate
	44,  // 78: ethereum.eth.v2.BlindedBeaconBlockBodyDeneb.execution_payload_header:type_name -> ethereum.engine.v1.ExecutionPayloadHeaderDeneb
	43,  // 79: ethereum.eth.v2.BlindedBeaconBlockBodyDeneb.bls_to_execution_changes:type_name -> ethereum.eth.v2.SignedBLSToExecutionChange
	33,  // 80: ethereum.eth.v2.BeaconBlockBodyAltair.eth1_data:type_name -> ethereum.eth.v1.Eth1Data
	34,  // 81: ethereum.eth.v2.BeaconBlockBodyAltair.proposer_slashings:type_name -> ethereum.eth.v1.ProposerSlashing
	35,  // 82: ethereum.eth.v2.BeaconBlockBodyAltair.attester_slashings:type_name -> ethereum.eth.v1.AttesterSlashing
	36,  // 83: ethereum.eth.v2.BeaconBlockBodyAltair.attestations:type_name -> ethereum.eth.v1.Attestation
	37,  // 84: ethereum.eth.v2.BeaconBlockBodyAltair.deposits:type_name -> ethereum.eth.v1.Deposit
	38,  // 85: ethereum.eth.v2.BeaconBlockBodyAltair.voluntary_exits:type_name -> ethereum.eth.v1.SignedVoluntaryExit
	39,  // 86: ethereum.eth.v2.BeaconBlockBodyAltair.sync_aggregate:type_name -> ethereum.eth.v1.SyncAggregate
	27,  // 87: ethereum.eth.v2.BeaconBlockCapella.body:type_name -> ethereum.eth.v2.BeaconBlockBodyCapella
	33,  // 88: ethereum.eth.v2.BeaconBlockBodyCapella.eth1_data:type_name -> ethereum.eth.v1.Eth1Data
	34,  // 89: ethereum.eth.v2.BeaconBlockBodyCapella.proposer_slashings:type_name -> ethereum.eth.v1.ProposerSlashing
	35,  // 90: ethereum.eth.v2.BeaconBlockBodyCapella.attester_slashings:type_name -> ethereum.eth.v1.AttesterSlashing
	36,  // 91: ethereum.eth.v2.BeaconBlockBodyCapella.attestations:type_name -> ethereum.eth.v1.Attestation
	37,  // 92: ethereum.eth.v2.BeaconBlockBodyCapella.deposits:type_name -> ethereum.eth.v1.Deposit
	38,  // 93: ethereum.eth.v2.BeaconBlockBodyCapella.voluntary_exits:type_name -> ethereum.eth.v1.SignedVoluntaryExit
	39,  // 94: ethereum.eth.v2.BeaconBlockBodyCapella.sync_aggregate:type_name -> ethereum.eth.v1.SyncAggregate
	45,  // 95: ethereum.eth.v2.BeaconBlockBodyCapella.execution_payload:type_name -> ethereum.engine.v1.ExecutionPayloadCapella
	43,  // 96: ethereum.eth.v2.BeaconBlockBodyCapella.bls_to_execution_changes:type_name -> ethereum.eth.v2.SignedBLSToExecutionChange
	29,  // 97: ethereum.eth.v2.BeaconBlockDeneb.body:type_name -> ethereum.eth.v2.BeaconBlockBodyDeneb
	33,  // 98: ethereum.eth.v2.BeaconBlockBodyDeneb.eth1_data:type_name -> ethereum.eth.v1.Eth1Data
	34,  // 99: ethereum.eth.v2.BeaconBlockBodyDeneb.proposer_slashings:type_name -> ethereum.eth.v1.ProposerSlashing
	35,  // 100: ethereum.eth.v2.BeaconBlockBodyDeneb.attester_slashings:type_name -> ethereum.eth.v1.AttesterSlashing
	36,  // 101: ethereum.eth.v2.BeaconBlockBodyDeneb.attestations:type_name -> ethereum.eth.v1.Attestation
	37,  // 102: ethereum.eth.v2.BeaconBlockBodyDeneb.deposits:type_name -> ethereum.eth.v1.Deposit
	38,  // 103: ethereum.eth.v2.BeaconBlockBodyDeneb.voluntary_exits:type_name -> ethereum.eth.v1.SignedVoluntaryExit
	39,  // 104: ethereum.eth.v2.BeaconBlockBodyDeneb.sync_aggregate:type_name -> ethereum.eth.v1.SyncAggregate
	46,  // 105: ethereum.eth.v2.BeaconBlockBodyDeneb.execution_payload:type_name -> ethereum.engine.v1.ExecutionPayloadDeneb
	43,  // 106: ethereum.eth.v2.BeaconBlockBodyDeneb.bls_to_execution_changes:type_name -> ethereum.eth.v2.SignedBLSToExecutionChange
	19,  // 107: ethereum.eth.v2.BlindedBeaconBlockContentsDeneb.blinded_block:type_name -> ethereum.eth.v2.BlindedBeaconBlockDeneb
	47,  // 108: ethereum.eth.v2.BlindedBeaconBlockContentsDeneb.blinded_blob_sidecars:type_name -> ethereum.eth.v2.BlindedBlobSidecars
...
func file_proto_eth_v2_beacon_block_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_proto_eth_v2_beacon_block_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*BlindedBeaconBlockContentsContainer); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_proto_eth_v2_beacon_block_proto_msgTypes[3].OneofWrappers = []interface{}{
		...
		(*BeaconBlockContainerV2_DenebBlock)(nil),
	}
	...
	file_proto_eth_v2_beacon_block_proto_msgTypes[7].OneofWrappers = []interface{}{
		(*BlindedBeaconBlockContentsContainer_Phase0Block)(nil),
		(*BlindedBeaconBlockContentsContainer_AltairBlock)(nil),
		(*BlindedBeaconBlockContentsContainer_BellatrixBlock)(nil),
		(*BlindedBeaconBlockContentsContainer_CapellaBlock)(nil),
		(*BlindedBeaconBlockContentsContainer_DenebContents)(nil),
	}
