...
func (x *BeaconBlockContainerAltair) GetMessage() *BeaconBlockAltair {
	if x != nil {
		return x.Message
	}
	return nil
...
func (x *BeaconBlockContainerAltair) GetSignature() []byte {
	if x != nil {
		return x.Signature
	}
	return nil
...
var file_proto_eth_v2_beacon_block_proto_rawDesc = []byte{
	...
	0x02, 0x39, 0x36, 0x52, 0x09, 0x73, 0x69, 0x67, 0x6e, 0x61, 0x74, 0x75, 0x72, 0x65, 0x22, 0x80,
	0x01, 0x0a, 0x1a, 0x42, 0x65, 0x61, 0x63, 0x6f, 0x6e, 0x42, 0x6c, 0x6f, 0x63, 0x6b, 0x43, 0x6f,
	0x6e, 0x74, 0x61, 0x69, 0x6e, 0x65, 0x72, 0x41, 0x6c, 0x74, 0x61, 0x69, 0x72, 0x12, 0x3c, 0x0a,
	...
	0x65, 0x22, 0xc0, 0x02, 0x0a, 0x11, 0x42, 0x65, 0x61, 0x63, 0x6f, 0x6e, 0x42, 0x6c, 0x6f, 0x63,
...
var file_proto_eth_v2_beacon_block_proto_goTypes = []interface{}{
	...
	(*BeaconBlockContainerAltair)(nil), // 4: ethereum.eth.v2.BeaconBlockContainerAltair
...
var file_proto_eth_v2_beacon_block_proto_depIdxs = []int32{
	...
	5,  // 3: ethereum.eth.v2.BeaconBlockContainerAltair.message:type_name -> ethereum.eth.v2.BeaconBlockAltair
