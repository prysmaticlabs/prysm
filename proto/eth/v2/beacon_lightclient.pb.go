...
type LightClientUpdateInternal struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	AttestedHeader          []byte                                                            `protobuf:"bytes,1,opt,name=attested_header,json=attestedHeader,proto3" json:"attested_header,omitempty" ssz-max:"2147483647"`
	NextSyncCommittee       *SyncCommittee                                                    `protobuf:"bytes,2,opt,name=next_sync_committee,json=nextSyncCommittee,proto3" json:"next_sync_committee,omitempty"`
	...
	FinalizedHeader         []byte                                                            `protobuf:"bytes,4,opt,name=finalized_header,json=finalizedHeader,proto3" json:"finalized_header,omitempty" ssz-max:"2147483647"`
...
func (x *LightClientUpdateInternal) Reset() {
	*x = LightClientUpdateInternal{}
	if protoimpl.UnsafeEnabled {
		mi := &file_proto_eth_v2_beacon_lightclient_proto_msgTypes[11]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *LightClientUpdateInternal) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*LightClientUpdateInternal) ProtoMessage() {}

func (x *LightClientUpdateInternal) ProtoReflect() protoreflect.Message {
	mi := &file_proto_eth_v2_beacon_lightclient_proto_msgTypes[11]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use LightClientUpdateInternal.ProtoReflect.Descriptor instead.
func (*LightClientUpdateInternal) Descriptor() ([]byte, []int) {
	return file_proto_eth_v2_beacon_lightclient_proto_rawDescGZIP(), []int{11}
}

func (x *LightClientUpdateInternal) GetAttestedHeader() []byte {
	if x != nil {
		return x.AttestedHeader
	}
	return nil
...
func (x *LightClientUpdateInternal) GetNextSyncCommittee() *SyncCommittee {
	if x != nil {
		return x.NextSyncCommittee
	}
	return nil
...
func (x *LightClientUpdateInternal) GetNextSyncCommitteeBranch() [][]byte {
	if x != nil {
		return x.NextSyncCommitteeBranch
	}
	return nil
...
func (x *LightClientUpdateInternal) GetFinalizedHeader() []byte {
	if x != nil {
		return x.FinalizedHeader
	}
	return nil
...
func (x *LightClientUpdateInternal) GetFinalityBranch() [][]byte {
	if x != nil {
		return x.FinalityBranch
	}
	return nil
...
func (x *LightClientUpdateInternal) GetSyncAggregate() *v1.SyncAggregate {
	if x != nil {
		return x.SyncAggregate
	}
	return nil
...
func (x *LightClientUpdateInternal) GetSignatureSlot() github_com_prysmaticlabs_prysm_v5_consensus_types_primitives.Slot {
	if x != nil {
		return x.SignatureSlot
	}
	return github_com_prysmaticlabs_prysm_v5_consensus_types_primitives.Slot(0)
...
type LightClientFinalityUpdateInternal struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	AttestedHeader  []byte                                                            `protobuf:"bytes,1,opt,name=attested_header,json=attestedHeader,proto3" json:"attested_header,omitempty" ssz-max:"2147483647"`
	FinalizedHeader []byte                                                            `protobuf:"bytes,2,opt,name=finalized_header,json=finalizedHeader,proto3" json:"finalized_header,omitempty" ssz-max:"2147483647"`
...
func (x *LightClientFinalityUpdateInternal) Reset() {
	*x = LightClientFinalityUpdateInternal{}
	if protoimpl.UnsafeEnabled {
		mi := &file_proto_eth_v2_beacon_lightclient_proto_msgTypes[12]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *LightClientFinalityUpdateInternal) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*LightClientFinalityUpdateInternal) ProtoMessage() {}

func (x *LightClientFinalityUpdateInternal) ProtoReflect() protoreflect.Message {
	mi := &file_proto_eth_v2_beacon_lightclient_proto_msgTypes[12]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use LightClientFinalityUpdateInternal.ProtoReflect.Descriptor instead.
func (*LightClientFinalityUpdateInternal) Descriptor() ([]byte, []int) {
	return file_proto_eth_v2_beacon_lightclient_proto_rawDescGZIP(), []int{12}
}

func (x *LightClientFinalityUpdateInternal) GetAttestedHeader() []byte {
	if x != nil {
		return x.AttestedHeader
	}
	return nil
...
func (x *LightClientFinalityUpdateInternal) GetFinalizedHeader() []byte {
	if x != nil {
		return x.FinalizedHeader
	}
	return nil
...
func (x *LightClientFinalityUpdateInternal) GetFinalityBranch() [][]byte {
	if x != nil {
		return x.FinalityBranch
	}
	return nil
...
func (x *LightClientFinalityUpdateInternal) GetSyncAggregate() *v1.SyncAggregate {
	if x != nil {
		return x.SyncAggregate
	}
	return nil
...
func (x *LightClientFinalityUpdateInternal) GetSignatureSlot() github_com_prysmaticlabs_prysm_v5_consensus_types_primitives.Slot {
	if x != nil {
		return x.SignatureSlot
	}
	return github_com_prysmaticlabs_prysm_v5_consensus_types_primitives.Slot(0)
...
type LightClientOptimisticUpdateInternal struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *LightClientOptimisticUpdateInternal) Reset() {
	*x = LightClientOptimisticUpdateInternal{}
	if protoimpl.UnsafeEnabled {
		mi := &file_proto_eth_v2_beacon_lightclient_proto_msgTypes[13]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *LightClientOptimisticUpdateInternal) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*LightClientOptimisticUpdateInternal) ProtoMessage() {}

func (x *LightClientOptimisticUpdateInternal) ProtoReflect() protoreflect.Message {
	mi := &file_proto_eth_v2_beacon_lightclient_proto_msgTypes[13]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use LightClientOptimisticUpdateInternal.ProtoReflect.Descriptor instead.
func (*LightClientOptimisticUpdateInternal) Descriptor() ([]byte, []int) {
	return file_proto_eth_v2_beacon_lightclient_proto_rawDescGZIP(), []int{13}
}

func (x *LightClientOptimisticUpdateInternal) GetAttestedHeader() []byte {
	if x != nil {
		return x.AttestedHeader
	}
	return nil
...
func (x *LightClientOptimisticUpdateInternal) GetSyncAggregate() *v1.SyncAggregate {
	if x != nil {
		return x.SyncAggregate
	}
	return nil
...
func (x *LightClientOptimisticUpdateInternal) GetSignatureSlot() github_com_prysmaticlabs_prysm_v5_consensus_types_primitives.Slot {
	if x != nil {
		return x.SignatureSlot
	}
	return github_com_prysmaticlabs_prysm_v5_consensus_types_primitives.Slot(0)
...
var file_proto_eth_v2_beacon_lightclient_proto_rawDesc = []byte{
	...
	0x48, 0x65, 0x61, 0x64, 0x65, 0x72, 0x52, 0x06, 0x62, 0x65, 0x61, 0x63, 0x6f, 0x6e, 0x22, 0xdc,
	...
	0x78, 0x65, 0x63, 0x75, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x33, 0x0a, 0x10, 0x65, 0x78, 0x65, 0x63,
	0x75, 0x74, 0x69, 0x6f, 0x6e, 0x5f, 0x62, 0x72, 0x61, 0x6e, 0x63, 0x68, 0x18, 0x03, 0x20, 0x03,
	0x28, 0x0c, 0x42, 0x08, 0x8a, 0xb5, 0x18, 0x04, 0x34, 0x2c, 0x33, 0x32, 0x52, 0x0f, 0x65, 0x78,
	0x65, 0x63, 0x75, 0x74, 0x69, 0x6f, 0x6e, 0x42, 0x72, 0x61, 0x6e, 0x63, 0x68, 0x22, 0xd8, 0x01,
	0x0a, 0x16, 0x4c, 0x69, 0x67, 0x68, 0x74, 0x43, 0x6c, 0x69, 0x65, 0x6e, 0x74, 0x48, 0x65, 0x61,
	0x64, 0x65, 0x72, 0x44, 0x65, 0x6e, 0x65, 0x62, 0x12, 0x3a, 0x0a, 0x06, 0x62, 0x65, 0x61, 0x63,
	0x6f, 0x6e, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x22, 0x2e, 0x65, 0x74, 0x68, 0x65, 0x72,
	...
	0x61, 0x63, 0x6f, 0x6e, 0x12, 0x4d, 0x0a, 0x09, 0x65, 0x78, 0x65, 0x63, 0x75, 0x74, 0x69, 0x6f,
	0x6e, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x2f, 0x2e, 0x65, 0x74, 0x68, 0x65, 0x72, 0x65,
	...
	0x6f, 0x6e, 0x42, 0x72, 0x61, 0x6e, 0x63, 0x68, 0x22, 0x93, 0x02, 0x0a, 0x1a, 0x4c, 0x69, 0x67,
	0x68, 0x74, 0x43, 0x6c, 0x69, 0x65, 0x6e, 0x74, 0x48, 0x65, 0x61, 0x64, 0x65, 0x72, 0x43, 0x6f,
	0x6e, 0x74, 0x61, 0x69, 0x6e, 0x65, 0x72, 0x12, 0x49, 0x0a, 0x0d, 0x68, 0x65, 0x61, 0x64, 0x65,
	0x72, 0x5f, 0x61, 0x6c, 0x74, 0x61, 0x69, 0x72, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x22,
	...
	0x65, 0x72, 0x48, 0x00, 0x52, 0x0c, 0x68, 0x65, 0x61, 0x64, 0x65, 0x72, 0x41, 0x6c, 0x74, 0x61,
	0x69, 0x72, 0x12, 0x52, 0x0a, 0x0e, 0x68, 0x65, 0x61, 0x64, 0x65, 0x72, 0x5f, 0x63, 0x61, 0x70,
	0x65, 0x6c, 0x6c, 0x61, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x29, 0x2e, 0x65, 0x74, 0x68,
	...
	0x70, 0x65, 0x6c, 0x6c, 0x61, 0x48, 0x00, 0x52, 0x0d, 0x68, 0x65, 0x61, 0x64, 0x65, 0x72, 0x43,
	0x61, 0x70, 0x65, 0x6c, 0x6c, 0x61, 0x12, 0x4c, 0x0a, 0x0c, 0x68, 0x65, 0x61, 0x64, 0x65, 0x72,
	0x5f, 0x64, 0x65, 0x6e, 0x65, 0x62, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x27, 0x2e, 0x65,
	...
	,
	...
	0x65, 0x65, 0x12, 0x41, 0x0a, 0x1d, 0x63, 0x75, 0x72, 0x72, 0x65, 0x6e, 0x74, 0x5f, 0x73, 0x79,
	0x6e, 0x63, 0x5f, 0x63, 0x6f, 0x6d, 0x6d, 0x69, 0x74, 0x74, 0x65, 0x65, 0x5f, 0x62, 0x72, 0x61,
	0x6e, 0x63, 0x68, 0x18, 0x03, 0x20, 0x03, 0x28, 0x0c, 0x52, 0x1a, 0x63, 0x75, 0x72, 0x72, 0x65,
	0x6e, 0x74, 0x53, 0x79, 0x6e, 0x63, 0x43, 0x6f, 0x6d, 0x6d, 0x69, 0x74, 0x74, 0x65, 0x65, 0x42,
	0x72, 0x61, 0x6e, 0x63, 0x68, 0x22, 0xac, 0x04, 0x0a, 0x11, 0x4c, 0x69, 0x67, 0x68, 0x74, 0x43,
	0x6c, 0x69, 0x65, 0x6e, 0x74, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x12, 0x54, 0x0a, 0x0f, 0x61,
	...
	0x72, 0x12, 0x4e, 0x0a, 0x13, 0x6e, 0x65, 0x78, 0x74, 0x5f, 0x73, 0x79, 0x6e, 0x63, 0x5f, 0x63,
	0x6f, 0x6d, 0x6d, 0x69, 0x74, 0x74, 0x65, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1e,
	0x2e, 0x65, 0x74, 0x68, 0x65, 0x72, 0x65, 0x75, 0x6d, 0x2e, 0x65, 0x74, 0x68, 0x2e, 0x76, 0x32,
	...
	,
	...
	0x53, 0x6c, 0x6f, 0x74, 0x22, 0x9a, 0x01, 0x0a, 0x24, 0x4c, 0x69, 0x67, 0x68, 0x74, 0x43, 0x6c,
	0x69, 0x65, 0x6e, 0x74, 0x46, 0x69, 0x6e, 0x61, 0x6c, 0x69, 0x74, 0x79, 0x55, 0x70, 0x64, 0x61,
	0x74, 0x65, 0x57, 0x69, 0x74, 0x68, 0x56, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x12, 0x32, 0x0a,
	...
	0x6e, 0x12, 0x3e, 0x0a, 0x04, 0x64, 0x61, 0x74, 0x61, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32,
	...
	,
	...
	0x64, 0x65, 0x72, 0x43, 0x6f, 0x6e, 0x74, 0x61, 0x69, 0x6e, 0x65, 0x72, 0x52, 0x0f, 0x66, 0x69,
	...
	0x67, 0x6e, 0x61, 0x74, 0x75, 0x72, 0x65, 0x53, 0x6c, 0x6f, 0x74, 0x22, 0x9e, 0x01, 0x0a, 0x26,
	...
	0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x52, 0x04, 0x64, 0x61, 0x74, 0x61, 0x22, 0xa8, 0x02, 0x0a,
	0x1b, 0x4c, 0x69, 0x67, 0x68, 0x74, 0x43, 0x6c, 0x69, 0x65, 0x6e, 0x74, 0x4f, 0x70, 0x74, 0x69,
	0x6d, 0x69, 0x73, 0x74, 0x69, 0x63, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x12, 0x54, 0x0a, 0x0f,
	...
	0x65, 0x6e, 0x74, 0x48, 0x65, 0x61, 0x64, 0x65, 0x72, 0x43, 0x6f, 0x6e, 0x74, 0x61, 0x69, 0x6e,
	0x65, 0x72, 0x52, 0x0e, 0x61, 0x74, 0x74, 0x65, 0x73, 0x74, 0x65, 0x64, 0x48, 0x65, 0x61, 0x64,
	0x65, 0x72, 0x12, 0x45, 0x0a, 0x0e, 0x73, 0x79, 0x6e, 0x63, 0x5f, 0x61, 0x67, 0x67, 0x72, 0x65,
	0x67, 0x61, 0x74, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1e, 0x2e, 0x65, 0x74, 0x68,
	...
	0x75, 0x72, 0x65, 0x53, 0x6c, 0x6f, 0x74, 0x22, 0x8a, 0x01, 0x0a, 0x1c, 0x4c, 0x69, 0x67, 0x68,
	0x74, 0x43, 0x6c, 0x69, 0x65, 0x6e, 0x74, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x57, 0x69, 0x74,
	0x68, 0x56, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x12, 0x32, 0x0a, 0x07, 0x76, 0x65, 0x72, 0x73,
	...
	,
	...
	0x63, 0x68, 0x12, 0x39, 0x0a, 0x10, 0x66, 0x69, 0x6e, 0x61, 0x6c, 0x69, 0x7a, 0x65, 0x64, 0x5f,
	0x68, 0x65, 0x61, 0x64, 0x65, 0x72, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0c, 0x42, 0x0e, 0x92, 0xb5,
	0x18, 0x0a, 0x32, 0x31, 0x34, 0x37, 0x34, 0x38, 0x33, 0x36, 0x34, 0x37, 0x52, 0x0f, 0x66, 0x69,
	...
	0x74, 0x65, 0x18, 0x06, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1e, 0x2e, 0x65, 0x74, 0x68, 0x65, 0x72,
	...
	,
	...
	,
	...
	0x73, 0x69, 0x67, 0x6e, 0x61, 0x74, 0x75, 0x72, 0x65, 0x53, 0x6c, 0x6f, 0x74, 0x42, 0x83, 0x01,
...
var file_proto_eth_v2_beacon_lightclient_proto_msgTypes = make([]protoimpl.MessageInfo, 14)
var file_proto_eth_v2_beacon_lightclient_proto_goTypes = []interface{}{
	...
	(*LightClientUpdateInternal)(nil),              // 11: ethereum.eth.v2.LightClientUpdateInternal
	(*LightClientFinalityUpdateInternal)(nil),      // 12: ethereum.eth.v2.LightClientFinalityUpdateInternal
	(*LightClientOptimisticUpdateInternal)(nil),    // 13: ethereum.eth.v2.LightClientOptimisticUpdateInternal
	...
	(*v1.SyncAggregate)(nil),                       // 18: ethereum.eth.v1.SyncAggregate
	(Version)(0),                                   // 19: ethereum.eth.v2.Version
}
var file_proto_eth_v2_beacon_lightclient_proto_depIdxs = []int32{
	14, // 0: ethereum.eth.v2.LightClientHeader.beacon:type_name -> ethereum.eth.v1.BeaconBlockHeader
	14, // 1: ethereum.eth.v2.LightClientHeaderCapella.beacon:type_name -> ethereum.eth.v1.BeaconBlockHeader
	15, // 2: ethereum.eth.v2.LightClientHeaderCapella.execution:type_name -> ethereum.engine.v1.ExecutionPayloadHeaderCapella
	14, // 3: ethereum.eth.v2.LightClientHeaderDeneb.beacon:type_name -> ethereum.eth.v1.BeaconBlockHeader
	16, // 4: ethereum.eth.v2.LightClientHeaderDeneb.execution:type_name -> ethereum.engine.v1.ExecutionPayloadHeaderDeneb
	...
	17, // 9: ethereum.eth.v2.LightClientBootstrap.current_sync_committee:type_name -> ethereum.eth.v2.SyncCommittee
	3,  // 10: ethereum.eth.v2.LightClientUpdate.attested_header:type_name -> ethereum.eth.v2.LightClientHeaderContainer
	17, // 11: ethereum.eth.v2.LightClientUpdate.next_sync_committee:type_name -> ethereum.eth.v2.SyncCommittee
	3,  // 12: ethereum.eth.v2.LightClientUpdate.finalized_header:type_name -> ethereum.eth.v2.LightClientHeaderContainer
	18, // 13: ethereum.eth.v2.LightClientUpdate.sync_aggregate:type_name -> ethereum.eth.v1.SyncAggregate
	19, // 14: ethereum.eth.v2.LightClientFinalityUpdateWithVersion.version:type_name -> ethereum.eth.v2.Version
	...
	18, // 18: ethereum.eth.v2.LightClientFinalityUpdate.sync_aggregate:type_name -> ethereum.eth.v1.SyncAggregate
	19, // 19: ethereum.eth.v2.LightClientOptimisticUpdateWithVersion.version:type_name -> ethereum.eth.v2.Version
	...
	18, // 22: ethereum.eth.v2.LightClientOptimisticUpdate.sync_aggregate:type_name -> ethereum.eth.v1.SyncAggregate
	19, // 23: ethereum.eth.v2.LightClientUpdateWithVersion.version:type_name -> ethereum.eth.v2.Version
	5,  // 24: ethereum.eth.v2.LightClientUpdateWithVersion.data:type_name -> ethereum.eth.v2.LightClientUpdate
	17, // 25: ethereum.eth.v2.LightClientUpdateInternal.next_sync_committee:type_name -> ethereum.eth.v2.SyncCommittee
	18, // 26: ethereum.eth.v2.LightClientUpdateInternal.sync_aggregate:type_name -> ethereum.eth.v1.SyncAggregate
	18, // 27: ethereum.eth.v2.LightClientFinalityUpdateInternal.sync_aggregate:type_name -> ethereum.eth.v1.SyncAggregate
	18, // 28: ethereum.eth.v2.LightClientOptimisticUpdateInternal.sync_aggregate:type_name -> ethereum.eth.v1.SyncAggregate
...
func file_proto_eth_v2_beacon_lightclient_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_proto_eth_v2_beacon_lightclient_proto_msgTypes[11].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*LightClientUpdateInternal); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_proto_eth_v2_beacon_lightclient_proto_msgTypes[12].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*LightClientFinalityUpdateInternal); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_proto_eth_v2_beacon_lightclient_proto_msgTypes[13].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*LightClientOptimisticUpdateInternal); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
