...
func (*GetGasLimitResponse_GasLimit) Descriptor() ([]byte, []int) {
	return file_proto_eth_service_key_management_proto_rawDescGZIP(), []int{10, 0}
}
...
var file_proto_eth_service_key_management_proto_msgTypes = make([]protoimpl.MessageInfo, 16)
