...
var file_proto_eth_service_beacon_chain_service_proto_rawDesc = []byte{
	...
	0x6f, 0x32, 0xd0, 0x1d, 0x0a, 0x0b, 0x42, 0x65, 0x61, 0x63, 0x6f, 0x6e, 0x43, 0x68, 0x61, 0x69,
	...
	0x6f, 0x12, 0x89, 0x01, 0x0a, 0x0e, 0x47, 0x65, 0x74, 0x42, 0x6c, 0x6f, 0x63, 0x6b, 0x48, 0x65,
...
var file_proto_eth_service_beacon_chain_service_proto_goTypes = []interface{}{
	...
	(*v2.SignedBeaconBlockContentsContainer)(nil),        // 5: ethereum.eth.v2.SignedBeaconBlockContentsContainer
	(*v2.SSZContainer)(nil),                              // 6: ethereum.eth.v2.SSZContainer
	(*v2.SignedBlindedBeaconBlockContentsContainer)(nil), // 7: ethereum.eth.v2.SignedBlindedBeaconBlockContentsContainer
	(*v2.BlockRequestV2)(nil),                            // 8: ethereum.eth.v2.BlockRequestV2
	(*v1.AttesterSlashing)(nil),                          // 9: ethereum.eth.v1.AttesterSlashing
	(*v1.ProposerSlashing)(nil),                          // 10: ethereum.eth.v1.ProposerSlashing
	(*v2.SubmitBLSToExecutionChangesRequest)(nil),        // 11: ethereum.eth.v2.SubmitBLSToExecutionChangesRequest
	(*v1.GenesisResponse)(nil),                           // 12: ethereum.eth.v1.GenesisResponse
	(*v1.WeakSubjectivityResponse)(nil),                  // 13: ethereum.eth.v1.WeakSubjectivityResponse
	(*v1.StateRootResponse)(nil),                         // 14: ethereum.eth.v1.StateRootResponse
	(*v1.StateFinalityCheckpointResponse)(nil),           // 15: ethereum.eth.v1.StateFinalityCheckpointResponse
	(*v2.StateSyncCommitteesResponse)(nil),               // 16: ethereum.eth.v2.StateSyncCommitteesResponse
	(*v2.RandaoResponse)(nil),                            // 17: ethereum.eth.v2.RandaoResponse
	(*v1.BlockHeaderResponse)(nil),                       // 18: ethereum.eth.v1.BlockHeaderResponse
	(*v1.BlockResponse)(nil),                             // 19: ethereum.eth.v1.BlockResponse
	(*v1.BlockSSZResponse)(nil),                          // 20: ethereum.eth.v1.BlockSSZResponse
	(*v2.BlockResponseV2)(nil),                           // 21: ethereum.eth.v2.BlockResponseV2
	(*v2.BlindedBlockResponse)(nil),                      // 22: ethereum.eth.v2.BlindedBlockResponse
	(*v1.BlockAttestationsResponse)(nil),                 // 23: ethereum.eth.v1.BlockAttestationsResponse
	(*v1.AttesterSlashingsPoolResponse)(nil),             // 24: ethereum.eth.v1.AttesterSlashingsPoolResponse
	(*v1.ProposerSlashingPoolResponse)(nil),              // 25: ethereum.eth.v1.ProposerSlashingPoolResponse
	(*v2.BLSToExecutionChangesPoolResponse)(nil),         // 26: ethereum.eth.v2.BLSToExecutionChangesPoolResponse
	(*v1.ForkScheduleResponse)(nil),                      // 27: ethereum.eth.v1.ForkScheduleResponse
	(*v1.SpecResponse)(nil),                              // 28: ethereum.eth.v1.SpecResponse
}
var file_proto_eth_service_beacon_chain_service_proto_depIdxs = []int32{
	...
	4,  // 6: ethereum.eth.service.BeaconChain.GetBlockHeader:input_type -> ethereum.eth.v1.BlockRequest
	5,  // 7: ethereum.eth.service.BeaconChain.SubmitBlock:input_type -> ethereum.eth.v2.SignedBeaconBlockContentsContainer
	6,  // 8: ethereum.eth.service.BeaconChain.SubmitBlockSSZ:input_type -> ethereum.eth.v2.SSZContainer
	7,  // 9: ethereum.eth.service.BeaconChain.SubmitBlindedBlock:input_type -> ethereum.eth.v2.SignedBlindedBeaconBlockContentsContainer
	6,  // 10: ethereum.eth.service.BeaconChain.SubmitBlindedBlockSSZ:input_type -> ethereum.eth.v2.SSZContainer
	4,  // 11: ethereum.eth.service.BeaconChain.GetBlock:input_type -> ethereum.eth.v1.BlockRequest
	4,  // 12: ethereum.eth.service.BeaconChain.GetBlockSSZ:input_type -> ethereum.eth.v1.BlockRequest
	8,  // 13: ethereum.eth.service.BeaconChain.GetBlockV2:input_type -> ethereum.eth.v2.BlockRequestV2
	4,  // 14: ethereum.eth.service.BeaconChain.GetBlindedBlock:input_type -> ethereum.eth.v1.BlockRequest
	4,  // 15: ethereum.eth.service.BeaconChain.GetBlindedBlockSSZ:input_type -> ethereum.eth.v1.BlockRequest
	8,  // 16: ethereum.eth.service.BeaconChain.GetBlockSSZV2:input_type -> ethereum.eth.v2.BlockRequestV2
	4,  // 17: ethereum.eth.service.BeaconChain.ListBlockAttestations:input_type -> ethereum.eth.v1.BlockRequest
	0,  // 18: ethereum.eth.service.BeaconChain.ListPoolAttesterSlashings:input_type -> google.protobuf.Empty
	9,  // 19: ethereum.eth.service.BeaconChain.SubmitAttesterSlashing:input_type -> ethereum.eth.v1.AttesterSlashing
	0,  // 20: ethereum.eth.service.BeaconChain.ListPoolProposerSlashings:input_type -> google.protobuf.Empty
	10, // 21: ethereum.eth.service.BeaconChain.SubmitProposerSlashing:input_type -> ethereum.eth.v1.ProposerSlashing
	11, // 22: ethereum.eth.service.BeaconChain.SubmitSignedBLSToExecutionChanges:input_type -> ethereum.eth.v2.SubmitBLSToExecutionChangesRequest
	0,  // 23: ethereum.eth.service.BeaconChain.ListBLSToExecutionChanges:input_type -> google.protobuf.Empty
	0,  // 24: ethereum.eth.service.BeaconChain.GetForkSchedule:input_type -> google.protobuf.Empty
	0,  // 25: ethereum.eth.service.BeaconChain.GetSpec:input_type -> google.protobuf.Empty
	12, // 26: ethereum.eth.service.BeaconChain.GetGenesis:output_type -> ethereum.eth.v1.GenesisResponse
	13, // 27: ethereum.eth.service.BeaconChain.GetWeakSubjectivity:output_type -> ethereum.eth.v1.WeakSubjectivityResponse
	14, // 28: ethereum.eth.service.BeaconChain.GetStateRoot:output_type -> ethereum.eth.v1.StateRootResponse
	15, // 29: ethereum.eth.service.BeaconChain.GetFinalityCheckpoints:output_type -> ethereum.eth.v1.StateFinalityCheckpointResponse
	16, // 30: ethereum.eth.service.BeaconChain.ListSyncCommittees:output_type -> ethereum.eth.v2.StateSyncCommitteesResponse
	17, // 31: ethereum.eth.service.BeaconChain.GetRandao:output_type -> ethereum.eth.v2.RandaoResponse
	18, // 32: ethereum.eth.service.BeaconChain.GetBlockHeader:output_type -> ethereum.eth.v1.BlockHeaderResponse
	0,  // 33: ethereum.eth.service.BeaconChain.SubmitBlock:output_type -> google.protobuf.Empty
	0,  // 34: ethereum.eth.service.BeaconChain.SubmitBlockSSZ:output_type -> google.protobuf.Empty
	0,  // 35: ethereum.eth.service.BeaconChain.SubmitBlindedBlock:output_type -> google.protobuf.Empty
	0,  // 36: ethereum.eth.service.BeaconChain.SubmitBlindedBlockSSZ:output_type -> google.protobuf.Empty
	19, // 37: ethereum.eth.service.BeaconChain.GetBlock:output_type -> ethereum.eth.v1.BlockResponse
	20, // 38: ethereum.eth.service.BeaconChain.GetBlockSSZ:output_type -> ethereum.eth.v1.BlockSSZResponse
	21, // 39: ethereum.eth.service.BeaconChain.GetBlockV2:output_type -> ethereum.eth.v2.BlockResponseV2
	22, // 40: ethereum.eth.service.BeaconChain.GetBlindedBlock:output_type -> ethereum.eth.v2.BlindedBlockResponse
	6,  // 41: ethereum.eth.service.BeaconChain.GetBlindedBlockSSZ:output_type -> ethereum.eth.v2.SSZContainer
	6,  // 42: ethereum.eth.service.BeaconChain.GetBlockSSZV2:output_type -> ethereum.eth.v2.SSZContainer
	23, // 43: ethereum.eth.service.BeaconChain.ListBlockAttestations:output_type -> ethereum.eth.v1.BlockAttestationsResponse
	24, // 44: ethereum.eth.service.BeaconChain.ListPoolAttesterSlashings:output_type -> ethereum.eth.v1.AttesterSlashingsPoolResponse
	0,  // 45: ethereum.eth.service.BeaconChain.SubmitAttesterSlashing:output_type -> google.protobuf.Empty
	25, // 46: ethereum.eth.service.BeaconChain.ListPoolProposerSlashings:output_type -> ethereum.eth.v1.ProposerSlashingPoolResponse
	0,  // 47: ethereum.eth.service.BeaconChain.SubmitProposerSlashing:output_type -> google.protobuf.Empty
	0,  // 48: ethereum.eth.service.BeaconChain.SubmitSignedBLSToExecutionChanges:output_type -> google.protobuf.Empty
	26, // 49: ethereum.eth.service.BeaconChain.ListBLSToExecutionChanges:output_type -> ethereum.eth.v2.BLSToExecutionChangesPoolResponse
	27, // 50: ethereum.eth.service.BeaconChain.GetForkSchedule:output_type -> ethereum.eth.v1.ForkScheduleResponse
	28, // 51: ethereum.eth.service.BeaconChain.GetSpec:output_type -> ethereum.eth.v1.SpecResponse
