...
var file_proto_eth_service_beacon_chain_service_proto_rawDesc = []byte{
	...
	0x6f, 0x32, 0xab, 0x1b, 0x0a, 0x0b, 0x42, 0x65, 0x61, 0x63, 0x6f, 0x6e, 0x43, 0x68, 0x61, 0x69,
	...
	0x65, 0x5f, 0x69, 0x64, 0x7d, 0x2f, 0x72, 0x61, 0x6e, 0x64, 0x61, 0x6f, 0x12, 0x89, 0x01, 0x0a,
...
var file_proto_eth_service_beacon_chain_service_proto_goTypes = []interface{}{
	...
	(*v1.WeakSubjectivityResponse)(nil),                  // 12: ethereum.eth.v1.WeakSubjectivityResponse
	(*v1.StateRootResponse)(nil),                         // 13: ethereum.eth.v1.StateRootResponse
	(*v2.StateSyncCommitteesResponse)(nil),               // 14: ethereum.eth.v2.StateSyncCommitteesResponse
	(*v2.RandaoResponse)(nil),                            // 15: ethereum.eth.v2.RandaoResponse
	(*v1.BlockHeaderResponse)(nil),                       // 16: ethereum.eth.v1.BlockHeaderResponse
	(*v1.BlockResponse)(nil),                             // 17: ethereum.eth.v1.BlockResponse
	(*v1.BlockSSZResponse)(nil),                          // 18: ethereum.eth.v1.BlockSSZResponse
	(*v2.BlockResponseV2)(nil),                           // 19: ethereum.eth.v2.BlockResponseV2
	(*v2.BlindedBlockResponse)(nil),                      // 20: ethereum.eth.v2.BlindedBlockResponse
	(*v1.BlockAttestationsResponse)(nil),                 // 21: ethereum.eth.v1.BlockAttestationsResponse
	(*v1.AttesterSlashingsPoolResponse)(nil),             // 22: ethereum.eth.v1.AttesterSlashingsPoolResponse
	(*v1.ProposerSlashingPoolResponse)(nil),              // 23: ethereum.eth.v1.ProposerSlashingPoolResponse
	(*v2.BLSToExecutionChangesPoolResponse)(nil),         // 24: ethereum.eth.v2.BLSToExecutionChangesPoolResponse
	(*v1.ForkScheduleResponse)(nil),                      // 25: ethereum.eth.v1.ForkScheduleResponse
	(*v1.SpecResponse)(nil),                              // 26: ethereum.eth.v1.SpecResponse
}
var file_proto_eth_service_beacon_chain_service_proto_depIdxs = []int32{
	...
	4,  // 4: ethereum.eth.service.BeaconChain.GetBlockHeader:input_type -> ethereum.eth.v1.BlockRequest
	5,  // 5: ethereum.eth.service.BeaconChain.SubmitBlock:input_type -> ethereum.eth.v2.SignedBeaconBlockContentsContainer
	6,  // 6: ethereum.eth.service.BeaconChain.SubmitBlockSSZ:input_type -> ethereum.eth.v2.SSZContainer
	7,  // 7: ethereum.eth.service.BeaconChain.SubmitBlindedBlock:input_type -> ethereum.eth.v2.SignedBlindedBeaconBlockContentsContainer
	6,  // 8: ethereum.eth.service.BeaconChain.SubmitBlindedBlockSSZ:input_type -> ethereum.eth.v2.SSZContainer
	4,  // 9: ethereum.eth.service.BeaconChain.GetBlock:input_type -> ethereum.eth.v1.BlockRequest
	4,  // 10: ethereum.eth.service.BeaconChain.GetBlockSSZ:input_type -> ethereum.eth.v1.BlockRequest
	8,  // 11: ethereum.eth.service.BeaconChain.GetBlockV2:input_type -> ethereum.eth.v2.BlockRequestV2
	4,  // 12: ethereum.eth.service.BeaconChain.GetBlindedBlock:input_type -> ethereum.eth.v1.BlockRequest
	4,  // 13: ethereum.eth.service.BeaconChain.GetBlindedBlockSSZ:input_type -> ethereum.eth.v1.BlockRequest
	8,  // 14: ethereum.eth.service.BeaconChain.GetBlockSSZV2:input_type -> ethereum.eth.v2.BlockRequestV2
	4,  // 15: ethereum.eth.service.BeaconChain.ListBlockAttestations:input_type -> ethereum.eth.v1.BlockRequest
	0,  // 16: ethereum.eth.service.BeaconChain.ListPoolAttesterSlashings:input_type -> google.protobuf.Empty
	9,  // 17: ethereum.eth.service.BeaconChain.SubmitAttesterSlashing:input_type -> ethereum.eth.v1.AttesterSlashing
	0,  // 18: ethereum.eth.service.BeaconChain.ListPoolProposerSlashings:input_type -> google.protobuf.Empty
	10, // 19: ethereum.eth.service.BeaconChain.SubmitProposerSlashing:input_type -> ethereum.eth.v1.ProposerSlashing
	11, // 20: ethereum.eth.service.BeaconChain.SubmitSignedBLSToExecutionChanges:input_type -> ethereum.eth.v2.SubmitBLSToExecutionChangesRequest
	0,  // 21: ethereum.eth.service.BeaconChain.ListBLSToExecutionChanges:input_type -> google.protobuf.Empty
	0,  // 22: ethereum.eth.service.BeaconChain.GetForkSchedule:input_type -> google.protobuf.Empty
	0,  // 23: ethereum.eth.service.BeaconChain.GetSpec:input_type -> google.protobuf.Empty
	12, // 24: ethereum.eth.service.BeaconChain.GetWeakSubjectivity:output_type -> ethereum.eth.v1.WeakSubjectivityResponse
	13, // 25: ethereum.eth.service.BeaconChain.GetStateRoot:output_type -> ethereum.eth.v1.StateRootResponse
	14, // 26: ethereum.eth.service.BeaconChain.ListSyncCommittees:output_type -> ethereum.eth.v2.StateSyncCommitteesResponse
	15, // 27: ethereum.eth.service.BeaconChain.GetRandao:output_type -> ethereum.eth.v2.RandaoResponse
	16, // 28: ethereum.eth.service.BeaconChain.GetBlockHeader:output_type -> ethereum.eth.v1.BlockHeaderResponse
	0,  // 29: ethereum.eth.service.BeaconChain.SubmitBlock:output_type -> google.protobuf.Empty
	0,  // 30: ethereum.eth.service.BeaconChain.SubmitBlockSSZ:output_type -> google.protobuf.Empty
	0,  // 31: ethereum.eth.service.BeaconChain.SubmitBlindedBlock:output_type -> google.protobuf.Empty
	0,  // 32: ethereum.eth.service.BeaconChain.SubmitBlindedBlockSSZ:output_type -> google.protobuf.Empty
	17, // 33: ethereum.eth.service.BeaconChain.GetBlock:output_type -> ethereum.eth.v1.BlockResponse
	18, // 34: ethereum.eth.service.BeaconChain.GetBlockSSZ:output_type -> ethereum.eth.v1.BlockSSZResponse
	19, // 35: ethereum.eth.service.BeaconChain.GetBlockV2:output_type -> ethereum.eth.v2.BlockResponseV2
	20, // 36: ethereum.eth.service.BeaconChain.GetBlindedBlock:output_type -> ethereum.eth.v2.BlindedBlockResponse
	6,  // 37: ethereum.eth.service.BeaconChain.GetBlindedBlockSSZ:output_type -> ethereum.eth.v2.SSZContainer
	6,  // 38: ethereum.eth.service.BeaconChain.GetBlockSSZV2:output_type -> ethereum.eth.v2.SSZContainer
	21, // 39: ethereum.eth.service.BeaconChain.ListBlockAttestations:output_type -> ethereum.eth.v1.BlockAttestationsResponse
	22, // 40: ethereum.eth.service.BeaconChain.ListPoolAttesterSlashings:output_type -> ethereum.eth.v1.AttesterSlashingsPoolResponse
	0,  // 41: ethereum.eth.service.BeaconChain.SubmitAttesterSlashing:output_type -> google.protobuf.Empty
	23, // 42: ethereum.eth.service.BeaconChain.ListPoolProposerSlashings:output_type -> ethereum.eth.v1.ProposerSlashingPoolResponse
	0,  // 43: ethereum.eth.service.BeaconChain.SubmitProposerSlashing:output_type -> google.protobuf.Empty
	0,  // 44: ethereum.eth.service.BeaconChain.SubmitSignedBLSToExecutionChanges:output_type -> google.protobuf.Empty
	24, // 45: ethereum.eth.service.BeaconChain.ListBLSToExecutionChanges:output_type -> ethereum.eth.v2.BLSToExecutionChangesPoolResponse
	25, // 46: ethereum.eth.service.BeaconChain.GetForkSchedule:output_type -> ethereum.eth.v1.ForkScheduleResponse
	26, // 47: ethereum.eth.service.BeaconChain.GetSpec:output_type -> ethereum.eth.v1.SpecResponse
