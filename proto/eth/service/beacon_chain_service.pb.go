...
var file_proto_eth_service_beacon_chain_service_proto_rawDesc = []byte{
	...
	0x2f, 0x76, 0x32, 0x2f, 0x73, 0x73, 0x7a, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x1a, 0x1e, 0x70,
	0x72, 0x6f, 0x74, 0x6f, 0x2f, 0x65, 0x74, 0x68, 0x2f, 0x76, 0x32, 0x2f, 0x77, 0x69, 0x74, 0x68,
	0x64, 0x72, 0x61, 0x77, 0x61, 0x6c, 0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x32, 0xaf, 0x12,
	0x0a, 0x0b, 0x42, 0x65, 0x61, 0x63, 0x6f, 0x6e, 0x43, 0x68, 0x61, 0x69, 0x6e, 0x12, 0x8e, 0x01,
	0x0a, 0x13, 0x47, 0x65, 0x74, 0x57, 0x65, 0x61, 0x6b, 0x53, 0x75, 0x62, 0x6a, 0x65, 0x63, 0x74,
	0x69, 0x76, 0x69, 0x74, 0x79, 0x12, 0x16, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2e, 0x70,
	...
	0x76, 0x31, 0x2f, 0x62, 0x65, 0x61, 0x63, 0x6f, 0x6e, 0x2f, 0x77, 0x65, 0x61, 0x6b, 0x5f, 0x73,
	0x75, 0x62, 0x6a, 0x65, 0x63, 0x74, 0x69, 0x76, 0x69, 0x74, 0x79, 0x88, 0x02, 0x01, 0x12, 0x7f,
...
var file_proto_eth_service_beacon_chain_service_proto_goTypes = []interface{}{
	...
	(*v2.SubmitBLSToExecutionChangesRequest)(nil), // 5: ethereum.eth.v2.SubmitBLSToExecutionChangesRequest
	(*v1.WeakSubjectivityResponse)(nil),           // 6: ethereum.eth.v1.WeakSubjectivityResponse
	(*v1.BlockResponse)(nil),                      // 7: ethereum.eth.v1.BlockResponse
	(*v1.BlockSSZResponse)(nil),                   // 8: ethereum.eth.v1.BlockSSZResponse
	(*v2.BlockResponseV2)(nil),                    // 9: ethereum.eth.v2.BlockResponseV2
	(*v2.BlindedBlockResponse)(nil),               // 10: ethereum.eth.v2.BlindedBlockResponse
	(*v2.SSZContainer)(nil),                       // 11: ethereum.eth.v2.SSZContainer
	(*v1.BlockAttestationsResponse)(nil),          // 12: ethereum.eth.v1.BlockAttestationsResponse
	(*v1.AttesterSlashingsPoolResponse)(nil),      // 13: ethereum.eth.v1.AttesterSlashingsPoolResponse
	(*v1.ProposerSlashingPoolResponse)(nil),       // 14: ethereum.eth.v1.ProposerSlashingPoolResponse
	(*v2.BLSToExecutionChangesPoolResponse)(nil),  // 15: ethereum.eth.v2.BLSToExecutionChangesPoolResponse
	(*v1.ForkScheduleResponse)(nil),               // 16: ethereum.eth.v1.ForkScheduleResponse
	(*v1.SpecResponse)(nil),                       // 17: ethereum.eth.v1.SpecResponse
}
var file_proto_eth_service_beacon_chain_service_proto_depIdxs = []int32{
	...
	5,  // 12: ethereum.eth.service.BeaconChain.SubmitSignedBLSToExecutionChanges:input_type -> ethereum.eth.v2.SubmitBLSToExecutionChangesRequest
	0,  // 13: ethereum.eth.service.BeaconChain.ListBLSToExecutionChanges:input_type -> google.protobuf.Empty
	0,  // 14: ethereum.eth.service.BeaconChain.GetForkSchedule:input_type -> google.protobuf.Empty
	0,  // 15: ethereum.eth.service.BeaconChain.GetSpec:input_type -> google.protobuf.Empty
	6,  // 16: ethereum.eth.service.BeaconChain.GetWeakSubjectivity:output_type -> ethereum.eth.v1.WeakSubjectivityResponse
	7,  // 17: ethereum.eth.service.BeaconChain.GetBlock:output_type -> ethereum.eth.v1.BlockResponse
	8,  // 18: ethereum.eth.service.BeaconChain.GetBlockSSZ:output_type -> ethereum.eth.v1.BlockSSZResponse
	9,  // 19: ethereum.eth.service.BeaconChain.GetBlockV2:output_type -> ethereum.eth.v2.BlockResponseV2
	10, // 20: ethereum.eth.service.BeaconChain.GetBlindedBlock:output_type -> ethereum.eth.v2.BlindedBlockResponse
	11, // 21: ethereum.eth.service.BeaconChain.GetBlindedBlockSSZ:output_type -> ethereum.eth.v2.SSZContainer
	11, // 22: ethereum.eth.service.BeaconChain.GetBlockSSZV2:output_type -> ethereum.eth.v2.SSZContainer
	12, // 23: ethereum.eth.service.BeaconChain.ListBlockAttestations:output_type -> ethereum.eth.v1.BlockAttestationsResponse
	13, // 24: ethereum.eth.service.BeaconChain.ListPoolAttesterSlashings:output_type -> ethereum.eth.v1.AttesterSlashingsPoolResponse
	0,  // 25: ethereum.eth.service.BeaconChain.SubmitAttesterSlashing:output_type -> google.protobuf.Empty
	14, // 26: ethereum.eth.service.BeaconChain.ListPoolProposerSlashings:output_type -> ethereum.eth.v1.ProposerSlashingPoolResponse
	0,  // 27: ethereum.eth.service.BeaconChain.SubmitProposerSlashing:output_type -> google.protobuf.Empty
	0,  // 28: ethereum.eth.service.BeaconChain.SubmitSignedBLSToExecutionChanges:output_type -> google.protobuf.Empty
	15, // 29: ethereum.eth.service.BeaconChain.ListBLSToExecutionChanges:output_type -> ethereum.eth.v2.BLSToExecutionChangesPoolResponse
	16, // 30: ethereum.eth.service.BeaconChain.GetForkSchedule:output_type -> ethereum.eth.v1.ForkScheduleResponse
	17, // 31: ethereum.eth.service.BeaconChain.GetSpec:output_type -> ethereum.eth.v1.SpecResponse
