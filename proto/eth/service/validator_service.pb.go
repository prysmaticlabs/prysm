...
var file_proto_eth_service_validator_service_proto_rawDesc = []byte{
	...
	0x6c, 0x6f, 0x74, 0x7d, 0x12, 0x8a, 0x01, 0x0a, 0x0e, 0x50, 0x72, 0x6f, 0x64, 0x75, 0x63, 0x65,
	0x42, 0x6c, 0x6f, 0x63, 0x6b, 0x56, 0x32, 0x12, 0x26, 0x2e, 0x65, 0x74, 0x68, 0x65, 0x72, 0x65,
	0x75, 0x6d, 0x2e, 0x65, 0x74, 0x68, 0x2e, 0x76, 0x32, 0x2e, 0x50, 0x72, 0x6f, 0x64, 0x75, 0x63,
	0x65, 0x42, 0x6c, 0x6f, 0x63, 0x6b, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x56, 0x32, 0x1a,
	...
	0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x56, 0x32, 0x22, 0x27, 0x82, 0xd3, 0xe4, 0x93, 0x02, 0x21,
...
var file_proto_eth_service_validator_service_proto_depIdxs = []int32{
	...
	4,  // 4: ethereum.eth.service.BeaconValidator.ProduceBlockV2:input_type -> ethereum.eth.v2.ProduceBlockRequestV2
	...
	16, // 16: ethereum.eth.service.BeaconValidator.ProduceBlockV2:output_type -> ethereum.eth.v2.ProduceBlockResponseV2
...
type BeaconValidatorClient interface {
	...
	ProduceBlockV2(ctx context.Context, in *v2.ProduceBlockRequestV2, opts ...grpc.CallOption) (*v2.ProduceBlockResponseV2, error)
...
func (c *beaconValidatorClient) ProduceBlockV2(ctx context.Context, in *v2.ProduceBlockRequestV2, opts ...grpc.CallOption) (*v2.ProduceBlockResponseV2, error) {
...
type BeaconValidatorServer interface {
	...
	ProduceBlockV2(context.Context, *v2.ProduceBlockRequestV2) (*v2.ProduceBlockResponseV2, error)
...
func (*UnimplementedBeaconValidatorServer) ProduceBlockV2(context.Context, *v2.ProduceBlockRequestV2) (*v2.ProduceBlockResponseV2, error) {
...
func _BeaconValidator_ProduceBlockV2_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BeaconValidatorServer).ProduceBlockV2(ctx, req.(*v2.ProduceBlockRequestV2))
	}
	return interceptor(ctx, in, info, handler)
}
