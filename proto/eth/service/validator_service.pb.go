...
var file_proto_eth_service_validator_service_proto_rawDesc = []byte{
	...
	0x74, 0x6f, 0x32, 0xad, 0x07, 0x0a, 0x0f, 0x42, 0x65, 0x61, 0x63, 0x6f, 0x6e, 0x56, 0x61, 0x6c,
	...
	0x9d, 0x01, 0x0a, 0x15, 0x50, 0x72, 0x65, 0x70, 0x61, 0x72, 0x65, 0x42, 0x65, 0x61, 0x63, 0x6f,
	0x6e, 0x50, 0x72, 0x6f, 0x70, 0x6f, 0x73, 0x65, 0x72, 0x12, 0x2d, 0x2e, 0x65, 0x74, 0x68, 0x65,
	0x72, 0x65, 0x75, 0x6d, 0x2e, 0x65, 0x74, 0x68, 0x2e, 0x76, 0x31, 0x2e, 0x50, 0x72, 0x65, 0x70,
...
var file_proto_eth_service_validator_service_proto_goTypes = []interface{}{
	...
	(*v1.PrepareBeaconProposerRequest)(nil), // 1: ethereum.eth.v1.PrepareBeaconProposerRequest
	(*v2.GetLivenessRequest)(nil),           // 2: ethereum.eth.v2.GetLivenessRequest
	(*v2.ProduceBlockResponseV2)(nil),       // 3: ethereum.eth.v2.ProduceBlockResponseV2
	(*v2.SSZContainer)(nil),                 // 4: ethereum.eth.v2.SSZContainer
	(*v2.ProduceBlindedBlockResponse)(nil),  // 5: ethereum.eth.v2.ProduceBlindedBlockResponse
	(*empty.Empty)(nil),                     // 6: google.protobuf.Empty
	(*v2.GetLivenessResponse)(nil),          // 7: ethereum.eth.v2.GetLivenessResponse
}
var file_proto_eth_service_validator_service_proto_depIdxs = []int32{
	...
	1, // 4: ethereum.eth.service.BeaconValidator.PrepareBeaconProposer:input_type -> ethereum.eth.v1.PrepareBeaconProposerRequest
	2, // 5: ethereum.eth.service.BeaconValidator.GetLiveness:input_type -> ethereum.eth.v2.GetLivenessRequest
	3, // 6: ethereum.eth.service.BeaconValidator.ProduceBlockV2:output_type -> ethereum.eth.v2.ProduceBlockResponseV2
	4, // 7: ethereum.eth.service.BeaconValidator.ProduceBlockV2SSZ:output_type -> ethereum.eth.v2.SSZContainer
	5, // 8: ethereum.eth.service.BeaconValidator.ProduceBlindedBlock:output_type -> ethereum.eth.v2.ProduceBlindedBlockResponse
	4, // 9: ethereum.eth.service.BeaconValidator.ProduceBlindedBlockSSZ:output_type -> ethereum.eth.v2.SSZContainer
	6, // 10: ethereum.eth.service.BeaconValidator.PrepareBeaconProposer:output_type -> google.protobuf.Empty
	7, // 11: ethereum.eth.service.BeaconValidator.GetLiveness:output_type -> ethereum.eth.v2.GetLivenessResponse
