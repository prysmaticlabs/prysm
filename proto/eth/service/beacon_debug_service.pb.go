...
var file_proto_eth_service_beacon_debug_service_proto_rawDesc = []byte{
	...
	0x72, 0x6f, 0x74, 0x6f, 0x32, 0xd2, 0x05, 0x0a, 0x0b, 0x42, 0x65, 0x61, 0x63, 0x6f, 0x6e, 0x44,
	...
	0x7b, 0x73, 0x74, 0x61, 0x74, 0x65, 0x5f, 0x69, 0x64, 0x7d, 0x2f, 0x73, 0x73, 0x7a, 0x12, 0x8f,
	0x01, 0x0a, 0x14, 0x47, 0x65, 0x74, 0x42, 0x65, 0x61, 0x63, 0x6f, 0x6e, 0x53, 0x74, 0x61, 0x74,
	0x65, 0x41, 0x6c, 0x74, 0x61, 0x69, 0x72, 0x12, 0x1f, 0x2e, 0x65, 0x74, 0x68, 0x65, 0x72, 0x65,
	...
	0x12, 0x99, 0x01, 0x0a, 0x17, 0x47, 0x65, 0x74, 0x42, 0x65, 0x61, 0x63, 0x6f, 0x6e, 0x53, 0x74,
	0x61, 0x74, 0x65, 0x53, 0x53, 0x5a, 0x41, 0x6c, 0x74, 0x61, 0x69, 0x72, 0x12, 0x1f, 0x2e, 0x65,
	0x74, 0x68, 0x65, 0x72, 0x65, 0x75, 0x6d, 0x2e, 0x65, 0x74, 0x68, 0x2e, 0x76, 0x32, 0x2e, 0x53,
	0x74, 0x61, 0x74, 0x65, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x56, 0x32, 0x1a, 0x29, 0x2e,
	...
	0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x56, 0x32, 0x22, 0x32, 0x82, 0xd3, 0xe4, 0x93, 0x02, 0x2c,
	0x12, 0x2a, 0x2f, 0x65, 0x74, 0x68, 0x2f, 0x76, 0x32, 0x2f, 0x64, 0x65, 0x62, 0x75, 0x67, 0x2f,
	0x62, 0x65, 0x61, 0x63, 0x6f, 0x6e, 0x2f, 0x73, 0x74, 0x61, 0x74, 0x65, 0x73, 0x2f, 0x7b, 0x73,
	0x74, 0x61, 0x74, 0x65, 0x5f, 0x69, 0x64, 0x7d, 0x2f, 0x73, 0x73, 0x7a, 0x12, 0x7b, 0x0a, 0x13,
	0x4c, 0x69, 0x73, 0x74, 0x46, 0x6f, 0x72, 0x6b, 0x43, 0x68, 0x6f, 0x69, 0x63, 0x65, 0x48, 0x65,
	0x61, 0x64, 0x73, 0x12, 0x16, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2e, 0x70, 0x72, 0x6f,
	...
	0x72, 0x6b, 0x43, 0x68, 0x6f, 0x69, 0x63, 0x65, 0x48, 0x65, 0x61, 0x64, 0x73, 0x52, 0x65, 0x73,
	...
	0x63, 0x6f, 0x6e, 0x2f, 0x68, 0x65, 0x61, 0x64, 0x73, 0x42, 0x95, 0x01, 0x0a, 0x18, 0x6f, 0x72,
	0x67, 0x2e, 0x65, 0x74, 0x68, 0x65, 0x72, 0x65, 0x75, 0x6d, 0x2e, 0x65, 0x74, 0x68, 0x2e, 0x73,
	0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x42, 0x17, 0x42, 0x65, 0x61, 0x63, 0x6f, 0x6e, 0x44, 0x65,
	0x62, 0x75, 0x67, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50,
...
var file_proto_eth_service_beacon_debug_service_proto_depIdxs = []int32{
	...
	1, // 2: ethereum.eth.service.BeaconDebug.GetBeaconStateAltair:input_type -> ethereum.eth.v2.StateRequestV2
	1, // 3: ethereum.eth.service.BeaconDebug.GetBeaconStateSSZAltair:input_type -> ethereum.eth.v2.StateRequestV2
	...
	5, // 7: ethereum.eth.service.BeaconDebug.GetBeaconStateAltair:output_type -> ethereum.eth.v2.BeaconStateResponseV2
	6, // 8: ethereum.eth.service.BeaconDebug.GetBeaconStateSSZAltair:output_type -> ethereum.eth.v2.BeaconStateSSZResponseV2
...
type BeaconDebugClient interface {
	...
	GetBeaconStateAltair(ctx context.Context, in *v2.StateRequestV2, opts ...grpc.CallOption) (*v2.BeaconStateResponseV2, error)
	GetBeaconStateSSZAltair(ctx context.Context, in *v2.StateRequestV2, opts ...grpc.CallOption) (*v2.BeaconStateSSZResponseV2, error)
...
func (c *beaconDebugClient) GetBeaconStateAltair(ctx context.Context, in *v2.StateRequestV2, opts ...grpc.CallOption) (*v2.BeaconStateResponseV2, error) {
...
func (c *beaconDebugClient) GetBeaconStateSSZAltair(ctx context.Context, in *v2.StateRequestV2, opts ...grpc.CallOption) (*v2.BeaconStateSSZResponseV2, error) {
...
type BeaconDebugServer interface {
	...
	GetBeaconStateAltair(context.Context, *v2.StateRequestV2) (*v2.BeaconStateResponseV2, error)
	GetBeaconStateSSZAltair(context.Context, *v2.StateRequestV2) (*v2.BeaconStateSSZResponseV2, error)
...
func (*UnimplementedBeaconDebugServer) GetBeaconStateAltair(context.Context, *v2.StateRequestV2) (*v2.BeaconStateResponseV2, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetBeaconStateAltair not implemented")
}
func (*UnimplementedBeaconDebugServer) GetBeaconStateSSZAltair(context.Context, *v2.StateRequestV2) (*v2.BeaconStateSSZResponseV2, error) {
...
func _BeaconDebug_GetBeaconStateAltair_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BeaconDebugServer).GetBeaconStateAltair(ctx, req.(*v2.StateRequestV2))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _BeaconDebug_GetBeaconStateSSZAltair_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BeaconDebugServer).GetBeaconStateSSZAltair(ctx, req.(*v2.StateRequestV2))
	}
	return interceptor(ctx, in, info, handler)
}
