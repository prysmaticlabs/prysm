...
func (*PrepareBeaconProposerRequest_FeeRecipientContainer) Descriptor() ([]byte, []int) {
	return file_proto_eth_v1_validator_proto_rawDescGZIP(), []int{4, 0}
}
...
var file_proto_eth_v1_validator_proto_rawDesc = []byte{
	...
	0x04, 0x64, 0x61, 0x74, 0x61, 0x22, 0xc4, 0x02, 0x0a, 0x1c, 0x50, 0x72, 0x65, 0x70, 0x61, 0x72,
	0x65, 0x42, 0x65, 0x61, 0x63, 0x6f, 0x6e, 0x50, 0x72, 0x6f, 0x70, 0x6f, 0x73, 0x65, 0x72, 0x52,
	0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x63, 0x0a, 0x0a, 0x72, 0x65, 0x63, 0x69, 0x70, 0x69,
	0x65, 0x6e, 0x74, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x43, 0x2e, 0x65, 0x74, 0x68,
...
var file_proto_eth_v1_validator_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
var file_proto_eth_v1_validator_proto_goTypes = []interface{}{
	...
	(*PrepareBeaconProposerRequest)(nil),                       // 5: ethereum.eth.v1.PrepareBeaconProposerRequest
	(*PrepareBeaconProposerRequest_FeeRecipientContainer)(nil), // 6: ethereum.eth.v1.PrepareBeaconProposerRequest.FeeRecipientContainer
	(*BeaconBlock)(nil),                                        // 7: ethereum.eth.v1.BeaconBlock
}
var file_proto_eth_v1_validator_proto_depIdxs = []int32{
	...
	7, // 2: ethereum.eth.v1.ProduceBlockResponse.data:type_name -> ethereum.eth.v1.BeaconBlock
	6, // 3: ethereum.eth.v1.PrepareBeaconProposerRequest.recipients:type_name -> ethereum.eth.v1.PrepareBeaconProposerRequest.FeeRecipientContainer
