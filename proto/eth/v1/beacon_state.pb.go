...
type ForkChoiceHeadsResponse struct {
	...
	Data []*ForkChoiceHead `protobuf:"bytesutil,1,rep,name=data,proto3" json:"data,omitempty"`
}
...
type BeaconStateResponse struct {
	...
	Data *BeaconState `protobuf:"bytesutil,1,opt,name=data,proto3" json:"data,omitempty"`
}
