...
var file_proto_eth_v1_beacon_chain_proto_rawDesc = []byte{
	...
	0x01, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x07, 0x73, 0x74, 0x61, 0x74, 0x65, 0x49, 0x64, 0x22, 0x41,
...
var file_proto_eth_v1_beacon_chain_proto_goTypes = []interface{}{
	...
	(*ForkScheduleResponse)(nil),     // 2: ethereum.eth.v1.ForkScheduleResponse
	(*SpecResponse)(nil),             // 3: ethereum.eth.v1.SpecResponse
	(*DepositContractResponse)(nil),  // 4: ethereum.eth.v1.DepositContractResponse
	(*DepositContract)(nil),          // 5: ethereum.eth.v1.DepositContract
	(*WeakSubjectivityResponse)(nil), // 6: ethereum.eth.v1.WeakSubjectivityResponse
	(*WeakSubjectivityData)(nil),     // 7: ethereum.eth.v1.WeakSubjectivityData
	(*ForkChoiceDump)(nil),           // 8: ethereum.eth.v1.ForkChoiceDump
	(*ForkChoiceNode)(nil),           // 9: ethereum.eth.v1.ForkChoiceNode
	nil,                              // 10: ethereum.eth.v1.SpecResponse.DataEntry
	(*Fork)(nil),                     // 11: ethereum.eth.v1.Fork
	(*Checkpoint)(nil),               // 12: ethereum.eth.v1.Checkpoint
}
var file_proto_eth_v1_beacon_chain_proto_depIdxs = []int32{
	11, // 0: ethereum.eth.v1.ForkScheduleResponse.data:type_name -> ethereum.eth.v1.Fork
	10, // 1: ethereum.eth.v1.SpecResponse.data:type_name -> ethereum.eth.v1.SpecResponse.DataEntry
	5,  // 2: ethereum.eth.v1.DepositContractResponse.data:type_name -> ethereum.eth.v1.DepositContract
	7,  // 3: ethereum.eth.v1.WeakSubjectivityResponse.data:type_name -> ethereum.eth.v1.WeakSubjectivityData
	12, // 4: ethereum.eth.v1.WeakSubjectivityData.ws_checkpoint:type_name -> ethereum.eth.v1.Checkpoint
	12, // 5: ethereum.eth.v1.ForkChoiceDump.justified_checkpoint:type_name -> ethereum.eth.v1.Checkpoint
	12, // 6: ethereum.eth.v1.ForkChoiceDump.finalized_checkpoint:type_name -> ethereum.eth.v1.Checkpoint
	12, // 7: ethereum.eth.v1.ForkChoiceDump.unrealized_justified_checkpoint:type_name -> ethereum.eth.v1.Checkpoint
	12, // 8: ethereum.eth.v1.ForkChoiceDump.unrealized_finalized_checkpoint:type_name -> ethereum.eth.v1.Checkpoint
	9,  // 9: ethereum.eth.v1.ForkChoiceDump.fork_choice_nodes:type_name -> ethereum.eth.v1.ForkChoiceNode
	0,  // 10: ethereum.eth.v1.ForkChoiceNode.validity:type_name -> ethereum.eth.v1.ForkChoiceNodeValidity
