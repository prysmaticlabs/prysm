...
var file_proto_eth_v1_beacon_chain_proto_rawDesc = []byte{
	...
	0x20, 0x01, 0x28, 0x0c, 0x52, 0x07, 0x73, 0x74, 0x61, 0x74, 0x65, 0x49, 0x64, 0x22, 0x56, 0x0a,
	...
	0x61, 0x73, 0x68, 0x69, 0x6e, 0x67, 0x52, 0x04, 0x64, 0x61, 0x74, 0x61, 0x22, 0x59, 0x0a, 0x18,
...
var file_proto_eth_v1_beacon_chain_proto_msgTypes = make([]protoimpl.MessageInfo, 7)
var file_proto_eth_v1_beacon_chain_proto_goTypes = []interface{}{
	...
	(*WeakSubjectivityResponse)(nil),      // 4: ethereum.eth.v1.WeakSubjectivityResponse
	(*WeakSubjectivityData)(nil),          // 5: ethereum.eth.v1.WeakSubjectivityData
	(*ForkChoiceDump)(nil),                // 6: ethereum.eth.v1.ForkChoiceDump
	(*ForkChoiceNode)(nil),                // 7: ethereum.eth.v1.ForkChoiceNode
	(*AttesterSlashing)(nil),              // 8: ethereum.eth.v1.AttesterSlashing
	(*ProposerSlashing)(nil),              // 9: ethereum.eth.v1.ProposerSlashing
	(*Checkpoint)(nil),                    // 10: ethereum.eth.v1.Checkpoint
}
var file_proto_eth_v1_beacon_chain_proto_depIdxs = []int32{
	8,  // 0: ethereum.eth.v1.AttesterSlashingsPoolResponse.data:type_name -> ethereum.eth.v1.AttesterSlashing
	9,  // 1: ethereum.eth.v1.ProposerSlashingPoolResponse.data:type_name -> ethereum.eth.v1.ProposerSlashing
	5,  // 2: ethereum.eth.v1.WeakSubjectivityResponse.data:type_name -> ethereum.eth.v1.WeakSubjectivityData
	10, // 3: ethereum.eth.v1.WeakSubjectivityData.ws_checkpoint:type_name -> ethereum.eth.v1.Checkpoint
	10, // 4: ethereum.eth.v1.ForkChoiceDump.justified_checkpoint:type_name -> ethereum.eth.v1.Checkpoint
	10, // 5: ethereum.eth.v1.ForkChoiceDump.finalized_checkpoint:type_name -> ethereum.eth.v1.Checkpoint
	10, // 6: ethereum.eth.v1.ForkChoiceDump.unrealized_justified_checkpoint:type_name -> ethereum.eth.v1.Checkpoint
	10, // 7: ethereum.eth.v1.ForkChoiceDump.unrealized_finalized_checkpoint:type_name -> ethereum.eth.v1.Checkpoint
	7,  // 8: ethereum.eth.v1.ForkChoiceDump.fork_choice_nodes:type_name -> ethereum.eth.v1.ForkChoiceNode
	0,  // 9: ethereum.eth.v1.ForkChoiceNode.validity:type_name -> ethereum.eth.v1.ForkChoiceNodeValidity
