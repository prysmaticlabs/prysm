...
var file_proto_eth_v1_beacon_chain_proto_msgTypes = make([]protoimpl.MessageInfo, 26)
var file_proto_eth_v1_beacon_chain_proto_goTypes = []interface{}{
	...
	(*BlockRequest)(nil),                                            // 6: ethereum.eth.v1.BlockRequest
	(*BlockHeaderResponse)(nil),                                     // 7: ethereum.eth.v1.BlockHeaderResponse
	(*BlockHeaderContainer)(nil),                                    // 8: ethereum.eth.v1.BlockHeaderContainer
	(*BeaconBlockHeaderContainer)(nil),                              // 9: ethereum.eth.v1.BeaconBlockHeaderContainer
	(*BlockResponse)(nil),                                           // 10: ethereum.eth.v1.BlockResponse
	(*BlockSSZResponse)(nil),                                        // 11: ethereum.eth.v1.BlockSSZResponse
	(*BeaconBlockContainer)(nil),                                    // 12: ethereum.eth.v1.BeaconBlockContainer
	(*AttesterSlashingsPoolResponse)(nil),                           // 13: ethereum.eth.v1.AttesterSlashingsPoolResponse
	(*ProposerSlashingPoolResponse)(nil),                            // 14: ethereum.eth.v1.ProposerSlashingPoolResponse
	(*ForkScheduleResponse)(nil),                                    // 15: ethereum.eth.v1.ForkScheduleResponse
	(*SpecResponse)(nil),                                            // 16: ethereum.eth.v1.SpecResponse
	(*DepositContractResponse)(nil),                                 // 17: ethereum.eth.v1.DepositContractResponse
	(*DepositContract)(nil),                                         // 18: ethereum.eth.v1.DepositContract
	(*WeakSubjectivityResponse)(nil),                                // 19: ethereum.eth.v1.WeakSubjectivityResponse
	(*WeakSubjectivityData)(nil),                                    // 20: ethereum.eth.v1.WeakSubjectivityData
	(*ForkChoiceDump)(nil),                                          // 21: ethereum.eth.v1.ForkChoiceDump
	(*ForkChoiceNode)(nil),                                          // 22: ethereum.eth.v1.ForkChoiceNode
	(*GenesisResponse_Genesis)(nil),                                 // 23: ethereum.eth.v1.GenesisResponse.Genesis
	(*StateRootResponse_StateRoot)(nil),                             // 24: ethereum.eth.v1.StateRootResponse.StateRoot
	(*StateFinalityCheckpointResponse_StateFinalityCheckpoint)(nil), // 25: ethereum.eth.v1.StateFinalityCheckpointResponse.StateFinalityCheckpoint
	nil,                         // 26: ethereum.eth.v1.SpecResponse.DataEntry
	(*Attestation)(nil),         // 27: ethereum.eth.v1.Attestation
	(*BeaconBlockHeader)(nil),   // 28: ethereum.eth.v1.BeaconBlockHeader
	(*BeaconBlock)(nil),         // 29: ethereum.eth.v1.BeaconBlock
	(*AttesterSlashing)(nil),    // 30: ethereum.eth.v1.AttesterSlashing
	(*ProposerSlashing)(nil),    // 31: ethereum.eth.v1.ProposerSlashing
	(*Fork)(nil),                // 32: ethereum.eth.v1.Fork
	(*Checkpoint)(nil),          // 33: ethereum.eth.v1.Checkpoint
	(*timestamp.Timestamp)(nil), // 34: google.protobuf.Timestamp
}
var file_proto_eth_v1_beacon_chain_proto_depIdxs = []int32{
	23, // 0: ethereum.eth.v1.GenesisResponse.data:type_name -> ethereum.eth.v1.GenesisResponse.Genesis
	24, // 1: ethereum.eth.v1.StateRootResponse.data:type_name -> ethereum.eth.v1.StateRootResponse.StateRoot
	25, // 2: ethereum.eth.v1.StateFinalityCheckpointResponse.data:type_name -> ethereum.eth.v1.StateFinalityCheckpointResponse.StateFinalityCheckpoint
	27, // 3: ethereum.eth.v1.BlockAttestationsResponse.data:type_name -> ethereum.eth.v1.Attestation
	8,  // 4: ethereum.eth.v1.BlockHeaderResponse.data:type_name -> ethereum.eth.v1.BlockHeaderContainer
	9,  // 5: ethereum.eth.v1.BlockHeaderContainer.header:type_name -> ethereum.eth.v1.BeaconBlockHeaderContainer
	28, // 6: ethereum.eth.v1.BeaconBlockHeaderContainer.message:type_name -> ethereum.eth.v1.BeaconBlockHeader
	12, // 7: ethereum.eth.v1.BlockResponse.data:type_name -> ethereum.eth.v1.BeaconBlockContainer
	29, // 8: ethereum.eth.v1.BeaconBlockContainer.message:type_name -> ethereum.eth.v1.BeaconBlock
	30, // 9: ethereum.eth.v1.AttesterSlashingsPoolResponse.data:type_name -> ethereum.eth.v1.AttesterSlashing
	31, // 10: ethereum.eth.v1.ProposerSlashingPoolResponse.data:type_name -> ethereum.eth.v1.ProposerSlashing
	32, // 11: ethereum.eth.v1.ForkScheduleResponse.data:type_name -> ethereum.eth.v1.Fork
	26, // 12: ethereum.eth.v1.SpecResponse.data:type_name -> ethereum.eth.v1.SpecResponse.DataEntry
	18, // 13: ethereum.eth.v1.DepositContractResponse.data:type_name -> ethereum.eth.v1.DepositContract
	20, // 14: ethereum.eth.v1.WeakSubjectivityResponse.data:type_name -> ethereum.eth.v1.WeakSubjectivityData
	33, // 15: ethereum.eth.v1.WeakSubjectivityData.ws_checkpoint:type_name -> ethereum.eth.v1.Checkpoint
	33, // 16: ethereum.eth.v1.ForkChoiceDump.justified_checkpoint:type_name -> ethereum.eth.v1.Checkpoint
	33, // 17: ethereum.eth.v1.ForkChoiceDump.finalized_checkpoint:type_name -> ethereum.eth.v1.Checkpoint
	33, // 18: ethereum.eth.v1.ForkChoiceDump.unrealized_justified_checkpoint:type_name -> ethereum.eth.v1.Checkpoint
	33, // 19: ethereum.eth.v1.ForkChoiceDump.unrealized_finalized_checkpoint:type_name -> ethereum.eth.v1.Checkpoint
	22, // 20: ethereum.eth.v1.ForkChoiceDump.fork_choice_nodes:type_name -> ethereum.eth.v1.ForkChoiceNode
	0,  // 21: ethereum.eth.v1.ForkChoiceNode.validity:type_name -> ethereum.eth.v1.ForkChoiceNodeValidity
	34, // 22: ethereum.eth.v1.GenesisResponse.Genesis.genesis_time:type_name -> google.protobuf.Timestamp
	33, // 23: ethereum.eth.v1.StateFinalityCheckpointResponse.StateFinalityCheckpoint.previous_justified:type_name -> ethereum.eth.v1.Checkpoint
	33, // 24: ethereum.eth.v1.StateFinalityCheckpointResponse.StateFinalityCheckpoint.current_justified:type_name -> ethereum.eth.v1.Checkpoint
	33, // 25: ethereum.eth.v1.StateFinalityCheckpointResponse.StateFinalityCheckpoint.finalized:type_name -> ethereum.eth.v1.Checkpoint
