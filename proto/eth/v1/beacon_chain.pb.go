...
var file_proto_eth_v1_beacon_chain_proto_msgTypes = make([]protoimpl.MessageInfo, 22)
var file_proto_eth_v1_beacon_chain_proto_goTypes = []interface{}{
	...
	(*BlockHeaderResponse)(nil),           // 5: ethereum.eth.v1.BlockHeaderResponse
	(*BlockHeaderContainer)(nil),          // 6: ethereum.eth.v1.BlockHeaderContainer
	(*BeaconBlockHeaderContainer)(nil),    // 7: ethereum.eth.v1.BeaconBlockHeaderContainer
	(*BlockResponse)(nil),                 // 8: ethereum.eth.v1.BlockResponse
	(*BlockSSZResponse)(nil),              // 9: ethereum.eth.v1.BlockSSZResponse
	(*BeaconBlockContainer)(nil),          // 10: ethereum.eth.v1.BeaconBlockContainer
	(*AttesterSlashingsPoolResponse)(nil), // 11: ethereum.eth.v1.AttesterSlashingsPoolResponse
	(*ProposerSlashingPoolResponse)(nil),  // 12: ethereum.eth.v1.ProposerSlashingPoolResponse
	(*ForkScheduleResponse)(nil),          // 13: ethereum.eth.v1.ForkScheduleResponse
	(*SpecResponse)(nil),                  // 14: ethereum.eth.v1.SpecResponse
	(*DepositContractResponse)(nil),       // 15: ethereum.eth.v1.DepositContractResponse
	(*DepositContract)(nil),               // 16: ethereum.eth.v1.DepositContract
	(*WeakSubjectivityResponse)(nil),      // 17: ethereum.eth.v1.WeakSubjectivityResponse
	(*WeakSubjectivityData)(nil),          // 18: ethereum.eth.v1.WeakSubjectivityData
	(*ForkChoiceDump)(nil),                // 19: ethereum.eth.v1.ForkChoiceDump
	(*ForkChoiceNode)(nil),                // 20: ethereum.eth.v1.ForkChoiceNode
	(*StateRootResponse_StateRoot)(nil),   // 21: ethereum.eth.v1.StateRootResponse.StateRoot
	nil,                                   // 22: ethereum.eth.v1.SpecResponse.DataEntry
	(*Attestation)(nil),                   // 23: ethereum.eth.v1.Attestation
	(*BeaconBlockHeader)(nil),             // 24: ethereum.eth.v1.BeaconBlockHeader
	(*BeaconBlock)(nil),                   // 25: ethereum.eth.v1.BeaconBlock
	(*AttesterSlashing)(nil),              // 26: ethereum.eth.v1.AttesterSlashing
	(*ProposerSlashing)(nil),              // 27: ethereum.eth.v1.ProposerSlashing
	(*Fork)(nil),                          // 28: ethereum.eth.v1.Fork
	(*Checkpoint)(nil),                    // 29: ethereum.eth.v1.Checkpoint
}
var file_proto_eth_v1_beacon_chain_proto_depIdxs = []int32{
	21, // 0: ethereum.eth.v1.StateRootResponse.data:type_name -> ethereum.eth.v1.StateRootResponse.StateRoot
	23, // 1: ethereum.eth.v1.BlockAttestationsResponse.data:type_name -> ethereum.eth.v1.Attestation
	6,  // 2: ethereum.eth.v1.BlockHeaderResponse.data:type_name -> ethereum.eth.v1.BlockHeaderContainer
	7,  // 3: ethereum.eth.v1.BlockHeaderContainer.header:type_name -> ethereum.eth.v1.BeaconBlockHeaderContainer
	24, // 4: ethereum.eth.v1.BeaconBlockHeaderContainer.message:type_name -> ethereum.eth.v1.BeaconBlockHeader
	10, // 5: ethereum.eth.v1.BlockResponse.data:type_name -> ethereum.eth.v1.BeaconBlockContainer
	25, // 6: ethereum.eth.v1.BeaconBlockContainer.message:type_name -> ethereum.eth.v1.BeaconBlock
	26, // 7: ethereum.eth.v1.AttesterSlashingsPoolResponse.data:type_name -> ethereum.eth.v1.AttesterSlashing
	27, // 8: ethereum.eth.v1.ProposerSlashingPoolResponse.data:type_name -> ethereum.eth.v1.ProposerSlashing
	28, // 9: ethereum.eth.v1.ForkScheduleResponse.data:type_name -> ethereum.eth.v1.Fork
	22, // 10: ethereum.eth.v1.SpecResponse.data:type_name -> ethereum.eth.v1.SpecResponse.DataEntry
	16, // 11: ethereum.eth.v1.DepositContractResponse.data:type_name -> ethereum.eth.v1.DepositContract
	18, // 12: ethereum.eth.v1.WeakSubjectivityResponse.data:type_name -> ethereum.eth.v1.WeakSubjectivityData
	29, // 13: ethereum.eth.v1.WeakSubjectivityData.ws_checkpoint:type_name -> ethereum.eth.v1.Checkpoint
	29, // 14: ethereum.eth.v1.ForkChoiceDump.justified_checkpoint:type_name -> ethereum.eth.v1.Checkpoint
	29, // 15: ethereum.eth.v1.ForkChoiceDump.finalized_checkpoint:type_name -> ethereum.eth.v1.Checkpoint
	29, // 16: ethereum.eth.v1.ForkChoiceDump.unrealized_justified_checkpoint:type_name -> ethereum.eth.v1.Checkpoint
	29, // 17: ethereum.eth.v1.ForkChoiceDump.unrealized_finalized_checkpoint:type_name -> ethereum.eth.v1.Checkpoint
	20, // 18: ethereum.eth.v1.ForkChoiceDump.fork_choice_nodes:type_name -> ethereum.eth.v1.ForkChoiceNode
	0,  // 19: ethereum.eth.v1.ForkChoiceNode.validity:type_name -> ethereum.eth.v1.ForkChoiceNodeValidity
