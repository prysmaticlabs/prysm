...
var file_proto_eth_v1_beacon_chain_proto_rawDesc = []byte{
	...
	0x01, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x07, 0x73, 0x74, 0x61, 0x74, 0x65, 0x49, 0x64, 0x22, 0xcf,
	0x01, 0x0a, 0x11, 0x53, 0x74, 0x61, 0x74, 0x65, 0x52, 0x6f, 0x6f, 0x74, 0x52, 0x65, 0x73, 0x70,
	...
	0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x2e, 0x53, 0x74, 0x61, 0x74, 0x65, 0x52, 0x6f, 0x6f, 0x74,
	...
	0x6e, 0x61, 0x6c, 0x69, 0x7a, 0x65, 0x64, 0x1a, 0x27, 0x0a, 0x09, 0x53, 0x74, 0x61, 0x74, 0x65,
	0x52, 0x6f, 0x6f, 0x74, 0x12, 0x1a, 0x0a, 0x04, 0x72, 0x6f, 0x6f, 0x74, 0x18, 0x01, 0x20, 0x01,
...
var file_proto_eth_v1_beacon_chain_proto_msgTypes = make([]protoimpl.MessageInfo, 14)
var file_proto_eth_v1_beacon_chain_proto_goTypes = []interface{}{
	...
	(*AttesterSlashingsPoolResponse)(nil), // 3: ethereum.eth.v1.AttesterSlashingsPoolResponse
	(*ProposerSlashingPoolResponse)(nil),  // 4: ethereum.eth.v1.ProposerSlashingPoolResponse
	(*ForkScheduleResponse)(nil),          // 5: ethereum.eth.v1.ForkScheduleResponse
	(*SpecResponse)(nil),                  // 6: ethereum.eth.v1.SpecResponse
	(*DepositContractResponse)(nil),       // 7: ethereum.eth.v1.DepositContractResponse
	(*DepositContract)(nil),               // 8: ethereum.eth.v1.DepositContract
	(*WeakSubjectivityResponse)(nil),      // 9: ethereum.eth.v1.WeakSubjectivityResponse
	(*WeakSubjectivityData)(nil),          // 10: ethereum.eth.v1.WeakSubjectivityData
	(*ForkChoiceDump)(nil),                // 11: ethereum.eth.v1.ForkChoiceDump
	(*ForkChoiceNode)(nil),                // 12: ethereum.eth.v1.ForkChoiceNode
	(*StateRootResponse_StateRoot)(nil),   // 13: ethereum.eth.v1.StateRootResponse.StateRoot
	nil,                                   // 14: ethereum.eth.v1.SpecResponse.DataEntry
	(*AttesterSlashing)(nil),              // 15: ethereum.eth.v1.AttesterSlashing
	(*ProposerSlashing)(nil),              // 16: ethereum.eth.v1.ProposerSlashing
	(*Fork)(nil),                          // 17: ethereum.eth.v1.Fork
	(*Checkpoint)(nil),                    // 18: ethereum.eth.v1.Checkpoint
}
var file_proto_eth_v1_beacon_chain_proto_depIdxs = []int32{
	13, // 0: ethereum.eth.v1.StateRootResponse.data:type_name -> ethereum.eth.v1.StateRootResponse.StateRoot
	15, // 1: ethereum.eth.v1.AttesterSlashingsPoolResponse.data:type_name -> ethereum.eth.v1.AttesterSlashing
	16, // 2: ethereum.eth.v1.ProposerSlashingPoolResponse.data:type_name -> ethereum.eth.v1.ProposerSlashing
	17, // 3: ethereum.eth.v1.ForkScheduleResponse.data:type_name -> ethereum.eth.v1.Fork
	14, // 4: ethereum.eth.v1.SpecResponse.data:type_name -> ethereum.eth.v1.SpecResponse.DataEntry
	8,  // 5: ethereum.eth.v1.DepositContractResponse.data:type_name -> ethereum.eth.v1.DepositContract
	10, // 6: ethereum.eth.v1.WeakSubjectivityResponse.data:type_name -> ethereum.eth.v1.WeakSubjectivityData
	18, // 7: ethereum.eth.v1.WeakSubjectivityData.ws_checkpoint:type_name -> ethereum.eth.v1.Checkpoint
	18, // 8: ethereum.eth.v1.ForkChoiceDump.justified_checkpoint:type_name -> ethereum.eth.v1.Checkpoint
	18, // 9: ethereum.eth.v1.ForkChoiceDump.finalized_checkpoint:type_name -> ethereum.eth.v1.Checkpoint
	18, // 10: ethereum.eth.v1.ForkChoiceDump.unrealized_justified_checkpoint:type_name -> ethereum.eth.v1.Checkpoint
	18, // 11: ethereum.eth.v1.ForkChoiceDump.unrealized_finalized_checkpoint:type_name -> ethereum.eth.v1.Checkpoint
	12, // 12: ethereum.eth.v1.ForkChoiceDump.fork_choice_nodes:type_name -> ethereum.eth.v1.ForkChoiceNode
	0,  // 13: ethereum.eth.v1.ForkChoiceNode.validity:type_name -> ethereum.eth.v1.ForkChoiceNodeValidity
