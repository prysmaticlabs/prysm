...
var file_proto_eth_v1_beacon_chain_proto_rawDesc = []byte{
	...
	0x20, 0x01, 0x28, 0x0c, 0x52, 0x07, 0x73, 0x74, 0x61, 0x74, 0x65, 0x49, 0x64, 0x22, 0x9e, 0x01,
	0x0a, 0x19, 0x42, 0x6c, 0x6f, 0x63, 0x6b, 0x41, 0x74, 0x74, 0x65, 0x73, 0x74, 0x61, 0x74, 0x69,
	0x6f, 0x6e, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x30, 0x0a, 0x04, 0x64,
	...
	0x73, 0x74, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x52, 0x04, 0x64, 0x61, 0x74, 0x61, 0x12, 0x31, 0x0a,
	...
	0x52, 0x07, 0x62, 0x6c, 0x6f, 0x63, 0x6b, 0x49, 0x64, 0x22, 0x4a, 0x0a, 0x0d, 0x42, 0x6c, 0x6f,
...
var file_proto_eth_v1_beacon_chain_proto_msgTypes = make([]protoimpl.MessageInfo, 17)
var file_proto_eth_v1_beacon_chain_proto_goTypes = []interface{}{
	...
	(*BlockAttestationsResponse)(nil),     // 2: ethereum.eth.v1.BlockAttestationsResponse
	(*BlockRequest)(nil),                  // 3: ethereum.eth.v1.BlockRequest
	(*BlockResponse)(nil),                 // 4: ethereum.eth.v1.BlockResponse
	(*BlockSSZResponse)(nil),              // 5: ethereum.eth.v1.BlockSSZResponse
	(*BeaconBlockContainer)(nil),          // 6: ethereum.eth.v1.BeaconBlockContainer
	(*AttesterSlashingsPoolResponse)(nil), // 7: ethereum.eth.v1.AttesterSlashingsPoolResponse
	(*ProposerSlashingPoolResponse)(nil),  // 8: ethereum.eth.v1.ProposerSlashingPoolResponse
	(*ForkScheduleResponse)(nil),          // 9: ethereum.eth.v1.ForkScheduleResponse
	(*SpecResponse)(nil),                  // 10: ethereum.eth.v1.SpecResponse
	(*DepositContractResponse)(nil),       // 11: ethereum.eth.v1.DepositContractResponse
	(*DepositContract)(nil),               // 12: ethereum.eth.v1.DepositContract
	(*WeakSubjectivityResponse)(nil),      // 13: ethereum.eth.v1.WeakSubjectivityResponse
	(*WeakSubjectivityData)(nil),          // 14: ethereum.eth.v1.WeakSubjectivityData
	(*ForkChoiceDump)(nil),                // 15: ethereum.eth.v1.ForkChoiceDump
	(*ForkChoiceNode)(nil),                // 16: ethereum.eth.v1.ForkChoiceNode
	nil,                                   // 17: ethereum.eth.v1.SpecResponse.DataEntry
	(*Attestation)(nil),                   // 18: ethereum.eth.v1.Attestation
	(*BeaconBlock)(nil),                   // 19: ethereum.eth.v1.BeaconBlock
	(*AttesterSlashing)(nil),              // 20: ethereum.eth.v1.AttesterSlashing
	(*ProposerSlashing)(nil),              // 21: ethereum.eth.v1.ProposerSlashing
	(*Fork)(nil),                          // 22: ethereum.eth.v1.Fork
	(*Checkpoint)(nil),                    // 23: ethereum.eth.v1.Checkpoint
}
var file_proto_eth_v1_beacon_chain_proto_depIdxs = []int32{
	18, // 0: ethereum.eth.v1.BlockAttestationsResponse.data:type_name -> ethereum.eth.v1.Attestation
	6,  // 1: ethereum.eth.v1.BlockResponse.data:type_name -> ethereum.eth.v1.BeaconBlockContainer
	19, // 2: ethereum.eth.v1.BeaconBlockContainer.message:type_name -> ethereum.eth.v1.BeaconBlock
	20, // 3: ethereum.eth.v1.AttesterSlashingsPoolResponse.data:type_name -> ethereum.eth.v1.AttesterSlashing
	21, // 4: ethereum.eth.v1.ProposerSlashingPoolResponse.data:type_name -> ethereum.eth.v1.ProposerSlashing
	22, // 5: ethereum.eth.v1.ForkScheduleResponse.data:type_name -> ethereum.eth.v1.Fork
	17, // 6: ethereum.eth.v1.SpecResponse.data:type_name -> ethereum.eth.v1.SpecResponse.DataEntry
	12, // 7: ethereum.eth.v1.DepositContractResponse.data:type_name -> ethereum.eth.v1.DepositContract
	14, // 8: ethereum.eth.v1.WeakSubjectivityResponse.data:type_name -> ethereum.eth.v1.WeakSubjectivityData
	23, // 9: ethereum.eth.v1.WeakSubjectivityData.ws_checkpoint:type_name -> ethereum.eth.v1.Checkpoint
	23, // 10: ethereum.eth.v1.ForkChoiceDump.justified_checkpoint:type_name -> ethereum.eth.v1.Checkpoint
	23, // 11: ethereum.eth.v1.ForkChoiceDump.finalized_checkpoint:type_name -> ethereum.eth.v1.Checkpoint
	23, // 12: ethereum.eth.v1.ForkChoiceDump.unrealized_justified_checkpoint:type_name -> ethereum.eth.v1.Checkpoint
	23, // 13: ethereum.eth.v1.ForkChoiceDump.unrealized_finalized_checkpoint:type_name -> ethereum.eth.v1.Checkpoint
	16, // 14: ethereum.eth.v1.ForkChoiceDump.fork_choice_nodes:type_name -> ethereum.eth.v1.ForkChoiceNode
	0,  // 15: ethereum.eth.v1.ForkChoiceNode.validity:type_name -> ethereum.eth.v1.ForkChoiceNodeValidity
