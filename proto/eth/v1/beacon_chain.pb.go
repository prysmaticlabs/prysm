...
var file_proto_eth_v1_beacon_chain_proto_rawDesc = []byte{
	...
	0x6c, 0x69, 0x7a, 0x65, 0x64, 0x22, 0x9e, 0x01, 0x0a, 0x19, 0x42, 0x6c, 0x6f, 0x63, 0x6b, 0x41,
	...
	0x61, 0x6c, 0x69, 0x7a, 0x65, 0x64, 0x22, 0xbc, 0x01, 0x0a, 0x13, 0x42, 0x6c, 0x6f, 0x63, 0x6b,
	0x48, 0x65, 0x61, 0x64, 0x65, 0x72, 0x73, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x5e,
	...
	,
...
var file_proto_eth_v1_beacon_chain_proto_msgTypes = make([]protoimpl.MessageInfo, 28)
var file_proto_eth_v1_beacon_chain_proto_goTypes = []interface{}{
	...
	(*BlockAttestationsResponse)(nil),                               // 5: ethereum.eth.v1.BlockAttestationsResponse
	(*BlockHeadersRequest)(nil),                                     // 6: ethereum.eth.v1.BlockHeadersRequest
	(*BlockHeadersResponse)(nil),                                    // 7: ethereum.eth.v1.BlockHeadersResponse
	(*BlockRequest)(nil),                                            // 8: ethereum.eth.v1.BlockRequest
	(*BlockHeaderResponse)(nil),                                     // 9: ethereum.eth.v1.BlockHeaderResponse
	(*BlockHeaderContainer)(nil),                                    // 10: ethereum.eth.v1.BlockHeaderContainer
	(*BeaconBlockHeaderContainer)(nil),                              // 11: ethereum.eth.v1.BeaconBlockHeaderContainer
	(*BlockResponse)(nil),                                           // 12: ethereum.eth.v1.BlockResponse
	(*BlockSSZResponse)(nil),                                        // 13: ethereum.eth.v1.BlockSSZResponse
	(*BeaconBlockContainer)(nil),                                    // 14: ethereum.eth.v1.BeaconBlockContainer
	(*AttesterSlashingsPoolResponse)(nil),                           // 15: ethereum.eth.v1.AttesterSlashingsPoolResponse
	(*ProposerSlashingPoolResponse)(nil),                            // 16: ethereum.eth.v1.ProposerSlashingPoolResponse
	(*ForkScheduleResponse)(nil),                                    // 17: ethereum.eth.v1.ForkScheduleResponse
	(*SpecResponse)(nil),                                            // 18: ethereum.eth.v1.SpecResponse
	(*DepositContractResponse)(nil),                                 // 19: ethereum.eth.v1.DepositContractResponse
	(*DepositContract)(nil),                                         // 20: ethereum.eth.v1.DepositContract
	(*WeakSubjectivityResponse)(nil),                                // 21: ethereum.eth.v1.WeakSubjectivityResponse
	(*WeakSubjectivityData)(nil),                                    // 22: ethereum.eth.v1.WeakSubjectivityData
	(*ForkChoiceDump)(nil),                                          // 23: ethereum.eth.v1.ForkChoiceDump
	(*ForkChoiceNode)(nil),                                          // 24: ethereum.eth.v1.ForkChoiceNode
	(*GenesisResponse_Genesis)(nil),                                 // 25: ethereum.eth.v1.GenesisResponse.Genesis
	(*StateRootResponse_StateRoot)(nil),                             // 26: ethereum.eth.v1.StateRootResponse.StateRoot
	(*StateFinalityCheckpointResponse_StateFinalityCheckpoint)(nil), // 27: ethereum.eth.v1.StateFinalityCheckpointResponse.StateFinalityCheckpoint
	nil,                         // 28: ethereum.eth.v1.SpecResponse.DataEntry
	(*Attestation)(nil),         // 29: ethereum.eth.v1.Attestation
	(*BeaconBlockHeader)(nil),   // 30: ethereum.eth.v1.BeaconBlockHeader
	(*BeaconBlock)(nil),         // 31: ethereum.eth.v1.BeaconBlock
	(*AttesterSlashing)(nil),    // 32: ethereum.eth.v1.AttesterSlashing
	(*ProposerSlashing)(nil),    // 33: ethereum.eth.v1.ProposerSlashing
	(*Fork)(nil),                // 34: ethereum.eth.v1.Fork
	(*Checkpoint)(nil),          // 35: ethereum.eth.v1.Checkpoint
	(*timestamp.Timestamp)(nil), // 36: google.protobuf.Timestamp
}
var file_proto_eth_v1_beacon_chain_proto_depIdxs = []int32{
	25, // 0: ethereum.eth.v1.GenesisResponse.data:type_name -> ethereum.eth.v1.GenesisResponse.Genesis
	26, // 1: ethereum.eth.v1.StateRootResponse.data:type_name -> ethereum.eth.v1.StateRootResponse.StateRoot
	27, // 2: ethereum.eth.v1.StateFinalityCheckpointResponse.data:type_name -> ethereum.eth.v1.StateFinalityCheckpointResponse.StateFinalityCheckpoint
	29, // 3: ethereum.eth.v1.BlockAttestationsResponse.data:type_name -> ethereum.eth.v1.Attestation
	10, // 4: ethereum.eth.v1.BlockHeadersResponse.data:type_name -> ethereum.eth.v1.BlockHeaderContainer
	10, // 5: ethereum.eth.v1.BlockHeaderResponse.data:type_name -> ethereum.eth.v1.BlockHeaderContainer
	11, // 6: ethereum.eth.v1.BlockHeaderContainer.header:type_name -> ethereum.eth.v1.BeaconBlockHeaderContainer
	30, // 7: ethereum.eth.v1.BeaconBlockHeaderContainer.message:type_name -> ethereum.eth.v1.BeaconBlockHeader
	14, // 8: ethereum.eth.v1.BlockResponse.data:type_name -> ethereum.eth.v1.BeaconBlockContainer
	31, // 9: ethereum.eth.v1.BeaconBlockContainer.message:type_name -> ethereum.eth.v1.BeaconBlock
	32, // 10: ethereum.eth.v1.AttesterSlashingsPoolResponse.data:type_name -> ethereum.eth.v1.AttesterSlashing
	33, // 11: ethereum.eth.v1.ProposerSlashingPoolResponse.data:type_name -> ethereum.eth.v1.ProposerSlashing
	34, // 12: ethereum.eth.v1.ForkScheduleResponse.data:type_name -> ethereum.eth.v1.Fork
	28, // 13: ethereum.eth.v1.SpecResponse.data:type_name -> ethereum.eth.v1.SpecResponse.DataEntry
	20, // 14: ethereum.eth.v1.DepositContractResponse.data:type_name -> ethereum.eth.v1.DepositContract
	22, // 15: ethereum.eth.v1.WeakSubjectivityResponse.data:type_name -> ethereum.eth.v1.WeakSubjectivityData
	35, // 16: ethereum.eth.v1.WeakSubjectivityData.ws_checkpoint:type_name -> ethereum.eth.v1.Checkpoint
	35, // 17: ethereum.eth.v1.ForkChoiceDump.justified_checkpoint:type_name -> ethereum.eth.v1.Checkpoint
	35, // 18: ethereum.eth.v1.ForkChoiceDump.finalized_checkpoint:type_name -> ethereum.eth.v1.Checkpoint
	35, // 19: ethereum.eth.v1.ForkChoiceDump.unrealized_justified_checkpoint:type_name -> ethereum.eth.v1.Checkpoint
	35, // 20: ethereum.eth.v1.ForkChoiceDump.unrealized_finalized_checkpoint:type_name -> ethereum.eth.v1.Checkpoint
	24, // 21: ethereum.eth.v1.ForkChoiceDump.fork_choice_nodes:type_name -> ethereum.eth.v1.ForkChoiceNode
	0,  // 22: ethereum.eth.v1.ForkChoiceNode.validity:type_name -> ethereum.eth.v1.ForkChoiceNodeValidity
	36, // 23: ethereum.eth.v1.GenesisResponse.Genesis.genesis_time:type_name -> google.protobuf.Timestamp
	35, // 24: ethereum.eth.v1.StateFinalityCheckpointResponse.StateFinalityCheckpoint.previous_justified:type_name -> ethereum.eth.v1.Checkpoint
	35, // 25: ethereum.eth.v1.StateFinalityCheckpointResponse.StateFinalityCheckpoint.current_justified:type_name -> ethereum.eth.v1.Checkpoint
	35, // 26: ethereum.eth.v1.StateFinalityCheckpointResponse.StateFinalityCheckpoint.finalized:type_name -> ethereum.eth.v1.Checkpoint
