...
type ShardReceiptProof struct {
	Shard                uint64               `protobuf:"varint,1,opt,name=shard,proto3" json:"shard,omitempty"`
	Proof                [][]byte             `protobuf:"bytes,2,rep,name=proof,proto3" json:"proof,omitempty" ssz-max:"?"`
	Receipt              []*ShardReceiptDelta `protobuf:"bytes,3,rep,name=receipt,proto3" json:"receipt,omitempty" ssz-max:"?"`
	XXX_NoUnkeyedLiteral struct{}             `json:"-"`
	XXX_unrecognized     []byte               `json:"-"`
	XXX_sizecache        int32                `json:"-"`
}

func (m *ShardReceiptProof) Reset()         { *m = ShardReceiptProof{} }
func (m *ShardReceiptProof) String() string { return proto.CompactTextString(m) }
func (*ShardReceiptProof) ProtoMessage()    {}
func (*ShardReceiptProof) Descriptor() ([]byte, []int) {
	return fileDescriptor_9369dd0265944233, []int{10}
}
func (m *ShardReceiptProof) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *ShardReceiptProof) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_ShardReceiptProof.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalTo(b)
		if err != nil {
...
func (m *ShardReceiptProof) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ShardReceiptProof.Merge(m, src)
}
func (m *ShardReceiptProof) XXX_Size() int {
	return m.Size()
}
func (m *ShardReceiptProof) XXX_DiscardUnknown() {
	xxx_messageInfo_ShardReceiptProof.DiscardUnknown(m)
}

var xxx_messageInfo_ShardReceiptProof proto.InternalMessageInfo

func (m *ShardReceiptProof) GetShard() uint64 {
	if m != nil {
		return m.Shard
	}
	return 0
...
func (m *ShardReceiptProof) GetProof() [][]byte {
	if m != nil {
		return m.Proof
	}
	return nil
...
func (m *ShardReceiptProof) GetReceipt() []*ShardReceiptDelta {
	if m != nil {
		return m.Receipt
	}
	return nil
...
type ShardReceiptDelta struct {
	...
	RewardCoefficient    uint64   `protobuf:"varint,2,opt,name=reward_coefficient,json=rewardCoefficient,proto3" json:"reward_coefficient,omitempty"`
...
func (m *ShardReceiptDelta) Reset()         { *m = ShardReceiptDelta{} }
func (m *ShardReceiptDelta) String() string { return proto.CompactTextString(m) }
func (*ShardReceiptDelta) ProtoMessage()    {}
func (*ShardReceiptDelta) Descriptor() ([]byte, []int) {
	return fileDescriptor_9369dd0265944233, []int{11}
}
func (m *ShardReceiptDelta) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *ShardReceiptDelta) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_ShardReceiptDelta.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalTo(b)
		if err != nil {
...
func (m *ShardReceiptDelta) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ShardReceiptDelta.Merge(m, src)
}
func (m *ShardReceiptDelta) XXX_Size() int {
	return m.Size()
}
func (m *ShardReceiptDelta) XXX_DiscardUnknown() {
	xxx_messageInfo_ShardReceiptDelta.DiscardUnknown(m)
}

var xxx_messageInfo_ShardReceiptDelta proto.InternalMessageInfo

func (m *ShardReceiptDelta) GetValidatorIndex() uint64 {
	if m != nil {
		return m.ValidatorIndex
	}
	return 0
...
func (m *ShardReceiptDelta) GetRewardCoefficient() uint64 {
	if m != nil {
		return m.RewardCoefficient
	}
	return 0
}

func (m *ShardReceiptDelta) GetBlockFee() uint64 {
	if m != nil {
		return m.BlockFee
	}
	return 0
...
func init() {
	...
	proto.RegisterType((*ShardReceiptProof)(nil), "ethereum.eth.v1alpha1.ShardReceiptProof")
	proto.RegisterType((*ShardReceiptDelta)(nil), "ethereum.eth.v1alpha1.ShardReceiptDelta")
}
...
var fileDescriptor_9369dd0265944233 = []byte{
	...
	,
}
...
func (m *ShardReceiptProof) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *ShardReceiptProof) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	if m.Shard != 0 {
		dAtA[i] = 0x8
		i++
		i = encodeVarintBeaconBlock(dAtA, i, uint64(m.Shard))
	}
	if len(m.Proof) > 0 {
		for _, b := range m.Proof {
			dAtA[i] = 0x12
...
func (m *ShardReceiptDelta) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *ShardReceiptDelta) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	...
	if m.RewardCoefficient != 0 {
		dAtA[i] = 0x10
		i++
		i = encodeVarintBeaconBlock(dAtA, i, uint64(m.RewardCoefficient))
	}
	if m.BlockFee != 0 {
		dAtA[i] = 0x18
		i++
		i = encodeVarintBeaconBlock(dAtA, i, uint64(m.BlockFee))
	}
	if m.XXX_unrecognized != nil {
		i += copy(dAtA[i:], m.XXX_unrecognized)
	}
...
func (m *ShardReceiptProof) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	if m.Shard != 0 {
		n += 1 + sovBeaconBlock(uint64(m.Shard))
	}
	if len(m.Proof) > 0 {
		for _, b := range m.Proof {
			l = len(b)
...
func (m *ShardReceiptDelta) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	...
	if m.RewardCoefficient != 0 {
		n += 1 + sovBeaconBlock(uint64(m.RewardCoefficient))
	}
	if m.BlockFee != 0 {
		n += 1 + sovBeaconBlock(uint64(m.BlockFee))
	}
	if m.XXX_unrecognized != nil {
		n += len(m.XXX_unrecognized)
	}
...
func (m *ShardReceiptProof) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ShardReceiptProof: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ShardReceiptProof: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
		...
		case 3:
			...
			m.Receipt = append(m.Receipt, &ShardReceiptDelta{})
...
func (m *ShardReceiptDelta) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ShardReceiptDelta: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ShardReceiptDelta: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
		...
		case 2:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.RewardCoefficient |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 3:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field BlockFee", wireType)
			}
			m.BlockFee = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.BlockFee |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
