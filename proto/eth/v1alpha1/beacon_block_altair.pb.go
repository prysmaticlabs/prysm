...
func (x *SignedBeaconBlockAltair) Reset() {
	*x = SignedBeaconBlockAltair{}
	if protoimpl.UnsafeEnabled {
		mi := &file_eth_v1alpha1_beacon_block_altair_proto_msgTypes[0]
...
func (*SignedBeaconBlockAltair) Descriptor() ([]byte, []int) {
	return file_eth_v1alpha1_beacon_block_altair_proto_rawDescGZIP(), []int{0}
}
...
func (x *BeaconBlockAltair) Reset() {
	*x = BeaconBlockAltair{}
	if protoimpl.UnsafeEnabled {
		mi := &file_eth_v1alpha1_beacon_block_altair_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*BeaconBlockAltair) Descriptor() ([]byte, []int) {
	return file_eth_v1alpha1_beacon_block_altair_proto_rawDescGZIP(), []int{1}
}
...
func (x *BeaconBlockBodyAltair) Reset() {
	*x = BeaconBlockBodyAltair{}
	if protoimpl.UnsafeEnabled {
		mi := &file_eth_v1alpha1_beacon_block_altair_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*BeaconBlockBodyAltair) Descriptor() ([]byte, []int) {
	return file_eth_v1alpha1_beacon_block_altair_proto_rawDescGZIP(), []int{2}
}
...
func (x *SyncAggregate) Reset() {
	*x = SyncAggregate{}
	if protoimpl.UnsafeEnabled {
		mi := &file_eth_v1alpha1_beacon_block_altair_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*SyncAggregate) Descriptor() ([]byte, []int) {
	return file_eth_v1alpha1_beacon_block_altair_proto_rawDescGZIP(), []int{3}
}
...
var file_eth_v1alpha1_beacon_block_altair_proto_rawDesc = []byte{
	,
	...
	0x69, 0x67, 0x6e, 0x61, 0x74, 0x75, 0x72, 0x65, 0x22, 0xc6, 0x02, 0x0a, 0x11, 0x42, 0x65, 0x61,
	0x63, 0x6f, 0x6e, 0x42, 0x6c, 0x6f, 0x63, 0x6b, 0x41, 0x6c, 0x74, 0x61, 0x69, 0x72, 0x12, 0x40,
	...
	0x79, 0x22, 0xa4, 0x05, 0x0a, 0x15, 0x42, 0x65, 0x61, 0x63, 0x6f, 0x6e, 0x42, 0x6c, 0x6f, 0x63,
	...
	0x67, 0x67, 0x72, 0x65, 0x67, 0x61, 0x74, 0x65, 0x22, 0xbe, 0x01, 0x0a, 0x0d, 0x53, 0x79, 0x6e,
	...
	0x53, 0x69, 0x67, 0x6e, 0x61, 0x74, 0x75, 0x72, 0x65, 0x42, 0x9d, 0x01, 0x0a, 0x19, 0x6f, 0x72,
	0x67, 0x2e, 0x65, 0x74, 0x68, 0x65, 0x72, 0x65, 0x75, 0x6d, 0x2e, 0x65, 0x74, 0x68, 0x2e, 0x76,
	0x31, 0x61, 0x6c, 0x70, 0x68, 0x61, 0x31, 0x42, 0x16, 0x42, 0x65, 0x61, 0x63, 0x6f, 0x6e, 0x42,
	0x6c, 0x6f, 0x63, 0x6b, 0x41, 0x6c, 0x74, 0x61, 0x69, 0x72, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50,
	0x01, 0x5a, 0x36, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x70, 0x72,
...
var (
	file_eth_v1alpha1_beacon_block_altair_proto_rawDescOnce sync.Once
	file_eth_v1alpha1_beacon_block_altair_proto_rawDescData = file_eth_v1alpha1_beacon_block_altair_proto_rawDesc
)

func file_eth_v1alpha1_beacon_block_altair_proto_rawDescGZIP() []byte {
	file_eth_v1alpha1_beacon_block_altair_proto_rawDescOnce.Do(func() {
		file_eth_v1alpha1_beacon_block_altair_proto_rawDescData = protoimpl.X.CompressGZIP(file_eth_v1alpha1_beacon_block_altair_proto_rawDescData)
	})
	return file_eth_v1alpha1_beacon_block_altair_proto_rawDescData
}

var file_eth_v1alpha1_beacon_block_altair_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_eth_v1alpha1_beacon_block_altair_proto_goTypes = []interface{}{
...
var file_eth_v1alpha1_beacon_block_altair_proto_depIdxs = []int32{
...
func init() { file_eth_v1alpha1_beacon_block_altair_proto_init() }
func file_eth_v1alpha1_beacon_block_altair_proto_init() {
	if File_eth_v1alpha1_beacon_block_altair_proto != nil {
		return
	}
	file_eth_v1alpha1_attestation_proto_init()
	file_eth_v1alpha1_beacon_block_proto_init()
	if !protoimpl.UnsafeEnabled {
		file_eth_v1alpha1_beacon_block_altair_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_eth_v1alpha1_beacon_block_altair_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_eth_v1alpha1_beacon_block_altair_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_eth_v1alpha1_beacon_block_altair_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_eth_v1alpha1_beacon_block_altair_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_eth_v1alpha1_beacon_block_altair_proto_goTypes,
		DependencyIndexes: file_eth_v1alpha1_beacon_block_altair_proto_depIdxs,
		MessageInfos:      file_eth_v1alpha1_beacon_block_altair_proto_msgTypes,
	}.Build()
	File_eth_v1alpha1_beacon_block_altair_proto = out.File
	file_eth_v1alpha1_beacon_block_altair_proto_rawDesc = nil
	file_eth_v1alpha1_beacon_block_altair_proto_goTypes = nil
	file_eth_v1alpha1_beacon_block_altair_proto_depIdxs = nil
}
