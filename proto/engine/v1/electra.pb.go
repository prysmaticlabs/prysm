...
type ExecutionEnvelopeElectra struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
	...
	ExecutionRequestsHash [][]byte               `protobuf:"bytes,5,rep,name=execution_requests_hash,json=executionRequestsHash,proto3" json:"execution_requests_hash,omitempty"`
}

func (x *ExecutionEnvelopeElectra) Reset() {
	*x = ExecutionEnvelopeElectra{}
	if protoimpl.UnsafeEnabled {
...
func (x *ExecutionEnvelopeElectra) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ExecutionEnvelopeElectra) ProtoMessage() {}

func (x *ExecutionEnvelopeElectra) ProtoReflect() protoreflect.Message {
	mi := &file_proto_engine_v1_electra_proto_msgTypes[4]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ExecutionEnvelopeElectra.ProtoReflect.Descriptor instead.
func (*ExecutionEnvelopeElectra) Descriptor() ([]byte, []int) {
	return file_proto_engine_v1_electra_proto_rawDescGZIP(), []int{4}
}

func (x *ExecutionEnvelopeElectra) GetPayload() *ExecutionPayloadDeneb {
	if x != nil {
		return x.Payload
	}
	return nil
...
func (x *ExecutionEnvelopeElectra) GetValue() []byte {
	if x != nil {
		return x.Value
	}
	return nil
...
func (x *ExecutionEnvelopeElectra) GetBlobsBundle() *BlobsBundle {
	if x != nil {
...
func (x *ExecutionEnvelopeElectra) GetShouldOverrideBuilder() bool {
	if x != nil {
...
func (x *ExecutionEnvelopeElectra) GetExecutionRequestsHash() [][]byte {
	if x != nil {
		return x.ExecutionRequestsHash
	}
	return nil
}
...
var file_proto_engine_v1_electra_proto_rawDesc = []byte{
	...
	0x6f, 0x6c, 0x69, 0x64, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x22, 0xa9, 0x02, 0x0a, 0x18, 0x45,
	0x78, 0x65, 0x63, 0x75, 0x74, 0x69, 0x6f, 0x6e, 0x45, 0x6e, 0x76, 0x65, 0x6c, 0x6f, 0x70, 0x65,
	0x45, 0x6c, 0x65, 0x63, 0x74, 0x72, 0x61, 0x12, 0x43, 0x0a, 0x07, 0x70, 0x61, 0x79, 0x6c, 0x6f,
	...
	0x76, 0x65, 0x72, 0x72, 0x69, 0x64, 0x65, 0x42, 0x75, 0x69, 0x6c, 0x64, 0x65, 0x72, 0x12, 0x36,
	0x0a, 0x17, 0x65, 0x78, 0x65, 0x63, 0x75, 0x74, 0x69, 0x6f, 0x6e, 0x5f, 0x72, 0x65, 0x71, 0x75,
	0x65, 0x73, 0x74, 0x73, 0x5f, 0x68, 0x61, 0x73, 0x68, 0x18, 0x05, 0x20, 0x03, 0x28, 0x0c, 0x52,
	0x15, 0x65, 0x78, 0x65, 0x63, 0x75, 0x74, 0x69, 0x6f, 0x6e, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73,
	0x74, 0x73, 0x48, 0x61, 0x73, 0x68, 0x42, 0x8e, 0x01, 0x0a, 0x16, 0x6f, 0x72, 0x67, 0x2e, 0x65,
...
var file_proto_engine_v1_electra_proto_goTypes = []interface{}{
	...
	(*ExecutionEnvelopeElectra)(nil), // 4: ethereum.engine.v1.ExecutionEnvelopeElectra
...
var file_proto_engine_v1_electra_proto_depIdxs = []int32{
	...
	5, // 3: ethereum.engine.v1.ExecutionEnvelopeElectra.payload:type_name -> ethereum.engine.v1.ExecutionPayloadDeneb
	6, // 4: ethereum.engine.v1.ExecutionEnvelopeElectra.blobs_bundle:type_name -> ethereum.engine.v1.BlobsBundle
...
func file_proto_engine_v1_electra_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_proto_engine_v1_electra_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ExecutionEnvelopeElectra); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
