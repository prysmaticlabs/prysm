...
func (b *BlobsBundle) HashTreeRootWith(hh *ssz.Hasher) (err error) {
	...
	// Field (0) 'KzgCommitments'
	{
		...
		if ssz.EnableVectorizedHTR {
			hh.MerkleizeWithMixinVectorizedHTR(subIndx, numItems, ssz.CalculateLimit(4, numItems, 0))
		} else {
			hh.MerkleizeWithMixin(subIndx, numItems, ssz.CalculateLimit(4, numItems, 0))
		}
	}
...
func (b *BlindedBlobsBundle) HashTreeRootWith(hh *ssz.Hasher) (err error) {
	...
	// Field (2) 'BlobRoots'
	{
		...
		if ssz.EnableVectorizedHTR {
			hh.MerkleizeWithMixinVectorizedHTR(subIndx, numItems, ssz.CalculateLimit(4, numItems, 32))
		} else {
