...
// Hash: 274fc5b7e7f5b2fef1278cc5c37de100e2415bb3d2dd7eda89add51b51cf8025
package enginev1
...
func (e *ExecutionPayload4844) UnmarshalSSZ(buf []byte) error {
	...
	if cap(e.ExcessDataGas) == 0 {
		e.ExcessDataGas = make([]byte, 0, len(buf[472:504]))
	}
	e.ExcessDataGas = append(e.ExcessDataGas, buf[472:504]...)
