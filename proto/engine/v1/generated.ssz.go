...
// Hash: 6b8b8b614b6f385b4cb5ccbf298628bfb0e800c7700764525773983f6c700a14
package enginev1
...
func (e *ExecutionPayloadCapella) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	// Field (12) 'ExcessBlobs'
	dst = ssz.MarshalUint64(dst, e.ExcessBlobs)
...
func (e *ExecutionPayloadCapella) UnmarshalSSZ(buf []byte) error {
	...
	// Field (12) 'ExcessBlobs'
	e.ExcessBlobs = ssz.UnmarshallUint64(buf[472:480])

	// Field (13) 'BlockHash'
	if cap(e.BlockHash) == 0 {
		e.BlockHash = make([]byte, 0, len(buf[480:512]))
	}
	e.BlockHash = append(e.BlockHash, buf[480:512]...)

	// Offset (14) 'Transactions'
	if o14 = ssz.ReadOffset(buf[512:516]); o14 > size || o10 > o14 {
		return ssz.ErrOffset
	}

	// Offset (15) 'Withdrawals'
	if o15 = ssz.ReadOffset(buf[516:520]); o15 > size || o14 > o15 {
		return ssz.ErrOffset
	}
...
func (e *ExecutionPayloadHeaderCapella) UnmarshalSSZ(buf []byte) error {
	...
	// Field (13) 'ExcessBlobs'
	e.ExcessBlobs = ssz.UnmarshallUint64(buf[504:512])

	// Field (14) 'TransactionsRoot'
	if cap(e.TransactionsRoot) == 0 {
		e.TransactionsRoot = make([]byte, 0, len(buf[512:544]))
	}
	e.TransactionsRoot = append(e.TransactionsRoot, buf[512:544]...)

	// Field (15) 'WithdrawalsRoot'
	if cap(e.WithdrawalsRoot) == 0 {
		e.WithdrawalsRoot = make([]byte, 0, len(buf[544:576]))
	}
	e.WithdrawalsRoot = append(e.WithdrawalsRoot, buf[544:576]...)
...
func (b *Blob) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	// Field (0) 'Data'
	if size := len(b.Data); size != 131072 {
		err = ssz.ErrBytesLengthFn("--.Data", size, 131072)
		return
	}
...
func (b *Blob) UnmarshalSSZ(buf []byte) error {
	...
	// Field (0) 'Data'
	if cap(b.Data) == 0 {
		b.Data = make([]byte, 0, len(buf[0:131072]))
	}
	b.Data = append(b.Data, buf[0:131072]...)
