...
// Hash: ac3100be535e7ad34c4dc78beecd1a2e3cca422254e21f7d8cbb932b7c207342
package enginev1
...
func (e *ExecutionPayloadDeneb) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	if size := len(e.ExcessDataGas); size != 32 {
		err = ssz.ErrBytesLengthFn("--.ExcessDataGas", size, 32)
		return
	}
	dst = append(dst, e.ExcessDataGas...)
...
func (e *ExecutionPayloadDeneb) UnmarshalSSZ(buf []byte) error {
	...
	// Field (15) 'ExcessDataGas'
	if cap(e.ExcessDataGas) == 0 {
		e.ExcessDataGas = make([]byte, 0, len(buf[512:544]))
	}
	e.ExcessDataGas = append(e.ExcessDataGas, buf[512:544]...)
...
func (e *ExecutionPayloadHeaderDeneb) UnmarshalSSZ(buf []byte) error {
	...
	// Field (15) 'ExcessDataGas'
	if cap(e.ExcessDataGas) == 0 {
		e.ExcessDataGas = make([]byte, 0, len(buf[568:600]))
	}
	e.ExcessDataGas = append(e.ExcessDataGas, buf[568:600]...)
