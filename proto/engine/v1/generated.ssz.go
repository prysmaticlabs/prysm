...
// Hash: 12b840d59b393b823430ca02a67efa1aaf6068bbc70852bce698de6acee4330a
package enginev1
...
func (e *ExecutionPayload4844) UnmarshalSSZ(buf []byte) error {
	...
	// Field (14) 'ExcessBlobs'
	e.ExcessBlobs = ssz.UnmarshallUint64(buf[508:516])
...
func (e *ExecutionPayloadHeader4844) UnmarshalSSZ(buf []byte) error {
	...
	// Field (14) 'ExcessBlobs'
	e.ExcessBlobs = ssz.UnmarshallUint64(buf[536:544])
