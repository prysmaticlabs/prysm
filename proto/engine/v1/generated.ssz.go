...
// Hash: ce406b7c6b5f093d6185d5f6575b7f8aeab3b06a779e3850ea8d745120118f93
package enginev1
...
func (e *ExecutionPayload) UnmarshalSSZ(buf []byte) error {
	...
	// Field (6) 'BlockNumber'
	e.BlockNumber = Quantity(ssz.UnmarshallUint64(buf[192:200]))

	// Field (7) 'GasLimit'
	e.GasLimit = Quantity(ssz.UnmarshallUint64(buf[200:208]))

	// Field (8) 'GasUsed'
	e.GasUsed = Quantity(ssz.UnmarshallUint64(buf[208:216]))

	// Field (9) 'Timestamp'
	e.Timestamp = Quantity(ssz.UnmarshallUint64(buf[216:224]))
	...
	// Offset (13) 'Transactions'
	if o13 = ssz.ReadOffset(buf[320:324]); o13 > size {
