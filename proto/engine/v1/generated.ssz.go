...
// Hash: db83674b7d60215b93a4964a082b84c350ac331be875724071f501df2e9206cd
package enginev1
...
func (e *ExecutionPayload4844) UnmarshalSSZ(buf []byte) error {
	...
	if cap(e.ExcessDataGas) == 0 {
		e.ExcessDataGas = make([]byte, 0, len(buf[508:540]))
	}
	e.ExcessDataGas = append(e.ExcessDataGas, buf[508:540]...)
...
func (e *ExecutionPayloadHeader4844) UnmarshalSSZ(buf []byte) error {
	...
	// Field (14) 'ExcessDataGas'
	if cap(e.ExcessDataGas) == 0 {
		e.ExcessDataGas = make([]byte, 0, len(buf[536:568]))
	}
	e.ExcessDataGas = append(e.ExcessDataGas, buf[536:568]...)
