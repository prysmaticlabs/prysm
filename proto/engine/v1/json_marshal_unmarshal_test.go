...
func TestRandom(t *testing.T) {
	hash := common.HexToHash("0xff01ff01ff01ff01ff01ff01ff01ff01000000000000000000000g0000000000")
	if hash.String() != "0xff01ff01ff01ff01ff01ff01ff01ff01000000000000000000000g0000000000" {
		t.Errorf("%s isnt correct", hash.String())
	}
}
