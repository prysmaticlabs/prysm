...
type TransitionConfiguration struct {
	...
	TerminalTotalDifficulty []byte `protobuf:"bytes,1,opt,name=terminal_total_difficulty,json=terminalTotalDifficulty,proto3" json:"terminal_total_difficulty,omitempty"`
...
func (x *TransitionConfiguration) GetTerminalTotalDifficulty() []byte {
	if x != nil {
...
var file_proto_engine_v1_execution_engine_proto_rawDesc = []byte{
	...
	0x63, 0x75, 0x6c, 0x74, 0x79, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x17, 0x74, 0x65, 0x72,
