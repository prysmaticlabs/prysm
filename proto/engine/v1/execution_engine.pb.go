...
type ExchangeCapabilities struct {
	...
	SupportedMethods [][]byte `protobuf:"bytes,1,rep,name=supported_methods,json=supportedMethods,proto3" json:"supported_methods,omitempty"`
}
...
func (x *ExchangeCapabilities) GetSupportedMethods() [][]byte {
	if x != nil {
...
var file_proto_engine_v1_execution_engine_proto_rawDesc = []byte{
	...
	0x01, 0x20, 0x03, 0x28, 0x0c, 0x52, 0x10, 0x73, 0x75, 0x70, 0x70, 0x6f, 0x72, 0x74, 0x65, 0x64,
