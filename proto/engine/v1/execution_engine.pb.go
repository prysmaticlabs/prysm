...
type ExecutionPayload struct {
	...
	ParentHash    Bytes    `protobuf:"bytes,1,opt,name=parent_hash,json=parentHash,proto3" json:"parent_hash,omitempty" cast-type:"Bytes" ssz-size:"32"`
	...
	StateRoot     Bytes    `protobuf:"bytes,3,opt,name=state_root,json=stateRoot,proto3" json:"state_root,omitempty" cast-type:"Bytes" ssz-size:"32"`
	ReceiptsRoot  Bytes    `protobuf:"bytes,4,opt,name=receipts_root,json=receiptsRoot,proto3" json:"receipts_root,omitempty" cast-type:"Bytes" ssz-size:"32"`
	LogsBloom     []byte   `protobuf:"bytes,5,opt,name=logs_bloom,json=logsBloom,proto3" json:"logs_bloom,omitempty" ssz-size:"256"`
	Random        Bytes    `protobuf:"bytes,6,opt,name=random,proto3" json:"random,omitempty" cast-type:"Bytes" ssz-size:"32"`
	...
	BaseFeePerGas Bytes    `protobuf:"bytes,12,opt,name=base_fee_per_gas,json=baseFeePerGas,proto3" json:"base_fee_per_gas,omitempty" cast-type:"Bytes" ssz-size:"32"`
	BlockHash     Bytes    `protobuf:"bytes,13,opt,name=block_hash,json=blockHash,proto3" json:"block_hash,omitempty" cast-type:"Bytes" ssz-size:"32"`
...
func (x *ExecutionPayload) GetParentHash() Bytes {
	if x != nil {
		return x.ParentHash
	}
	return Bytes(nil)
...
func (x *ExecutionPayload) GetStateRoot() Bytes {
	if x != nil {
		return x.StateRoot
	}
	return Bytes(nil)
...
func (x *ExecutionPayload) GetReceiptsRoot() Bytes {
	if x != nil {
...
func (x *ExecutionPayload) GetRandom() Bytes {
	if x != nil {
		return x.Random
	}
	return Bytes(nil)
...
func (x *ExecutionPayload) GetBaseFeePerGas() Bytes {
	if x != nil {
...
func (x *ExecutionPayload) GetBlockHash() Bytes {
	if x != nil {
		return x.BlockHash
	}
	return Bytes(nil)
...
type PayloadAttributes struct {
	...
	Random                Bytes  `protobuf:"bytes,2,opt,name=random,proto3" json:"random,omitempty" cast-type:"Bytes" ssz-size:"32"`
...
func (x *PayloadAttributes) GetRandom() Bytes {
	if x != nil {
		return x.Random
	}
	return Bytes(nil)
...
type PayloadStatus struct {
	...
	LatestValidHash Bytes                `protobuf:"bytes,2,opt,name=latest_valid_hash,json=latestValidHash,proto3" json:"latest_valid_hash,omitempty" cast-type:"Bytes" ssz-size:"32"`
...
func (x *PayloadStatus) GetLatestValidHash() Bytes {
	if x != nil {
...
type ForkchoiceState struct {
	...
	HeadBlockHash      Bytes `protobuf:"bytes,1,opt,name=head_block_hash,json=headBlockHash,proto3" json:"head_block_hash,omitempty" cast-type:"Bytes" ssz-size:"32"`
	SafeBlockHash      Bytes `protobuf:"bytes,2,opt,name=safe_block_hash,json=safeBlockHash,proto3" json:"safe_block_hash,omitempty" cast-type:"Bytes" ssz-size:"32"`
	FinalizedBlockHash Bytes `protobuf:"bytes,3,opt,name=finalized_block_hash,json=finalizedBlockHash,proto3" json:"finalized_block_hash,omitempty" cast-type:"Bytes" ssz-size:"32"`
}
...
func (x *ForkchoiceState) GetHeadBlockHash() Bytes {
	if x != nil {
...
func (x *ForkchoiceState) GetSafeBlockHash() Bytes {
	if x != nil {
...
func (x *ForkchoiceState) GetFinalizedBlockHash() Bytes {
	if x != nil {
...
var file_proto_engine_v1_execution_engine_proto_rawDesc = []byte{
	...
	0x6f, 0x6e, 0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0