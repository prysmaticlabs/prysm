...
type ExecutionPayloadWithBlobTxs struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
	...
	BlockHash        []byte                   `protobuf:"bytes,13,opt,name=block_hash,json=blockHash,proto3" json:"block_hash,omitempty" ssz-size:"32"`
	Transactions     [][]byte                 `protobuf:"bytes,14,rep,name=transactions,proto3" json:"transactions,omitempty" ssz-max:"1048576,1073741824" ssz-size:"?,?"`
	BlobTransactions []*SignedBlobTransaction `protobuf:"bytes,15,rep,name=blob_transactions,json=blobTransactions,proto3" json:"blob_transactions,omitempty" ssz-max:"1073741824"`
}

func (x *ExecutionPayloadWithBlobTxs) Reset() {
	*x = ExecutionPayloadWithBlobTxs{}
	if protoimpl.UnsafeEnabled {
...
func (x *ExecutionPayloadWithBlobTxs) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ExecutionPayloadWithBlobTxs) ProtoMessage() {}

func (x *ExecutionPayloadWithBlobTxs) ProtoReflect() protoreflect.Message {
	mi := &file_proto_engine_v1_execution_engine_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ExecutionPayloadWithBlobTxs.ProtoReflect.Descriptor instead.
func (*ExecutionPayloadWithBlobTxs) Descriptor() ([]byte, []int) {
	return file_proto_engine_v1_execution_engine_proto_rawDescGZIP(), []int{2}
}

func (x *ExecutionPayloadWithBlobTxs) GetParentHash() []byte {
	if x != nil {
		return x.ParentHash
	}
	return nil
...
func (x *ExecutionPayloadWithBlobTxs) GetFeeRecipient() []byte {
	if x != nil {
		return x.FeeRecipient
	}
	return nil
...
func (x *ExecutionPayloadWithBlobTxs) GetStateRoot() []byte {
	if x != nil {
		return x.StateRoot
	}
	return nil
...
func (x *ExecutionPayloadWithBlobTxs) GetReceiptsRoot() []byte {
	if x != nil {
		return x.ReceiptsRoot
	}
	return nil
...
func (x *ExecutionPayloadWithBlobTxs) GetLogsBloom() []byte {
	if x != nil {
		return x.LogsBloom
	}
	return nil
...
func (x *ExecutionPayloadWithBlobTxs) GetRandom() []byte {
	if x != nil {
		return x.Random
	}
	return nil
...
func (x *ExecutionPayloadWithBlobTxs) GetBlockNumber() uint64 {
	if x != nil {
		return x.BlockNumber
	}
	return 0
...
func (x *ExecutionPayloadWithBlobTxs) GetGasLimit() uint64 {
	if x != nil {
		return x.GasLimit
	}
	return 0
...
func (x *ExecutionPayloadWithBlobTxs) GetGasUsed() uint64 {
	if x != nil {
		return x.GasUsed
	}
	return 0
...
func (x *ExecutionPayloadWithBlobTxs) GetTimestamp() uint64 {
	if x != nil {
		return x.Timestamp
	}
	return 0
...
func (x *ExecutionPayloadWithBlobTxs) GetExtraData() []byte {
	if x != nil {
		return x.ExtraData
	}
	return nil
...
func (x *ExecutionPayloadWithBlobTxs) GetBaseFeePerGas() []byte {
	if x != nil {
		return x.BaseFeePerGas
	}
	return nil
...
func (x *ExecutionPayloadWithBlobTxs) GetBlockHash() []byte {
	if x != nil {
		return x.BlockHash
	}
	return nil
...
func (x *ExecutionPayloadWithBlobTxs) GetTransactions() [][]byte {
	if x != nil {
		return x.Transactions
	}
	return nil
...
func (x *ExecutionPayloadWithBlobTxs) GetBlobTransactions() []*SignedBlobTransaction {
	if x != nil {
		return x.BlobTransactions
	}
	return nil
}

type SignedBlobTransaction struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Header     *BlobTransaction `protobuf:"bytes,1,opt,name=header,proto3" json:"header,omitempty"`
	Signatures *ECDSASignature  `protobuf:"bytes,2,opt,name=signatures,proto3" json:"signatures,omitempty"`
}

func (x *SignedBlobTransaction) Reset() {
	*x = SignedBlobTransaction{}
	if protoimpl.UnsafeEnabled {
...
func (x *SignedBlobTransaction) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SignedBlobTransaction) ProtoMessage() {}

func (x *SignedBlobTransaction) ProtoReflect() protoreflect.Message {
	mi := &file_proto_engine_v1_execution_engine_proto_msgTypes[3]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SignedBlobTransaction.ProtoReflect.Descriptor instead.
func (*SignedBlobTransaction) Descriptor() ([]byte, []int) {
	return file_proto_engine_v1_execution_engine_proto_rawDescGZIP(), []int{3}
}

func (x *SignedBlobTransaction) GetHeader() *BlobTransaction {
	if x != nil {
		return x.Header
	}
	return nil
...
func (x *SignedBlobTransaction) GetSignatures() *ECDSASignature {
	if x != nil {
		return x.Signatures
	}
	return nil
...
type BlobTransaction struct {
	...
	MaxBasefee          []byte   `protobuf:"bytes,3,opt,name=max_basefee,json=maxBasefee,proto3" json:"max_basefee,omitempty" ssz-size:"32"`
	PriorityFee         []byte   `protobuf:"bytes,4,opt,name=priority_fee,json=priorityFee,proto3" json:"priority_fee,omitempty" ssz-size:"32"`
	Address             []byte   `protobuf:"bytes,5,opt,name=address,proto3" json:"address,omitempty" ssz-size:"20"`
	Value               []byte   `protobuf:"bytes,6,opt,name=value,proto3" json:"value,omitempty" ssz-size:"32"`
	Data                []byte   `protobuf:"bytes,7,opt,name=data,proto3" json:"data,omitempty" ssz-max:"32"`
	BlobVersionedHashes [][]byte `protobuf:"bytes,8,rep,name=blob_versioned_hashes,json=blobVersionedHashes,proto3" json:"blob_versioned_hashes,omitempty" ssz-max:"16777216" ssz-size:"?,32"`
}
...
func (x *BlobTransaction) GetNounce() uint64 {
	if x != nil {
		return x.Nounce
	}
	return 0
...
func (x *BlobTransaction) GetMaxBasefee() []byte {
	if x != nil {
		return x.MaxBasefee
	}
	return nil
...
func (x *BlobTransaction) GetPriorityFee() []byte {
	if x != nil {
...
func (x *BlobTransaction) GetAddress() []byte {
	if x != nil {
		return x.Address
	}
	return nil
...
func (x *BlobTransaction) GetBlobVersionedHashes() [][]byte {
	if x != nil {
...
type ECDSASignature struct {
	...
	V []byte `protobuf:"bytes,1,opt,name=v,proto3" json:"v,omitempty" ssz-size:"1"`
	R []byte `protobuf:"bytes,2,opt,name=r,proto3" json:"r,omitempty" ssz-size:"32"`
	S []byte `protobuf:"bytes,3,opt,name=s,proto3" json:"s,omitempty" ssz-size:"32"`
}
...
func (x *ECDSASignature) GetV() []byte {
	if x != nil {
		return x.V
	}
	return nil
...
var file_proto_engine_v1_execution_engine_proto_rawDesc = []byte{
	...
	0x74, 0x72, 0x61, 0x6e, 0x73, 0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x22, 0xb2, 0x05, 0x0a,
	0x1b, 0x45, 0x78, 0x65, 0x63, 0x75, 0x74, 0x69, 0x6f, 0x6e, 0x50, 0x61, 0x79, 0x6c, 0x6f, 0x61,
	0x64, 0x57, 0x69, 0x74, 0x68, 0x42, 0x6c, 0x6f, 0x62, 0x54, 0x78, 0x73, 0x12, 0x27, 0x0a, 0x0b,
	...
	0x32, 0x35, 0x36, 0x52, 0x09, 0x6c, 0x6f, 0x67, 0x73, 0x42, 0x6c, 0x6f, 0x6f, 0x6d, 0x12, 0x1e,
	0x0a, 0x06, 0x72, 0x61, 0x6e, 0x64, 0x6f, 0x6d, 0x18, 0x06, 0x20, 0x01, 0x28, 0x0c, 0x42, 0x06,
	0x8a, 0xb5, 0x18, 0x02, 0x33, 0x32, 0x52, 0x06, 0x72, 0x61, 0x6e, 0x64, 0x6f, 0x6d, 0x12, 0x21,
	...
	0x6e, 0x73, 0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x12, 0x66, 0x0a, 0x11, 0x62, 0x6c, 0x6f,
	0x62, 0x5f, 0x74, 0x72, 0x61, 0x6e, 0x73, 0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x18, 0x0f,
	...
	,
	...
	0x62, 0x65, 0x72, 0x22, 0x91, 0x01, 0x0a, 0x11, 0x50, 0x61, 0x79, 0x6c, 0x6f, 0x61, 0x64, 0x41,
	...
	0x6d, 0x65, 0x73, 0x74, 0x61, 0x6d, 0x70, 0x12, 0x1e, 0x0a, 0x06, 0x72, 0x61, 0x6e, 0x64, 0x6f,
	0x6d, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0c, 0x42, 0x06, 0x8a, 0xb5, 0x18, 0x02, 0x33, 0x32, 0x52,
	0x06, 0x72, 0x61, 0x6e, 0x64, 0x6f, 0x6d, 0x12, 0x3e, 0x0a, 0x17, 0x73, 0x75, 0x67, 0x67, 0x65,
	...
	0x63, 0x69, 0x70, 0x69, 0x65, 0x6e, 0x74, 0x22, 0xae, 0x02, 0x0a, 0x0d, 0x50, 0x61, 0x79, 0x6c,
	...
	0x61, 0x74, 0x69, 0x6f, 0x6e, 0x45, 0x72, 0x72, 0x6f, 0x72, 0x22, 0x7c, 0x0a, 0x06, 0x53, 0x74,
	...
	0x42, 0x4c, 0x4f, 0x43, 0x4b, 0x5f, 0x48, 0x41, 0x53, 0x48, 0x10, 0x05, 0x12, 0x1a, 0x0a, 0x16,
	0x49, 0x4e, 0x56, 0x41, 0x4c, 0x49, 0x44, 0x5f, 0x54, 0x45, 0x52, 0x4d, 0x49, 0x4e, 0x41, 0x4c,
	0x5f, 0x42, 0x4c, 0x4f, 0x43, 0x4b, 0x10, 0x06, 0x22, 0xab, 0x01, 0x0a, 0x0f, 0x46, 0x6f, 0x72,
	...
	0x63, 0x6b, 0x48, 0x61, 0x73, 0x68, 0x42, 0x93, 0x01, 0x0a, 0x16, 0x6f, 0x72, 0x67, 0x2e, 0x65,
	0x74, 0x68, 0x65, 0x72, 0x65, 0x75, 0x6d, 0x2e, 0x65, 0x6e, 0x67, 0x69, 0x6e, 0x65, 0x2e, 0x76,
...
var file_proto_engine_v1_execution_engine_proto_goTypes = []interface{}{
	...
	(*ExecutionPayloadWithBlobTxs)(nil), // 3: ethereum.engine.v1.ExecutionPayloadWithBlobTxs
	(*SignedBlobTransaction)(nil),       // 4: ethereum.engine.v1.SignedBlobTransaction
	(*BlobTransaction)(nil),             // 5: ethereum.engine.v1.BlobTransaction
	(*ECDSASignature)(nil),              // 6: ethereum.engine.v1.ECDSASignature
...
var file_proto_engine_v1_execution_engine_proto_depIdxs = []int32{
	4, // 0: ethereum.engine.v1.ExecutionPayloadWithBlobTxs.blob_transactions:type_name -> ethereum.engine.v1.SignedBlobTransaction
	5, // 1: ethereum.engine.v1.SignedBlobTransaction.header:type_name -> ethereum.engine.v1.BlobTransaction
	6, // 2: ethereum.engine.v1.SignedBlobTransaction.signatures:type_name -> ethereum.engine.v1.ECDSASignature
...
func file_proto_engine_v1_execution_engine_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_proto_engine_v1_execution_engine_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ExecutionPayloadWithBlobTxs); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_proto_engine_v1_execution_engine_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*SignedBlobTransaction); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
