...
// source: sharding/v1/services.proto
...
func (*ShuffleRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_services_52dcf1ab43afe490, []int{0}
}
...
func (*ShuffleResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_services_52dcf1ab43afe490, []int{1}
}
...
type ProposeRequest struct {
	...
	ShardAggregateVotes     []*AggregateVote `protobuf:"bytes,4,rep,name=shard_aggregate_votes,json=shardAggregateVotes,proto3" json:"shard_aggregate_votes,omitempty"`
	XXX_NoUnkeyedLiteral    struct{}         `json:"-"`
	XXX_unrecognized        []byte           `json:"-"`
	XXX_sizecache           int32            `json:"-"`
}
...
func (*ProposeRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_services_52dcf1ab43afe490, []int{2}
}
...
func (m *ProposeRequest) GetShardAggregateVotes() []*AggregateVote {
	if m != nil {
...
func (*ProposeResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_services_52dcf1ab43afe490, []int{3}
}
...
func (*SignRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_services_52dcf1ab43afe490, []int{4}
}
...
func (m *SignRequest) GetSignature() *Signature {
	if m != nil {
		return m.Signature
	}
	return nil
...
func (*SignResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_services_52dcf1ab43afe490, []int{5}
}
...
func init() {
	proto.RegisterType((*ShuffleRequest)(nil), "sharding.v1.ShuffleRequest")
	proto.RegisterType((*ShuffleResponse)(nil), "sharding.v1.ShuffleResponse")
	proto.RegisterType((*ProposeRequest)(nil), "sharding.v1.ProposeRequest")
	proto.RegisterType((*ProposeResponse)(nil), "sharding.v1.ProposeResponse")
	proto.RegisterType((*SignRequest)(nil), "sharding.v1.SignRequest")
	proto.RegisterType((*SignResponse)(nil), "sharding.v1.SignResponse")
}
...
func (c *beaconServiceClient) ShuffleValidators(ctx context.Context, in *ShuffleRequest, opts ...grpc.CallOption) (*ShuffleResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/sharding.v1.BeaconService/ShuffleValidators", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *beaconServiceClient) SignBlock(ctx context.Context, in *SignRequest, opts ...grpc.CallOption) (*SignResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/sharding.v1.BeaconService/SignBlock", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *beaconServiceClient) ProposeBlock(ctx context.Context, in *ProposeRequest, opts ...grpc.CallOption) (*ProposeResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/sharding.v1.BeaconService/ProposeBlock", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _BeaconService_ShuffleValidators_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/sharding.v1.BeaconService/ShuffleValidators",
	}
...
func _BeaconService_SignBlock_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/sharding.v1.BeaconService/SignBlock",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _BeaconService_ProposeBlock_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/sharding.v1.BeaconService/ProposeBlock",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _BeaconService_serviceDesc = grpc.ServiceDesc{
	ServiceName: "sharding.v1.BeaconService",
	...
	Metadata: "sharding/v1/services.proto",
}

func init() {
	proto.RegisterFile("sharding/v1/services.proto", fileDescriptor_services_52dcf1ab43afe490)
}

var fileDescriptor_services_52dcf1ab43afe490 = []byte{
	// 464 bytes of a gzipped FileDescriptorProto
	,
}
