...
func BlockIfaceToV1BlockHeader(block blockInterface.SignedBeaconBlock) (*ethpb.SignedBeaconBlockHeader, error) {
...
func SignedBeaconBlock(block blockInterface.SignedBeaconBlock) (*ethpb.SignedBeaconBlock, error) {
