...
func BlockIfaceToV1BlockHeader(block block2.SignedBeaconBlock) (*ethpb.SignedBeaconBlockHeader, error) {
...
func SignedBeaconBlock(block block2.SignedBeaconBlock) (*ethpb.SignedBeaconBlock, error) {
