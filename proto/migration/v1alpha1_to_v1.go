...
// SignedBeaconBlockV1 converts a signed beacon block interface to a v1 block.
func SignedBeaconBlockV1(block block.SignedBeaconBlock) (*ethpbv1.SignedBeaconBlock, error) {
