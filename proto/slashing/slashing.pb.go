...
type SignedBlkHeaderWrapper struct {
	SignedBlockHeader    *v1alpha1.SignedBeaconBlockHeader `protobuf:"bytes,1,opt,name=signed_block_header,json=signedBlockHeader,proto3" json:"signed_block_header,omitempty"`
...
func (m *SignedBlkHeaderWrapper) Reset()         { *m = SignedBlkHeaderWrapper{} }
func (m *SignedBlkHeaderWrapper) String() string { return proto.CompactTextString(m) }
func (*SignedBlkHeaderWrapper) ProtoMessage()    {}
func (*SignedBlkHeaderWrapper) Descriptor() ([]byte, []int) {
	return fileDescriptor_da7e95107d0081b4, []int{8}
}
func (m *SignedBlkHeaderWrapper) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *SignedBlkHeaderWrapper) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_SignedBlkHeaderWrapper.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *SignedBlkHeaderWrapper) XXX_Merge(src proto.Message) {
	xxx_messageInfo_SignedBlkHeaderWrapper.Merge(m, src)
}
func (m *SignedBlkHeaderWrapper) XXX_Size() int {
	return m.Size()
}
func (m *SignedBlkHeaderWrapper) XXX_DiscardUnknown() {
	xxx_messageInfo_SignedBlkHeaderWrapper.DiscardUnknown(m)
}

var xxx_messageInfo_SignedBlkHeaderWrapper proto.InternalMessageInfo

func (m *SignedBlkHeaderWrapper) GetSignedBlockHeader() *v1alpha1.SignedBeaconBlockHeader {
	if m != nil {
		return m.SignedBlockHeader
	}
	return nil
}

func (m *SignedBlkHeaderWrapper) GetSigningRoot() []byte {
	if m != nil {
...
type IndexedAttestationWrapper struct {
	IndexedAttestation   *v1alpha1.IndexedAttestation `protobuf:"bytes,1,opt,name=indexed_attestation,json=indexedAttestation,proto3" json:"indexed_attestation,omitempty"`
	SigningRoot          []byte                       `protobuf:"bytes,2,opt,name=signing_root,json=signingRoot,proto3" json:"signing_root,omitempty"`
	XXX_NoUnkeyedLiteral struct{}                     `json:"-"`
	XXX_unrecognized     []byte                       `json:"-"`
	XXX_sizecache        int32                        `json:"-"`
...
func (m *IndexedAttestationWrapper) Reset()         { *m = IndexedAttestationWrapper{} }
func (m *IndexedAttestationWrapper) String() string { return proto.CompactTextString(m) }
func (*IndexedAttestationWrapper) ProtoMessage()    {}
func (*IndexedAttestationWrapper) Descriptor() ([]byte, []int) {
	return fileDescriptor_da7e95107d0081b4, []int{9}
}
func (m *IndexedAttestationWrapper) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *IndexedAttestationWrapper) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_IndexedAttestationWrapper.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *IndexedAttestationWrapper) XXX_Merge(src proto.Message) {
	xxx_messageInfo_IndexedAttestationWrapper.Merge(m, src)
}
func (m *IndexedAttestationWrapper) XXX_Size() int {
	return m.Size()
}
func (m *IndexedAttestationWrapper) XXX_DiscardUnknown() {
	xxx_messageInfo_IndexedAttestationWrapper.DiscardUnknown(m)
}

var xxx_messageInfo_IndexedAttestationWrapper proto.InternalMessageInfo

func (m *IndexedAttestationWrapper) GetIndexedAttestation() *v1alpha1.IndexedAttestation {
	if m != nil {
		return m.IndexedAttestation
	}
	return nil
}

func (m *IndexedAttestationWrapper) GetSigningRoot() []byte {
	if m != nil {
		return m.SigningRoot
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*SignedBlkHeaderWrapper)(nil), "ethereum.slashing.SignedBlkHeaderWrapper")
	proto.RegisterType((*IndexedAttestationWrapper)(nil), "ethereum.slashing.IndexedAttestationWrapper")
}
...
var fileDescriptor_da7e95107d0081b4 = []byte{
	...
	,
}
...
func (m *SignedBlkHeaderWrapper) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *SignedBlkHeaderWrapper) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *SignedBlkHeaderWrapper) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	if len(m.SigningRoot) > 0 {
		...
		i = encodeVarintSlashing(dAtA, i, uint64(len(m.SigningRoot)))
		i--
		dAtA[i] = 0x12
	}
	if m.SignedBlockHeader != nil {
		{
			size, err := m.SignedBlockHeader.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *IndexedAttestationWrapper) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *IndexedAttestationWrapper) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *IndexedAttestationWrapper) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	if m.IndexedAttestation != nil {
		{
			size, err := m.IndexedAttestation.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *SignedBlkHeaderWrapper) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *IndexedAttestationWrapper) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *SignedBlkHeaderWrapper) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: SignedBlkHeaderWrapper: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: SignedBlkHeaderWrapper: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field SignedBlockHeader", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.SignedBlockHeader == nil {
				m.SignedBlockHeader = &v1alpha1.SignedBeaconBlockHeader{}
			}
			if err := m.SignedBlockHeader.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 2:
...
func (m *IndexedAttestationWrapper) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: IndexedAttestationWrapper: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: IndexedAttestationWrapper: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field IndexedAttestation", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.IndexedAttestation == nil {
				m.IndexedAttestation = &v1alpha1.IndexedAttestation{}
			}
			if err := m.IndexedAttestation.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 2:
