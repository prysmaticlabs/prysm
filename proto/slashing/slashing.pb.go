...
type HighestAttestation struct {
	...
	HighestSourceEpoch   github_com_farazdagi_prysm_shared_types.Epoch `protobuf:"varint,2,opt,name=highest_source_epoch,json=highestSourceEpoch,proto3,casttype=github.com/farazdagi/prysm-shared-types.Epoch" json:"highest_source_epoch,omitempty"`
	HighestTargetEpoch   github_com_farazdagi_prysm_shared_types.Epoch `protobuf:"varint,3,opt,name=highest_target_epoch,json=highestTargetEpoch,proto3,casttype=github.com/farazdagi/prysm-shared-types.Epoch" json:"highest_target_epoch,omitempty"`
	XXX_NoUnkeyedLiteral struct{}                                      `json:"-"`
	XXX_unrecognized     []byte                                        `json:"-"`
	XXX_sizecache        int32                                         `json:"-"`
}
...
func (m *HighestAttestation) GetHighestSourceEpoch() github_com_farazdagi_prysm_shared_types.Epoch {
	if m != nil {
...
func (m *HighestAttestation) GetHighestTargetEpoch() github_com_farazdagi_prysm_shared_types.Epoch {
	if m != nil {
...
type ProposalHistory struct {
	...
	LatestEpochWritten   github_com_farazdagi_prysm_shared_types.Epoch `protobuf:"varint,2,opt,name=latest_epoch_written,json=latestEpochWritten,proto3,casttype=github.com/farazdagi/prysm-shared-types.Epoch" json:"latest_epoch_written,omitempty"`
	XXX_NoUnkeyedLiteral struct{}                                      `json:"-"`
	XXX_unrecognized     []byte                                        `json:"-"`
	XXX_sizecache        int32                                         `json:"-"`
}
...
func (m *ProposalHistory) GetLatestEpochWritten() github_com_farazdagi_prysm_shared_types.Epoch {
	if m != nil {
...
func (m *AttestationHistory) GetLatestEpochWritten() github_com_farazdagi_prysm_shared_types.Epoch {
	if m != nil {
		return m.LatestEpochWritten
	}
	return 0
...
var fileDescriptor_da7e95107d0081b4 = []byte{
	...
	,
}
	...
	for iNdEx < l {
		...
		case 2:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.HighestSourceEpoch |= github_com_farazdagi_prysm_shared_types.Epoch(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 3:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.HighestTargetEpoch |= github_com_farazdagi_prysm_shared_types.Epoch(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
	...
	for iNdEx < l {
		...
		case 2:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.LatestEpochWritten |= github_com_farazdagi_prysm_shared_types.Epoch(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
