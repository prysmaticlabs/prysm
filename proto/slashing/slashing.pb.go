...
type ValidatorProposalHistory struct {
	ProposalHistory      github_com_prysmaticlabs_go_bitfield.Bitlist `protobuf:"bytes,1,opt,name=proposal_history,json=proposalHistory,proto3,casttype=github.com/prysmaticlabs/go-bitfield.Bitlist" json:"proposal_history,omitempty"`
...
func (m *ValidatorProposalHistory) GetProposalHistory() github_com_prysmaticlabs_go_bitfield.Bitlist {
	if m != nil {
...
func (m *ValidatorProposalHistory) GetLatestEpochWritten() uint64 {
	if m != nil {
...
func init() {
	...
	proto.RegisterType((*ValidatorProposalHistory)(nil), "ethereum.slashing.ValidatorProposalHistory")
}
...
var fileDescriptor_da7e95107d0081b4 = []byte{
	...
	,
}
...
func (m *ValidatorProposalHistory) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	if len(m.ProposalHistory) > 0 {
		i -= len(m.ProposalHistory)
		copy(dAtA[i:], m.ProposalHistory)
		i = encodeVarintSlashing(dAtA, i, uint64(len(m.ProposalHistory)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
