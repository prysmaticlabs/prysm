...
var (
	...
	// ApiTimeout specifies the length of an HTTP request timeout in minutes.
	ApiTimeout = &cli.DurationFlag{
		Name:  "api-timeout",
		Usage: "Specify the length of timeout for API requests in minutes",
		Value: 2 * time.Minute,
	}
)
