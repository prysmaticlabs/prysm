...
func TestEnterPassword(t *testing.T) {
	...
	var tt = []struct {
		...
		{
			name:        "first_match",
			rets:        []rets{{pw: "abcd", err: nil}, {pw: "abcd", err: nil}},
			expectedErr: nil,
			expectedPw:  "abcd",
		},
		{
			name:        "first_match_with_newline",
			rets:        []rets{{pw: "abcd\n", err: nil}, {pw: "abcd", err: nil}},
			expectedErr: nil,
			expectedPw:  "abcd",
		},
		{
			name:        "first_match_with_newline_confirm",
			rets:        []rets{{pw: "abcd", err: nil}, {pw: "abcd\n", err: nil}},
			expectedErr: nil,
			expectedPw:  "abcd",
		},
		{
			name:        "first_match_both_newline",
			rets:        []rets{{pw: "abcd\n", err: nil}, {pw: "abcd\n", err: nil}},
			expectedErr: nil,
			expectedPw:  "abcd",
		},
		{
			name:        "second_match",
			rets:        []rets{{pw: "abcd", err: nil}, {pw: "aba", err: nil}, {pw: "abcd", err: nil}, {pw: "abcd", err: nil}},
			expectedErr: nil,
			expectedPw:  "abcd",
		},
		{
			name:        "cant_read",
			rets:        []rets{{pw: "pw", err: errors.New("i/o fail")}},
			expectedErr: errors.New("i/o fail"),
			expectedPw:  "",
		},
	}
