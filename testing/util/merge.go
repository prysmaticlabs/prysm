...
// NewBeaconBlockEPBS creates a beacon block with minimum marshalable fields.
func NewBeaconBlockEPBS() *ethpb.SignedBeaconBlockEpbs {
	return HydrateSignedBeaconBlockEPBS(&ethpb.SignedBeaconBlockEpbs{})
}