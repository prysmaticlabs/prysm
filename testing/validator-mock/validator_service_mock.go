...
func (m *MockValidatorService) RandomActiveValidator() ([48]byte, primitives.ValidatorIndex, error) {
	m.ctrl.T.Helper()
...
func (mr *MockValidatorServiceMockRecorder) RandomActiveValidator() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "RandomActiveValidator", reflect.TypeOf((*MockValidatorService)(nil).RandomActiveValidator))
}
