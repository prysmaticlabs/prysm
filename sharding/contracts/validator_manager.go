...
type VMCCollationAdded struct {
	ShardId         *big.Int
	CollationHeader []byte
	IsNewHead       bool
	Score           *big.Int
	Raw             types.Log // Blockchain specific contextual infos
}

// FilterCollationAdded is a free log retrieval operation binding the contract event 0x431eecd13a3a04d2fdec84f4cb3ec783d0a6b1d7e92500bdd8d8de0dca7b2510.
//
// Solidity: event CollationAdded(shardId indexed uint256, collationHeader bytes, isNewHead bool, score uint256)
...
// WatchCollationAdded is a free log subscription operation binding the contract event 0x431eecd13a3a04d2fdec84f4cb3ec783d0a6b1d7e92500bdd8d8de0dca7b2510.
//
// Solidity: event CollationAdded(shardId indexed uint256, collationHeader bytes, isNewHead bool, score uint256)
