...
go_repository(
    ...
    commit = "b1f58c0365c0a8af3928cb1937d95e2554cb89a6",  # v0.2.3
...
go_repository(
    ...
    build_file_proto_mode = "disable_global",
    commit = "6b94711fc471e6d8e5e2ca72c955ea1d3ca643a9",  # v0.7.2
...
go_repository(
    ...
    commit = "a8232c8ad2e784b3966d04f86a28f9223d1d11a8",  # v0.4.1
...
go_repository(
    ...
    commit = "4b4c43c6b164c72028792a5e709437bdf150b263",  # v0.2.2
...
go_repository(
    ...
    build_file_proto_mode = "disable_global",
    commit = "105e0c6d63f10531ed07f3b5a2195771a0fa444b",  # v0.18.1
...
go_repository(
    name = "io_k8s_api",
    build_file_proto_mode = "disable_global",
    commit = "397b068634f76a03972fd5f822562aa82204a080",  # v0.18.1
