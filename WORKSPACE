...
filegroup(
    ...
    """,
    sha256 = "03f088de4936d45986005da583aff82b4d934f4bf9e171f53720d4b492dfe40a",
...
filegroup(
    ...
    """,
    sha256 = "a3a83dbd3abe1bfb52bc3583051302f376a39d38211fe3adb386b8c05a6a6df5",
...
filegroup(
    ...
    """,
    sha256 = "6c7596528cd999628c7b402d4954ae61d9aad81c41a4dfdf42abfa546058ae0d",
...
http_archive(
    ...
    urls = ["https://github.com/edenhill/librdkafka/archive/v1.3.0.tar.gz"],
)
...
go_repository(
    ...
    commit = "9ad477ba8b7a369cad709790eca366e8afe2d3e0",  # v0.6.0
...
go_repository(
    ...
    commit = "59abcf549dadaf50b2c1d089203bf808f8b38ca9",  # v0.2.0
...
go_repository(
    ...
    commit = "fc1542af81e36fff7740bffec7277dde962f638d",  # v0.1.3
...
go_repository(
    ...
    commit = "4850c197847aa06aecc37570077fc16e9215d565",  # v0.0.10
...
go_repository(
    ...
    commit = "f0fffd9a2f5b58f79ae54b6940c8eef4bfc6542b",  # v0.1.1
...
go_repository(
    ...
    build_file_proto_mode = "disable_global",
    commit = "dffa2f8b27f804ef3b315d336b46d7d28acdf1b0",  # v0.5.2
...
go_repository(
    ...
    commit = "2c6281f942344897619330abc7c911b879d04468",  # v0.3.1
...
go_repository(
    ...
    build_file_proto_mode = "disable_global",
    commit = "731dcecc205498f52a21b12e311af095efb4b188",  # v0.17.4
...
go_repository(
    name = "io_k8s_api",
    build_file_proto_mode = "disable_global",
    commit = "d3c87f2f52e31c74a4ccb065b706b688f4e6341d",  # v0.17.4
...
go_repository(
    ...
    commit = "0da06874266c88228b8f14615396a1f6bfc90ed7",  # v0.0.6
...
go_repository(
    ...
    commit = "a6b88cf34a491498e4c7d15c107a31058693e2cb",  # v0.54.0
...
go_repository(
    ...
    build_file_proto_mode = "disable_global",
    commit = "371a34d8018b939c5a2bfafb4afd64a690b8827b",  # v0.5.0
...
go_repository(
    ...
    commit = "9c1c8644183fc8cb3bc7693a0303ba990105599d",  # v0.2.3
    importpath = "github.com/libp2p/go-libp2p-yamux",
)

go_repository(
    name = "com_github_libp2p_go_libp2p_mplex",
    commit = "3643ce4ddb91f4ba819b3ff247207c854e17527d",  # v0.2.2
