...
def bls_dependencies():
    _maybe(
        ...
        build_file = "@prysm//hack/third_party/herumi:bls_eth_go_binary.BUILD",
    )
    _maybe(
        http_archive,
        name = "herumi_mcl",
        ...
        build_file = "@prysm//hack/third_party/herumi:mcl.BUILD",
    )
    _maybe(
        http_archive,
        name = "herumi_bls",
        ...
        build_file = "@prysm//hack/third_party/herumi:bls.BUILD",
    )
