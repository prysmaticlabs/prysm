...
require (
	...
	github.com/prysmaticlabs/ethereumapis v0.0.0-20210114085516-412aad9ca272
	...
	github.com/prysmaticlabs/protoc-gen-go-cast v0.0.0-20210114090733-ab96db35152c // indirect
