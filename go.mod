...
require (
	...
	github.com/prysmaticlabs/ethereumapis v0.0.0-20210326205829-aa6dddf57def
...
replace github.com/ethereum/go-ethereum => github.com/prysmaticlabs/bazel-go-ethereum v0.0.0-20210326202722-3ab481cbf467
