...
require (
	...
	github.com/alecthomas/gometalinter v2.0.5+incompatible
	...
	github.com/libp2p/go-libp2p-net v3.0.14+incompatible // indirect
	...
	github.com/nicksnyder/go-i18n v0.0.0-20170210005948-2c24b78755bd
