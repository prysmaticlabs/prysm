...
require (
	...
	github.com/prysmaticlabs/ethereumapis 174e3b90d786
	...
	github.com/wealdtech/go-eth2-wallet-types/v2 v2.3.0
	github.com/x-cray/logrus-prefixed-formatter v0.5.2
	go.etcd.io/bbolt v1.3.5
	go.opencensus.io v0.22.4
	go.uber.org/automaxprocs v1.3.0
	golang.org/x/crypto 75b288015ac9
	golang.org/x/exp v0.0.0-20200513190911-00229845015e
	golang.org/x/net v0.0.0-20200528225125-3c3fba18258b // indirect
	golang.org/x/sys v0.0.0-20200523222454-059865788121 // indirect
	golang.org/x/tools 0cc1aa72b347
	google.golang.org/genproto 07506425bd67
