...
// MockSlasherServiceServer is a mock of BeaconServiceServer interface
...
func (m *MockServiceServer) BlockTree(arg0 context.Context, arg1 *types.Empty) (*v1.BlockTreeResponse, error) {
	m.ctrl.T.Helper()
