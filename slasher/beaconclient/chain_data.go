...
func (s *Service) ChainHead(
	...
	defer span.End()
	res, err := s.cfg.BeaconClient.GetChainHead(ctx, &emptypb.Empty{})
	if err != nil || res == nil {
...
func (s *Service) GenesisValidatorsRoot(
	...
	if s.genesisValidatorRoot == nil {
		res, err := s.cfg.NodeClient.GetGenesis(ctx, &emptypb.Empty{})
		if err != nil {
...
func (s *Service) querySyncStatus(ctx context.Context) {
	status, err := s.cfg.NodeClient.GetSyncStatus(ctx, &emptypb.Empty{})
	if err != nil {
