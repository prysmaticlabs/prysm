...
def prysm_deps():
    ...
    go_repository(
        ...
        sum = "h1:6JJVl8gqGTpM7+zW+kP6ddON14qAvpAWIo8tQQ98XdI=",
        version = "v1.10.24-0.20230201150825-5c8cc10d1e05",
    )
    ...
    go_repository(
        ...
        sum = "h1:JVxN5Ca7ds0ZqvEBfoMsXOBWS+GA7uPkhPZiaLXSep8=",
        version = "v0.0.0-20230215205823-6741487670ed",
    )
