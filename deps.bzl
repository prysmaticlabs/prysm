...
def prysm_deps():
    ...
    go_repository(
        ...
        sum = "h1:eU2PgZzEXzp4EEmHHCqS0ZUnbHz9E78s3dss9BXSOM8=",
        version = "v0.0.0-20210401210457-db0002bfd4ac",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:YSp7NCCDMdW4AIsdmef1Ica8CV+e5onmkPcws0+NWPQ=",
        version = "v0.0.0-20210401203017-e5049b268be2",
    )
