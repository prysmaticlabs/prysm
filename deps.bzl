...
def prysm_deps():
    ...
    go_repository(
        ...
        sum = "h1:xrZtQ0tUH1w+JcNuUbHdJfUgqZIz31lE2Ps0dhMZH1U=",
        version = "v1.10.19-0.20220607211042-6d4820c91805",
    )
    ...
    go_repository(
        ...
        sum = "h1:geJA1V5NgjlkR4syD9wdf5L5RMVzAaFxAA6cgdV/JkQ=",
        version = "v0.0.0-20220602201051-e406b8091121",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:rQicVCEacWyk4JZ6G5bD9TKR7lZEG1MWcG7UdWYrFAU=",
        version = "v0.5.0",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:moKKKG875KNGsCjZxTIFB75ihHiVjFeWg5I4aR1pDLk=",
        version = "v0.18.0",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:kTnLArltMabZlzY63pgGDA4kkUcLkBFSM98zBssn/IY=",
        version = "v0.3.0",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:0kYSgiK/D7Eo28GTuRXo5YHsWwAisVpFCqCVPUd/vJs=",
        version = "v0.14.0",
    )
    ...
    go_repository(
        ...
        sum = "h1:5ubK4/vLE2JkogKlJ2JLeXcSfA6qY6mE2HMJV9ve/Sk=",
        version = "v0.6.0",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:HJminhQSGISBIRb93N6WK3t6Fa8OOTnHd/VBjL4mY5A=",
        version = "v0.6.0",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:UaXf+CTq6Ns1N2V1EgqJ9Q3xaRsiN7ImVlDMpirMAWw=",
        version = "v0.10.2",
    )
    go_repository(
        name = "com_github_libp2p_go_libp2p_testing",
        importpath = "github.com/libp2p/go-libp2p-testing",
        sum = "h1:/te8SOIyj5sGH5Jr1Uoo+qYB00aK8O4+yHGzLgfE3kc=",
        version = "v0.8.0",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:MSMe+tUfxpC9GArTz7a4G5zQKQgGh00Vio87d3j3xIg=",
        version = "v0.7.1",
    )
    go_repository(
        name = "com_github_libp2p_go_libp2p_yamux",
        importpath = "github.com/libp2p/go-libp2p-yamux",
        sum = "h1:6GKWntresp0TFxMP/oSoH96nV8XKJRdynXsdp43dn0Y=",
        version = "v0.8.2",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:5kKp029zrsLVJT5q6ASt4LwuZFxj3B13wXXaGmFrWg0=",
        version = "v0.6.0",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:edOOs688VLZAozWC7Kj5/6HHXKNwi9M6wgRmmLa8M6Q=",
        version = "v0.5.1",
    )
    ...
    go_repository(
        ...
        sum = "h1:326XBL6Q+5CQ2KtjXz32+eGu02W/Kz2+Fm4SpXdr0q4=",
        version = "v0.6.0",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:LW0q5+A1Wy0npEsPJP9wmare2NH4ohNluN5EWVwv2mE=",
        version = "v3.0.2",
    )
    ...
    go_repository(
        ...
        sum = "h1:S25/rfnfsMVgORT4/J61MJ7rdyseOZOyvLIrZEZ7s6s=",
