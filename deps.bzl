...
def prysm_deps():
    ...
    go_repository(
        ...
        sum = "h1:2fNOyQqrHSjFdqnKqSLj9W7eGTcqKujJPA8vAuT1zN8=",
        version = "v0.0.0-20230821143352-55b44ac08de8",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:GJjjtWJ+db1xGao7vTsOgAOGgjfPe7eRGPL+xxMX0qE=",
        version = "v0.11.2",
    )
    ...
    go_repository(
        ...
        sum = "h1:dglsK4NuDRreW5+/0EoTFxCiZwkRZay/aDoOul2lca0=",
        version = "v1.10.10-0.20230829211949-79f3c2d9c96b",
    )
